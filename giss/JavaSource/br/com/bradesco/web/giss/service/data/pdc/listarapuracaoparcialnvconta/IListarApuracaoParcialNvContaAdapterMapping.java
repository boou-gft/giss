 ...
 */
public interface IListarApuracaoParcialNvContaAdapterMapping {
     ...
     */
    String mappingRequest(ListarApuracaoParcialNvContaRequest message);
     ...
     */
    ListarApuracaoParcialNvContaResponse mappingResponse(String response);
