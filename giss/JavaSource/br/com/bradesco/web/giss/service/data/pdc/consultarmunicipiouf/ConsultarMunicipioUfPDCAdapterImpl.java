package br.com.bradesco.web.giss.service.data.pdc.consultarmunicipiouf;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarMunicipioUf
 * </p>
 * 
 ...
 */
public class ConsultarMunicipioUfPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarMunicipioUfPDCAdapter, IConsultarMunicipioUfAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarmunicipiouf.IConsultarMunicipioUfPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarmunicipiouf.request.ConsultarMunicipioUfRequest)
     * @param message Objeto do tipo ConsultarMunicipioUfRequest 
     ...
     * @return Objeto do tipo ConsultarMunicipioUfResponse 
     ...
     */
    public ConsultarMunicipioUfResponse invokeProcess(
            ConsultarMunicipioUfRequest message) 
     ...
     */
    public String mappingRequest(ConsultarMunicipioUfRequest message) {
     ...
     * objeto do tipo ConsultarMunicipioUfResponse.
     * 
	 * @param response Objeto do tipo ConsultarMunicipioUfResponse 
     ...
     */
    public ConsultarMunicipioUfResponse mappingResponse(String response) {

        ConsultarMunicipioUfResponse processResponse = new ConsultarMunicipioUfResponse();
        try {
            
            processResponse = 
            	(ConsultarMunicipioUfResponse) ConsultarMunicipioUfResponse.
