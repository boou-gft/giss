package br.com.bradesco.web.giss.service.data.pdc.excluirctacontabil;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirCtaContabil
 * </p>
 * 
 ...
 */
public class ExcluirCtaContabilPDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirCtaContabilPDCAdapter, IExcluirCtaContabilAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.excluirctacontabil.IExcluirCtaContabilPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.excluirctacontabil.request.ExcluirCtaContabilRequest)
     * @param message Objeto do tipo ExcluirCtaContabilRequest 
     ...
     * @return Objeto do tipo ExcluirCtaContabilResponse 
     ...
     */
    public ExcluirCtaContabilResponse invokeProcess(
            ExcluirCtaContabilRequest message) 
     ...
     */
    public String mappingRequest(ExcluirCtaContabilRequest message) {
     ...
     * objeto do tipo ExcluirCtaContabilResponse.
     * 
	 * @param response Objeto do tipo ExcluirCtaContabilResponse 
     ...
     */
    public ExcluirCtaContabilResponse mappingResponse(String response) {

        ExcluirCtaContabilResponse processResponse = new ExcluirCtaContabilResponse();
        try {
            
            processResponse = 
            	(ExcluirCtaContabilResponse) ExcluirCtaContabilResponse.
