 ...
 */
public interface ISolicitarRemessaAliquotaAdapterMapping {
     ...
     */
    String mappingRequest(SolicitarRemessaAliquotaRequest message);
     ...
     */
    SolicitarRemessaAliquotaResponse mappingResponse(String response);
