package br.com.bradesco.web.giss.service.data.pdc.consultarcompetencia;
...
import br.com.bradesco.web.giss.service.data.pdc.consultarcompetencia.request.ConsultarCompetenciaRequest;
import br.com.bradesco.web.giss.service.data.pdc.consultarcompetencia.response.ConsultarCompetenciaResponse;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarCompetencia
 * </p>
 * 
 ...
 */
public class ConsultarCompetenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarCompetenciaPDCAdapter, IConsultarCompetenciaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarcompetencia.IConsultarCompetenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarcompetencia.request.ConsultarCompetenciaRequest)
     * @param message Objeto do tipo ConsultarCompetenciaRequest 
     ...
     * @return Objeto do tipo ConsultarCompetenciaResponse 
     ...
     */
    public ConsultarCompetenciaResponse invokeProcess(
            ConsultarCompetenciaRequest message) 
     ...
     */
    public String mappingRequest(ConsultarCompetenciaRequest message) {
     ...
     * objeto do tipo ConsultarCompetenciaResponse.
     * 
	 * @param response Objeto do tipo ConsultarCompetenciaResponse 
     ...
     */
    public ConsultarCompetenciaResponse mappingResponse(String response) {

        ConsultarCompetenciaResponse processResponse = new ConsultarCompetenciaResponse();
        try {
            
            processResponse = 
            	(ConsultarCompetenciaResponse) ConsultarCompetenciaResponse.
