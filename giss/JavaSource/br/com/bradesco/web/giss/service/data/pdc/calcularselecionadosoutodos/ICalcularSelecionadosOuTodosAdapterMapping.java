 ...
 */
public interface ICalcularSelecionadosOuTodosAdapterMapping {
     ...
     */
    String mappingRequest(CalcularSelecionadosOuTodosRequest message);
     ...
     */
    CalcularSelecionadosOuTodosResponse mappingResponse(String response);
