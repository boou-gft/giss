 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ManterAliquotaManutencao
 * </p>
 * 
 ...
 */
public class ManterAliquotaManutencaoPDCAdapterImpl extends PdcBaseAdapter implements
        IManterAliquotaManutencaoPDCAdapter, IManterAliquotaManutencaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ManterAliquotaManutencaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ManterAliquotaManutencaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ManterAliquotaManutencaoResponse invokeProcess(ManterAliquotaManutencaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaManutencaoResponse invokeProcess(ManterAliquotaManutencaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ManterAliquotaManutencaoRequest 
     ...
     */
    private ManterAliquotaManutencaoResponse invokeProcess(
            ManterAliquotaManutencaoRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaManutencaoResponse[] invokeProcess(ManterAliquotaManutencaoRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaManutencaoResponse[] invokeProcess(ManterAliquotaManutencaoRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ManterAliquotaManutencaoRequest message) {
     ...
     * objeto do tipo ManterAliquotaManutencaoResponse.
     * 
	 * @param response Objeto do tipo ManterAliquotaManutencaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ManterAliquotaManutencaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ManterAliquotaManutencaoResponse mappingResponse(String response) {

        ManterAliquotaManutencaoResponse processResponse = new ManterAliquotaManutencaoResponse();
        try {
            
            processResponse = 
            	(ManterAliquotaManutencaoResponse) ManterAliquotaManutencaoResponse.
