package br.com.bradesco.web.giss.service.data.pdc.resultpesqapurmovnaotributavel;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ResultPesqApurMovNaoTributavel
 * </p>
 * 
 ...
 */
public class ResultPesqApurMovNaoTributavelPDCAdapterImpl extends PdcBaseAdapter implements
        IResultPesqApurMovNaoTributavelPDCAdapter, IResultPesqApurMovNaoTributavelAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.resultpesqapurmovnaotributavel.IResultPesqApurMovNaoTributavelPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.resultpesqapurmovnaotributavel.request.ResultPesqApurMovNaoTributavelRequest)
     * @param message Objeto do tipo ResultPesqApurMovNaoTributavelRequest 
     ...
     * @return Objeto do tipo ResultPesqApurMovNaoTributavelResponse 
     ...
     */
    public ResultPesqApurMovNaoTributavelResponse invokeProcess(
            ResultPesqApurMovNaoTributavelRequest message) 
     ...
     */
    public String mappingRequest(ResultPesqApurMovNaoTributavelRequest message) {
     ...
     * objeto do tipo ResultPesqApurMovNaoTributavelResponse.
     * 
	 * @param response Objeto do tipo ResultPesqApurMovNaoTributavelResponse 
     ...
     */
    public ResultPesqApurMovNaoTributavelResponse mappingResponse(String response) {

        ResultPesqApurMovNaoTributavelResponse processResponse = new ResultPesqApurMovNaoTributavelResponse();
        try {
            
            processResponse = 
            	(ResultPesqApurMovNaoTributavelResponse) ResultPesqApurMovNaoTributavelResponse.
