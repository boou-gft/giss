 ...
 */
public interface IAprovarCargaMassivaAdapterMapping {
     ...
     */
    String mappingRequest(AprovarCargaMassivaRequest message);
     ...
     */
    AprovarCargaMassivaResponse mappingResponse(String response);
