 ...
 */
public interface IListarRetificadorContabilPDCAdapter {
     ...
     */
    ListarRetificadorContabilResponse invokeProcess(ListarRetificadorContabilRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarRetificadorContabilResponse invokeProcess(ListarRetificadorContabilRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ListarRetificadorContabilResponse[] invokeProcess(ListarRetificadorContabilRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarRetificadorContabilResponse[] invokeProcess(ListarRetificadorContabilRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
