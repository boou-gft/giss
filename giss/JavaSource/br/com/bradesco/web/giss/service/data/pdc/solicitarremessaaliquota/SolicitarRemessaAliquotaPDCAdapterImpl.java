 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: SolicitarRemessaAliquota
 * </p>
 * 
 ...
 */
public class SolicitarRemessaAliquotaPDCAdapterImpl extends PdcBaseAdapter implements
        ISolicitarRemessaAliquotaPDCAdapter, ISolicitarRemessaAliquotaAdapterMapping {
     ...
     */
    public SolicitarRemessaAliquotaResponse invokeProcess(SolicitarRemessaAliquotaRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarRemessaAliquotaResponse invokeProcess(SolicitarRemessaAliquotaRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo SolicitarRemessaAliquotaRequest 
     ...
     */
    private SolicitarRemessaAliquotaResponse invokeProcess(
            SolicitarRemessaAliquotaRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarRemessaAliquotaResponse[] invokeProcess(SolicitarRemessaAliquotaRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarRemessaAliquotaResponse[] invokeProcess(SolicitarRemessaAliquotaRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(SolicitarRemessaAliquotaRequest message) {
     ...
     * objeto do tipo SolicitarRemessaAliquotaResponse.
     * 
	 * @param response Objeto do tipo SolicitarRemessaAliquotaResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo SolicitarRemessaAliquotaResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public SolicitarRemessaAliquotaResponse mappingResponse(String response) {

        SolicitarRemessaAliquotaResponse processResponse = new SolicitarRemessaAliquotaResponse();
        try {
            
            processResponse = 
            	(SolicitarRemessaAliquotaResponse) SolicitarRemessaAliquotaResponse.
