...
/**
 * Class DetalharJustificativaApuracaoResponseDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class DetalharJustificativaApuracaoResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DetalharJustificativaApuracaoResponseDescriptor() 
     {
        super();
        xmlName = "DetalharJustificativaApuracaoResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DetalharJustificativaApuracaoResponse target = (DetalharJustificativaApuracaoResponse) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _listaList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.detalharjustificativaapuracao.response.Lista.class, "_listaList", "lista", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    DetalharJustificativaApuracaoResponse target = (DetalharJustificativaApuracaoResponse) object;
                    target.addLista( (br.com.bradesco.web.giss.service.data.pdc.detalharjustificativaapuracao.response.Lista) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.detalharjustificativaapuracao.response.Lista();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.detalharjustificativaapuracao.response.DetalharJustificativaApuracaoResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.detalharjustificativaapuracao.response.DetalharJustificativaApuracaoResponse.class;
