 ...
 * Schema.
 * $Id: ComboTipoIncidenciaResponseDescriptor.java,v 1.1 2017/04/11 14:11:41 gmichelini Exp $
 */
...
/**
 * Class ComboTipoIncidenciaResponseDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:11:41 $
 */
public class ComboTipoIncidenciaResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ComboTipoIncidenciaResponseDescriptor() 
     {
        super();
        xmlName = "comboTipoIncidenciaResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ComboTipoIncidenciaResponse target = (ComboTipoIncidenciaResponse) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _ocorrenciasList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.combotipoincidencia.response.Ocorrencias.class, "_ocorrenciasList", "ocorrencias", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ComboTipoIncidenciaResponse target = (ComboTipoIncidenciaResponse) object;
                    target.addOcorrencias( (br.com.bradesco.web.giss.service.data.pdc.combotipoincidencia.response.Ocorrencias) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.combotipoincidencia.response.Ocorrencias();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.combotipoincidencia.response.ComboTipoIncidenciaResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.combotipoincidencia.response.ComboTipoIncidenciaResponse.class;
