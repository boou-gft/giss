 ...
 * Schema.
 * $Id: ListarMunicipiosNovosRequest.java,v 1.2 2017/06/05 15:06:05 gmichelini Exp $
 */

package br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.request;
...
/**
 * Class ListarMunicipiosNovosRequest.
 * 
 * @version $Revision: 1.2 $ $Date: 2017/06/05 15:06:05 $
 */
public class ListarMunicipiosNovosRequest implements java.io.Serializable {
    ...
    public ListarMunicipiosNovosRequest() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.request.ListarMunicipiosNovosRequest()
     ...
     * 
     * @param reader
     * @return ListarMunicipiosNovosRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.request.ListarMunicipiosNovosRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.request.ListarMunicipiosNovosRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.request.ListarMunicipiosNovosRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.request.ListarMunicipiosNovosRequest unmarshal(java.io.Reader) 
