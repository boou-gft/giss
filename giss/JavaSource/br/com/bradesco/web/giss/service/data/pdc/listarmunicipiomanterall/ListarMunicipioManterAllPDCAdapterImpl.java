 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarMunicipioManterAll
 * </p>
 * 
 ...
 */
public class ListarMunicipioManterAllPDCAdapterImpl extends PdcBaseAdapter implements
        IListarMunicipioManterAllPDCAdapter, IListarMunicipioManterAllAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarmunicipiomanterall.IListarMunicipioManterAllPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarmunicipiomanterall.request.ListarMunicipioManterAllRequest)
     * @param message Objeto do tipo ListarMunicipioManterAllRequest 
     ...
     */
    public ListarMunicipioManterAllResponse invokeProcess(
            ListarMunicipioManterAllRequest message) 
     ...
     */
    public String mappingRequest(ListarMunicipioManterAllRequest message) {
     ...
     * objeto do tipo ListarMunicipioManterAllResponse.
     * 
	 * @param response Objeto do tipo ListarMunicipioManterAllResponse 
     ...
     */
    public ListarMunicipioManterAllResponse mappingResponse(String response) {

        ListarMunicipioManterAllResponse processResponse = new ListarMunicipioManterAllResponse();
        try {
            
            processResponse = 
            	(ListarMunicipioManterAllResponse) ListarMunicipioManterAllResponse.
