 ...
 * Schema.
 * $Id: OcorrenciasMunManterDescriptor.java,v 1.3 2017/06/05 16:32:35 gmichelini Exp $
 */
...
public class OcorrenciasMunManterDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasMunManterDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanter.response.OcorrenciasMunManterDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanter.response.OcorrenciasMunManter.class;
