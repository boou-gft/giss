 ...
 */
public interface IConsultarMunicipiosNovosAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarMunicipiosNovosRequest message);
     ...
     */
    ConsultarMunicipiosNovosResponse mappingResponse(String response);
