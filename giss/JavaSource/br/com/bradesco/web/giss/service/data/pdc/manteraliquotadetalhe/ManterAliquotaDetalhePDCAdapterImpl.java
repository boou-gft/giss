package br.com.bradesco.web.giss.service.data.pdc.manteraliquotadetalhe;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ManterAliquotaDetalhe
 * </p>
 * 
 ...
 */
public class ManterAliquotaDetalhePDCAdapterImpl extends PdcBaseAdapter implements
        IManterAliquotaDetalhePDCAdapter, IManterAliquotaDetalheAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ManterAliquotaDetalheRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ManterAliquotaDetalheResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ManterAliquotaDetalheResponse invokeProcess(ManterAliquotaDetalheRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaDetalheResponse invokeProcess(ManterAliquotaDetalheRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ManterAliquotaDetalheRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ManterAliquotaDetalheResponse 
     ...
     */
    private ManterAliquotaDetalheResponse invokeProcess(
            ManterAliquotaDetalheRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaDetalheResponse[] invokeProcess(ManterAliquotaDetalheRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaDetalheResponse[] invokeProcess(ManterAliquotaDetalheRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ManterAliquotaDetalheRequest message) {
     ...
     * objeto do tipo ManterAliquotaDetalheResponse.
     * 
	 * @param response Objeto do tipo ManterAliquotaDetalheResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ManterAliquotaDetalheResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ManterAliquotaDetalheResponse mappingResponse(String response) {

        ManterAliquotaDetalheResponse processResponse = new ManterAliquotaDetalheResponse();
        try {
            
            processResponse = 
            	(ManterAliquotaDetalheResponse) ManterAliquotaDetalheResponse.
