package br.com.bradesco.web.giss.service.data.pdc.incluirjustificativa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirJustificativa
 * </p>
 * 
 ...
 */
public class IncluirJustificativaPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirJustificativaPDCAdapter, IIncluirJustificativaAdapterMapping {
     ...
     */
    public IncluirJustificativaResponse invokeProcess(IncluirJustificativaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluirjustificativa.IIncluirJustificativaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluirjustificativa.request.IncluirJustificativaRequest)
     * @param message Objeto do tipo IncluirJustificativaRequest 
     ...
     * @return Objeto do tipo IncluirJustificativaResponse 
     ...
     */
    private IncluirJustificativaResponse invokeProcess(
            IncluirJustificativaRequest message, 
     ...
     */
    public String mappingRequest(IncluirJustificativaRequest message) {
     ...
     * objeto do tipo IncluirJustificativaResponse.
     * 
	 * @param response Objeto do tipo IncluirJustificativaResponse 
     ...
     */
    public IncluirJustificativaResponse mappingResponse(String response) {

        IncluirJustificativaResponse processResponse = new IncluirJustificativaResponse();
        try {
            
            processResponse = 
            	(IncluirJustificativaResponse) IncluirJustificativaResponse.
