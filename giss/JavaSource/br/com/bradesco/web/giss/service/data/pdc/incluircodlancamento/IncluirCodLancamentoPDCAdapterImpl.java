package br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirCodLancamento
 * </p>
 * 
 ...
 */
public class IncluirCodLancamentoPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirCodLancamentoPDCAdapter, IIncluirCodLancamentoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento.IIncluirCodLancamentoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento.request.IncluirCodLancamentoRequest)
     * @param message Objeto do tipo IncluirCodLancamentoRequest 
     ...
     * @return Objeto do tipo IncluirCodLancamentoResponse 
     ...
     */
    public IncluirCodLancamentoResponse invokeProcess(
            IncluirCodLancamentoRequest message) 
     ...
     */
    public String mappingRequest(IncluirCodLancamentoRequest message) {
     ...
     * objeto do tipo IncluirCodLancamentoResponse.
     * 
	 * @param response Objeto do tipo IncluirCodLancamentoResponse 
     ...
     */
    public IncluirCodLancamentoResponse mappingResponse(String response) {

        IncluirCodLancamentoResponse processResponse = new IncluirCodLancamentoResponse();
        try {
            
            processResponse = 
            	(IncluirCodLancamentoResponse) IncluirCodLancamentoResponse.
