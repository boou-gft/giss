package br.com.bradesco.web.giss.service.data.pdc.listarmunicipiossemconvenio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarMunicipiosSemConvenio
 * </p>
 * 
 ...
 */
public class ListarMunicipiosSemConvenioPDCAdapterImpl extends PdcBaseAdapter implements
        IListarMunicipiosSemConvenioPDCAdapter, IListarMunicipiosSemConvenioAdapterMapping {
     ...
     */
    public ListarMunicipiosSemConvenioResponse invokeProcess(ListarMunicipiosSemConvenioRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.service.data.pdc.listarmunicipiossemconvenio.IListarMunicipiosSemConvenioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.service.data.pdc.listarmunicipiossemconvenio.request.ListarMunicipiosSemConvenioRequest)
     * @param message Objeto do tipo ListarMunicipiosSemConvenioRequest 
     ...
     * @return Objeto do tipo ListarMunicipiosSemConvenioResponse 
     ...
     */
    private ListarMunicipiosSemConvenioResponse invokeProcess(
            ListarMunicipiosSemConvenioRequest message, 
     ...
     */
    public String mappingRequest(ListarMunicipiosSemConvenioRequest message) {
     ...
     * objeto do tipo ListarMunicipiosSemConvenioResponse.
     * 
	 * @param response Objeto do tipo ListarMunicipiosSemConvenioResponse 
     ...
     */
    public ListarMunicipiosSemConvenioResponse mappingResponse(String response) {

        ListarMunicipiosSemConvenioResponse processResponse = new ListarMunicipiosSemConvenioResponse();
        try {
            
            processResponse = 
            	(ListarMunicipiosSemConvenioResponse) ListarMunicipiosSemConvenioResponse.
