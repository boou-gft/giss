 ...
 */
public interface IListarContasContabeisPeriodoAdapterMapping {
     ...
     */
    String mappingRequest(ListarContasContabeisPeriodoRequest message);
     ...
     */
    ListarContasContabeisPeriodoResponse mappingResponse(String response);
