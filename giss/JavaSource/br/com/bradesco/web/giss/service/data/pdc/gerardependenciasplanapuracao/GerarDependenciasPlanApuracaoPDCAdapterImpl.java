package br.com.bradesco.web.giss.service.data.pdc.gerardependenciasplanapuracao;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: GerarDependenciasPlanApuracao
 * </p>
 * 
 ...
 */
public class GerarDependenciasPlanApuracaoPDCAdapterImpl extends PdcBaseAdapter implements
        IGerarDependenciasPlanApuracaoPDCAdapter, IGerarDependenciasPlanApuracaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.gerardependenciasplanapuracao.IGerarDependenciasPlanApuracaoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.gerardependenciasplanapuracao.request.GerarDependenciasPlanApuracaoRequest)
     * @param message Objeto do tipo GerarDependenciasPlanApuracaoRequest 
     ...
     * @return Objeto do tipo GerarDependenciasPlanApuracaoResponse 
     ...
     */
    public GerarDependenciasPlanApuracaoResponse invokeProcess(
            GerarDependenciasPlanApuracaoRequest message) 
     ...
     */
    public String mappingRequest(GerarDependenciasPlanApuracaoRequest message) {
     ...
     * objeto do tipo GerarDependenciasPlanApuracaoResponse.
     * 
	 * @param response Objeto do tipo GerarDependenciasPlanApuracaoResponse 
     ...
     */
    public GerarDependenciasPlanApuracaoResponse mappingResponse(String response) {

        GerarDependenciasPlanApuracaoResponse processResponse = new GerarDependenciasPlanApuracaoResponse();
        try {
            
            processResponse = 
            	(GerarDependenciasPlanApuracaoResponse) GerarDependenciasPlanApuracaoResponse.
