package br.com.bradesco.web.giss.service.data.pdc.listarhistoricoitemleicompl;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarHistoricoItemLeiCompl
 * </p>
 * 
 ...
 */
public class ListarHistoricoItemLeiComplPDCAdapterImpl extends PdcBaseAdapter implements
        IListarHistoricoItemLeiComplPDCAdapter, IListarHistoricoItemLeiComplAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarhistoricoitemleicompl.IListarHistoricoItemLeiComplPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarhistoricoitemleicompl.request.ListarHistoricoItemLeiComplRequest)
     * @param message Objeto do tipo ListarHistoricoItemLeiComplRequest 
     ...
     * @return Objeto do tipo ListarHistoricoItemLeiComplResponse 
     ...
     */
    public ListarHistoricoItemLeiComplResponse invokeProcess(
            ListarHistoricoItemLeiComplRequest message) 
     ...
     */
    public String mappingRequest(ListarHistoricoItemLeiComplRequest message) {
     ...
     * objeto do tipo ListarHistoricoItemLeiComplResponse.
     * 
	 * @param response Objeto do tipo ListarHistoricoItemLeiComplResponse 
     ...
     */
    public ListarHistoricoItemLeiComplResponse mappingResponse(String response) {

        ListarHistoricoItemLeiComplResponse processResponse = new ListarHistoricoItemLeiComplResponse();
        try {
            
            processResponse = 
            	(ListarHistoricoItemLeiComplResponse) ListarHistoricoItemLeiComplResponse.
