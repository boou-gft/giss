package br.com.bradesco.web.giss.service.data.pdc.consultaapuracaopa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultaApuracaoPa
 * </p>
 * 
 ...
 */
public class ConsultaApuracaoPaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultaApuracaoPaPDCAdapter, IConsultaApuracaoPaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultaapuracaopa.IConsultaApuracaoPaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultaapuracaopa.request.ConsultaApuracaoPaRequest)
     * @param message Objeto do tipo ConsultaApuracaoPaRequest 
     ...
     * @return Objeto do tipo ConsultaApuracaoPaResponse 
     ...
     */
    public ConsultaApuracaoPaResponse invokeProcess(
            ConsultaApuracaoPaRequest message) 
     ...
     */
    public String mappingRequest(ConsultaApuracaoPaRequest message) {
     ...
     * objeto do tipo ConsultaApuracaoPaResponse.
     * 
	 * @param response Objeto do tipo ConsultaApuracaoPaResponse 
     ...
     */
    public ConsultaApuracaoPaResponse mappingResponse(String response) {

        ConsultaApuracaoPaResponse processResponse = new ConsultaApuracaoPaResponse();
        try {
            
            processResponse = 
            	(ConsultaApuracaoPaResponse) ConsultaApuracaoPaResponse.
