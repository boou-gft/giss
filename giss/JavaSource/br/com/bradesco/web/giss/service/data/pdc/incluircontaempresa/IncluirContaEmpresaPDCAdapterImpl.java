package br.com.bradesco.web.giss.service.data.pdc.incluircontaempresa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirContaEmpresa
 * </p>
 * 
 ...
 */
public class IncluirContaEmpresaPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirContaEmpresaPDCAdapter, IIncluirContaEmpresaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluircontaempresa.IIncluirContaEmpresaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluircontaempresa.request.IncluirContaEmpresaRequest)
     * @param message Objeto do tipo IncluirContaEmpresaRequest 
     ...
     * @return Objeto do tipo IncluirContaEmpresaResponse 
     ...
     */
    public IncluirContaEmpresaResponse invokeProcess(
            IncluirContaEmpresaRequest message) 
     ...
     */
    public String mappingRequest(IncluirContaEmpresaRequest message) {
     ...
     * objeto do tipo IncluirContaEmpresaResponse.
     * 
	 * @param response Objeto do tipo IncluirContaEmpresaResponse 
     ...
     */
    public IncluirContaEmpresaResponse mappingResponse(String response) {

        IncluirContaEmpresaResponse processResponse = new IncluirContaEmpresaResponse();
        try {
            
            processResponse = 
            	(IncluirContaEmpresaResponse) IncluirContaEmpresaResponse.
