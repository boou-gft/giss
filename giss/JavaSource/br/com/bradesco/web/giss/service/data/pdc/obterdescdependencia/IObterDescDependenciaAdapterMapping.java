 ...
 */
public interface IObterDescDependenciaAdapterMapping {
     ...
     */
    String mappingRequest(ObterDescDependenciaRequest message);
     ...
     */
    ObterDescDependenciaResponse mappingResponse(String response);
