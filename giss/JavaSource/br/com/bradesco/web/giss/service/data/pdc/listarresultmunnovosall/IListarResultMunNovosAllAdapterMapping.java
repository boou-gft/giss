 ...
 */
public interface IListarResultMunNovosAllAdapterMapping {
     ...
     */
    String mappingRequest(ListarResultMunNovosAllRequest message);
     ...
     */
    ListarResultMunNovosAllResponse mappingResponse(String response);
