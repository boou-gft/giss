 ...
 */
public interface IDetalharCargaMassivaAdapterMapping {
     ...
     */
    String mappingRequest(DetalharCargaMassivaRequest message);
     ...
     */
    DetalharCargaMassivaResponse mappingResponse(String response);
