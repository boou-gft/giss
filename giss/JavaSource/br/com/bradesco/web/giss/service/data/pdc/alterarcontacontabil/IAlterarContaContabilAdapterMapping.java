 ...
 */
public interface IAlterarContaContabilAdapterMapping {
     ...
     */
    String mappingRequest(AlterarContaContabilRequest message);
     ...
     */
    AlterarContaContabilResponse mappingResponse(String response);
