package br.com.bradesco.web.giss.service.data.pdc.listarcombodescitemserv;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarComboDescItemServ
 * </p>
 * 
 ...
 */
public class ListarComboDescItemServPDCAdapterImpl extends PdcBaseAdapter implements
        IListarComboDescItemServPDCAdapter, IListarComboDescItemServAdapterMapping {
     ...
     */
    public ListarComboDescItemServResponse invokeProcess(ListarComboDescItemServRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcombodescitemserv.IListarComboDescItemServPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcombodescitemserv.request.ListarComboDescItemServRequest)
     * @param message Objeto do tipo ListarComboDescItemServRequest 
     ...
     * @return Objeto do tipo ListarComboDescItemServResponse 
     ...
     */
    private ListarComboDescItemServResponse invokeProcess(
            ListarComboDescItemServRequest message, 
     ...
     */
    public String mappingRequest(ListarComboDescItemServRequest message) {
     ...
     * objeto do tipo ListarComboDescItemServResponse.
     * 
	 * @param response Objeto do tipo ListarComboDescItemServResponse 
     ...
     */
    public ListarComboDescItemServResponse mappingResponse(String response) {

        ListarComboDescItemServResponse processResponse = new ListarComboDescItemServResponse();
        try {
            
            processResponse = 
            	(ListarComboDescItemServResponse) ListarComboDescItemServResponse.
