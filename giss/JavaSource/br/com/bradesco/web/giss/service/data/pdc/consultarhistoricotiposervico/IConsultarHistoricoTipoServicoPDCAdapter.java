 ...
 */
public interface IConsultarHistoricoTipoServicoPDCAdapter {
     ...
     */
    ConsultarHistoricoTipoServicoResponse invokeProcess(ConsultarHistoricoTipoServicoRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ConsultarHistoricoTipoServicoResponse invokeProcess(ConsultarHistoricoTipoServicoRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ConsultarHistoricoTipoServicoResponse[] invokeProcess(ConsultarHistoricoTipoServicoRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ConsultarHistoricoTipoServicoResponse[] invokeProcess(ConsultarHistoricoTipoServicoRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
