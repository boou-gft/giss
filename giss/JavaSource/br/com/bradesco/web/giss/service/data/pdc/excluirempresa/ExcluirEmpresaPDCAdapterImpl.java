package br.com.bradesco.web.giss.service.data.pdc.excluirempresa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirEmpresa
 * </p>
 * 
 ...
 */
public class ExcluirEmpresaPDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirEmpresaPDCAdapter, IExcluirEmpresaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.excluirempresa.IExcluirEmpresaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.excluirempresa.request.ExcluirEmpresaRequest)
     * @param message Objeto do tipo ExcluirEmpresaRequest 
     ...
     * @return Objeto do tipo ExcluirEmpresaResponse 
     ...
     */
    public ExcluirEmpresaResponse invokeProcess(
            ExcluirEmpresaRequest message) 
     ...
     */
    public String mappingRequest(ExcluirEmpresaRequest message) {
     ...
     * objeto do tipo ExcluirEmpresaResponse.
     * 
	 * @param response Objeto do tipo ExcluirEmpresaResponse 
     ...
     */
    public ExcluirEmpresaResponse mappingResponse(String response) {

        ExcluirEmpresaResponse processResponse = new ExcluirEmpresaResponse();
        try {
            
            processResponse = 
            	(ExcluirEmpresaResponse) ExcluirEmpresaResponse.
