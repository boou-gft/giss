 ...
 */
public interface IConsultarDependenciaAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarDependenciaRequest message);
     ...
     */
    ConsultarDependenciaResponse mappingResponse(String response);
