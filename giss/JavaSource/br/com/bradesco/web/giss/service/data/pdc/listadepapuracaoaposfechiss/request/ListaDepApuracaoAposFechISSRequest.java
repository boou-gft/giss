 ...
 * Schema.
 * $Id: ListaDepApuracaoAposFechISSRequest.java,v 1.4 2018/04/24 02:26:53 gmichelini Exp $
 */
...
/**
 * Class ListaDepApuracaoAposFechISSRequest.
 * 
 * @version $Revision: 1.4 $ $Date: 2018/04/24 02:26:53 $
 */
public class ListaDepApuracaoAposFechISSRequest implements java.io.Serializable {
    ...
    /**
     * Field _diaMesAnoApuracao
     */
    private int _diaMesAnoApuracao = 0;

    /**
     * keeps track of state for field: _diaMesAnoApuracao
     */
    private boolean _has_diaMesAnoApuracao;
    ...
    public ListaDepApuracaoAposFechISSRequest() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listadepapuracaoaposfechiss.request.ListaDepApuracaoAposFechISSRequest()
    ...
    /**
     * Method deleteDiaMesAnoApuracao
     * 
     */
    public void deleteDiaMesAnoApuracao()
    {
        this._has_diaMesAnoApuracao= false;
    } //-- void deleteDiaMesAnoApuracao() 
    ...
    /**
     * Returns the value of field 'diaMesAnoApuracao'.
     * 
     * @return int
     * @return the value of field 'diaMesAnoApuracao'.
     */
    public int getDiaMesAnoApuracao()
    {
        return this._diaMesAnoApuracao;
    } //-- int getDiaMesAnoApuracao() 
    ...
    /**
     * Method hasDiaMesAnoApuracao
     * 
     * 
     * 
     * @return boolean
     */
    public boolean hasDiaMesAnoApuracao()
    {
        return this._has_diaMesAnoApuracao;
    } //-- boolean hasDiaMesAnoApuracao() 
    ...
    /**
     * Sets the value of field 'diaMesAnoApuracao'.
     * 
     * @param diaMesAnoApuracao the value of field
     * 'diaMesAnoApuracao'.
     */
    public void setDiaMesAnoApuracao(int diaMesAnoApuracao)
    {
        this._diaMesAnoApuracao = diaMesAnoApuracao;
        this._has_diaMesAnoApuracao = true;
    } //-- void setDiaMesAnoApuracao(int) 
     ...
     * 
     * @param reader
     * @return ListaDepApuracaoAposFechISSRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listadepapuracaoaposfechiss.request.ListaDepApuracaoAposFechISSRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listadepapuracaoaposfechiss.request.ListaDepApuracaoAposFechISSRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listadepapuracaoaposfechiss.request.ListaDepApuracaoAposFechISSRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listadepapuracaoaposfechiss.request.ListaDepApuracaoAposFechISSRequest unmarshal(java.io.Reader) 
