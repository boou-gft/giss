 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirBalancete
 * </p>
 * 
 ...
 */
public class ExcluirBalancetePDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirBalancetePDCAdapter, IExcluirBalanceteAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarempresa.IExcluirBalancetePDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarempresa.request.ExcluirBalanceteRequest)
     * @param message Objeto do tipo ExcluirBalanceteRequest 
     ...
     */
    public ExcluirBalanceteResponse invokeProcess(
            ExcluirBalanceteRequest message) 
     ...
     */
    public String mappingRequest(ExcluirBalanceteRequest message) {
     ...
     * objeto do tipo ExcluirBalanceteResponse.
     * 
	 * @param response Objeto do tipo ExcluirBalanceteResponse 
     ...
     */
    public ExcluirBalanceteResponse mappingResponse(String response) {

        ExcluirBalanceteResponse processResponse = new ExcluirBalanceteResponse();
        try {
            
            processResponse = 
            	(ExcluirBalanceteResponse) ExcluirBalanceteResponse.
