 ...
 * Schema.
 * $Id: MunicipiosDescriptor.java,v 1.1 2017/04/11 14:11:56 gmichelini Exp $
 */
...
/**
 * Class MunicipiosDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:11:56 $
 */
public class MunicipiosDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MunicipiosDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Municipios target = (Municipios) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.solicitarreprocessamentopormunicipio.request.MunicipiosDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.solicitarreprocessamentopormunicipio.request.Municipios.class;
