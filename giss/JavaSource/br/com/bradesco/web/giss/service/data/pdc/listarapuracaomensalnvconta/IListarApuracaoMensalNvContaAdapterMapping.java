 ...
 */
public interface IListarApuracaoMensalNvContaAdapterMapping {
     ...
     */
    String mappingRequest(ListarApuracaoMensalNvContaRequest message);
     ...
     */
    ListarApuracaoMensalNvContaResponse mappingResponse(String response);
