 ...
 */
public interface IConsultaApurParcialIssAdapterMapping {
     ...
     */
    String mappingRequest(ConsultaApurParcialIssRequest message);
     ...
     */
    ConsultaApurParcialIssResponse mappingResponse(String response);
