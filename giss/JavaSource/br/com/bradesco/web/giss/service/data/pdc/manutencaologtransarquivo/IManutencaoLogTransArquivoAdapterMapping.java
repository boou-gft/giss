 ...
 */
public interface IManutencaoLogTransArquivoAdapterMapping {
     ...
     */
    String mappingRequest(ManutencaoLogTransArquivoRequest message);
     ...
     */
    ManutencaoLogTransArquivoResponse mappingResponse(String response);
