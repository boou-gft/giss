 ...
 */
public interface IListarCargaMassivaAdapterMapping {
     ...
     */
    String mappingRequest(ListarCargaMassivaRequest message);
     ...
     */
    ListarCargaMassivaResponse mappingResponse(String response);
