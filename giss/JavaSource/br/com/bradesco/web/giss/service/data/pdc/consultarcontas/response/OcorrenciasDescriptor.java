 ...
 * Schema.
 * $Id: OcorrenciasDescriptor.java,v 1.1 2017/04/11 14:13:08 gmichelini Exp $
 */
...
public class OcorrenciasDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultarcontas.response.OcorrenciasDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.consultarcontas.response.Ocorrencias.class;
