 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarHistMunicEstadoDependencias
 * </p>
 * 
 ...
 */
public class ListarHistMunicEstadoDependenciasPDCAdapterImpl extends PdcBaseAdapter implements
        IListarHistMunicEstadoDependenciasPDCAdapter, IListarHistMunicEstadoDependenciasAdapterMapping {
     ...
     */
    public ListarHistMunicEstadoDependenciasResponse invokeProcess(ListarHistMunicEstadoDependenciasRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarHistMunicEstadoDependenciasResponse invokeProcess(ListarHistMunicEstadoDependenciasRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarHistMunicEstadoDependenciasRequest 
     ...
     */
    private ListarHistMunicEstadoDependenciasResponse invokeProcess(
            ListarHistMunicEstadoDependenciasRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarHistMunicEstadoDependenciasResponse[] invokeProcess(ListarHistMunicEstadoDependenciasRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarHistMunicEstadoDependenciasResponse[] invokeProcess(ListarHistMunicEstadoDependenciasRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ListarHistMunicEstadoDependenciasRequest message) {
     ...
     * objeto do tipo ListarHistMunicEstadoDependenciasResponse.
     * 
	 * @param response Objeto do tipo ListarHistMunicEstadoDependenciasResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListarHistMunicEstadoDependenciasResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListarHistMunicEstadoDependenciasResponse mappingResponse(String response) {

        ListarHistMunicEstadoDependenciasResponse processResponse = new ListarHistMunicEstadoDependenciasResponse();
        try {
            
            processResponse = 
            	(ListarHistMunicEstadoDependenciasResponse) ListarHistMunicEstadoDependenciasResponse.
