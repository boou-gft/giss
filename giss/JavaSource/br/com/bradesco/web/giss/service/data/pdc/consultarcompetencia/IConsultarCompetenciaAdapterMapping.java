 ...
 */
public interface IConsultarCompetenciaAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarCompetenciaRequest message);
     ...
     */
    ConsultarCompetenciaResponse mappingResponse(String response);
