 ...
 */
public interface IListarContasEmpPDCAdapter {
     ...
     */
    ListarContasEmpResponse invokeProcess(ListarContasEmpRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarContasEmpResponse invokeProcess(ListarContasEmpRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
