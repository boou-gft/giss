 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarReprocessarApuracao
 * </p>
 * 
 ...
 */
public class ListarReprocessarApuracaoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarReprocessarApuracaoPDCAdapter, IListarReprocessarApuracaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarReprocessarApuracaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ListarReprocessarApuracaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ListarReprocessarApuracaoResponse invokeProcess(ListarReprocessarApuracaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarReprocessarApuracaoResponse invokeProcess(ListarReprocessarApuracaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarReprocessarApuracaoRequest 
     ...
     */
    private ListarReprocessarApuracaoResponse invokeProcess(
            ListarReprocessarApuracaoRequest message, 
     ...
     */
    public String mappingRequest(ListarReprocessarApuracaoRequest message) {
     ...
     * objeto do tipo ListarReprocessarApuracaoResponse.
     * 
	 * @param response Objeto do tipo ListarReprocessarApuracaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListarReprocessarApuracaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListarReprocessarApuracaoResponse mappingResponse(String response) {

        ListarReprocessarApuracaoResponse processResponse = new ListarReprocessarApuracaoResponse();
        try {
            
            processResponse = 
            	(ListarReprocessarApuracaoResponse) ListarReprocessarApuracaoResponse.
