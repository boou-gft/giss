 ...
 */
public interface IParametrizacaoDepIncluirAdapterMapping {
     ...
     */
    String mappingRequest(ParametrizacaoDepIncluirRequest message);
     ...
     */
    ParametrizacaoDepIncluirResponse mappingResponse(String response);
