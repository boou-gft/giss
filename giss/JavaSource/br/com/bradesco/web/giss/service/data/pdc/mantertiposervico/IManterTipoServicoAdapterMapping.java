 ...
 */
public interface IManterTipoServicoAdapterMapping {
     ...
     */
    String mappingRequest(ManterTipoServicoRequest message);
     ...
     */
    ManterTipoServicoResponse mappingResponse(String response);
