 ...
 */
public interface IListarTipoIncidenciaPDCAdapter {
     ...
     */
    ListarTipoIncidenciaResponse invokeProcess(ListarTipoIncidenciaRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarTipoIncidenciaResponse invokeProcess(ListarTipoIncidenciaRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     * 
     * @param message Objeto do tipo ListarTipoIncidenciaRequest que contém a informação necessária para invocar o processo PDC.
     ...
     * @return Objeto do tipo ListarTipoIncidenciaResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
     ListarTipoIncidenciaResponse[] invokeProcess(ListarTipoIncidenciaRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarTipoIncidenciaResponse[] invokeProcess(ListarTipoIncidenciaRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
