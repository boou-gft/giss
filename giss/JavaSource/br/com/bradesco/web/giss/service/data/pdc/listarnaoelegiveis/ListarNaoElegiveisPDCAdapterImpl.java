 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarNaoElegiveis
 * </p>
 * 
 ...
 */
public class ListarNaoElegiveisPDCAdapterImpl extends PdcBaseAdapter implements
        IListarNaoElegiveisPDCAdapter, IListarNaoElegiveisAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarnaoelegiveis.IListarNaoElegiveisPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarnaoelegiveis.request.ListarNaoElegiveisRequest)
     * @param message Objeto do tipo ListarNaoElegiveisRequest 
     ...
     */
    public ListarNaoElegiveisResponse invokeProcess(
            ListarNaoElegiveisRequest message) 
     ...
     */
    public String mappingRequest(ListarNaoElegiveisRequest message) {
     ...
     * objeto do tipo ListarNaoElegiveisResponse.
     * 
	 * @param response Objeto do tipo ListarNaoElegiveisResponse 
     ...
     */
    public ListarNaoElegiveisResponse mappingResponse(String response) {

        ListarNaoElegiveisResponse processResponse = new ListarNaoElegiveisResponse();
        try {
            
            processResponse = 
            	(ListarNaoElegiveisResponse) ListarNaoElegiveisResponse.
