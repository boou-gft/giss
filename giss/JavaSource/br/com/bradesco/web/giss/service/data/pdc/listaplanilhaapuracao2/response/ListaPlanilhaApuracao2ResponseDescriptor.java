...
/**
 * Class ListaPlanilhaApuracao2ResponseDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ListaPlanilhaApuracao2ResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListaPlanilhaApuracao2ResponseDescriptor() 
     {
        super();
        xmlName = "listaPlanilhaApuracao2Response";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListaPlanilhaApuracao2Response target = (ListaPlanilhaApuracao2Response) object;
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao.class, "_ocorrenciasPlanApuracaoList", "OcorrenciasPlanApuracao", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ListaPlanilhaApuracao2Response target = (ListaPlanilhaApuracao2Response) object;
                    target.addOcorrenciasPlanApuracao( (br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.ListaPlanilhaApuracao2ResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.ListaPlanilhaApuracao2Response.class;
