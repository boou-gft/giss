...
/**
 * Class ListaPgtosNaoGerados.
 * 
 * @version $Revision$ $Date$
 */
public class ListaPgtosNaoGerados implements java.io.Serializable {
    ...
    public ListaPgtosNaoGerados() 
     {
        super();
        setValorIssApurado(new java.math.BigDecimal("0"));
        setValorBaseIss(new java.math.BigDecimal("0"));
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarpgtosnaogerados.response.ListaPgtosNaoGerados()
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarpgtosnaogerados.response.ListaPgtosNaoGerados unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarpgtosnaogerados.response.ListaPgtosNaoGerados) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarpgtosnaogerados.response.ListaPgtosNaoGerados.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarpgtosnaogerados.response.ListaPgtosNaoGerados unmarshal(java.io.Reader) 
