package br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarValoresMesTotal
 * </p>
 * 
 ...
 */
public class ListarValoresMesTotalPDCAdapterImpl extends PdcBaseAdapter implements
        IListarValoresMesTotalPDCAdapter, IListarValoresMesTotalAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.IListarValoresMesTotalPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.request.ListarValoresMesTotalRequest)
     * @param message Objeto do tipo ListarValoresMesTotalRequest 
     ...
     * @return Objeto do tipo ListarValoresMesTotalResponse 
     ...
     */
    public ListarValoresMesTotalResponse invokeProcess(
            ListarValoresMesTotalRequest message) 
     ...
     */
    public String mappingRequest(ListarValoresMesTotalRequest message) {
     ...
     * objeto do tipo ListarValoresMesTotalResponse.
     * 
	 * @param response Objeto do tipo ListarValoresMesTotalResponse 
     ...
     */
    public ListarValoresMesTotalResponse mappingResponse(String response) {

        ListarValoresMesTotalResponse processResponse = new ListarValoresMesTotalResponse();
        try {
            
            processResponse = 
            	(ListarValoresMesTotalResponse) ListarValoresMesTotalResponse.
