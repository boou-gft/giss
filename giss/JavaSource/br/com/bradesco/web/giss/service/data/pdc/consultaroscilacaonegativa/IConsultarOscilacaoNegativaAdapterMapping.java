 ...
 */
public interface IConsultarOscilacaoNegativaAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarOscilacaoNegativaRequest message);
     ...
     */
    ConsultarOscilacaoNegativaResponse mappingResponse(String response);
