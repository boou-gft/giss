 ...
 */
public interface IListarAliquotaZeradaAdapterMapping {
     ...
     */
    String mappingRequest(ListarAliquotaZeradaRequest message);
     ...
     */
    ListarAliquotaZeradaResponse mappingResponse(String response);
