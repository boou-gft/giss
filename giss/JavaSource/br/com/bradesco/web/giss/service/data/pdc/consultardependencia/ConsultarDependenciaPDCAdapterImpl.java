 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarDependencia
 * </p>
 * 
 ...
 */
public class ConsultarDependenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarDependenciaPDCAdapter, IConsultarDependenciaAdapterMapping {
     ...
     */
    public ConsultarDependenciaResponse invokeProcess(ConsultarDependenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultardependencia.IConsultarDependenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultardependencia.request.ConsultarDependenciaRequest)
     * @param message Objeto do tipo ConsultarDependenciaRequest 
     ...
     */
    private ConsultarDependenciaResponse invokeProcess(
            ConsultarDependenciaRequest message, 
     ...
     */
    public String mappingRequest(ConsultarDependenciaRequest message) {
     ...
     * objeto do tipo ConsultarDependenciaResponse.
     * 
	 * @param response Objeto do tipo ConsultarDependenciaResponse 
     ...
     */
    public ConsultarDependenciaResponse mappingResponse(String response) {

        ConsultarDependenciaResponse processResponse = new ConsultarDependenciaResponse();
        try {
            
            processResponse = 
            	(ConsultarDependenciaResponse) ConsultarDependenciaResponse.
