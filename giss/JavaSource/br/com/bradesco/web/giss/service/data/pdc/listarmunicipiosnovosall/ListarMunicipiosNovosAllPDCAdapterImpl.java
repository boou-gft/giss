package br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovosall;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarMunicipiosNovosAll
 * </p>
 * 
 ...
 */
public class ListarMunicipiosNovosAllPDCAdapterImpl extends PdcBaseAdapter implements
        IListarMunicipiosNovosAllPDCAdapter, IListarMunicipiosNovosAllAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovosall.IListarMunicipiosNovosAllPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovosall.request.ListarMunicipiosNovosAllRequest)
     * @param message Objeto do tipo ListarMunicipiosNovosAllRequest 
     ...
     * @return Objeto do tipo ListarMunicipiosNovosAllResponse 
     ...
     */
    public ListarMunicipiosNovosAllResponse invokeProcess(
            ListarMunicipiosNovosAllRequest message) 
     ...
     */
    public String mappingRequest(ListarMunicipiosNovosAllRequest message) {
     ...
     * objeto do tipo ListarMunicipiosNovosAllResponse.
     * 
	 * @param response Objeto do tipo ListarMunicipiosNovosAllResponse 
     ...
     */
    public ListarMunicipiosNovosAllResponse mappingResponse(String response) {

        ListarMunicipiosNovosAllResponse processResponse = new ListarMunicipiosNovosAllResponse();
        try {
            
            processResponse = 
            	(ListarMunicipiosNovosAllResponse) ListarMunicipiosNovosAllResponse.
