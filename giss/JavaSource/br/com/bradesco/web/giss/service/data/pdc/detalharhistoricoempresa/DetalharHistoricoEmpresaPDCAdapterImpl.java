package br.com.bradesco.web.giss.service.data.pdc.detalharhistoricoempresa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: DetalharHistoricoEmpresa
 * </p>
 * 
 ...
 */
public class DetalharHistoricoEmpresaPDCAdapterImpl extends PdcBaseAdapter implements
        IDetalharHistoricoEmpresaPDCAdapter, IDetalharHistoricoEmpresaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.detalharhistoricoempresa.IDetalharHistoricoEmpresaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.detalharhistoricoempresa.request.DetalharHistoricoEmpresaRequest)
     * @param message Objeto do tipo DetalharHistoricoEmpresaRequest 
     ...
     * @return Objeto do tipo DetalharHistoricoEmpresaResponse 
     ...
     */
    public DetalharHistoricoEmpresaResponse invokeProcess(
            DetalharHistoricoEmpresaRequest message) 
     ...
     */
    public String mappingRequest(DetalharHistoricoEmpresaRequest message) {
     ...
     * objeto do tipo DetalharHistoricoEmpresaResponse.
     * 
	 * @param response Objeto do tipo DetalharHistoricoEmpresaResponse 
     ...
     */
    public DetalharHistoricoEmpresaResponse mappingResponse(String response) {

        DetalharHistoricoEmpresaResponse processResponse = new DetalharHistoricoEmpresaResponse();
        try {
            
            processResponse = 
            	(DetalharHistoricoEmpresaResponse) DetalharHistoricoEmpresaResponse.
