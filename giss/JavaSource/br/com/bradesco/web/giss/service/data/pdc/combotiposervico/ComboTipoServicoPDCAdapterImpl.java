package br.com.bradesco.web.giss.service.data.pdc.combotiposervico;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ComboTipoServico
 * </p>
 * 
 ...
 */
public class ComboTipoServicoPDCAdapterImpl extends PdcBaseAdapter implements
        IComboTipoServicoPDCAdapter, IComboTipoServicoAdapterMapping {
     ...
     */
    public ComboTipoServicoResponse invokeProcess(ComboTipoServicoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.combotiposervico.IComboTipoServicoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.combotiposervico.request.ComboTipoServicoRequest)
     * @param message Objeto do tipo ComboTipoServicoRequest 
     ...
     * @return Objeto do tipo ComboTipoServicoResponse 
     ...
     */
    private ComboTipoServicoResponse invokeProcess(
            ComboTipoServicoRequest message, 
     ...
     */
    public String mappingRequest(ComboTipoServicoRequest message) {
     ...
     * objeto do tipo ComboTipoServicoResponse.
     * 
	 * @param response Objeto do tipo ComboTipoServicoResponse 
     ...
     */
    public ComboTipoServicoResponse mappingResponse(String response) {

        ComboTipoServicoResponse processResponse = new ComboTipoServicoResponse();
        try {
            
            processResponse = 
            	(ComboTipoServicoResponse) ComboTipoServicoResponse.
