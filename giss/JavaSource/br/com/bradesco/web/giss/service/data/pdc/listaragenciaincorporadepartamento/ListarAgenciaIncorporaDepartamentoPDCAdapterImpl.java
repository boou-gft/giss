package br.com.bradesco.web.giss.service.data.pdc.listaragenciaincorporadepartamento;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarAgenciaIncorporaDepartamento
 * </p>
 * 
 ...
 */
public class ListarAgenciaIncorporaDepartamentoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarAgenciaIncorporaDepartamentoPDCAdapter, IListarAgenciaIncorporaDepartamentoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listaragenciaincorporadepartamento.IListarAgenciaIncorporaDepartamentoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listaragenciaincorporadepartamento.request.ListarAgenciaIncorporaDepartamentoRequest)
     * @param message Objeto do tipo ListarAgenciaIncorporaDepartamentoRequest 
     ...
     * @return Objeto do tipo ListarAgenciaIncorporaDepartamentoResponse 
     ...
     */
    public ListarAgenciaIncorporaDepartamentoResponse invokeProcess(
            ListarAgenciaIncorporaDepartamentoRequest message) 
     ...
     */
    public String mappingRequest(ListarAgenciaIncorporaDepartamentoRequest message) {
     ...
     * objeto do tipo ListarAgenciaIncorporaDepartamentoResponse.
     * 
	 * @param response Objeto do tipo ListarAgenciaIncorporaDepartamentoResponse 
     ...
     */
    public ListarAgenciaIncorporaDepartamentoResponse mappingResponse(String response) {

        ListarAgenciaIncorporaDepartamentoResponse processResponse = new ListarAgenciaIncorporaDepartamentoResponse();
        try {
            
            processResponse = 
            	(ListarAgenciaIncorporaDepartamentoResponse) ListarAgenciaIncorporaDepartamentoResponse.
