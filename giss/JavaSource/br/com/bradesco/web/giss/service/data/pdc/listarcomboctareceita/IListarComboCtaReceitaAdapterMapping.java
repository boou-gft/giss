 ...
 */
public interface IListarComboCtaReceitaAdapterMapping {
     ...
     */
    String mappingRequest(ListarComboCtaReceitaRequest message);
     ...
     */
    ListarComboCtaReceitaResponse mappingResponse(String response);
