 ...
 */
public interface IListarMunicipioAliquotaDifAdapterMapping {
     ...
     */
    String mappingRequest(ListarMunicipioAliquotaDifRequest message);
     ...
     */
    ListarMunicipioAliquotaDifResponse mappingResponse(String response);
