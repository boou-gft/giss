 ...
 */
public interface IListaHistMunicipioPorEstadoAdapterMapping {
     ...
     */
    String mappingRequest(ListaHistMunicipioPorEstadoRequest message);
     ...
     */
    ListaHistMunicipioPorEstadoResponse mappingResponse(String response);
