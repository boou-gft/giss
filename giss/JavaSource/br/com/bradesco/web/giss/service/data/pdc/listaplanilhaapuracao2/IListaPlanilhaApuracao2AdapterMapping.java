 ...
 */
public interface IListaPlanilhaApuracao2AdapterMapping {
     ...
     */
    String mappingRequest(ListaPlanilhaApuracao2Request message);
     ...
     */
    ListaPlanilhaApuracao2Response mappingResponse(String response);
