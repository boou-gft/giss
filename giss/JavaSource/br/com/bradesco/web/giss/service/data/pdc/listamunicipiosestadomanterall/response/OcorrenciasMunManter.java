 ...
 * Schema.
 * $Id: OcorrenciasMunManter.java,v 1.4 2018/05/04 10:29:41 gmichelini Exp $
 */
...
/**
 * Class OcorrenciasMunManter.
 * 
 * @version $Revision: 1.4 $ $Date: 2018/05/04 10:29:41 $
 */
public class OcorrenciasMunManter implements java.io.Serializable {
    ...
    public OcorrenciasMunManter() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.response.OcorrenciasMunManter()
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.response.OcorrenciasMunManter unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.response.OcorrenciasMunManter) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.response.OcorrenciasMunManter.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.response.OcorrenciasMunManter unmarshal(java.io.Reader) 
