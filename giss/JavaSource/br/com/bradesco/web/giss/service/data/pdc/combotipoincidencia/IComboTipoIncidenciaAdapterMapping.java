 ...
 */
public interface IComboTipoIncidenciaAdapterMapping {
     ...
     */
    String mappingRequest(ComboTipoIncidenciaRequest message);
     ...
     */
    ComboTipoIncidenciaResponse mappingResponse(String response);
