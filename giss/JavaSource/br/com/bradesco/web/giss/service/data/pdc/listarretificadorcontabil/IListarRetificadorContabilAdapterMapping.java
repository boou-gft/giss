 ...
 */
public interface IListarRetificadorContabilAdapterMapping {
     ...
     */
    String mappingRequest(ListarRetificadorContabilRequest message);
     ...
     */
    ListarRetificadorContabilResponse mappingResponse(String response);
