 ...
 * Schema.
 * $Id: OcorrenciasDescriptor.java,v 1.1 2017/04/11 14:12:55 gmichelini Exp $
 */
 ...
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:12:55 $
 */
public class OcorrenciasDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listardependenciassaldodivergente.response.OcorrenciasDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listardependenciassaldodivergente.response.Ocorrencias.class;
