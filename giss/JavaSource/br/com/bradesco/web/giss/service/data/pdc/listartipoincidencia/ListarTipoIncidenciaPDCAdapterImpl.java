package br.com.bradesco.web.giss.service.data.pdc.listartipoincidencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarTipoIncidencia
 * </p>
 * 
 ...
 */
public class ListarTipoIncidenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarTipoIncidenciaPDCAdapter, IListarTipoIncidenciaAdapterMapping {
     ...
     */
    public ListarTipoIncidenciaResponse invokeProcess(ListarTipoIncidenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listartipoincidencia.IListarTipoIncidenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listartipoincidencia.request.ListarTipoIncidenciaRequest)
     * @param message Objeto do tipo ListarTipoIncidenciaRequest 
     ...
     * @return Objeto do tipo ListarTipoIncidenciaResponse 
     ...
     */
    private ListarTipoIncidenciaResponse invokeProcess(
            ListarTipoIncidenciaRequest message, 
     ...
     */
    public String mappingRequest(ListarTipoIncidenciaRequest message) {
     ...
     * objeto do tipo ListarTipoIncidenciaResponse.
     * 
	 * @param response Objeto do tipo ListarTipoIncidenciaResponse 
     ...
     */
    public ListarTipoIncidenciaResponse mappingResponse(String response) {

        ListarTipoIncidenciaResponse processResponse = new ListarTipoIncidenciaResponse();
        try {
            
            processResponse = 
            	(ListarTipoIncidenciaResponse) ListarTipoIncidenciaResponse.
	...
	public ListarTipoIncidenciaResponse invokeProcess(ListarTipoIncidenciaRequest request, String stateID) throws PdcAdapterException, PdcConnectorException {
		// TODO Auto-generated method stub
		return null;
	}

	public ListarTipoIncidenciaResponse[] invokeProcess(ListarTipoIncidenciaRequest request, int numItensWeb, int numItensMF) throws PdcAdapterException, PdcConnectorException {
		// TODO Auto-generated method stub
		return null;
	}

	public ListarTipoIncidenciaResponse[] invokeProcess(ListarTipoIncidenciaRequest request, String stateID, int numItensWeb, int numItensMF) throws PdcAdapterException, PdcConnectorException {
		// TODO Auto-generated method stub
		return null;
	}
}