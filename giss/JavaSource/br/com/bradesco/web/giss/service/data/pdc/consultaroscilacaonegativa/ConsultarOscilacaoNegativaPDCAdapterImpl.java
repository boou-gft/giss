package br.com.bradesco.web.giss.service.data.pdc.consultaroscilacaonegativa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarOscilacaoNegativa
 * </p>
 * 
 ...
 */
public class ConsultarOscilacaoNegativaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarOscilacaoNegativaPDCAdapter, IConsultarOscilacaoNegativaAdapterMapping {
     ...
     */
    public ConsultarOscilacaoNegativaResponse invokeProcess(ConsultarOscilacaoNegativaRequest message) {
     ...
     * M�todo Sobreescrito - Coment�rios: M�todo utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultaroscilacaonegativa.IConsultarOscilacaoNegativaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultaroscilacaonegativa.request.ConsultarOscilacaoNegativaRequest)
     * @param message Objeto do tipo ConsultarOscilacaoNegativaRequest 
     ...
     * @return Objeto do tipo ConsultarOscilacaoNegativaResponse 
     ...
     */
    private ConsultarOscilacaoNegativaResponse invokeProcess(
            ConsultarOscilacaoNegativaRequest message, 
     ...
     */
    public String mappingRequest(ConsultarOscilacaoNegativaRequest message) {
     ...
     * objeto do tipo ConsultarOscilacaoNegativaResponse.
     * 
	 * @param response Objeto do tipo ConsultarOscilacaoNegativaResponse 
     ...
     */
    public ConsultarOscilacaoNegativaResponse mappingResponse(String response) {

        ConsultarOscilacaoNegativaResponse processResponse = new ConsultarOscilacaoNegativaResponse();
        try {
            
            processResponse = 
            	(ConsultarOscilacaoNegativaResponse) ConsultarOscilacaoNegativaResponse.
