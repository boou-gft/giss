 ...
 */
public interface IListarDependenciasHistoricasAdapterMapping {
     ...
     */
    String mappingRequest(ListarDependenciasHistoricasRequest message);
     ...
     */
    ListarDependenciasHistoricasResponse mappingResponse(String response);
