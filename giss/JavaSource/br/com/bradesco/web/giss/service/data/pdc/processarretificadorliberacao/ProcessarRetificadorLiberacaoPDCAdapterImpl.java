package br.com.bradesco.web.giss.service.data.pdc.processarretificadorliberacao;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ProcessarRetificadorLiberacao
 * </p>
 * 
 ...
 */
public class ProcessarRetificadorLiberacaoPDCAdapterImpl extends PdcBaseAdapter implements
        IProcessarRetificadorLiberacaoPDCAdapter, IProcessarRetificadorLiberacaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ProcessarRetificadorLiberacaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ProcessarRetificadorLiberacaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ProcessarRetificadorLiberacaoResponse invokeProcess(ProcessarRetificadorLiberacaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ProcessarRetificadorLiberacaoResponse invokeProcess(ProcessarRetificadorLiberacaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ProcessarRetificadorLiberacaoRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ProcessarRetificadorLiberacaoResponse 
     ...
     */
    private ProcessarRetificadorLiberacaoResponse invokeProcess(
            ProcessarRetificadorLiberacaoRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ProcessarRetificadorLiberacaoResponse[] invokeProcess(ProcessarRetificadorLiberacaoRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ProcessarRetificadorLiberacaoResponse[] invokeProcess(ProcessarRetificadorLiberacaoRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ProcessarRetificadorLiberacaoRequest message) {
     ...
     * objeto do tipo ProcessarRetificadorLiberacaoResponse.
     * 
	 * @param response Objeto do tipo ProcessarRetificadorLiberacaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ProcessarRetificadorLiberacaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ProcessarRetificadorLiberacaoResponse mappingResponse(String response) {

        ProcessarRetificadorLiberacaoResponse processResponse = new ProcessarRetificadorLiberacaoResponse();
        try {
            
            processResponse = 
            	(ProcessarRetificadorLiberacaoResponse) ProcessarRetificadorLiberacaoResponse.
