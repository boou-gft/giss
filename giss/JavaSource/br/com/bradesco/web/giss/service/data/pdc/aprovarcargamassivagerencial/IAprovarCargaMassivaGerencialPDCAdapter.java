 ...
 */
public interface IAprovarCargaMassivaGerencialPDCAdapter {
     ...
     */
    AprovarCargaMassivaGerencialResponse invokeProcess(AprovarCargaMassivaGerencialRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    AprovarCargaMassivaGerencialResponse invokeProcess(AprovarCargaMassivaGerencialRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     AprovarCargaMassivaGerencialResponse[] invokeProcess(AprovarCargaMassivaGerencialRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    AprovarCargaMassivaGerencialResponse[] invokeProcess(AprovarCargaMassivaGerencialRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
