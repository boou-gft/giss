 ...
 * Schema.
 * $Id: ConsultaDependenciaHistoricoResponse.java,v 1.3 2018/03/12 11:24:02 gmichelini Exp $
 */
...
/**
 * Class ConsultaDependenciaHistoricoResponse.
 * 
 * @version $Revision: 1.3 $ $Date: 2018/03/12 11:24:02 $
 */
public class ConsultaDependenciaHistoricoResponse implements java.io.Serializable {
    ...
    /**
     * Field _tipoDepartamentoAnt
     */
    private java.lang.String _tipoDepartamentoAnt;
    ...
    /**
     * Field _codigoDepartamentoAgenciaIncorporadoraAnt
     */
    private int _codigoDepartamentoAgenciaIncorporadoraAnt = 0;

    /**
     * keeps track of state for field:
     * _codigoDepartamentoAgenciaIncorporadoraAnt
     */
    private boolean _has_codigoDepartamentoAgenciaIncorporadoraAnt;
    ...
    /**
     * Field _descricaoDepartamentoAgenciaIncorporadoraAnt
     */
    private java.lang.String _descricaoDepartamentoAgenciaIncorporadoraAnt;
    ...
    /**
     * Field _inscricaoMunicipalAnt
     */
    private java.lang.String _inscricaoMunicipalAnt;
    ...
    public ConsultaDependenciaHistoricoResponse() 
     {
        super();
        _listaConsultarDepList = new Vector();
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ConsultaDependenciaHistoricoResponse()
     ...
     */
    public void addListaConsultarDep(br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep vListaConsultarDep)
        throws java.lang.IndexOutOfBoundsException
    {
        if (!(_listaConsultarDepList.size() < 100)) {
            throw new IndexOutOfBoundsException("addListaConsultarDep has a maximum of 100");
        }
        _listaConsultarDepList.addElement(vListaConsultarDep);
    } //-- void addListaConsultarDep(br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep) 
     ...
     * @param vListaConsultarDep
     */
    public void addListaConsultarDep(int index, br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep vListaConsultarDep)
        throws java.lang.IndexOutOfBoundsException
    {
        if (!(_listaConsultarDepList.size() < 100)) {
            throw new IndexOutOfBoundsException("addListaConsultarDep has a maximum of 100");
    ...
    } //-- void addListaConsultarDep(int, br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep) 
    ...
    /**
     * Method deleteCodigoDepartamentoAgenciaIncorporadoraAnt
     * 
     */
    public void deleteCodigoDepartamentoAgenciaIncorporadoraAnt()
    {
        this._has_codigoDepartamentoAgenciaIncorporadoraAnt= false;
    } //-- void deleteCodigoDepartamentoAgenciaIncorporadoraAnt() 
    ...
    /**
     * Returns the value of field
     * 'codigoDepartamentoAgenciaIncorporadoraAnt'.
     * 
     * @return int
     * @return the value of field
     * 'codigoDepartamentoAgenciaIncorporadoraAnt'.
     */
    public int getCodigoDepartamentoAgenciaIncorporadoraAnt()
    {
        return this._codigoDepartamentoAgenciaIncorporadoraAnt;
    } //-- int getCodigoDepartamentoAgenciaIncorporadoraAnt() 
    ...
    /**
     * Returns the value of field
     * 'descricaoDepartamentoAgenciaIncorporadoraAnt'.
     * 
     * @return String
     * @return the value of field
     * 'descricaoDepartamentoAgenciaIncorporadoraAnt'.
     */
    public java.lang.String getDescricaoDepartamentoAgenciaIncorporadoraAnt()
    {
        return this._descricaoDepartamentoAgenciaIncorporadoraAnt;
    } //-- java.lang.String getDescricaoDepartamentoAgenciaIncorporadoraAnt() 
    ...
    /**
     * Returns the value of field 'inscricaoMunicipalAnt'.
     * 
     * @return String
     * @return the value of field 'inscricaoMunicipalAnt'.
     */
    public java.lang.String getInscricaoMunicipalAnt()
    {
        return this._inscricaoMunicipalAnt;
    } //-- java.lang.String getInscricaoMunicipalAnt() 
     ...
     */
    public br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep getListaConsultarDep(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep) _listaConsultarDepList.elementAt(index);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep getListaConsultarDep(int) 
     ...
     * @return ListaConsultarDep
     */
    public br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep[] getListaConsultarDep()
    {
        int size = _listaConsultarDepList.size();
        br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep[] mArray = new br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep) _listaConsultarDepList.elementAt(index);
        }
        return mArray;
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep[] getListaConsultarDep() 
    ...
    /**
     * Returns the value of field 'tipoDepartamentoAnt'.
     * 
     * @return String
     * @return the value of field 'tipoDepartamentoAnt'.
     */
    public java.lang.String getTipoDepartamentoAnt()
    {
        return this._tipoDepartamentoAnt;
    } //-- java.lang.String getTipoDepartamentoAnt() 
    ...
    /**
     * Method hasCodigoDepartamentoAgenciaIncorporadoraAnt
     * 
     * 
     * 
     * @return boolean
     */
    public boolean hasCodigoDepartamentoAgenciaIncorporadoraAnt()
    {
        return this._has_codigoDepartamentoAgenciaIncorporadoraAnt;
    } //-- boolean hasCodigoDepartamentoAgenciaIncorporadoraAnt() 
     ...
     * @return ListaConsultarDep
     */
    public br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep removeListaConsultarDep(int index)
    {
        java.lang.Object obj = _listaConsultarDepList.elementAt(index);
        _listaConsultarDepList.removeElementAt(index);
        return (br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep) obj;
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep removeListaConsultarDep(int) 
     ...
     * 'codigoDepartamentoAgenciaIncorporadoraAnt'.
     * 
     * @param codigoDepartamentoAgenciaIncorporadoraAnt the value
     * of field 'codigoDepartamentoAgenciaIncorporadoraAnt'.
     */
    public void setCodigoDepartamentoAgenciaIncorporadoraAnt(int codigoDepartamentoAgenciaIncorporadoraAnt)
    {
        this._codigoDepartamentoAgenciaIncorporadoraAnt = codigoDepartamentoAgenciaIncorporadoraAnt;
        this._has_codigoDepartamentoAgenciaIncorporadoraAnt = true;
    } //-- void setCodigoDepartamentoAgenciaIncorporadoraAnt(int) 
     ...
     * 'descricaoDepartamentoAgenciaIncorporadoraAnt'.
     * 
     * @param descricaoDepartamentoAgenciaIncorporadoraAnt the
     * value of field 'descricaoDepartamentoAgenciaIncorporadoraAnt'
     */
    public void setDescricaoDepartamentoAgenciaIncorporadoraAnt(java.lang.String descricaoDepartamentoAgenciaIncorporadoraAnt)
    {
        this._descricaoDepartamentoAgenciaIncorporadoraAnt = descricaoDepartamentoAgenciaIncorporadoraAnt;
    } //-- void setDescricaoDepartamentoAgenciaIncorporadoraAnt(java.lang.String) 
    ...
    /**
     * Sets the value of field 'inscricaoMunicipalAnt'.
     * 
     * @param inscricaoMunicipalAnt the value of field
     * 'inscricaoMunicipalAnt'.
     */
    public void setInscricaoMunicipalAnt(java.lang.String inscricaoMunicipalAnt)
    {
        this._inscricaoMunicipalAnt = inscricaoMunicipalAnt;
    } //-- void setInscricaoMunicipalAnt(java.lang.String) 
     ...
     * @param vListaConsultarDep
     */
    public void setListaConsultarDep(int index, br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep vListaConsultarDep)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _listaConsultarDepList.size())) {
        ...
        if (!(index < 100)) {
            throw new IndexOutOfBoundsException("setListaConsultarDep has a maximum of 100");
        }
        _listaConsultarDepList.setElementAt(vListaConsultarDep, index);
    } //-- void setListaConsultarDep(int, br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep) 
     ...
     */
    public void setListaConsultarDep(br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep[] listaConsultarDepArray)
    {
        //-- copy array
        _listaConsultarDepList.removeAllElements();
    ...
    } //-- void setListaConsultarDep(br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ListaConsultarDep) 
    ...
    /**
     * Sets the value of field 'tipoDepartamentoAnt'.
     * 
     * @param tipoDepartamentoAnt the value of field
     * 'tipoDepartamentoAnt'.
     */
    public void setTipoDepartamentoAnt(java.lang.String tipoDepartamentoAnt)
    {
        this._tipoDepartamentoAnt = tipoDepartamentoAnt;
    } //-- void setTipoDepartamentoAnt(java.lang.String) 
     ...
     * 
     * @param reader
     * @return ConsultaDependenciaHistoricoResponse
     */
    public static br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ConsultaDependenciaHistoricoResponse unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ConsultaDependenciaHistoricoResponse) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ConsultaDependenciaHistoricoResponse.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultadependenciahistorico.response.ConsultaDependenciaHistoricoResponse unmarshal(java.io.Reader) 
