...
public class Lista implements java.io.Serializable {
    ...
    /**
     * Field _identificadorProcessamentoIss
     */
    private int _identificadorProcessamentoIss = 0;

    /**
     * keeps track of state for field: _identificadorProcessamentoIs
     */
    private boolean _has_identificadorProcessamentoIss;
    ...
    public Lista() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarretificadorliberacao.response.Lista()
    ...
    /**
     * Method deleteIdentificadorProcessamentoIss
     * 
     */
    public void deleteIdentificadorProcessamentoIss()
    {
        this._has_identificadorProcessamentoIss= false;
    } //-- void deleteIdentificadorProcessamentoIss() 
    ...
    /**
     * Returns the value of field 'identificadorProcessamentoIss'.
     * 
     * @return int
     * @return the value of field 'identificadorProcessamentoIss'.
     */
    public int getIdentificadorProcessamentoIss()
    {
        return this._identificadorProcessamentoIss;
    } //-- int getIdentificadorProcessamentoIss() 
    ...
    /**
     * Method hasIdentificadorProcessamentoIss
     * 
     * 
     * 
     * @return boolean
     */
    public boolean hasIdentificadorProcessamentoIss()
    {
        return this._has_identificadorProcessamentoIss;
    } //-- boolean hasIdentificadorProcessamentoIss() 
    ...
    /**
     * Sets the value of field 'identificadorProcessamentoIss'.
     * 
     * @param identificadorProcessamentoIss the value of field
     * 'identificadorProcessamentoIss'.
     */
    public void setIdentificadorProcessamentoIss(int identificadorProcessamentoIss)
    {
        this._identificadorProcessamentoIss = identificadorProcessamentoIss;
        this._has_identificadorProcessamentoIss = true;
    } //-- void setIdentificadorProcessamentoIss(int) 
     ...
     * @return Lista
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarretificadorliberacao.response.Lista unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarretificadorliberacao.response.Lista) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarretificadorliberacao.response.Lista.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarretificadorliberacao.response.Lista unmarshal(java.io.Reader) 
