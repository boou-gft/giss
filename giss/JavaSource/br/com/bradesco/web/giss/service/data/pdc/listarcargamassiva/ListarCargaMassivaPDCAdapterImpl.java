package br.com.bradesco.web.giss.service.data.pdc.listarcargamassiva;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarCargaMassiva
 * </p>
 * 
 ...
 */
public class ListarCargaMassivaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarCargaMassivaPDCAdapter, IListarCargaMassivaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarCargaMassivaRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ListarCargaMassivaResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ListarCargaMassivaResponse invokeProcess(ListarCargaMassivaRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarCargaMassivaResponse invokeProcess(ListarCargaMassivaRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarCargaMassivaRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ListarCargaMassivaResponse 
     ...
     */
    private ListarCargaMassivaResponse invokeProcess(
            ListarCargaMassivaRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarCargaMassivaResponse[] invokeProcess(ListarCargaMassivaRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarCargaMassivaResponse[] invokeProcess(ListarCargaMassivaRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ListarCargaMassivaRequest message) {
     ...
     * objeto do tipo ListarCargaMassivaResponse.
     * 
	 * @param response Objeto do tipo ListarCargaMassivaResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListarCargaMassivaResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListarCargaMassivaResponse mappingResponse(String response) {

        ListarCargaMassivaResponse processResponse = new ListarCargaMassivaResponse();
        try {
            
            processResponse = 
            	(ListarCargaMassivaResponse) ListarCargaMassivaResponse.
