package br.com.bradesco.web.giss.service.data.pdc.reativaritemservicolc;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ReativarItemServicoLc
 * </p>
 * 
 ...
 */
public class ReativarItemServicoLcPDCAdapterImpl extends PdcBaseAdapter implements
        IReativarItemServicoLcPDCAdapter, IReativarItemServicoLcAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.reativaritemservicolc.IReativarItemServicoLcPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.reativaritemservicolc.request.ReativarItemServicoLcRequest)
     * @param message Objeto do tipo ReativarItemServicoLcRequest 
     ...
     * @return Objeto do tipo ReativarItemServicoLcResponse 
     ...
     */
    public ReativarItemServicoLcResponse invokeProcess(
            ReativarItemServicoLcRequest message) 
     ...
     */
    public String mappingRequest(ReativarItemServicoLcRequest message) {
     ...
     * objeto do tipo ReativarItemServicoLcResponse.
     * 
	 * @param response Objeto do tipo ReativarItemServicoLcResponse 
     ...
     */
    public ReativarItemServicoLcResponse mappingResponse(String response) {

        ReativarItemServicoLcResponse processResponse = new ReativarItemServicoLcResponse();
        try {
            
            processResponse = 
            	(ReativarItemServicoLcResponse) ReativarItemServicoLcResponse.
