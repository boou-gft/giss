 ...
 */
public interface IConferirRejeitarCargaMassivaPDCAdapter {
     ...
     */
    ConferirRejeitarCargaMassivaResponse invokeProcess(ConferirRejeitarCargaMassivaRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ConferirRejeitarCargaMassivaResponse invokeProcess(ConferirRejeitarCargaMassivaRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ConferirRejeitarCargaMassivaResponse[] invokeProcess(ConferirRejeitarCargaMassivaRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ConferirRejeitarCargaMassivaResponse[] invokeProcess(ConferirRejeitarCargaMassivaRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
