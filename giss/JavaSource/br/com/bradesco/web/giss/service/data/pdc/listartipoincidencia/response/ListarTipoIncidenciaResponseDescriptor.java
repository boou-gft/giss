 ...
 * Schema.
 * $Id: ListarTipoIncidenciaResponseDescriptor.java,v 1.2 2017/07/25 18:15:17 gilbertocopoli Exp $
 */
...
/**
 * Class ListarTipoIncidenciaResponseDescriptor.
 * 
 * @version $Revision: 1.2 $ $Date: 2017/07/25 18:15:17 $
 */
public class ListarTipoIncidenciaResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListarTipoIncidenciaResponseDescriptor() 
     {
        super();
        xmlName = "listarTipoIncidenciaResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListarTipoIncidenciaResponse target = (ListarTipoIncidenciaResponse) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _ocorrenciasList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.listartipoincidencia.response.Ocorrencias.class, "_ocorrenciasList", "ocorrencias", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ListarTipoIncidenciaResponse target = (ListarTipoIncidenciaResponse) object;
                    target.addOcorrencias( (br.com.bradesco.web.giss.service.data.pdc.listartipoincidencia.response.Ocorrencias) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.listartipoincidencia.response.Ocorrencias();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listartipoincidencia.response.ListarTipoIncidenciaResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listartipoincidencia.response.ListarTipoIncidenciaResponse.class;
