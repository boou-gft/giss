 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarPercentualTransicao
 * </p>
 * 
 ...
 */
public class ListarPercentualTransicaoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarPercentualTransicaoPDCAdapter, IListarPercentualTransicaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarPercentualTransicaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ListarPercentualTransicaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ListarPercentualTransicaoResponse invokeProcess(ListarPercentualTransicaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarPercentualTransicaoResponse invokeProcess(ListarPercentualTransicaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarPercentualTransicaoRequest 
     ...
     */
    private ListarPercentualTransicaoResponse invokeProcess(
            ListarPercentualTransicaoRequest message, 
     ...
     */
    public String mappingRequest(ListarPercentualTransicaoRequest message) {
     ...
     * objeto do tipo ListarPercentualTransicaoResponse.
     * 
	 * @param response Objeto do tipo ListarPercentualTransicaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListarPercentualTransicaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListarPercentualTransicaoResponse mappingResponse(String response) {

        ListarPercentualTransicaoResponse processResponse = new ListarPercentualTransicaoResponse();
        try {
            
            processResponse = 
            	(ListarPercentualTransicaoResponse) ListarPercentualTransicaoResponse.
