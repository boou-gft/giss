 ...
 */
public interface IListarMunicipiosNovosAdapterMapping {
     ...
     */
    String mappingRequest(ListarMunicipiosNovosRequest message);
     ...
     */
    ListarMunicipiosNovosResponse mappingResponse(String response);
