 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AlterarPercentualTransicao
 * </p>
 * 
 ...
 */
public class AlterarPercentualTransicaoPDCAdapterImpl extends PdcBaseAdapter implements
        IAlterarPercentualTransicaoPDCAdapter, IAlterarPercentualTransicaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo AlterarPercentualTransicaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo AlterarPercentualTransicaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public AlterarPercentualTransicaoResponse invokeProcess(AlterarPercentualTransicaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public AlterarPercentualTransicaoResponse invokeProcess(AlterarPercentualTransicaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo AlterarPercentualTransicaoRequest 
     ...
     */
    private AlterarPercentualTransicaoResponse invokeProcess(
            AlterarPercentualTransicaoRequest message, 
     ...
     */
    public String mappingRequest(AlterarPercentualTransicaoRequest message) {
     ...
     * objeto do tipo AlterarPercentualTransicaoResponse.
     * 
	 * @param response Objeto do tipo AlterarPercentualTransicaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo AlterarPercentualTransicaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public AlterarPercentualTransicaoResponse mappingResponse(String response) {

        AlterarPercentualTransicaoResponse processResponse = new AlterarPercentualTransicaoResponse();
        try {
            
            processResponse = 
            	(AlterarPercentualTransicaoResponse) AlterarPercentualTransicaoResponse.
