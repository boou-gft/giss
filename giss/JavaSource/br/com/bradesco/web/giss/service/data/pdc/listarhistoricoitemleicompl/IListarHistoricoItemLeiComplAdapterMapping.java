 ...
 */
public interface IListarHistoricoItemLeiComplAdapterMapping {
     ...
     */
    String mappingRequest(ListarHistoricoItemLeiComplRequest message);
     ...
     */
    ListarHistoricoItemLeiComplResponse mappingResponse(String response);
