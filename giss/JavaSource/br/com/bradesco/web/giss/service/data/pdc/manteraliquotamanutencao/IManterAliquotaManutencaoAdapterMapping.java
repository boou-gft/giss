 ...
 */
public interface IManterAliquotaManutencaoAdapterMapping {
     ...
     */
    String mappingRequest(ManterAliquotaManutencaoRequest message);
     ...
     */
    ManterAliquotaManutencaoResponse mappingResponse(String response);
