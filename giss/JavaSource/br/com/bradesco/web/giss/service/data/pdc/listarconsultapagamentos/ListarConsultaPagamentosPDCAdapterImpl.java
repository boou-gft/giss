package br.com.bradesco.web.giss.service.data.pdc.listarconsultapagamentos;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarConsultaPagamentos
 * </p>
 * 
 ...
 */
public class ListarConsultaPagamentosPDCAdapterImpl extends PdcBaseAdapter implements
        IListarConsultaPagamentosPDCAdapter, IListarConsultaPagamentosAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarconsultapagamentos.IListarConsultaPagamentosPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarconsultapagamentos.request.ListarConsultaPagamentosRequest)
     * @param message Objeto do tipo ListarConsultaPagamentosRequest 
     ...
     * @return Objeto do tipo ListarConsultaPagamentosResponse 
     ...
     */
    public ListarConsultaPagamentosResponse invokeProcess(
            ListarConsultaPagamentosRequest message) 
     ...
     */
    public String mappingRequest(ListarConsultaPagamentosRequest message) {
     ...
     * objeto do tipo ListarConsultaPagamentosResponse.
     * 
	 * @param response Objeto do tipo ListarConsultaPagamentosResponse 
     ...
     */
    public ListarConsultaPagamentosResponse mappingResponse(String response) {

        ListarConsultaPagamentosResponse processResponse = new ListarConsultaPagamentosResponse();
        try {
            
            processResponse = 
            	(ListarConsultaPagamentosResponse) ListarConsultaPagamentosResponse.
