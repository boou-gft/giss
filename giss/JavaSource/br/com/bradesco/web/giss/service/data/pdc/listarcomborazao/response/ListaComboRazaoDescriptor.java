 ...
 * Schema.
 * $Id: ListaComboRazaoDescriptor.java,v 1.2 2017/11/28 20:09:00 gabrielmarani Exp $
 */
...
/**
 * Class ListaComboRazaoDescriptor.
 * 
 * @version $Revision: 1.2 $ $Date: 2017/11/28 20:09:00 $
 */
public class ListaComboRazaoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListaComboRazaoDescriptor() 
     {
        super();
        xmlName = "listaComboRazao";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListaComboRazao target = (ListaComboRazao) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcomborazao.response.ListaComboRazaoDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarcomborazao.response.ListaComboRazao.class;
