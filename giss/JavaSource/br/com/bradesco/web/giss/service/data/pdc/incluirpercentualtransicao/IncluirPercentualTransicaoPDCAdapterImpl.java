package br.com.bradesco.web.giss.service.data.pdc.incluirpercentualtransicao;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirPercentualTransicao
 * </p>
 * 
 ...
 */
public class IncluirPercentualTransicaoPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirPercentualTransicaoPDCAdapter, IIncluirPercentualTransicaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo IncluirPercentualTransicaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo IncluirPercentualTransicaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public IncluirPercentualTransicaoResponse invokeProcess(IncluirPercentualTransicaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public IncluirPercentualTransicaoResponse invokeProcess(IncluirPercentualTransicaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo IncluirPercentualTransicaoRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo IncluirPercentualTransicaoResponse 
     ...
     */
    private IncluirPercentualTransicaoResponse invokeProcess(
            IncluirPercentualTransicaoRequest message, 
     ...
     */
    public String mappingRequest(IncluirPercentualTransicaoRequest message) {
     ...
     * objeto do tipo IncluirPercentualTransicaoResponse.
     * 
	 * @param response Objeto do tipo IncluirPercentualTransicaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo IncluirPercentualTransicaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public IncluirPercentualTransicaoResponse mappingResponse(String response) {

        IncluirPercentualTransicaoResponse processResponse = new IncluirPercentualTransicaoResponse();
        try {
            
            processResponse = 
            	(IncluirPercentualTransicaoResponse) IncluirPercentualTransicaoResponse.
