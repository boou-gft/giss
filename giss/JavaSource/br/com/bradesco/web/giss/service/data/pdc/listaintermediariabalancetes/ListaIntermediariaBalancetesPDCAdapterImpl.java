package br.com.bradesco.web.giss.service.data.pdc.listaintermediariabalancetes;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaIntermediariaBalancetes
 * </p>
 * 
 ...
 */
public class ListaIntermediariaBalancetesPDCAdapterImpl extends PdcBaseAdapter implements
        IListaIntermediariaBalancetesPDCAdapter, IListaIntermediariaBalancetesAdapterMapping {
     ...
     */
    public ListaIntermediariaBalancetesResponse invokeProcess(ListaIntermediariaBalancetesRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcontascontabeis.IListaIntermediariaBalancetesPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcontascontabeis.request.ListaIntermediariaBalancetesRequest)
     * @param message Objeto do tipo ListaIntermediariaBalancetesRequest 
     ...
     * @return Objeto do tipo ListaIntermediariaBalancetesResponse 
     ...
     */
    private ListaIntermediariaBalancetesResponse invokeProcess(
            ListaIntermediariaBalancetesRequest message, 
     ...
     */
    public String mappingRequest(ListaIntermediariaBalancetesRequest message) {
     ...
     * objeto do tipo ListaIntermediariaBalancetesResponse.
     * 
	 * @param response Objeto do tipo ListaIntermediariaBalancetesResponse 
     ...
     */
    public ListaIntermediariaBalancetesResponse mappingResponse(String response) {

        ListaIntermediariaBalancetesResponse processResponse = new ListaIntermediariaBalancetesResponse();
        try {
            
            processResponse = 
            	(ListaIntermediariaBalancetesResponse) ListaIntermediariaBalancetesResponse.
