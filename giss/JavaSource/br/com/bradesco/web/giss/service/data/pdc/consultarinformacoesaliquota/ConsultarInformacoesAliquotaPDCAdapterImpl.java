package br.com.bradesco.web.giss.service.data.pdc.consultarinformacoesaliquota;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarInformacoesAliquota
 * </p>
 * 
 ...
 */
public class ConsultarInformacoesAliquotaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarInformacoesAliquotaPDCAdapter, IConsultarInformacoesAliquotaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarinformacoesaliquota.IConsultarInformacoesAliquotaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarinformacoesaliquota.request.ConsultarInformacoesAliquotaRequest)
     * @param message Objeto do tipo ConsultarInformacoesAliquotaRequest 
     ...
     * @return Objeto do tipo ConsultarInformacoesAliquotaResponse 
     ...
     */
    public ConsultarInformacoesAliquotaResponse invokeProcess(
            ConsultarInformacoesAliquotaRequest message) 
     ...
     */
    public String mappingRequest(ConsultarInformacoesAliquotaRequest message) {
     ...
     * objeto do tipo ConsultarInformacoesAliquotaResponse.
     * 
	 * @param response Objeto do tipo ConsultarInformacoesAliquotaResponse 
     ...
     */
    public ConsultarInformacoesAliquotaResponse mappingResponse(String response) {

        ConsultarInformacoesAliquotaResponse processResponse = new ConsultarInformacoesAliquotaResponse();
        try {
            
            processResponse = 
            	(ConsultarInformacoesAliquotaResponse) ConsultarInformacoesAliquotaResponse.
