...
/**
 * Class ListaPlanilhaApuracao2Response.
 * 
 * @version $Revision$ $Date$
 */
public class ListaPlanilhaApuracao2Response implements java.io.Serializable {
    ...
    public ListaPlanilhaApuracao2Response() 
     {
        super();
        _ocorrenciasPlanApuracaoList = new Vector();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.ListaPlanilhaApuracao2Response()
     ...
     */
    public void addOcorrenciasPlanApuracao(br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao vOcorrenciasPlanApuracao)
        throws java.lang.IndexOutOfBoundsException
    {
        _ocorrenciasPlanApuracaoList.addElement(vOcorrenciasPlanApuracao);
    } //-- void addOcorrenciasPlanApuracao(br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao) 
     ...
     * @param vOcorrenciasPlanApuracao
     */
    public void addOcorrenciasPlanApuracao(int index, br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao vOcorrenciasPlanApuracao)
        throws java.lang.IndexOutOfBoundsException
    {
        _ocorrenciasPlanApuracaoList.insertElementAt(vOcorrenciasPlanApuracao, index);
    } //-- void addOcorrenciasPlanApuracao(int, br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao) 
     ...
     */
    public br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao getOcorrenciasPlanApuracao(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao) _ocorrenciasPlanApuracaoList.elementAt(index);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao getOcorrenciasPlanApuracao(int) 
     ...
     * @return OcorrenciasPlanApuracao
     */
    public br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao[] getOcorrenciasPlanApuracao()
    {
        int size = _ocorrenciasPlanApuracaoList.size();
        br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao[] mArray = new br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao) _ocorrenciasPlanApuracaoList.elementAt(index);
        }
        return mArray;
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao[] getOcorrenciasPlanApuracao() 
     ...
     * @return OcorrenciasPlanApuracao
     */
    public br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao removeOcorrenciasPlanApuracao(int index)
    {
        java.lang.Object obj = _ocorrenciasPlanApuracaoList.elementAt(index);
        _ocorrenciasPlanApuracaoList.removeElementAt(index);
        return (br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao) obj;
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao removeOcorrenciasPlanApuracao(int) 
     ...
     * @param vOcorrenciasPlanApuracao
     */
    public void setOcorrenciasPlanApuracao(int index, br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao vOcorrenciasPlanApuracao)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _ocorrenciasPlanApuracaoList.size())) {
    ...
    } //-- void setOcorrenciasPlanApuracao(int, br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao) 
     ...
     */
    public void setOcorrenciasPlanApuracao(br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao[] ocorrenciasPlanApuracaoArray)
    {
        //-- copy array
        _ocorrenciasPlanApuracaoList.removeAllElements();
    ...
    } //-- void setOcorrenciasPlanApuracao(br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.OcorrenciasPlanApuracao) 
     ...
     * 
     * @param reader
     * @return ListaPlanilhaApuracao2Response
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.ListaPlanilhaApuracao2Response unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.ListaPlanilhaApuracao2Response) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.ListaPlanilhaApuracao2Response.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao2.response.ListaPlanilhaApuracao2Response unmarshal(java.io.Reader) 
