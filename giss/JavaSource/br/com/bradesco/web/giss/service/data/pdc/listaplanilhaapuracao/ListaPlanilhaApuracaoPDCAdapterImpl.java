package br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaPlanilhaApuracao
 * </p>
 * 
 ...
 */
public class ListaPlanilhaApuracaoPDCAdapterImpl extends PdcBaseAdapter implements
        IListaPlanilhaApuracaoPDCAdapter, IListaPlanilhaApuracaoAdapterMapping {
     ...
     */
    public ListaPlanilhaApuracaoResponse invokeProcess(ListaPlanilhaApuracaoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao.IListaPlanilhaApuracaoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao.request.ListaPlanilhaApuracaoRequest)
     * @param message Objeto do tipo ListaPlanilhaApuracaoRequest 
     ...
     * @return Objeto do tipo ListaPlanilhaApuracaoResponse 
     ...
     */
    private ListaPlanilhaApuracaoResponse invokeProcess(
            ListaPlanilhaApuracaoRequest message, 
     ...
     */
    public String mappingRequest(ListaPlanilhaApuracaoRequest message) {
     ...
     * objeto do tipo ListaPlanilhaApuracaoResponse.
     * 
	 * @param response Objeto do tipo ListaPlanilhaApuracaoResponse 
     ...
     */
    public ListaPlanilhaApuracaoResponse mappingResponse(String response) {

        ListaPlanilhaApuracaoResponse processResponse = new ListaPlanilhaApuracaoResponse();
        try {
            
            processResponse = 
            	(ListaPlanilhaApuracaoResponse) ListaPlanilhaApuracaoResponse.
