 ...
 * Schema.
 * $Id: OcorrenciasDescriptor.java,v 1.2 2017/07/25 18:15:23 gilbertocopoli Exp $
 */
...
public class OcorrenciasDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultarhistoricotiposervico.response.OcorrenciasDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.consultarhistoricotiposervico.response.Ocorrencias.class;
