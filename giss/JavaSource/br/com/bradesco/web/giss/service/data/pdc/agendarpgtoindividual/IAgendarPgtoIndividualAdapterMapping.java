 ...
 */
public interface IAgendarPgtoIndividualAdapterMapping {
     ...
     */
    String mappingRequest(AgendarPgtoIndividualRequest message);
     ...
     */
    AgendarPgtoIndividualResponse mappingResponse(String response);
