...
public class Lista implements java.io.Serializable {
    ...
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.response.Lista()
     ...
     * @return Lista
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.response.Lista unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.response.Lista) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.response.Lista.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.response.Lista unmarshal(java.io.Reader) 
