package br.com.bradesco.web.giss.service.data.pdc.excluirdependencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirDependencia
 * </p>
 * 
 ...
 */
public class ExcluirDependenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirDependenciaPDCAdapter, IExcluirDependenciaAdapterMapping {
     ...
     */
    public ExcluirDependenciaResponse invokeProcess(ExcluirDependenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.excluirdependencia.IExcluirDependenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.excluirdependencia.request.ExcluirDependenciaRequest)
     * @param message Objeto do tipo ExcluirDependenciaRequest 
     ...
     * @return Objeto do tipo ExcluirDependenciaResponse 
     ...
     */
    private ExcluirDependenciaResponse invokeProcess(
            ExcluirDependenciaRequest message, 
     ...
     */
    public String mappingRequest(ExcluirDependenciaRequest message) {
     ...
     * objeto do tipo ExcluirDependenciaResponse.
     * 
	 * @param response Objeto do tipo ExcluirDependenciaResponse 
     ...
     */
    public ExcluirDependenciaResponse mappingResponse(String response) {

        ExcluirDependenciaResponse processResponse = new ExcluirDependenciaResponse();
        try {
            
            processResponse = 
            	(ExcluirDependenciaResponse) ExcluirDependenciaResponse.
