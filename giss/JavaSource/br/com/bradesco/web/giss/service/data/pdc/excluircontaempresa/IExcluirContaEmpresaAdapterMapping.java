 ...
 */
public interface IExcluirContaEmpresaAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirContaEmpresaRequest message);
     ...
     */
    ExcluirContaEmpresaResponse mappingResponse(String response);
