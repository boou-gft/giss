 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaDependenciaPorMunicipio
 * </p>
 * 
 ...
 */
public class ListaDependenciaPorMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IListaDependenciaPorMunicipioPDCAdapter, IListaDependenciaPorMunicipioAdapterMapping {
     ...
     */
    public ListaDependenciaPorMunicipioResponse invokeProcess(ListaDependenciaPorMunicipioRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listadependenciapormunicipio.IListaDependenciaPorMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listadependenciapormunicipio.request.ListaDependenciaPorMunicipioRequest)
     * @param message Objeto do tipo ListaDependenciaPorMunicipioRequest 
     ...
     */
    private ListaDependenciaPorMunicipioResponse invokeProcess(
            ListaDependenciaPorMunicipioRequest message, 
     ...
     */
    public String mappingRequest(ListaDependenciaPorMunicipioRequest message) {
     ...
     * objeto do tipo ListaDependenciaPorMunicipioResponse.
     * 
	 * @param response Objeto do tipo ListaDependenciaPorMunicipioResponse 
     ...
     */
    public ListaDependenciaPorMunicipioResponse mappingResponse(String response) {

        ListaDependenciaPorMunicipioResponse processResponse = new ListaDependenciaPorMunicipioResponse();
        try {
            
            processResponse = 
            	(ListaDependenciaPorMunicipioResponse) ListaDependenciaPorMunicipioResponse.
