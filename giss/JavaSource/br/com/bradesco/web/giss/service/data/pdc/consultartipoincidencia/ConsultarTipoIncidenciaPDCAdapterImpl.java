package br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarTipoIncidencia
 * </p>
 * 
 ...
 */
public class ConsultarTipoIncidenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarTipoIncidenciaPDCAdapter, IConsultarTipoIncidenciaAdapterMapping {
     ...
     */
    public ConsultarTipoIncidenciaResponse invokeProcess(ConsultarTipoIncidenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.IConsultarTipoIncidenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.request.ConsultarTipoIncidenciaRequest)
     * @param message Objeto do tipo ConsultarTipoIncidenciaRequest 
     ...
     * @return Objeto do tipo ConsultarTipoIncidenciaResponse 
     ...
     */
    private ConsultarTipoIncidenciaResponse invokeProcess(
            ConsultarTipoIncidenciaRequest message, 
     ...
     */
    public String mappingRequest(ConsultarTipoIncidenciaRequest message) {
     ...
     * objeto do tipo ConsultarTipoIncidenciaResponse.
     * 
	 * @param response Objeto do tipo ConsultarTipoIncidenciaResponse 
     ...
     */
    public ConsultarTipoIncidenciaResponse mappingResponse(String response) {

        ConsultarTipoIncidenciaResponse processResponse = new ConsultarTipoIncidenciaResponse();
        try {
            
            processResponse = 
            	(ConsultarTipoIncidenciaResponse) ConsultarTipoIncidenciaResponse.
