 ...
 */
public interface IListarCargaMassivaPDCAdapter {
     ...
     */
    ListarCargaMassivaResponse invokeProcess(ListarCargaMassivaRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarCargaMassivaResponse invokeProcess(ListarCargaMassivaRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ListarCargaMassivaResponse[] invokeProcess(ListarCargaMassivaRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarCargaMassivaResponse[] invokeProcess(ListarCargaMassivaRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
