package br.com.bradesco.web.giss.service.data.pdc.excluirmunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirMunicipio
 * </p>
 * 
 ...
 */
public class ExcluirMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirMunicipioPDCAdapter, IExcluirMunicipioAdapterMapping {
     ...
     */
    public ExcluirMunicipioResponse invokeProcess(ExcluirMunicipioRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.excluirmunicipio.IExcluirMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.excluirmunicipio.request.ExcluirMunicipioRequest)
     * @param message Objeto do tipo ExcluirMunicipioRequest 
     ...
     * @return Objeto do tipo ExcluirMunicipioResponse 
     ...
     */
    private ExcluirMunicipioResponse invokeProcess(
            ExcluirMunicipioRequest message, 
     ...
     */
    public String mappingRequest(ExcluirMunicipioRequest message) {
     ...
     * objeto do tipo ExcluirMunicipioResponse.
     * 
	 * @param response Objeto do tipo ExcluirMunicipioResponse 
     ...
     */
    public ExcluirMunicipioResponse mappingResponse(String response) {

        ExcluirMunicipioResponse processResponse = new ExcluirMunicipioResponse();
        try {
            
            processResponse = 
            	(ExcluirMunicipioResponse) ExcluirMunicipioResponse.
