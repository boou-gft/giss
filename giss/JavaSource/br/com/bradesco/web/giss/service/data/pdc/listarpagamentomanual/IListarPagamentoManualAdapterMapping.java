 ...
 */
public interface IListarPagamentoManualAdapterMapping {
     ...
     */
    String mappingRequest(ListarPagamentoManualRequest message);
     ...
     */
    ListarPagamentoManualResponse mappingResponse(String response);
