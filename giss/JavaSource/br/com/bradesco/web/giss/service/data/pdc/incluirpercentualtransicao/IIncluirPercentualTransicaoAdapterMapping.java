 ...
 */
public interface IIncluirPercentualTransicaoAdapterMapping {
     ...
     */
    String mappingRequest(IncluirPercentualTransicaoRequest message);
     ...
     */
    IncluirPercentualTransicaoResponse mappingResponse(String response);
