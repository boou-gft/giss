 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ManterTipoIncidencia
 * </p>
 * 
 ...
 */
public class ManterTipoIncidenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IManterTipoIncidenciaPDCAdapter, IManterTipoIncidenciaAdapterMapping {
     ...
     */
    public ManterTipoIncidenciaResponse invokeProcess(ManterTipoIncidenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.IManterTipoIncidenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.ManterTipoIncidenciaRequest)
     * @param message Objeto do tipo ManterTipoIncidenciaRequest 
     ...
     */
    private ManterTipoIncidenciaResponse invokeProcess(
            ManterTipoIncidenciaRequest message, 
     ...
     */
    public String mappingRequest(ManterTipoIncidenciaRequest message) {
     ...
     * objeto do tipo ManterTipoIncidenciaResponse.
     * 
	 * @param response Objeto do tipo ManterTipoIncidenciaResponse 
     ...
     */
    public ManterTipoIncidenciaResponse mappingResponse(String response) {

        ManterTipoIncidenciaResponse processResponse = new ManterTipoIncidenciaResponse();
        try {
            
            processResponse = 
            	(ManterTipoIncidenciaResponse) ManterTipoIncidenciaResponse.
