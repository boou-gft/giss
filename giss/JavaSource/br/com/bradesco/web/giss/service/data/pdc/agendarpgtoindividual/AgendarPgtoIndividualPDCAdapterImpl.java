package br.com.bradesco.web.giss.service.data.pdc.agendarpgtoindividual;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AgendarPgtoIndividual
 * </p>
 * 
 ...
 */
public class AgendarPgtoIndividualPDCAdapterImpl extends PdcBaseAdapter implements
        IAgendarPgtoIndividualPDCAdapter, IAgendarPgtoIndividualAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo AgendarPgtoIndividualRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo AgendarPgtoIndividualResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public AgendarPgtoIndividualResponse invokeProcess(AgendarPgtoIndividualRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public AgendarPgtoIndividualResponse invokeProcess(AgendarPgtoIndividualRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo AgendarPgtoIndividualRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo AgendarPgtoIndividualResponse 
     ...
     */
    private AgendarPgtoIndividualResponse invokeProcess(
            AgendarPgtoIndividualRequest message, 
     ...
     */
    public String mappingRequest(AgendarPgtoIndividualRequest message) {
     ...
     * objeto do tipo AgendarPgtoIndividualResponse.
     * 
	 * @param response Objeto do tipo AgendarPgtoIndividualResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo AgendarPgtoIndividualResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public AgendarPgtoIndividualResponse mappingResponse(String response) {

        AgendarPgtoIndividualResponse processResponse = new AgendarPgtoIndividualResponse();
        try {
            
            processResponse = 
            	(AgendarPgtoIndividualResponse) AgendarPgtoIndividualResponse.
