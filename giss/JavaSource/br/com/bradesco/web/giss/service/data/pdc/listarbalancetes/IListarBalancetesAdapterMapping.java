 ...
 */
public interface IListarBalancetesAdapterMapping {
     ...
     */
    String mappingRequest(ListarBalancetesRequest message);
     ...
     */
    ListarBalancetesResponse mappingResponse(String response);
