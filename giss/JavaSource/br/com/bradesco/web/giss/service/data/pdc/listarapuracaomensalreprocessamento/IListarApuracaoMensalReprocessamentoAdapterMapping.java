 ...
 */
public interface IListarApuracaoMensalReprocessamentoAdapterMapping {
     ...
     */
    String mappingRequest(ListarApuracaoMensalReprocessamentoRequest message);
     ...
     */
    ListarApuracaoMensalReprocessamentoResponse mappingResponse(String response);
