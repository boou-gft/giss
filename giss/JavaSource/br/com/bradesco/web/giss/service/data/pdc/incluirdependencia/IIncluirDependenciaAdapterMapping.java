 ...
 */
public interface IIncluirDependenciaAdapterMapping {
     ...
     */
    String mappingRequest(IncluirDependenciaRequest message);
     ...
     */
    IncluirDependenciaResponse mappingResponse(String response);
