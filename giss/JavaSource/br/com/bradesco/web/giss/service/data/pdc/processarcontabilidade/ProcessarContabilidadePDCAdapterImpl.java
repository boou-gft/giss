package br.com.bradesco.web.giss.service.data.pdc.processarcontabilidade;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ProcessarContabilidade
 * </p>
 * 
 ...
 */
public class ProcessarContabilidadePDCAdapterImpl extends PdcBaseAdapter implements
        IProcessarContabilidadePDCAdapter, IProcessarContabilidadeAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.processarcontabilidade.IProcessarContabilidadePDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.processarcontabilidade.request.ProcessarContabilidadeRequest)
     * @param message Objeto do tipo ProcessarContabilidadeRequest 
     ...
     * @return Objeto do tipo ProcessarContabilidadeResponse 
     ...
     */
    public ProcessarContabilidadeResponse invokeProcess(
            ProcessarContabilidadeRequest message) 
     ...
     */
    public String mappingRequest(ProcessarContabilidadeRequest message) {
     ...
     * objeto do tipo ProcessarContabilidadeResponse.
     * 
	 * @param response Objeto do tipo ProcessarContabilidadeResponse 
     ...
     */
    public ProcessarContabilidadeResponse mappingResponse(String response) {

        ProcessarContabilidadeResponse processResponse = new ProcessarContabilidadeResponse();
        try {
            
            processResponse = 
            	(ProcessarContabilidadeResponse) ProcessarContabilidadeResponse.
