package br.com.bradesco.web.giss.service.data.pdc.solicitarreprocessamentopormunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: SolicitarReprocessamentoPorMunicipio
 * </p>
 * 
 ...
 */
public class SolicitarReprocessamentoPorMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        ISolicitarReprocessamentoPorMunicipioPDCAdapter, ISolicitarReprocessamentoPorMunicipioAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo SolicitarReprocessamentoPorMunicipioRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo SolicitarReprocessamentoPorMunicipioResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public SolicitarReprocessamentoPorMunicipioResponse invokeProcess(SolicitarReprocessamentoPorMunicipioRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarReprocessamentoPorMunicipioResponse invokeProcess(SolicitarReprocessamentoPorMunicipioRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo SolicitarReprocessamentoPorMunicipioRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo SolicitarReprocessamentoPorMunicipioResponse 
     ...
     */
    private SolicitarReprocessamentoPorMunicipioResponse invokeProcess(
            SolicitarReprocessamentoPorMunicipioRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarReprocessamentoPorMunicipioResponse[] invokeProcess(SolicitarReprocessamentoPorMunicipioRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarReprocessamentoPorMunicipioResponse[] invokeProcess(SolicitarReprocessamentoPorMunicipioRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(SolicitarReprocessamentoPorMunicipioRequest message) {
     ...
     * objeto do tipo SolicitarReprocessamentoPorMunicipioResponse.
     * 
	 * @param response Objeto do tipo SolicitarReprocessamentoPorMunicipioResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo SolicitarReprocessamentoPorMunicipioResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public SolicitarReprocessamentoPorMunicipioResponse mappingResponse(String response) {

        SolicitarReprocessamentoPorMunicipioResponse processResponse = new SolicitarReprocessamentoPorMunicipioResponse();
        try {
            
            processResponse = 
            	(SolicitarReprocessamentoPorMunicipioResponse) SolicitarReprocessamentoPorMunicipioResponse.
