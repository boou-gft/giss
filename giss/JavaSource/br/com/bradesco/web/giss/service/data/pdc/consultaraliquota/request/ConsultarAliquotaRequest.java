 ...
 * Schema.
 * $Id: ConsultarAliquotaRequest.java,v 1.3 2017/12/08 17:29:26 gmichelini Exp $
 */
...
/**
 * Class ConsultarAliquotaRequest.
 * 
 * @version $Revision: 1.3 $ $Date: 2017/12/08 17:29:26 $
 */
public class ConsultarAliquotaRequest implements java.io.Serializable {
    ...
    public ConsultarAliquotaRequest() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultaraliquota.request.ConsultarAliquotaRequest()
     ...
     * 
     * @param reader
     * @return ConsultarAliquotaRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.consultaraliquota.request.ConsultarAliquotaRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.consultaraliquota.request.ConsultarAliquotaRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.consultaraliquota.request.ConsultarAliquotaRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultaraliquota.request.ConsultarAliquotaRequest unmarshal(java.io.Reader) 
