...
public class ConsultasSaida implements java.io.Serializable {
    ...
    public ConsultasSaida() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcombocosifemp.response.ConsultasSaida()
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarcombocosifemp.response.ConsultasSaida unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarcombocosifemp.response.ConsultasSaida) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarcombocosifemp.response.ConsultasSaida.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcombocosifemp.response.ConsultasSaida unmarshal(java.io.Reader)
