package br.com.bradesco.web.giss.service.data.pdc.parametrizarminmaxaliquota;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ParametrizarMinMaxAliquota
 * </p>
 * 
 ...
 */
public class ParametrizarMinMaxAliquotaPDCAdapterImpl extends PdcBaseAdapter implements
        IParametrizarMinMaxAliquotaPDCAdapter, IParametrizarMinMaxAliquotaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.parametrizarminmaxaliquota.IParametrizarMinMaxAliquotaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.parametrizarminmaxaliquota.request.ParametrizarMinMaxAliquotaRequest)
     * @param message Objeto do tipo ParametrizarMinMaxAliquotaRequest 
     ...
     * @return Objeto do tipo ParametrizarMinMaxAliquotaResponse 
     ...
     */
    public ParametrizarMinMaxAliquotaResponse invokeProcess(
            ParametrizarMinMaxAliquotaRequest message) 
     ...
     */
    public String mappingRequest(ParametrizarMinMaxAliquotaRequest message) {
     ...
     * objeto do tipo ParametrizarMinMaxAliquotaResponse.
     * 
	 * @param response Objeto do tipo ParametrizarMinMaxAliquotaResponse 
     ...
     */
    public ParametrizarMinMaxAliquotaResponse mappingResponse(String response) {

        ParametrizarMinMaxAliquotaResponse processResponse = new ParametrizarMinMaxAliquotaResponse();
        try {
            
            processResponse = 
            	(ParametrizarMinMaxAliquotaResponse) ParametrizarMinMaxAliquotaResponse.
