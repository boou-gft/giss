 ...
 */
public interface IListarHistoricoMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(ListarHistoricoMunicipioRequest message);
     ...
     */
    ListarHistoricoMunicipioResponse mappingResponse(String response);
