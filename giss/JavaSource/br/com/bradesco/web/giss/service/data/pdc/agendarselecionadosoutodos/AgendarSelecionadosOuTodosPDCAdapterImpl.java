package br.com.bradesco.web.giss.service.data.pdc.agendarselecionadosoutodos;
...
import br.com.bradesco.web.giss.service.data.pdc.agendarselecionadosoutodos.request.AgendarSelecionadosOuTodosRequest;
import br.com.bradesco.web.giss.service.data.pdc.agendarselecionadosoutodos.response.AgendarSelecionadosOuTodosResponse;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AgendarSelecionadosOuTodos
 * </p>
 * 
 ...
 */
public class AgendarSelecionadosOuTodosPDCAdapterImpl extends PdcBaseAdapter implements
        IAgendarSelecionadosOuTodosPDCAdapter, IAgendarSelecionadosOuTodosAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.agendarselecionadosoutodos.IAgendarSelecionadosOuTodosPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.agendarselecionadosoutodos.request.AgendarSelecionadosOuTodosRequest)
     * @param message Objeto do tipo AgendarSelecionadosOuTodosRequest 
     ...
     * @return Objeto do tipo AgendarSelecionadosOuTodosResponse 
     ...
     */
    public AgendarSelecionadosOuTodosResponse invokeProcess(
            AgendarSelecionadosOuTodosRequest message) 
     ...
     */
    public String mappingRequest(AgendarSelecionadosOuTodosRequest message) {
     ...
     * objeto do tipo AgendarSelecionadosOuTodosResponse.
     * 
	 * @param response Objeto do tipo AgendarSelecionadosOuTodosResponse 
     ...
     */
    public AgendarSelecionadosOuTodosResponse mappingResponse(String response) {

        AgendarSelecionadosOuTodosResponse processResponse = new AgendarSelecionadosOuTodosResponse();
        try {
            
            processResponse = 
            	(AgendarSelecionadosOuTodosResponse) AgendarSelecionadosOuTodosResponse.
