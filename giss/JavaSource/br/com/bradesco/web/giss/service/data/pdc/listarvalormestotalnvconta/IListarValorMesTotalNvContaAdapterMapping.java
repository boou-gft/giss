 ...
 */
public interface IListarValorMesTotalNvContaAdapterMapping {
     ...
     */
    String mappingRequest(ListarValorMesTotalNvContaRequest message);
     ...
     */
    ListarValorMesTotalNvContaResponse mappingResponse(String response);
