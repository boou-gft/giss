 ...
 */
public interface IConsultarLupaMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarLupaMunicipioRequest message);
     ...
     */
    ConsultarLupaMunicipioResponse mappingResponse(String response);
