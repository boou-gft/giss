 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaContasMunAliqDif
 * </p>
 * 
 ...
 */
public class ListaContasMunAliqDifPDCAdapterImpl extends PdcBaseAdapter implements
        IListaContasMunAliqDifPDCAdapter, IListaContasMunAliqDifAdapterMapping {
     ...
     */
    public ListaContasMunAliqDifResponse invokeProcess(ListaContasMunAliqDifRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listacontasmunaliqdif.IListaContasMunAliqDifPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listacontasmunaliqdif.request.ListaContasMunAliqDifRequest)
     * @param message Objeto do tipo ListaContasMunAliqDifRequest 
     ...
     */
    private ListaContasMunAliqDifResponse invokeProcess(
            ListaContasMunAliqDifRequest message, 
     ...
     */
    public String mappingRequest(ListaContasMunAliqDifRequest message) {
     ...
     * objeto do tipo ListaContasMunAliqDifResponse.
     * 
	 * @param response Objeto do tipo ListaContasMunAliqDifResponse 
     ...
     */
    public ListaContasMunAliqDifResponse mappingResponse(String response) {

        ListaContasMunAliqDifResponse processResponse = new ListaContasMunAliqDifResponse();
        try {
            
            processResponse = 
            	(ListaContasMunAliqDifResponse) ListaContasMunAliqDifResponse.
