package br.com.bradesco.web.giss.service.data.pdc.detalhardenpendenciasencerradas;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: DetalharDenpendenciasEncerradas
 * </p>
 * 
 ...
 */
public class DetalharDenpendenciasEncerradasPDCAdapterImpl extends PdcBaseAdapter implements
        IDetalharDenpendenciasEncerradasPDCAdapter, IDetalharDenpendenciasEncerradasAdapterMapping {
     ...
     */
    public DetalharDenpendenciasEncerradasResponse invokeProcess(DetalharDenpendenciasEncerradasRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.detalhardenpendenciasencerradas.IDetalharDenpendenciasEncerradasPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.detalhardenpendenciasencerradas.request.DetalharDenpendenciasEncerradasRequest)
     * @param message Objeto do tipo DetalharDenpendenciasEncerradasRequest 
     ...
     * @return Objeto do tipo DetalharDenpendenciasEncerradasResponse 
     ...
     */
    private DetalharDenpendenciasEncerradasResponse invokeProcess(
            DetalharDenpendenciasEncerradasRequest message, 
     ...
     */
    public String mappingRequest(DetalharDenpendenciasEncerradasRequest message) {
     ...
     * objeto do tipo DetalharDenpendenciasEncerradasResponse.
     * 
	 * @param response Objeto do tipo DetalharDenpendenciasEncerradasResponse 
     ...
     */
    public DetalharDenpendenciasEncerradasResponse mappingResponse(String response) {

        DetalharDenpendenciasEncerradasResponse processResponse = new DetalharDenpendenciasEncerradasResponse();
        try {
            
            processResponse = 
            	(DetalharDenpendenciasEncerradasResponse) DetalharDenpendenciasEncerradasResponse.
