package br.com.bradesco.web.giss.service.data.pdc.listarcomboestado;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarComboEstado
 * </p>
 * 
 ...
 */
public class ListarComboEstadoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarComboEstadoPDCAdapter, IListarComboEstadoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcomboestado.IListarComboEstadoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcomboestado.request.ListarComboEstadoRequest)
     * @param message Objeto do tipo ListarComboEstadoRequest 
     ...
     * @return Objeto do tipo ListarComboEstadoResponse 
     ...
     */
    public ListarComboEstadoResponse invokeProcess(
            ListarComboEstadoRequest message) 
     ...
     */
    public String mappingRequest(ListarComboEstadoRequest message) {
     ...
     * objeto do tipo ListarComboEstadoResponse.
     * 
	 * @param response Objeto do tipo ListarComboEstadoResponse 
     ...
     */
    public ListarComboEstadoResponse mappingResponse(String response) {

        ListarComboEstadoResponse processResponse = new ListarComboEstadoResponse();
        try {
            
            processResponse = 
            	(ListarComboEstadoResponse) ListarComboEstadoResponse.
