package br.com.bradesco.web.giss.service.data.pdc.manutencaologtransarquivo;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ManutencaoLogTransArquivo
 * </p>
 * 
 ...
 */
public class ManutencaoLogTransArquivoPDCAdapterImpl extends PdcBaseAdapter implements
        IManutencaoLogTransArquivoPDCAdapter, IManutencaoLogTransArquivoAdapterMapping {
     ...
     */
    public ManutencaoLogTransArquivoResponse invokeProcess(ManutencaoLogTransArquivoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.service.data.pdc.manutencaologtransarquivo.IManutencaoLogTransArquivoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.service.data.pdc.manutencaologtransarquivo.request.ManutencaoLogTransArquivoRequest)
     * @param message Objeto do tipo ManutencaoLogTransArquivoRequest 
     ...
     * @return Objeto do tipo ManutencaoLogTransArquivoResponse 
     ...
     */
    private ManutencaoLogTransArquivoResponse invokeProcess(
            ManutencaoLogTransArquivoRequest message, 
     ...
     */
    public String mappingRequest(ManutencaoLogTransArquivoRequest message) {
     ...
     * objeto do tipo ManutencaoLogTransArquivoResponse.
     * 
	 * @param response Objeto do tipo ManutencaoLogTransArquivoResponse 
     ...
     */
    public ManutencaoLogTransArquivoResponse mappingResponse(String response) {

        ManutencaoLogTransArquivoResponse processResponse = new ManutencaoLogTransArquivoResponse();
        try {
            
            processResponse = 
            	(ManutencaoLogTransArquivoResponse) ManutencaoLogTransArquivoResponse.
