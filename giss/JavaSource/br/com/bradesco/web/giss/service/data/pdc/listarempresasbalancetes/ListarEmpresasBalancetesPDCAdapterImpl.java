 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarEmpresasBalancetes
 * </p>
 * 
 ...
 */
public class ListarEmpresasBalancetesPDCAdapterImpl extends PdcBaseAdapter implements
        IListarEmpresasBalancetesPDCAdapter, IListarEmpresasBalancetesAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarempresa.IListarEmpresasBalancetesPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarempresa.request.ListarEmpresasBalancetesRequest)
     * @param message Objeto do tipo ListarEmpresasBalancetesRequest 
     ...
     */
    public ListarEmpresasBalancetesResponse invokeProcess(
            ListarEmpresasBalancetesRequest message) 
     ...
     */
    public String mappingRequest(ListarEmpresasBalancetesRequest message) {
     ...
     * objeto do tipo ListarEmpresasBalancetesResponse.
     * 
	 * @param response Objeto do tipo ListarEmpresasBalancetesResponse 
     ...
     */
    public ListarEmpresasBalancetesResponse mappingResponse(String response) {

        ListarEmpresasBalancetesResponse processResponse = new ListarEmpresasBalancetesResponse();
        try {
            
            processResponse = 
            	(ListarEmpresasBalancetesResponse) ListarEmpresasBalancetesResponse.
