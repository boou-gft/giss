package br.com.bradesco.web.giss.service.data.pdc.listarcomboctareceita;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarComboCtaReceita
 * </p>
 * 
 ...
 */
public class ListarComboCtaReceitaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarComboCtaReceitaPDCAdapter, IListarComboCtaReceitaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcomboctareceita.IListarComboCtaReceitaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcomboctareceita.request.ListarComboCtaReceitaRequest)
     * @param message Objeto do tipo ListarComboCtaReceitaRequest 
     ...
     * @return Objeto do tipo ListarComboCtaReceitaResponse 
     ...
     */
    public ListarComboCtaReceitaResponse invokeProcess(
            ListarComboCtaReceitaRequest message) 
     ...
     */
    public String mappingRequest(ListarComboCtaReceitaRequest message) {
     ...
     * objeto do tipo ListarComboCtaReceitaResponse.
     * 
	 * @param response Objeto do tipo ListarComboCtaReceitaResponse 
     ...
     */
    public ListarComboCtaReceitaResponse mappingResponse(String response) {

        ListarComboCtaReceitaResponse processResponse = new ListarComboCtaReceitaResponse();
        try {
            
            processResponse = 
            	(ListarComboCtaReceitaResponse) ListarComboCtaReceitaResponse.
