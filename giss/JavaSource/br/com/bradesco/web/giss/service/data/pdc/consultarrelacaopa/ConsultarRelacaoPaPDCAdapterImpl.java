package br.com.bradesco.web.giss.service.data.pdc.consultarrelacaopa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarRelacaoPa
 * </p>
 * 
 ...
 */
public class ConsultarRelacaoPaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarRelacaoPaPDCAdapter, IConsultarRelacaoPaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarrelacaopa.IConsultarRelacaoPaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarrelacaopa.request.ConsultarRelacaoPaRequest)
     * @param message Objeto do tipo ConsultarRelacaoPaRequest 
     ...
     * @return Objeto do tipo ConsultarRelacaoPaResponse 
     ...
     */
    public ConsultarRelacaoPaResponse invokeProcess(
            ConsultarRelacaoPaRequest message) 
     ...
     */
    public String mappingRequest(ConsultarRelacaoPaRequest message) {
     ...
     * objeto do tipo ConsultarRelacaoPaResponse.
     * 
	 * @param response Objeto do tipo ConsultarRelacaoPaResponse 
     ...
     */
    public ConsultarRelacaoPaResponse mappingResponse(String response) {

        ConsultarRelacaoPaResponse processResponse = new ConsultarRelacaoPaResponse();
        try {
            
            processResponse = 
            	(ConsultarRelacaoPaResponse) ConsultarRelacaoPaResponse.
