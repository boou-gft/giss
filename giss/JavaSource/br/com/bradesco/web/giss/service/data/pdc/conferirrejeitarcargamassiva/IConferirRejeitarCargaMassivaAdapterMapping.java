 ...
 */
public interface IConferirRejeitarCargaMassivaAdapterMapping {
     ...
     */
    String mappingRequest(ConferirRejeitarCargaMassivaRequest message);
     ...
     */
    ConferirRejeitarCargaMassivaResponse mappingResponse(String response);
