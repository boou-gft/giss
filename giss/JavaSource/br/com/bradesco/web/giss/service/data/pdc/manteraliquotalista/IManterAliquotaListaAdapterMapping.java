 ...
 */
public interface IManterAliquotaListaAdapterMapping {
     ...
     */
    String mappingRequest(ManterAliquotaListaRequest message);
     ...
     */
    ManterAliquotaListaResponse mappingResponse(String response);
