 ...
 */
public interface IListarPgtosVencidosCompAdapterMapping {
     ...
     */
    String mappingRequest(ListarPgtosVencidosCompRequest message);
     ...
     */
    ListarPgtosVencidosCompResponse mappingResponse(String response);
