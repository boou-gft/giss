 ...
 */
public interface IListarConsultaPagamentosAdapterMapping {
     ...
     */
    String mappingRequest(ListarConsultaPagamentosRequest message);
     ...
     */
    ListarConsultaPagamentosResponse mappingResponse(String response);
