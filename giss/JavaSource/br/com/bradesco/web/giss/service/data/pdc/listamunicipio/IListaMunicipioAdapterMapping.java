 ...
 */
public interface IListaMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(ListaMunicipioRequest message);
     ...
     */
    ListaMunicipioResponse mappingResponse(String response);
