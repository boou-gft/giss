package br.com.bradesco.web.giss.service.data.pdc.alteraritemcomplementar;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AlterarItemComplementar
 * </p>
 * 
 ...
 */
public class AlterarItemComplementarPDCAdapterImpl extends PdcBaseAdapter implements
        IAlterarItemComplementarPDCAdapter, IAlterarItemComplementarAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.alteraritemcomplementar.IAlterarItemComplementarPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.alteraritemcomplementar.request.AlterarItemComplementarRequest)
     * @param message Objeto do tipo AlterarItemComplementarRequest 
     ...
     * @return Objeto do tipo AlterarItemComplementarResponse 
     ...
     */
    public AlterarItemComplementarResponse invokeProcess(
            AlterarItemComplementarRequest message) 
     ...
     */
    public String mappingRequest(AlterarItemComplementarRequest message) {
     ...
     * objeto do tipo AlterarItemComplementarResponse.
     * 
	 * @param response Objeto do tipo AlterarItemComplementarResponse 
     ...
     */
    public AlterarItemComplementarResponse mappingResponse(String response) {

        AlterarItemComplementarResponse processResponse = new AlterarItemComplementarResponse();
        try {
            
            processResponse = 
            	(AlterarItemComplementarResponse) AlterarItemComplementarResponse.
