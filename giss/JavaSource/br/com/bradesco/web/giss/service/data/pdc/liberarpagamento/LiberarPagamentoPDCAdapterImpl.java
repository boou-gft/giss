package br.com.bradesco.web.giss.service.data.pdc.liberarpagamento;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: LiberarPagamento
 * </p>
 * 
 ...
 */
public class LiberarPagamentoPDCAdapterImpl extends PdcBaseAdapter implements
        ILiberarPagamentoPDCAdapter, ILiberarPagamentoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.liberarpagamento.ILiberarPagamentoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.liberarpagamento.request.LiberarPagamentoRequest)
     * @param message Objeto do tipo LiberarPagamentoRequest 
     ...
     * @return Objeto do tipo LiberarPagamentoResponse 
     ...
     */
    public LiberarPagamentoResponse invokeProcess(
            LiberarPagamentoRequest message) 
     ...
     */
    public String mappingRequest(LiberarPagamentoRequest message) {
     ...
     * objeto do tipo LiberarPagamentoResponse.
     * 
	 * @param response Objeto do tipo LiberarPagamentoResponse 
     ...
     */
    public LiberarPagamentoResponse mappingResponse(String response) {

        LiberarPagamentoResponse processResponse = new LiberarPagamentoResponse();
        try {
            
            processResponse = 
            	(LiberarPagamentoResponse) LiberarPagamentoResponse.
