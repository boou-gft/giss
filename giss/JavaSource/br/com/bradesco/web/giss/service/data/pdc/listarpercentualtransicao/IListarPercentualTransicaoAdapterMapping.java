 ...
 */
public interface IListarPercentualTransicaoAdapterMapping {
     ...
     */
    String mappingRequest(ListarPercentualTransicaoRequest message);
     ...
     */
    ListarPercentualTransicaoResponse mappingResponse(String response);
