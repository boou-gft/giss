package br.com.bradesco.web.giss.service.data.pdc.consultarlupacnpjemp;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarLupaCnpjEmp
 * </p>
 * 
 ...
 */
public class ConsultarLupaCnpjEmpPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarLupaCnpjEmpPDCAdapter, IConsultarLupaCnpjEmpAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarlupacnpjemp.IConsultarLupaCnpjEmpPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarlupacnpjemp.request.ConsultarLupaCnpjEmpRequest)
     * @param message Objeto do tipo ConsultarLupaCnpjEmpRequest 
     ...
     * @return Objeto do tipo ConsultarLupaCnpjEmpResponse 
     ...
     */
    public ConsultarLupaCnpjEmpResponse invokeProcess(
            ConsultarLupaCnpjEmpRequest message) 
     ...
     */
    public String mappingRequest(ConsultarLupaCnpjEmpRequest message) {
     ...
     * objeto do tipo ConsultarLupaCnpjEmpResponse.
     * 
	 * @param response Objeto do tipo ConsultarLupaCnpjEmpResponse 
     ...
     */
    public ConsultarLupaCnpjEmpResponse mappingResponse(String response) {

        ConsultarLupaCnpjEmpResponse processResponse = new ConsultarLupaCnpjEmpResponse();
        try {
            
            processResponse = 
            	(ConsultarLupaCnpjEmpResponse) ConsultarLupaCnpjEmpResponse.
