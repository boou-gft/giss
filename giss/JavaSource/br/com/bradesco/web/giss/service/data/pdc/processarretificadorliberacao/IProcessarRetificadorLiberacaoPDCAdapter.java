 ...
 */
public interface IProcessarRetificadorLiberacaoPDCAdapter {
     ...
     */
    ProcessarRetificadorLiberacaoResponse invokeProcess(ProcessarRetificadorLiberacaoRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ProcessarRetificadorLiberacaoResponse invokeProcess(ProcessarRetificadorLiberacaoRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ProcessarRetificadorLiberacaoResponse[] invokeProcess(ProcessarRetificadorLiberacaoRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ProcessarRetificadorLiberacaoResponse[] invokeProcess(ProcessarRetificadorLiberacaoRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
