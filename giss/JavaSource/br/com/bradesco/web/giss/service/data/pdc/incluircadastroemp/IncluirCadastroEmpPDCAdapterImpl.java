package br.com.bradesco.web.giss.service.data.pdc.incluircadastroemp;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirCadastroEmp
 * </p>
 * 
 ...
 */
public class IncluirCadastroEmpPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirCadastroEmpPDCAdapter, IIncluirCadastroEmpAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluircadastroemp.IIncluirCadastroEmpPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluircadastroemp.request.IncluirCadastroEmpRequest)
     * @param message Objeto do tipo IncluirCadastroEmpRequest 
     ...
     * @return Objeto do tipo IncluirCadastroEmpResponse 
     ...
     */
    public IncluirCadastroEmpResponse invokeProcess(
            IncluirCadastroEmpRequest message) 
     ...
     */
    public String mappingRequest(IncluirCadastroEmpRequest message) {
     ...
     * objeto do tipo IncluirCadastroEmpResponse.
     * 
	 * @param response Objeto do tipo IncluirCadastroEmpResponse 
     ...
     */
    public IncluirCadastroEmpResponse mappingResponse(String response) {

        IncluirCadastroEmpResponse processResponse = new IncluirCadastroEmpResponse();
        try {
            
            processResponse = 
            	(IncluirCadastroEmpResponse) IncluirCadastroEmpResponse.
