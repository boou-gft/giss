 ...
 */
public interface IListarHistCodLancamentoAdapterMapping {
     ...
     */
    String mappingRequest(ListarHistCodLancamentoRequest message);
     ...
     */
    ListarHistCodLancamentoResponse mappingResponse(String response);
