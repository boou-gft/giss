 ...
 */
public interface IConsultaDependenciaHistoricoAdapterMapping {
     ...
     */
    String mappingRequest(ConsultaDependenciaHistoricoRequest message);
     ...
     */
    ConsultaDependenciaHistoricoResponse mappingResponse(String response);
