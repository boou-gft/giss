 ...
 */
public interface IIncluirMunicipioPDCAdapter {
     ...
     */
    IncluirMunicipioResponse invokeProcess(IncluirMunicipioRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    IncluirMunicipioResponse invokeProcess(IncluirMunicipioRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     IncluirMunicipioResponse[] invokeProcess(IncluirMunicipioRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    IncluirMunicipioResponse[] invokeProcess(IncluirMunicipioRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
