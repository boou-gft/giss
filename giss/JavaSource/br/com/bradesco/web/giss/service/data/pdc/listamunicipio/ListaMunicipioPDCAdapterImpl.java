package br.com.bradesco.web.giss.service.data.pdc.listamunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaMunicipio
 * </p>
 * 
 ...
 */
public class ListaMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IListaMunicipioPDCAdapter, IListaMunicipioAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listamunicipio.IListaMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listamunicipio.request.ListaMunicipioRequest)
     * @param message Objeto do tipo ListaMunicipioRequest 
     ...
     * @return Objeto do tipo ListaMunicipioResponse 
     ...
     */
    public ListaMunicipioResponse invokeProcess(
            ListaMunicipioRequest message) 
     ...
     */
    public String mappingRequest(ListaMunicipioRequest message) {
     ...
     * objeto do tipo ListaMunicipioResponse.
     * 
	 * @param response Objeto do tipo ListaMunicipioResponse 
     ...
     */
    public ListaMunicipioResponse mappingResponse(String response) {

        ListaMunicipioResponse processResponse = new ListaMunicipioResponse();
        try {
            
            processResponse = 
            	(ListaMunicipioResponse) ListaMunicipioResponse.
