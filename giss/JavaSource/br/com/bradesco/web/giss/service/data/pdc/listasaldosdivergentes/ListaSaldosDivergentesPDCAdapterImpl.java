 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaSaldosDivergentes
 * </p>
 * 
 ...
 */
public class ListaSaldosDivergentesPDCAdapterImpl extends PdcBaseAdapter implements
        IListaSaldosDivergentesPDCAdapter, IListaSaldosDivergentesAdapterMapping {
     ...
     */
    public ListaSaldosDivergentesResponse invokeProcess(ListaSaldosDivergentesRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listasaldosdivergentes.IListaSaldosDivergentesPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listasaldosdivergentes.request.ListaSaldosDivergentesRequest)
     * @param message Objeto do tipo ListaSaldosDivergentesRequest 
     ...
     */
    private ListaSaldosDivergentesResponse invokeProcess(
            ListaSaldosDivergentesRequest message, 
     ...
     */
    public String mappingRequest(ListaSaldosDivergentesRequest message) {
     ...
     * objeto do tipo ListaSaldosDivergentesResponse.
     * 
	 * @param response Objeto do tipo ListaSaldosDivergentesResponse 
     ...
     */
    public ListaSaldosDivergentesResponse mappingResponse(String response) {

        ListaSaldosDivergentesResponse processResponse = new ListaSaldosDivergentesResponse();
        try {
            
            processResponse = 
            	(ListaSaldosDivergentesResponse) ListaSaldosDivergentesResponse.
