 ...
 */
public interface IAprovarCargaMassivaGerencialAdapterMapping {
     ...
     */
    String mappingRequest(AprovarCargaMassivaGerencialRequest message);
     ...
     */
    AprovarCargaMassivaGerencialResponse mappingResponse(String response);
