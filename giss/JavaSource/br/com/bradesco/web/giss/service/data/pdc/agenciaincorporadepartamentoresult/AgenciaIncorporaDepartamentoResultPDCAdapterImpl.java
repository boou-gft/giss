package br.com.bradesco.web.giss.service.data.pdc.agenciaincorporadepartamentoresult;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AgenciaIncorporaDepartamentoResult
 * </p>
 * 
 ...
 */
public class AgenciaIncorporaDepartamentoResultPDCAdapterImpl extends PdcBaseAdapter implements
        IAgenciaIncorporaDepartamentoResultPDCAdapter, IAgenciaIncorporaDepartamentoResultAdapterMapping {
     ...
     */
    public AgenciaIncorporaDepartamentoResultResponse invokeProcess(AgenciaIncorporaDepartamentoResultRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.agenciaincorporadepartamentoresult.IAgenciaIncorporaDepartamentoResultPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.agenciaincorporadepartamentoresult.request.AgenciaIncorporaDepartamentoResultRequest)
     * @param message Objeto do tipo AgenciaIncorporaDepartamentoResultRequest 
     ...
     * @return Objeto do tipo AgenciaIncorporaDepartamentoResultResponse 
     ...
     */
    private AgenciaIncorporaDepartamentoResultResponse invokeProcess(
            AgenciaIncorporaDepartamentoResultRequest message, 
     ...
     */
    public String mappingRequest(AgenciaIncorporaDepartamentoResultRequest message) {
     ...
     * objeto do tipo AgenciaIncorporaDepartamentoResultResponse.
     * 
	 * @param response Objeto do tipo AgenciaIncorporaDepartamentoResultResponse 
     ...
     */
    public AgenciaIncorporaDepartamentoResultResponse mappingResponse(String response) {

        AgenciaIncorporaDepartamentoResultResponse processResponse = new AgenciaIncorporaDepartamentoResultResponse();
        try {
            
            processResponse = 
            	(AgenciaIncorporaDepartamentoResultResponse) AgenciaIncorporaDepartamentoResultResponse.
