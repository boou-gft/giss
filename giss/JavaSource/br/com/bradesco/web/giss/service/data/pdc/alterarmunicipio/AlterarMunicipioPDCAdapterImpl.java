package br.com.bradesco.web.giss.service.data.pdc.alterarmunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AlterarMunicipio
 * </p>
 * 
 ...
 */
public class AlterarMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IAlterarMunicipioPDCAdapter, IAlterarMunicipioAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo AlterarMunicipioRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo AlterarMunicipioResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public AlterarMunicipioResponse invokeProcess(AlterarMunicipioRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public AlterarMunicipioResponse invokeProcess(AlterarMunicipioRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo AlterarMunicipioRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo AlterarMunicipioResponse 
     ...
     */
    private AlterarMunicipioResponse invokeProcess(
            AlterarMunicipioRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public AlterarMunicipioResponse[] invokeProcess(AlterarMunicipioRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public AlterarMunicipioResponse[] invokeProcess(AlterarMunicipioRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(AlterarMunicipioRequest message) {
     ...
     * objeto do tipo AlterarMunicipioResponse.
     * 
	 * @param response Objeto do tipo AlterarMunicipioResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo AlterarMunicipioResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public AlterarMunicipioResponse mappingResponse(String response) {

        AlterarMunicipioResponse processResponse = new AlterarMunicipioResponse();
        try {
            
            processResponse = 
            	(AlterarMunicipioResponse) AlterarMunicipioResponse.
