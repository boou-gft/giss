 ...
 */
public interface IIncluirContaEmpresaAdapterMapping {
     ...
     */
    String mappingRequest(IncluirContaEmpresaRequest message);
     ...
     */
    IncluirContaEmpresaResponse mappingResponse(String response);
