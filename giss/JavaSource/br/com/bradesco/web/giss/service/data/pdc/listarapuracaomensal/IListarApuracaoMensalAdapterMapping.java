 ...
 */
public interface IListarApuracaoMensalAdapterMapping {
     ...
     */
    String mappingRequest(ListarApuracaoMensalRequest message);
     ...
     */
    ListarApuracaoMensalResponse mappingResponse(String response);
