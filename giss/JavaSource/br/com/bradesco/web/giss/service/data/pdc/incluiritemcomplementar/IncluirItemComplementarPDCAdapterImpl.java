package br.com.bradesco.web.giss.service.data.pdc.incluiritemcomplementar;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirItemComplementar
 * </p>
 * 
 ...
 */
public class IncluirItemComplementarPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirItemComplementarPDCAdapter, IIncluirItemComplementarAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluiritemcomplementar.IIncluirItemComplementarPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluiritemcomplementar.request.IncluirItemComplementarRequest)
     * @param message Objeto do tipo IncluirItemComplementarRequest 
     ...
     * @return Objeto do tipo IncluirItemComplementarResponse 
     ...
     */
    public IncluirItemComplementarResponse invokeProcess(
            IncluirItemComplementarRequest message) 
     ...
     */
    public String mappingRequest(IncluirItemComplementarRequest message) {
     ...
     * objeto do tipo IncluirItemComplementarResponse.
     * 
	 * @param response Objeto do tipo IncluirItemComplementarResponse 
     ...
     */
    public IncluirItemComplementarResponse mappingResponse(String response) {

        IncluirItemComplementarResponse processResponse = new IncluirItemComplementarResponse();
        try {
            
            processResponse = 
            	(IncluirItemComplementarResponse) IncluirItemComplementarResponse.
