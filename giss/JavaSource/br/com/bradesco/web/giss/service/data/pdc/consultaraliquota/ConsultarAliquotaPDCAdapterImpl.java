package br.com.bradesco.web.giss.service.data.pdc.consultaraliquota;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarAliquota
 * </p>
 * 
 ...
 */
public class ConsultarAliquotaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarAliquotaPDCAdapter, IConsultarAliquotaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultaraliquota.IConsultarAliquotaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultaraliquota.request.ConsultarAliquotaRequest)
     * @param message Objeto do tipo ConsultarAliquotaRequest 
     ...
     * @return Objeto do tipo ConsultarAliquotaResponse 
     ...
     */
    public ConsultarAliquotaResponse invokeProcess(
            ConsultarAliquotaRequest message) 
     ...
     */
    public String mappingRequest(ConsultarAliquotaRequest message) {
     ...
     * objeto do tipo ConsultarAliquotaResponse.
     * 
	 * @param response Objeto do tipo ConsultarAliquotaResponse 
     ...
     */
    public ConsultarAliquotaResponse mappingResponse(String response) {

        ConsultarAliquotaResponse processResponse = new ConsultarAliquotaResponse();
        try {
            
            processResponse = 
            	(ConsultarAliquotaResponse) ConsultarAliquotaResponse.
