 ...
 */
public interface IGerarBalanceteAdapterMapping {
     ...
     */
    String mappingRequest(GerarBalanceteRequest message);
     ...
     */
    GerarBalanceteResponse mappingResponse(String response);
