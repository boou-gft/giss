package br.com.bradesco.web.giss.service.data.pdc.listarestados;
...
import br.com.bradesco.web.giss.service.data.pdc.listarestados.request.ListarEstadosRequest;
import br.com.bradesco.web.giss.service.data.pdc.listarestados.response.ListarEstadosResponse;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarEstados
 * </p>
 * 
 ...
 */
public class ListarEstadosPDCAdapterImpl extends PdcBaseAdapter implements
        IListarEstadosPDCAdapter, IListarEstadosAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarestados.IListarEstadosPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarestados.request.ListarEstadosRequest)
     * @param message Objeto do tipo ListarEstadosRequest 
     ...
     * @return Objeto do tipo ListarEstadosResponse 
     ...
     */
    public ListarEstadosResponse invokeProcess(
            ListarEstadosRequest message) 
     ...
     */
    public String mappingRequest(ListarEstadosRequest message) {
     ...
     * objeto do tipo ListarEstadosResponse.
     * 
	 * @param response Objeto do tipo ListarEstadosResponse 
     ...
     */
    public ListarEstadosResponse mappingResponse(String response) {

        ListarEstadosResponse processResponse = new ListarEstadosResponse();
        try {
            
            processResponse = 
            	(ListarEstadosResponse) ListarEstadosResponse.
