package br.com.bradesco.web.giss.service.data.pdc.incluirmunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirMunicipio
 * </p>
 * 
 ...
 */
public class IncluirMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirMunicipioPDCAdapter, IIncluirMunicipioAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo IncluirMunicipioRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo IncluirMunicipioResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public IncluirMunicipioResponse invokeProcess(IncluirMunicipioRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public IncluirMunicipioResponse invokeProcess(IncluirMunicipioRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo IncluirMunicipioRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo IncluirMunicipioResponse 
     ...
     */
    private IncluirMunicipioResponse invokeProcess(
            IncluirMunicipioRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public IncluirMunicipioResponse[] invokeProcess(IncluirMunicipioRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public IncluirMunicipioResponse[] invokeProcess(IncluirMunicipioRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(IncluirMunicipioRequest message) {
     ...
     * objeto do tipo IncluirMunicipioResponse.
     * 
	 * @param response Objeto do tipo IncluirMunicipioResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo IncluirMunicipioResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public IncluirMunicipioResponse mappingResponse(String response) {

        IncluirMunicipioResponse processResponse = new IncluirMunicipioResponse();
        try {
            
            processResponse = 
            	(IncluirMunicipioResponse) IncluirMunicipioResponse.
