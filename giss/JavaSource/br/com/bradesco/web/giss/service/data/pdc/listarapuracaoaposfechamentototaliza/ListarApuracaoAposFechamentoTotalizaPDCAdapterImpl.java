 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarApuracaoAposFechamentoTotaliza
 * </p>
 * 
 ...
 */
public class ListarApuracaoAposFechamentoTotalizaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarApuracaoAposFechamentoTotalizaPDCAdapter, IListarApuracaoAposFechamentoTotalizaAdapterMapping {
     ...
     */
    public ListarApuracaoAposFechamentoTotalizaResponse invokeProcess(ListarApuracaoAposFechamentoTotalizaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarapuracaoaposfechamentototaliza.IListarApuracaoAposFechamentoTotalizaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarapuracaoaposfechamentototaliza.request.ListarApuracaoAposFechamentoTotalizaRequest)
     * @param message Objeto do tipo ListarApuracaoAposFechamentoTotalizaRequest 
     ...
     */
    private ListarApuracaoAposFechamentoTotalizaResponse invokeProcess(
            ListarApuracaoAposFechamentoTotalizaRequest message, 
     ...
     */
    public String mappingRequest(ListarApuracaoAposFechamentoTotalizaRequest message) {
     ...
     * objeto do tipo ListarApuracaoAposFechamentoTotalizaResponse.
     * 
	 * @param response Objeto do tipo ListarApuracaoAposFechamentoTotalizaResponse 
     ...
     */
    public ListarApuracaoAposFechamentoTotalizaResponse mappingResponse(String response) {

        ListarApuracaoAposFechamentoTotalizaResponse processResponse = new ListarApuracaoAposFechamentoTotalizaResponse();
        try {
            
            processResponse = 
            	(ListarApuracaoAposFechamentoTotalizaResponse) ListarApuracaoAposFechamentoTotalizaResponse.
