 ...
 */
public interface IIncluirItemComplementarAdapterMapping {
     ...
     */
    String mappingRequest(IncluirItemComplementarRequest message);
     ...
     */
    IncluirItemComplementarResponse mappingResponse(String response);
