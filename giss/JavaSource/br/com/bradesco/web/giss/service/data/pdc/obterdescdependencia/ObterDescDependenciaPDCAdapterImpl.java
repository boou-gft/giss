package br.com.bradesco.web.giss.service.data.pdc.obterdescdependencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ObterDescDependencia
 * </p>
 * 
 ...
 */
public class ObterDescDependenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IObterDescDependenciaPDCAdapter, IObterDescDependenciaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.obterdescdependencia.IObterDescDependenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.obterdescdependencia.request.ObterDescDependenciaRequest)
     * @param message Objeto do tipo ObterDescDependenciaRequest 
     ...
     * @return Objeto do tipo ObterDescDependenciaResponse 
     ...
     */
    public ObterDescDependenciaResponse invokeProcess(
            ObterDescDependenciaRequest message) 
     ...
     */
    public String mappingRequest(ObterDescDependenciaRequest message) {
     ...
     * objeto do tipo ObterDescDependenciaResponse.
     * 
	 * @param response Objeto do tipo ObterDescDependenciaResponse 
     ...
     */
    public ObterDescDependenciaResponse mappingResponse(String response) {

        ObterDescDependenciaResponse processResponse = new ObterDescDependenciaResponse();
        try {
            
            processResponse = 
            	(ObterDescDependenciaResponse) ObterDescDependenciaResponse.
