 ...
 */
public interface IReprocessarApuracaoAdapterMapping {
     ...
     */
    String mappingRequest(ReprocessarApuracaoRequest message);
     ...
     */
    ReprocessarApuracaoResponse mappingResponse(String response);
