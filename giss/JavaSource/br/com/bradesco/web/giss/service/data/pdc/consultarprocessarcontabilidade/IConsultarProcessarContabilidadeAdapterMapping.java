 ...
 */
public interface IConsultarProcessarContabilidadeAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarProcessarContabilidadeRequest message);
     ...
     */
    ConsultarProcessarContabilidadeResponse mappingResponse(String response);
