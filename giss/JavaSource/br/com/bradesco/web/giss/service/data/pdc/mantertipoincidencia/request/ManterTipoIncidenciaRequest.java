 ...
 * Schema.
 * $Id: ManterTipoIncidenciaRequest.java,v 1.1 2017/04/11 14:09:41 gmichelini Exp $
 */
...
/**
 * Class ManterTipoIncidenciaRequest.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:09:41 $
 */
public class ManterTipoIncidenciaRequest implements java.io.Serializable {
    ...
    public ManterTipoIncidenciaRequest() 
     {
        super();
        _ocorrenciasList = new Vector();
    } //-- br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.ManterTipoIncidenciaRequest()
     ...
     * @param vOcorrencias
     */
    public void addOcorrencias(br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias vOcorrencias)
    ...
    } //-- void addOcorrencias(br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias) 
     ...
     * @param vOcorrencias
     */
    public void addOcorrencias(int index, br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias vOcorrencias)
        throws java.lang.IndexOutOfBoundsException
    {
        if (!(_ocorrenciasList.size() < 99)) {
            throw new IndexOutOfBoundsException("addOcorrencias has a maximum of 99");
    ...
    } //-- void addOcorrencias(int, br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias) 
     ...
     * @return Ocorrencias
     */
    public br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias getOcorrencias(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias) _ocorrenciasList.elementAt(index);
    } //-- br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias getOcorrencias(int) 
     ...
     * @return Ocorrencias
     */
    public br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias[] getOcorrencias()
    {
        int size = _ocorrenciasList.size();
        br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias[] mArray = new br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias) _ocorrenciasList.elementAt(index);
        }
        return mArray;
    } //-- br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias[] getOcorrencias() 
     ...
     * @return Ocorrencias
     */
    public br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias removeOcorrencias(int index)
    {
        java.lang.Object obj = _ocorrenciasList.elementAt(index);
        _ocorrenciasList.removeElementAt(index);
        return (br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias) obj;
    } //-- br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias removeOcorrencias(int) 
     ...
     * @param vOcorrencias
     */
    public void setOcorrencias(int index, br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias vOcorrencias)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _ocorrenciasList.size())) {
    ...
    } //-- void setOcorrencias(int, br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias) 
     ...
     */
    public void setOcorrencias(br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias[] ocorrenciasArray)
    {
        //-- copy array
        _ocorrenciasList.removeAllElements();
    ...
    } //-- void setOcorrencias(br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.Ocorrencias) 
     ...
     * 
     * @param reader
     * @return ManterTipoIncidenciaRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.ManterTipoIncidenciaRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.ManterTipoIncidenciaRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.ManterTipoIncidenciaRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.mantertipoincidencia.request.ManterTipoIncidenciaRequest unmarshal(java.io.Reader) 
