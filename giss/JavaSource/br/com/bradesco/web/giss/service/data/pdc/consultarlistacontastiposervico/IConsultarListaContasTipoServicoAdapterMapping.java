 ...
 */
public interface IConsultarListaContasTipoServicoAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarListaContasTipoServicoRequest message);
     ...
     */
    ConsultarListaContasTipoServicoResponse mappingResponse(String response);
