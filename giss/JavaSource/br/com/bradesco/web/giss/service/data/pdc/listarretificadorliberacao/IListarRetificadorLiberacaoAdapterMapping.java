 ...
 */
public interface IListarRetificadorLiberacaoAdapterMapping {
     ...
     */
    String mappingRequest(ListarRetificadorLiberacaoRequest message);
     ...
     */
    ListarRetificadorLiberacaoResponse mappingResponse(String response);
