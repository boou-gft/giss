 ...
 */
public interface IListarItemComplementarAdapterMapping {
     ...
     */
    String mappingRequest(ListarItemComplementarRequest message);
     ...
     */
    ListarItemComplementarResponse mappingResponse(String response);
