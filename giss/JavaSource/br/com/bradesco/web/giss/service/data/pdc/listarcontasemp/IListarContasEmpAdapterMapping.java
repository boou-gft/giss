 ...
 */
public interface IListarContasEmpAdapterMapping {
     ...
     */
    String mappingRequest(ListarContasEmpRequest message);
     ...
     */
    ListarContasEmpResponse mappingResponse(String response);
