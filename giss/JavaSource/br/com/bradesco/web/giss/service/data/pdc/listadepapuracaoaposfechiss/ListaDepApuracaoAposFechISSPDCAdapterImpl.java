package br.com.bradesco.web.giss.service.data.pdc.listadepapuracaoaposfechiss;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaDepApuracaoAposFechISS
 * </p>
 * 
 ...
 */
public class ListaDepApuracaoAposFechISSPDCAdapterImpl extends PdcBaseAdapter implements
        IListaDepApuracaoAposFechISSPDCAdapter, IListaDepApuracaoAposFechISSAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listadepapuracaoaposfechiss.IListaDepApuracaoAposFechISSPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listadepapuracaoaposfechiss.request.ListaDepApuracaoAposFechISSRequest)
     * @param message Objeto do tipo ListaDepApuracaoAposFechISSRequest 
     ...
     * @return Objeto do tipo ListaDepApuracaoAposFechISSResponse 
     ...
     */
    public ListaDepApuracaoAposFechISSResponse invokeProcess(
            ListaDepApuracaoAposFechISSRequest message) 
     ...
     */
    public String mappingRequest(ListaDepApuracaoAposFechISSRequest message) {
     ...
     * objeto do tipo ListaDepApuracaoAposFechISSResponse.
     * 
	 * @param response Objeto do tipo ListaDepApuracaoAposFechISSResponse 
     ...
     */
    public ListaDepApuracaoAposFechISSResponse mappingResponse(String response) {

        ListaDepApuracaoAposFechISSResponse processResponse = new ListaDepApuracaoAposFechISSResponse();
        try {
            
            processResponse = 
            	(ListaDepApuracaoAposFechISSResponse) ListaDepApuracaoAposFechISSResponse.
