package br.com.bradesco.web.giss.service.data.pdc.listarbalancetes;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarBalancetes
 * </p>
 * 
 ...
 */
public class ListarBalancetesPDCAdapterImpl extends PdcBaseAdapter implements
        IListarBalancetesPDCAdapter, IListarBalancetesAdapterMapping {
     ...
     */
    public ListarBalancetesResponse invokeProcess(ListarBalancetesRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcontascontabeis.IListarBalancetesPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcontascontabeis.request.ListarBalancetesRequest)
     * @param message Objeto do tipo ListarBalancetesRequest 
     ...
     * @return Objeto do tipo ListarBalancetesResponse 
     ...
     */
    private ListarBalancetesResponse invokeProcess(
            ListarBalancetesRequest message, 
     ...
     */
    public String mappingRequest(ListarBalancetesRequest message) {
     ...
     * objeto do tipo ListarBalancetesResponse.
     * 
	 * @param response Objeto do tipo ListarBalancetesResponse 
     ...
     */
    public ListarBalancetesResponse mappingResponse(String response) {

        ListarBalancetesResponse processResponse = new ListarBalancetesResponse();
        try {
            
            processResponse = 
            	(ListarBalancetesResponse) ListarBalancetesResponse.
