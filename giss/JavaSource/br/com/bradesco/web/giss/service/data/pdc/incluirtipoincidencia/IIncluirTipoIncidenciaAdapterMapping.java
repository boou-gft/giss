 ...
 */
public interface IIncluirTipoIncidenciaAdapterMapping {
     ...
     */
    String mappingRequest(IncluirTipoIncidenciaRequest message);
     ...
     */
    IncluirTipoIncidenciaResponse mappingResponse(String response);
