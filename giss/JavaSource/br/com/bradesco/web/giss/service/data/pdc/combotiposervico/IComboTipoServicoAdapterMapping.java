 ...
 */
public interface IComboTipoServicoAdapterMapping {
     ...
     */
    String mappingRequest(ComboTipoServicoRequest message);
     ...
     */
    ComboTipoServicoResponse mappingResponse(String response);
