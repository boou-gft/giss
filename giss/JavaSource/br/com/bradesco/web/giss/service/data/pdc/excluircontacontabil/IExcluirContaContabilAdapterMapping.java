 ...
 */
public interface IExcluirContaContabilAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirContaContabilRequest message);
     ...
     */
    ExcluirContaContabilResponse mappingResponse(String response);
