 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirAlterarContasMunicipio
 * </p>
 * 
 ...
 */
public class IncluirAlterarContasMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirAlterarContasMunicipioPDCAdapter, IIncluirAlterarContasMunicipioAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluiralterarcontasmunicipio.IIncluirAlterarContasMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluiralterarcontasmunicipio.request.IncluirAlterarContasMunicipioRequest)
     * @param message Objeto do tipo IncluirAlterarContasMunicipioRequest 
     ...
     */
    public IncluirAlterarContasMunicipioResponse invokeProcess(
            IncluirAlterarContasMunicipioRequest message) 
     ...
     */
    public String mappingRequest(IncluirAlterarContasMunicipioRequest message) {
     ...
     * objeto do tipo IncluirAlterarContasMunicipioResponse.
     * 
	 * @param response Objeto do tipo IncluirAlterarContasMunicipioResponse 
     ...
     */
    public IncluirAlterarContasMunicipioResponse mappingResponse(String response) {

        IncluirAlterarContasMunicipioResponse processResponse = new IncluirAlterarContasMunicipioResponse();
        try {
            
            processResponse = 
            	(IncluirAlterarContasMunicipioResponse) IncluirAlterarContasMunicipioResponse.
