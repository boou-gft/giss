package br.com.bradesco.web.giss.service.data.pdc.agendarpgtolote;
...
import br.com.bradesco.web.giss.service.data.pdc.agendarpgtolote.request.AgendarPgtoLoteRequest;
import br.com.bradesco.web.giss.service.data.pdc.agendarpgtolote.response.AgendarPgtoLoteResponse;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AgendarPgtoLote
 * </p>
 * 
 ...
 */
public class AgendarPgtoLotePDCAdapterImpl extends PdcBaseAdapter implements
        IAgendarPgtoLotePDCAdapter, IAgendarPgtoLoteAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.agendarpgtolote.IAgendarPgtoLotePDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.agendarpgtolote.request.AgendarPgtoLoteRequest)
     * @param message Objeto do tipo AgendarPgtoLoteRequest 
     ...
     * @return Objeto do tipo AgendarPgtoLoteResponse 
     ...
     */
    public AgendarPgtoLoteResponse invokeProcess(
            AgendarPgtoLoteRequest message) 
     ...
     */
    public String mappingRequest(AgendarPgtoLoteRequest message) {
     ...
     * objeto do tipo AgendarPgtoLoteResponse.
     * 
	 * @param response Objeto do tipo AgendarPgtoLoteResponse 
     ...
     */
    public AgendarPgtoLoteResponse mappingResponse(String response) {

        AgendarPgtoLoteResponse processResponse = new AgendarPgtoLoteResponse();
        try {
            
            processResponse = 
            	(AgendarPgtoLoteResponse) AgendarPgtoLoteResponse.
