 ...
 */
public interface IExcluirDependenciaAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirDependenciaRequest message);
     ...
     */
    ExcluirDependenciaResponse mappingResponse(String response);
