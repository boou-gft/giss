 ...
 * Schema.
 * $Id: ReceitaDescriptor.java,v 1.1 2012/11/22 15:40:48 gmichelini Exp $
 */
...
/**
 * Class ReceitaDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2012/11/22 15:40:48 $
 */
public class ReceitaDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReceitaDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.response.ReceitaDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.response.Receita.class;
