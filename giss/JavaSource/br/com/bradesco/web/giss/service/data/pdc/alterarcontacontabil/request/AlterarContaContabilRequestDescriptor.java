 ...
 * Schema.
 * $Id: AlterarContaContabilRequestDescriptor.java,v 1.2 2017/08/14 20:08:21 gilbertocopoli Exp $
 */
...
/**
 * Class AlterarContaContabilRequestDescriptor.
 * 
 * @version $Revision: 1.2 $ $Date: 2017/08/14 20:08:21 $
 */
public class AlterarContaContabilRequestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AlterarContaContabilRequestDescriptor() 
     {
        super();
        xmlName = "alterarContaContabilRequest";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                AlterarContaContabilRequest target = (AlterarContaContabilRequest) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _codigoItemLeiCompl
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Integer.TYPE, "_codigoItemLeiCompl", "codigoItemLeiCompl", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                AlterarContaContabilRequest target = (AlterarContaContabilRequest) object;
                if(!target.hasCodigoItemLeiCompl())
                    return null;
                return new java.lang.Integer(target.getCodigoItemLeiCompl());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setCodigoItemLeiCompl( ((java.lang.Integer)value).intValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _codigoItemLeiCompl
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            IntegerValidator typeValidator= new IntegerValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.alterarcontacontabil.request.AlterarContaContabilRequestDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.alterarcontacontabil.request.AlterarContaContabilRequest.class;
