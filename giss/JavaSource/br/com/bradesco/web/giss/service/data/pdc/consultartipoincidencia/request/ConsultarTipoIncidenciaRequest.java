 ...
 * Schema.
 * $Id: ConsultarTipoIncidenciaRequest.java,v 1.1 2017/04/11 14:13:06 gmichelini Exp $
 */

package br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.request;
...
/**
 * Class ConsultarTipoIncidenciaRequest.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:13:06 $
 */
public class ConsultarTipoIncidenciaRequest implements java.io.Serializable {
    ...
    public ConsultarTipoIncidenciaRequest() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.request.ConsultarTipoIncidenciaRequest()
     ...
     * 
     * @param reader
     * @return ConsultarTipoIncidenciaRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.request.ConsultarTipoIncidenciaRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.request.ConsultarTipoIncidenciaRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.request.ConsultarTipoIncidenciaRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.request.ConsultarTipoIncidenciaRequest unmarshal(java.io.Reader) 
