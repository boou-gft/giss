...
/**
 * Class AlterarCadastroEmpRequest.
 * 
 * @version $Revision$ $Date$
 */
public class AlterarCadastroEmpRequest implements java.io.Serializable {
    ...
    public AlterarCadastroEmpRequest() 
     {
        super();
        setPercentual(new java.math.BigDecimal("0"));
    } //-- br.com.bradesco.web.giss.service.data.pdc.alterarcadastroemp.request.AlterarCadastroEmpRequest()
     ...
     * 
     * @param reader
     * @return AlterarCadastroEmpRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.alterarcadastroemp.request.AlterarCadastroEmpRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.alterarcadastroemp.request.AlterarCadastroEmpRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.alterarcadastroemp.request.AlterarCadastroEmpRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.alterarcadastroemp.request.AlterarCadastroEmpRequest unmarshal(java.io.Reader) 
