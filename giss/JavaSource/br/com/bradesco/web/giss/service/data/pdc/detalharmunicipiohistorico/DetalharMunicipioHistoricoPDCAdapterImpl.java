package br.com.bradesco.web.giss.service.data.pdc.detalharmunicipiohistorico;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: DetalharMunicipioHistorico
 * </p>
 * 
 ...
 */
public class DetalharMunicipioHistoricoPDCAdapterImpl extends PdcBaseAdapter implements
        IDetalharMunicipioHistoricoPDCAdapter, IDetalharMunicipioHistoricoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.detalharmunicipiohistorico.IDetalharMunicipioHistoricoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.detalharmunicipiohistorico.request.DetalharMunicipioHistoricoRequest)
     * @param message Objeto do tipo DetalharMunicipioHistoricoRequest 
     ...
     * @return Objeto do tipo DetalharMunicipioHistoricoResponse 
     ...
     */
    public DetalharMunicipioHistoricoResponse invokeProcess(
            DetalharMunicipioHistoricoRequest message) 
     ...
     */
    public String mappingRequest(DetalharMunicipioHistoricoRequest message) {
     ...
     * objeto do tipo DetalharMunicipioHistoricoResponse.
     * 
	 * @param response Objeto do tipo DetalharMunicipioHistoricoResponse 
     ...
     */
    public DetalharMunicipioHistoricoResponse mappingResponse(String response) {

        DetalharMunicipioHistoricoResponse processResponse = new DetalharMunicipioHistoricoResponse();
        try {
            
            processResponse = 
            	(DetalharMunicipioHistoricoResponse) DetalharMunicipioHistoricoResponse.
