package br.com.bradesco.web.giss.service.data.pdc.detalharhistoricotipoincidencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: DetalharHistoricoTipoIncidencia
 * </p>
 * 
 ...
 */
public class DetalharHistoricoTipoIncidenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IDetalharHistoricoTipoIncidenciaPDCAdapter, IDetalharHistoricoTipoIncidenciaAdapterMapping {
     ...
     */
    public DetalharHistoricoTipoIncidenciaResponse invokeProcess(DetalharHistoricoTipoIncidenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.detalharhistoricotipoincidencia.IDetalharHistoricoTipoIncidenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.detalharhistoricotipoincidencia.request.DetalharHistoricoTipoIncidenciaRequest)
     * @param message Objeto do tipo DetalharHistoricoTipoIncidenciaRequest 
     ...
     * @return Objeto do tipo DetalharHistoricoTipoIncidenciaResponse 
     ...
     */
    private DetalharHistoricoTipoIncidenciaResponse invokeProcess(
            DetalharHistoricoTipoIncidenciaRequest message, 
     ...
     */
    public String mappingRequest(DetalharHistoricoTipoIncidenciaRequest message) {
     ...
     * objeto do tipo DetalharHistoricoTipoIncidenciaResponse.
     * 
	 * @param response Objeto do tipo DetalharHistoricoTipoIncidenciaResponse 
     ...
     */
    public DetalharHistoricoTipoIncidenciaResponse mappingResponse(String response) {

        DetalharHistoricoTipoIncidenciaResponse processResponse = new DetalharHistoricoTipoIncidenciaResponse();
        try {
            
            processResponse = 
            	(DetalharHistoricoTipoIncidenciaResponse) DetalharHistoricoTipoIncidenciaResponse.
