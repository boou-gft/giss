package br.com.bradesco.web.giss.service.data.pdc.logtransmissaoarquivo;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: LogTransmissaoArquivo
 * </p>
 * 
 ...
 */
public class LogTransmissaoArquivoPDCAdapterImpl extends PdcBaseAdapter implements
        ILogTransmissaoArquivoPDCAdapter, ILogTransmissaoArquivoAdapterMapping {
     ...
     */
    public LogTransmissaoArquivoResponse invokeProcess(LogTransmissaoArquivoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.service.data.pdc.logtransmissaoarquivo.ILogTransmissaoArquivoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.service.data.pdc.logtransmissaoarquivo.request.LogTransmissaoArquivoRequest)
     * @param message Objeto do tipo LogTransmissaoArquivoRequest 
     ...
     * @return Objeto do tipo LogTransmissaoArquivoResponse 
     ...
     */
    private LogTransmissaoArquivoResponse invokeProcess(
            LogTransmissaoArquivoRequest message, 
     ...
     */
    public String mappingRequest(LogTransmissaoArquivoRequest message) {
     ...
     * objeto do tipo LogTransmissaoArquivoResponse.
     * 
	 * @param response Objeto do tipo LogTransmissaoArquivoResponse 
     ...
     */
    public LogTransmissaoArquivoResponse mappingResponse(String response) {

        LogTransmissaoArquivoResponse processResponse = new LogTransmissaoArquivoResponse();
        try {
            
            processResponse = 
            	(LogTransmissaoArquivoResponse) LogTransmissaoArquivoResponse.
