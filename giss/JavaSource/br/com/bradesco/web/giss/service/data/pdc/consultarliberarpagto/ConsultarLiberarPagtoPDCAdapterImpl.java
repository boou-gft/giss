 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarLiberarPagto
 * </p>
 * 
 ...
 */
public class ConsultarLiberarPagtoPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarLiberarPagtoPDCAdapter, IConsultarLiberarPagtoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarliberarpagto.IConsultarLiberarPagtoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarliberarpagto.request.ConsultarLiberarPagtoRequest)
     * @param message Objeto do tipo ConsultarLiberarPagtoRequest 
     ...
     */
    public ConsultarLiberarPagtoResponse invokeProcess(
            ConsultarLiberarPagtoRequest message) 
     ...
     */
    public String mappingRequest(ConsultarLiberarPagtoRequest message) {
     ...
     * objeto do tipo ConsultarLiberarPagtoResponse.
     * 
	 * @param response Objeto do tipo ConsultarLiberarPagtoResponse 
     ...
     */
    public ConsultarLiberarPagtoResponse mappingResponse(String response) {

        ConsultarLiberarPagtoResponse processResponse = new ConsultarLiberarPagtoResponse();
        try {
            
            processResponse = 
            	(ConsultarLiberarPagtoResponse) ConsultarLiberarPagtoResponse.
