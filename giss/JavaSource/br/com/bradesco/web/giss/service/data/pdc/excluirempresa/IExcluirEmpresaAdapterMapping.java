 ...
 */
public interface IExcluirEmpresaAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirEmpresaRequest message);
     ...
     */
    ExcluirEmpresaResponse mappingResponse(String response);
