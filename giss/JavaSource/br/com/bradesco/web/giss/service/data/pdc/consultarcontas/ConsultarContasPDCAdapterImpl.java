package br.com.bradesco.web.giss.service.data.pdc.consultarcontas;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarContas
 * </p>
 * 
 ...
 */
public class ConsultarContasPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarContasPDCAdapter, IConsultarContasAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ConsultarContasRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ConsultarContasResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ConsultarContasResponse invokeProcess(ConsultarContasRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConsultarContasResponse invokeProcess(ConsultarContasRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ConsultarContasRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ConsultarContasResponse 
     ...
     */
    private ConsultarContasResponse invokeProcess(
            ConsultarContasRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConsultarContasResponse[] invokeProcess(ConsultarContasRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConsultarContasResponse[] invokeProcess(ConsultarContasRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ConsultarContasRequest message) {
     ...
     * objeto do tipo ConsultarContasResponse.
     * 
	 * @param response Objeto do tipo ConsultarContasResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ConsultarContasResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ConsultarContasResponse mappingResponse(String response) {

        ConsultarContasResponse processResponse = new ConsultarContasResponse();
        try {
            
            processResponse = 
            	(ConsultarContasResponse) ConsultarContasResponse.
