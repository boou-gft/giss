 ...
 */
public interface IConsultarDependenciasEncerradasAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarDependenciasEncerradasRequest message);
     ...
     */
    ConsultarDependenciasEncerradasResponse mappingResponse(String response);
