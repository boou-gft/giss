 ...
 */
public interface IIncluirContaContabilAdapterMapping {
     ...
     */
    String mappingRequest(IncluirContaContabilRequest message);
     ...
     */
    IncluirContaContabilResponse mappingResponse(String response);
