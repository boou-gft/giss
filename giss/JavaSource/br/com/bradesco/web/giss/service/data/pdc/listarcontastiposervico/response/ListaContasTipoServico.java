...
/**
 * Class ListaContasTipoServico.
 * 
 * @version $Revision$ $Date$
 */
public class ListaContasTipoServico implements java.io.Serializable {
     ...
     */
    private double _percentualAliquota = 0;

    /**
     * keeps track of state for field: _percentualAliquota
     */
    private boolean _has_percentualAliquota;
    ...
    public ListaContasTipoServico() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.response.ListaContasTipoServico()
    ...
    /**
     * Method deletePercentualAliquota
     * 
     */
    public void deletePercentualAliquota()
    {
        this._has_percentualAliquota= false;
    } //-- void deletePercentualAliquota() 
    ...
    /**
     * Method hasPercentualAliquota
     * 
     * 
     * 
     * @return boolean
     */
    public boolean hasPercentualAliquota()
    {
        return this._has_percentualAliquota;
    } //-- boolean hasPercentualAliquota() 
    ...
    public void setPercentualAliquota(double percentualAliquota)
    {
        ...
        this._has_percentualAliquota = true;
    } //-- void setPercentualAliquota(double) 
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.response.ListaContasTipoServico unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.response.ListaContasTipoServico) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.response.ListaContasTipoServico.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.response.ListaContasTipoServico unmarshal(java.io.Reader) 
