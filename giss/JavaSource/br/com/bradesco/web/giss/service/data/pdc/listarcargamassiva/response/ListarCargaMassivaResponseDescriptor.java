...
/**
 * Class ListarCargaMassivaResponseDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ListarCargaMassivaResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListarCargaMassivaResponseDescriptor() 
     {
        super();
        xmlName = "listarCargaMassivaResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListarCargaMassivaResponse target = (ListarCargaMassivaResponse) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _listaList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.listarcargamassiva.response.Lista.class, "_listaList", "lista", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ListarCargaMassivaResponse target = (ListarCargaMassivaResponse) object;
                    target.addLista( (br.com.bradesco.web.giss.service.data.pdc.listarcargamassiva.response.Lista) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.listarcargamassiva.response.Lista();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcargamassiva.response.ListarCargaMassivaResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarcargamassiva.response.ListarCargaMassivaResponse.class;
