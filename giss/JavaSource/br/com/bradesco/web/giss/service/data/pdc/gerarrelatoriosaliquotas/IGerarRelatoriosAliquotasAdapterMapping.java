 ...
 */
public interface IGerarRelatoriosAliquotasAdapterMapping {
     ...
     */
    String mappingRequest(GerarRelatoriosAliquotasRequest message);
     ...
     */
    GerarRelatoriosAliquotasResponse mappingResponse(String response);
