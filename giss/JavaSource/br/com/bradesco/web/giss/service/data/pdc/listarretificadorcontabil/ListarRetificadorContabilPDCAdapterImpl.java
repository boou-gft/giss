package br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarRetificadorContabil
 * </p>
 * 
 ...
 */
public class ListarRetificadorContabilPDCAdapterImpl extends PdcBaseAdapter implements
        IListarRetificadorContabilPDCAdapter, IListarRetificadorContabilAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarRetificadorContabilRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ListarRetificadorContabilResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ListarRetificadorContabilResponse invokeProcess(ListarRetificadorContabilRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarRetificadorContabilResponse invokeProcess(ListarRetificadorContabilRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarRetificadorContabilRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ListarRetificadorContabilResponse 
     ...
     */
    private ListarRetificadorContabilResponse invokeProcess(
            ListarRetificadorContabilRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarRetificadorContabilResponse[] invokeProcess(ListarRetificadorContabilRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarRetificadorContabilResponse[] invokeProcess(ListarRetificadorContabilRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ListarRetificadorContabilRequest message) {
     ...
     * objeto do tipo ListarRetificadorContabilResponse.
     * 
	 * @param response Objeto do tipo ListarRetificadorContabilResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListarRetificadorContabilResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListarRetificadorContabilResponse mappingResponse(String response) {

        ListarRetificadorContabilResponse processResponse = new ListarRetificadorContabilResponse();
        try {
            
            processResponse = 
            	(ListarRetificadorContabilResponse) ListarRetificadorContabilResponse.
