 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarLcAliquota
 * </p>
 * 
 ...
 */
public class ListarLcAliquotaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarLcAliquotaPDCAdapter, IListarLcAliquotaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarlcaliquota.IListarLcAliquotaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarlcaliquota.request.ListarLcAliquotaRequest)
     * @param message Objeto do tipo ListarLcAliquotaRequest 
     ...
     */
    public ListarLcAliquotaResponse invokeProcess(
            ListarLcAliquotaRequest message) 
     ...
     */
    public String mappingRequest(ListarLcAliquotaRequest message) {
     ...
     * objeto do tipo ListarLcAliquotaResponse.
     * 
	 * @param response Objeto do tipo ListarLcAliquotaResponse 
     ...
     */
    public ListarLcAliquotaResponse mappingResponse(String response) {

        ListarLcAliquotaResponse processResponse = new ListarLcAliquotaResponse();
        try {
            
            processResponse = 
            	(ListarLcAliquotaResponse) ListarLcAliquotaResponse.
