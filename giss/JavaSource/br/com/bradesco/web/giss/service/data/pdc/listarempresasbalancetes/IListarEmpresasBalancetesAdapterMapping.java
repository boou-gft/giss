 ...
 */
public interface IListarEmpresasBalancetesAdapterMapping {
     ...
     */
    String mappingRequest(ListarEmpresasBalancetesRequest message);
     ...
     */
    ListarEmpresasBalancetesResponse mappingResponse(String response);
