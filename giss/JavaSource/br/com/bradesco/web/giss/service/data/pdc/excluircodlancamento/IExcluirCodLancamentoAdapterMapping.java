 ...
 */
public interface IExcluirCodLancamentoAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirCodLancamentoRequest message);
     ...
     */
    ExcluirCodLancamentoResponse mappingResponse(String response);
