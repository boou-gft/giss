package br.com.bradesco.web.giss.service.data.pdc.parametrizacaodepexcluir;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ParametrizacaoDepExcluir
 * </p>
 * 
 ...
 */
public class ParametrizacaoDepExcluirPDCAdapterImpl extends PdcBaseAdapter implements
        IParametrizacaoDepExcluirPDCAdapter, IParametrizacaoDepExcluirAdapterMapping {
     ...
     */
    public ParametrizacaoDepExcluirResponse invokeProcess(ParametrizacaoDepExcluirRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.service.data.pdc.parametrizacaodepexcluir.IParametrizacaoDepExcluirPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.service.data.pdc.parametrizacaodepexcluir.request.ParametrizacaoDepExcluirRequest)
     * @param message Objeto do tipo ParametrizacaoDepExcluirRequest 
     ...
     * @return Objeto do tipo ParametrizacaoDepExcluirResponse 
     ...
     */
    private ParametrizacaoDepExcluirResponse invokeProcess(
            ParametrizacaoDepExcluirRequest message, 
     ...
     */
    public String mappingRequest(ParametrizacaoDepExcluirRequest message) {
     ...
     * objeto do tipo ParametrizacaoDepExcluirResponse.
     * 
	 * @param response Objeto do tipo ParametrizacaoDepExcluirResponse 
     ...
     */
    public ParametrizacaoDepExcluirResponse mappingResponse(String response) {

        ParametrizacaoDepExcluirResponse processResponse = new ParametrizacaoDepExcluirResponse();
        try {
            
            processResponse = 
            	(ParametrizacaoDepExcluirResponse) ParametrizacaoDepExcluirResponse.
