 ...
 */
public interface IListarDiferencasRetificadorContabilAdapterMapping {
     ...
     */
    String mappingRequest(ListarDiferencasRetificadorContabilRequest message);
     ...
     */
    ListarDiferencasRetificadorContabilResponse mappingResponse(String response);
