 ...
 */
public interface ICancelarTedTransferenciaAdapterMapping {
     ...
     */
    String mappingRequest(CancelarTedTransferenciaRequest message);
     ...
     */
    CancelarTedTransferenciaResponse mappingResponse(String response);
