 ...
 */
public interface IResultadoPesquisaOscilacaoNegativaPlanilhaAdapterMapping {
     ...
     */
    String mappingRequest(ResultadoPesquisaOscilacaoNegativaPlanilhaRequest message);
     ...
     */
    ResultadoPesquisaOscilacaoNegativaPlanilhaResponse mappingResponse(String response);
