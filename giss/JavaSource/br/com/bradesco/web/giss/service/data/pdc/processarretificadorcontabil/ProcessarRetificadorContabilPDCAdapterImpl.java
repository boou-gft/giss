package br.com.bradesco.web.giss.service.data.pdc.processarretificadorcontabil;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ProcessarRetificadorContabil
 * </p>
 * 
 ...
 */
public class ProcessarRetificadorContabilPDCAdapterImpl extends PdcBaseAdapter implements
        IProcessarRetificadorContabilPDCAdapter, IProcessarRetificadorContabilAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ProcessarRetificadorContabilRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ProcessarRetificadorContabilResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ProcessarRetificadorContabilResponse invokeProcess(ProcessarRetificadorContabilRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ProcessarRetificadorContabilResponse invokeProcess(ProcessarRetificadorContabilRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ProcessarRetificadorContabilRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ProcessarRetificadorContabilResponse 
     ...
     */
    private ProcessarRetificadorContabilResponse invokeProcess(
            ProcessarRetificadorContabilRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ProcessarRetificadorContabilResponse[] invokeProcess(ProcessarRetificadorContabilRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ProcessarRetificadorContabilResponse[] invokeProcess(ProcessarRetificadorContabilRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ProcessarRetificadorContabilRequest message) {
     ...
     * objeto do tipo ProcessarRetificadorContabilResponse.
     * 
	 * @param response Objeto do tipo ProcessarRetificadorContabilResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ProcessarRetificadorContabilResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ProcessarRetificadorContabilResponse mappingResponse(String response) {

        ProcessarRetificadorContabilResponse processResponse = new ProcessarRetificadorContabilResponse();
        try {
            
            processResponse = 
            	(ProcessarRetificadorContabilResponse) ProcessarRetificadorContabilResponse.
