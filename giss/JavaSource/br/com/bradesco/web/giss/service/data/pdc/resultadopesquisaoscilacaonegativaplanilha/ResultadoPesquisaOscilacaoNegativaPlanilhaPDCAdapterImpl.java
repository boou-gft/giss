package br.com.bradesco.web.giss.service.data.pdc.resultadopesquisaoscilacaonegativaplanilha;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ResultadoPesquisaOscilacaoNegativaPlanilha
 * </p>
 * 
 ...
 */
public class ResultadoPesquisaOscilacaoNegativaPlanilhaPDCAdapterImpl extends PdcBaseAdapter implements
        IResultadoPesquisaOscilacaoNegativaPlanilhaPDCAdapter, IResultadoPesquisaOscilacaoNegativaPlanilhaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.resultadopesquisaoscilacaonegativaplanilha.IResultadoPesquisaOscilacaoNegativaPlanilhaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.resultadopesquisaoscilacaonegativaplanilha.request.ResultadoPesquisaOscilacaoNegativaPlanilhaRequest)
     * @param message Objeto do tipo ResultadoPesquisaOscilacaoNegativaPlanilhaRequest 
     ...
     * @return Objeto do tipo ResultadoPesquisaOscilacaoNegativaPlanilhaResponse 
     ...
     */
    public ResultadoPesquisaOscilacaoNegativaPlanilhaResponse invokeProcess(
            ResultadoPesquisaOscilacaoNegativaPlanilhaRequest message) 
     ...
     */
    public String mappingRequest(ResultadoPesquisaOscilacaoNegativaPlanilhaRequest message) {
     ...
     * objeto do tipo ResultadoPesquisaOscilacaoNegativaPlanilhaResponse.
     * 
	 * @param response Objeto do tipo ResultadoPesquisaOscilacaoNegativaPlanilhaResponse 
     ...
     */
    public ResultadoPesquisaOscilacaoNegativaPlanilhaResponse mappingResponse(String response) {

        ResultadoPesquisaOscilacaoNegativaPlanilhaResponse processResponse = new ResultadoPesquisaOscilacaoNegativaPlanilhaResponse();
        try {
            
            processResponse = 
            	(ResultadoPesquisaOscilacaoNegativaPlanilhaResponse) ResultadoPesquisaOscilacaoNegativaPlanilhaResponse.
