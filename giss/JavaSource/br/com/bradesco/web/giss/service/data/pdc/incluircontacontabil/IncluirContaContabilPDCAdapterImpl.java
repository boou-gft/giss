package br.com.bradesco.web.giss.service.data.pdc.incluircontacontabil;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirContaContabil
 * </p>
 * 
 ...
 */
public class IncluirContaContabilPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirContaContabilPDCAdapter, IIncluirContaContabilAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluircontacontabil.IIncluirContaContabilPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluircontacontabil.request.IncluirContaContabilRequest)
     * @param message Objeto do tipo IncluirContaContabilRequest 
     ...
     * @return Objeto do tipo IncluirContaContabilResponse 
     ...
     */
    public IncluirContaContabilResponse invokeProcess(
            IncluirContaContabilRequest message) 
     ...
     */
    public String mappingRequest(IncluirContaContabilRequest message) {
     ...
     * objeto do tipo IncluirContaContabilResponse.
     * 
	 * @param response Objeto do tipo IncluirContaContabilResponse 
     ...
     */
    public IncluirContaContabilResponse mappingResponse(String response) {

        IncluirContaContabilResponse processResponse = new IncluirContaContabilResponse();
        try {
            
            processResponse = 
            	(IncluirContaContabilResponse) IncluirContaContabilResponse.
