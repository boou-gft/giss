 ...
 */
public interface IListarReprocessamentoDependenciaAdapterMapping {
     ...
     */
    String mappingRequest(ListarReprocessamentoDependenciaRequest message);
     ...
     */
    ListarReprocessamentoDependenciaResponse mappingResponse(String response);
