package br.com.bradesco.web.giss.service.data.pdc.listartiposervico;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarTipoServico
 * </p>
 * 
 ...
 */
public class ListarTipoServicoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarTipoServicoPDCAdapter, IListarTipoServicoAdapterMapping {
     ...
     */
    public ListarTipoServicoResponse invokeProcess(ListarTipoServicoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.piloto.service.data.pdc.listartiposervico.IListarTipoServicoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.piloto.service.data.pdc.listartiposervico.request.ListarTipoServicoRequest)
     * @param message Objeto do tipo ListarTipoServicoRequest 
     ...
     * @return Objeto do tipo ListarTipoServicoResponse 
     ...
     */
    private ListarTipoServicoResponse invokeProcess(
            ListarTipoServicoRequest message, 
     ...
     */
    public String mappingRequest(ListarTipoServicoRequest message) {
     ...
     * objeto do tipo ListarTipoServicoResponse.
     * 
	 * @param response Objeto do tipo ListarTipoServicoResponse 
     ...
     */
    public ListarTipoServicoResponse mappingResponse(String response) {

        ListarTipoServicoResponse processResponse = new ListarTipoServicoResponse();
        try {
            
            processResponse = 
            	(ListarTipoServicoResponse) ListarTipoServicoResponse.
