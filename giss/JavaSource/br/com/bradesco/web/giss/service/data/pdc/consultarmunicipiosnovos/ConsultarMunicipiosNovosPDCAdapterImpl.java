package br.com.bradesco.web.giss.service.data.pdc.consultarmunicipiosnovos;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarMunicipiosNovos
 * </p>
 * 
 ...
 */
public class ConsultarMunicipiosNovosPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarMunicipiosNovosPDCAdapter, IConsultarMunicipiosNovosAdapterMapping {
     ...
     */
    public ConsultarMunicipiosNovosResponse invokeProcess(ConsultarMunicipiosNovosRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarmunicipiosnovos.IConsultarMunicipiosNovosPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarmunicipiosnovos.request.ConsultarMunicipiosNovosRequest)
     * @param message Objeto do tipo ConsultarMunicipiosNovosRequest 
     ...
     * @return Objeto do tipo ConsultarMunicipiosNovosResponse 
     ...
     */
    private ConsultarMunicipiosNovosResponse invokeProcess(
            ConsultarMunicipiosNovosRequest message, 
     ...
     */
    public String mappingRequest(ConsultarMunicipiosNovosRequest message) {
     ...
     * objeto do tipo ConsultarMunicipiosNovosResponse.
     * 
	 * @param response Objeto do tipo ConsultarMunicipiosNovosResponse 
     ...
     */
    public ConsultarMunicipiosNovosResponse mappingResponse(String response) {

        ConsultarMunicipiosNovosResponse processResponse = new ConsultarMunicipiosNovosResponse();
        try {
            
            processResponse = 
            	(ConsultarMunicipiosNovosResponse) ConsultarMunicipiosNovosResponse.
