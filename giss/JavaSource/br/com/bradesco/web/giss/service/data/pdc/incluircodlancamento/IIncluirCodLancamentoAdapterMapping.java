 ...
 */
public interface IIncluirCodLancamentoAdapterMapping {
     ...
     */
    String mappingRequest(IncluirCodLancamentoRequest message);
     ...
     */
    IncluirCodLancamentoResponse mappingResponse(String response);
