 ...
 */
public interface IListarDependenciasMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(ListarDependenciasMunicipioRequest message);
     ...
     */
    ListarDependenciasMunicipioResponse mappingResponse(String response);
