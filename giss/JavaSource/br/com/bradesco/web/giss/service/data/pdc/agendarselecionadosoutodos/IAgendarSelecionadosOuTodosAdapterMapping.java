 ...
 */
public interface IAgendarSelecionadosOuTodosAdapterMapping {
     ...
     */
    String mappingRequest(AgendarSelecionadosOuTodosRequest message);
     ...
     */
    AgendarSelecionadosOuTodosResponse mappingResponse(String response);
