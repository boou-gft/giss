 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarPgtosVencidosComp
 * </p>
 * 
 ...
 */
public class ListarPgtosVencidosCompPDCAdapterImpl extends PdcBaseAdapter implements
        IListarPgtosVencidosCompPDCAdapter, IListarPgtosVencidosCompAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarpgtosvencidoscomp.IListarPgtosVencidosCompPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarpgtosvencidoscomp.request.ListarPgtosVencidosCompRequest)
     * @param message Objeto do tipo ListarPgtosVencidosCompRequest 
     ...
     */
    public ListarPgtosVencidosCompResponse invokeProcess(
            ListarPgtosVencidosCompRequest message) 
     ...
     */
    public String mappingRequest(ListarPgtosVencidosCompRequest message) {
     ...
     * objeto do tipo ListarPgtosVencidosCompResponse.
     * 
	 * @param response Objeto do tipo ListarPgtosVencidosCompResponse 
     ...
     */
    public ListarPgtosVencidosCompResponse mappingResponse(String response) {

        ListarPgtosVencidosCompResponse processResponse = new ListarPgtosVencidosCompResponse();
        try {
            
            processResponse = 
            	(ListarPgtosVencidosCompResponse) ListarPgtosVencidosCompResponse.
