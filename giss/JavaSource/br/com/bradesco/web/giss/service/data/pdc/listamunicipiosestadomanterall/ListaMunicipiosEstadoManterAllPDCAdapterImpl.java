package br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall;
...
import br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.request.ListaMunicipiosEstadoManterAllRequest;
import br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.response.ListaMunicipiosEstadoManterAllResponse;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaMunicipiosEstadoManterAll
 * </p>
 * 
 ...
 */
public class ListaMunicipiosEstadoManterAllPDCAdapterImpl extends PdcBaseAdapter implements
        IListaMunicipiosEstadoManterAllPDCAdapter, IListaMunicipiosEstadoManterAllAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.IListaMunicipiosEstadoManterAllPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanterall.request.ListaMunicipiosEstadoManterAllRequest)
     * @param message Objeto do tipo ListaMunicipiosEstadoManterAllRequest 
     ...
     * @return Objeto do tipo ListaMunicipiosEstadoManterAllResponse 
     ...
     */
    public ListaMunicipiosEstadoManterAllResponse invokeProcess(
            ListaMunicipiosEstadoManterAllRequest message) 
     ...
     */
    public String mappingRequest(ListaMunicipiosEstadoManterAllRequest message) {
     ...
     * objeto do tipo ListaMunicipiosEstadoManterAllResponse.
     * 
	 * @param response Objeto do tipo ListaMunicipiosEstadoManterAllResponse 
     ...
     */
    public ListaMunicipiosEstadoManterAllResponse mappingResponse(String response) {

        ListaMunicipiosEstadoManterAllResponse processResponse = new ListaMunicipiosEstadoManterAllResponse();
        try {
            
            processResponse = 
            	(ListaMunicipiosEstadoManterAllResponse) ListaMunicipiosEstadoManterAllResponse.
