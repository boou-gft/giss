package br.com.bradesco.web.giss.service.data.pdc.listarhistcodlancamento;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarHistCodLancamento
 * </p>
 * 
 ...
 */
public class ListarHistCodLancamentoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarHistCodLancamentoPDCAdapter, IListarHistCodLancamentoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarhistcodlancamento.IListarHistCodLancamentoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarhistcodlancamento.request.ListarHistCodLancamentoRequest)
     * @param message Objeto do tipo ListarHistCodLancamentoRequest 
     ...
     * @return Objeto do tipo ListarHistCodLancamentoResponse 
     ...
     */
    public ListarHistCodLancamentoResponse invokeProcess(
            ListarHistCodLancamentoRequest message) 
     ...
     */
    public String mappingRequest(ListarHistCodLancamentoRequest message) {
     ...
     * objeto do tipo ListarHistCodLancamentoResponse.
     * 
	 * @param response Objeto do tipo ListarHistCodLancamentoResponse 
     ...
     */
    public ListarHistCodLancamentoResponse mappingResponse(String response) {

        ListarHistCodLancamentoResponse processResponse = new ListarHistCodLancamentoResponse();
        try {
            
            processResponse = 
            	(ListarHistCodLancamentoResponse) ListarHistCodLancamentoResponse.
