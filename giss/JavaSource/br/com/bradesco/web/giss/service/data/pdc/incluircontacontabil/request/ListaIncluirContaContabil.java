 ...
 * Schema.
 * $Id: ListaIncluirContaContabil.java,v 1.1 2017/12/05 10:28:45 gmichelini Exp $
 */
...
/**
 * Class ListaIncluirContaContabil.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/12/05 10:28:45 $
 */
public class ListaIncluirContaContabil implements java.io.Serializable {
    ...
    /**
     * Field _codFuncBradesco
     */
    private long _codFuncBradesco = 0;

    /**
     * keeps track of state for field: _codFuncBradesco
     */
    private boolean _has_codFuncBradesco;
    ...
    public ListaIncluirContaContabil() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.incluircontacontabil.request.ListaIncluirContaContabil()
    ...
    /**
     * Method deleteCodFuncBradesco
     * 
     */
    public void deleteCodFuncBradesco()
    {
        this._has_codFuncBradesco= false;
    } //-- void deleteCodFuncBradesco() 
    ...
    /**
     * Returns the value of field 'codFuncBradesco'.
     * 
     * @return long
     * @return the value of field 'codFuncBradesco'.
     */
    public long getCodFuncBradesco()
    {
        return this._codFuncBradesco;
    } //-- long getCodFuncBradesco() 
    ...
    /**
     * Method hasCodFuncBradesco
     * 
     * 
     * 
     * @return boolean
     */
    public boolean hasCodFuncBradesco()
    {
        return this._has_codFuncBradesco;
    } //-- boolean hasCodFuncBradesco() 
    ...
    /**
     * Sets the value of field 'codFuncBradesco'.
     * 
     * @param codFuncBradesco the value of field 'codFuncBradesco'.
     */
    public void setCodFuncBradesco(long codFuncBradesco)
    {
        this._codFuncBradesco = codFuncBradesco;
        this._has_codFuncBradesco = true;
    } //-- void setCodFuncBradesco(long) 
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.incluircontacontabil.request.ListaIncluirContaContabil unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.incluircontacontabil.request.ListaIncluirContaContabil) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.incluircontacontabil.request.ListaIncluirContaContabil.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.incluircontacontabil.request.ListaIncluirContaContabil unmarshal(java.io.Reader) 
