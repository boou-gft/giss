 ...
 */
public interface IListarPlanilhaApuracaoAdapterMapping {
     ...
     */
    String mappingRequest(ListarPlanilhaApuracaoRequest message);
     ...
     */
    ListarPlanilhaApuracaoResponse mappingResponse(String response);
