package br.com.bradesco.web.giss.service.data.pdc.alteraraliquota;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AlterarAliquota
 * </p>
 * 
 ...
 */
public class AlterarAliquotaPDCAdapterImpl extends PdcBaseAdapter implements
        IAlterarAliquotaPDCAdapter, IAlterarAliquotaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.alteraraliquota.IAlterarAliquotaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.alteraraliquota.request.AlterarAliquotaRequest)
     * @param message Objeto do tipo AlterarAliquotaRequest 
     ...
     * @return Objeto do tipo AlterarAliquotaResponse 
     ...
     */
    public AlterarAliquotaResponse invokeProcess(
            AlterarAliquotaRequest message) 
     ...
     */
    public String mappingRequest(AlterarAliquotaRequest message) {
     ...
     * objeto do tipo AlterarAliquotaResponse.
     * 
	 * @param response Objeto do tipo AlterarAliquotaResponse 
     ...
     */
    public AlterarAliquotaResponse mappingResponse(String response) {

        AlterarAliquotaResponse processResponse = new AlterarAliquotaResponse();
        try {
            
            processResponse = 
            	(AlterarAliquotaResponse) AlterarAliquotaResponse.
