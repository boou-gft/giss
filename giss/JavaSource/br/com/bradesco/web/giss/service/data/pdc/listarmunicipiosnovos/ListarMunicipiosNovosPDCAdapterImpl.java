package br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarMunicipiosNovos
 * </p>
 * 
 ...
 */
public class ListarMunicipiosNovosPDCAdapterImpl extends PdcBaseAdapter implements
        IListarMunicipiosNovosPDCAdapter, IListarMunicipiosNovosAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.IListarMunicipiosNovosPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.request.ListarMunicipiosNovosRequest)
     * @param message Objeto do tipo ListarMunicipiosNovosRequest 
     ...
     * @return Objeto do tipo ListarMunicipiosNovosResponse 
     ...
     */
    public ListarMunicipiosNovosResponse invokeProcess(
            ListarMunicipiosNovosRequest message) 
     ...
     */
    public String mappingRequest(ListarMunicipiosNovosRequest message) {
     ...
     * objeto do tipo ListarMunicipiosNovosResponse.
     * 
	 * @param response Objeto do tipo ListarMunicipiosNovosResponse 
     ...
     */
    public ListarMunicipiosNovosResponse mappingResponse(String response) {

        ListarMunicipiosNovosResponse processResponse = new ListarMunicipiosNovosResponse();
        try {
            
            processResponse = 
            	(ListarMunicipiosNovosResponse) ListarMunicipiosNovosResponse.
