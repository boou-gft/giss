 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExecutarBalanceteFiscalizacoesIss
 * </p>
 * 
 ...
 */
public class ExecutarBalanceteFiscalizacoesIssPDCAdapterImpl extends PdcBaseAdapter implements
        IExecutarBalanceteFiscalizacoesIssPDCAdapter, IExecutarBalanceteFiscalizacoesIssAdapterMapping {
     ...
     */
    public ExecutarBalanceteFiscalizacoesIssResponse invokeProcess(ExecutarBalanceteFiscalizacoesIssRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.excluircontacontabil.IExecutarBalanceteFiscalizacoesIssPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.excluircontacontabil.request.ExecutarBalanceteFiscalizacoesIssRequest)
     * @param message Objeto do tipo ExecutarBalanceteFiscalizacoesIssRequest 
     ...
     */
    private ExecutarBalanceteFiscalizacoesIssResponse invokeProcess(
            ExecutarBalanceteFiscalizacoesIssRequest message, 
     ...
     */
    public String mappingRequest(ExecutarBalanceteFiscalizacoesIssRequest message) {
     ...
     * objeto do tipo ExecutarBalanceteFiscalizacoesIssResponse.
     * 
	 * @param response Objeto do tipo ExecutarBalanceteFiscalizacoesIssResponse 
     ...
     */
    public ExecutarBalanceteFiscalizacoesIssResponse mappingResponse(String response) {

        ExecutarBalanceteFiscalizacoesIssResponse processResponse = new ExecutarBalanceteFiscalizacoesIssResponse();
        try {
            
            processResponse = 
            	(ExecutarBalanceteFiscalizacoesIssResponse) ExecutarBalanceteFiscalizacoesIssResponse.
