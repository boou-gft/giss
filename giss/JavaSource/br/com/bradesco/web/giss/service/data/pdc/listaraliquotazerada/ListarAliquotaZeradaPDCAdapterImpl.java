package br.com.bradesco.web.giss.service.data.pdc.listaraliquotazerada;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarAliquotaZerada
 * </p>
 * 
 ...
 */
public class ListarAliquotaZeradaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarAliquotaZeradaPDCAdapter, IListarAliquotaZeradaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listaraliquotazerada.IListarAliquotaZeradaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listaraliquotazerada.request.ListarAliquotaZeradaRequest)
     * @param message Objeto do tipo ListarAliquotaZeradaRequest 
     ...
     * @return Objeto do tipo ListarAliquotaZeradaResponse 
     ...
     */
    public ListarAliquotaZeradaResponse invokeProcess(
            ListarAliquotaZeradaRequest message) 
     ...
     */
    public String mappingRequest(ListarAliquotaZeradaRequest message) {
     ...
     * objeto do tipo ListarAliquotaZeradaResponse.
     * 
	 * @param response Objeto do tipo ListarAliquotaZeradaResponse 
     ...
     */
    public ListarAliquotaZeradaResponse mappingResponse(String response) {

        ListarAliquotaZeradaResponse processResponse = new ListarAliquotaZeradaResponse();
        try {
            
            processResponse = 
            	(ListarAliquotaZeradaResponse) ListarAliquotaZeradaResponse.
