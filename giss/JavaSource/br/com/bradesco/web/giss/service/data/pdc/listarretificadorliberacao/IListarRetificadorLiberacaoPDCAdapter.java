 ...
 */
public interface IListarRetificadorLiberacaoPDCAdapter {
     ...
     */
    ListarRetificadorLiberacaoResponse invokeProcess(ListarRetificadorLiberacaoRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarRetificadorLiberacaoResponse invokeProcess(ListarRetificadorLiberacaoRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ListarRetificadorLiberacaoResponse[] invokeProcess(ListarRetificadorLiberacaoRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ListarRetificadorLiberacaoResponse[] invokeProcess(ListarRetificadorLiberacaoRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
