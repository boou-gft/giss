 ...
 */
public interface IListarValoresMesTotalAdapterMapping {
     ...
     */
    String mappingRequest(ListarValoresMesTotalRequest message);
     ...
     */
    ListarValoresMesTotalResponse mappingResponse(String response);
