 ...
 */
public interface IReativarItemServicoLcAdapterMapping {
     ...
     */
    String mappingRequest(ReativarItemServicoLcRequest message);
     ...
     */
    ReativarItemServicoLcResponse mappingResponse(String response);
