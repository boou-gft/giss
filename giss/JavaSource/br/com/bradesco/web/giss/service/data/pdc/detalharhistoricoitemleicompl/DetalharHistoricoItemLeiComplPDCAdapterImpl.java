package br.com.bradesco.web.giss.service.data.pdc.detalharhistoricoitemleicompl;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: DetalharHistoricoItemLeiCompl
 * </p>
 * 
 ...
 */
public class DetalharHistoricoItemLeiComplPDCAdapterImpl extends PdcBaseAdapter implements
        IDetalharHistoricoItemLeiComplPDCAdapter, IDetalharHistoricoItemLeiComplAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.detalharhistoricoitemleicompl.IDetalharHistoricoItemLeiComplPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.detalharhistoricoitemleicompl.request.DetalharHistoricoItemLeiComplRequest)
     * @param message Objeto do tipo DetalharHistoricoItemLeiComplRequest 
     ...
     * @return Objeto do tipo DetalharHistoricoItemLeiComplResponse 
     ...
     */
    public DetalharHistoricoItemLeiComplResponse invokeProcess(
            DetalharHistoricoItemLeiComplRequest message) 
     ...
     */
    public String mappingRequest(DetalharHistoricoItemLeiComplRequest message) {
     ...
     * objeto do tipo DetalharHistoricoItemLeiComplResponse.
     * 
	 * @param response Objeto do tipo DetalharHistoricoItemLeiComplResponse 
     ...
     */
    public DetalharHistoricoItemLeiComplResponse mappingResponse(String response) {

        DetalharHistoricoItemLeiComplResponse processResponse = new DetalharHistoricoItemLeiComplResponse();
        try {
            
            processResponse = 
            	(DetalharHistoricoItemLeiComplResponse) DetalharHistoricoItemLeiComplResponse.
