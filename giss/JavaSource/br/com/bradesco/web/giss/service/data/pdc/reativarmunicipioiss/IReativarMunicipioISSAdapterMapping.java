 ...
 */
public interface IReativarMunicipioISSAdapterMapping {
     ...
     */
    String mappingRequest(ReativarMunicipioISSRequest message);
     ...
     */
    ReativarMunicipioISSResponse mappingResponse(String response);
