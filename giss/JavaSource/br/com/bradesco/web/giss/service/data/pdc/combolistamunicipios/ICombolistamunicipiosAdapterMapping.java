 ...
 */
public interface ICombolistamunicipiosAdapterMapping {
     ...
     */
    String mappingRequest(CombolistamunicipiosRequest message);
     ...
     */
    CombolistamunicipiosResponse mappingResponse(String response);
