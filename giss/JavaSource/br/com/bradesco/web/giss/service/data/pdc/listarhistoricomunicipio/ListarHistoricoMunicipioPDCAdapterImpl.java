package br.com.bradesco.web.giss.service.data.pdc.listarhistoricomunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarHistoricoMunicipio
 * </p>
 * 
 ...
 */
public class ListarHistoricoMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IListarHistoricoMunicipioPDCAdapter, IListarHistoricoMunicipioAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarhistoricomunicipio.IListarHistoricoMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarhistoricomunicipio.request.ListarHistoricoMunicipioRequest)
     * @param message Objeto do tipo ListarHistoricoMunicipioRequest 
     ...
     * @return Objeto do tipo ListarHistoricoMunicipioResponse 
     ...
     */
    public ListarHistoricoMunicipioResponse invokeProcess(
            ListarHistoricoMunicipioRequest message) 
     ...
     */
    public String mappingRequest(ListarHistoricoMunicipioRequest message) {
     ...
     * objeto do tipo ListarHistoricoMunicipioResponse.
     * 
	 * @param response Objeto do tipo ListarHistoricoMunicipioResponse 
     ...
     */
    public ListarHistoricoMunicipioResponse mappingResponse(String response) {

        ListarHistoricoMunicipioResponse processResponse = new ListarHistoricoMunicipioResponse();
        try {
            
            processResponse = 
            	(ListarHistoricoMunicipioResponse) ListarHistoricoMunicipioResponse.
