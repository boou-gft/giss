package br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ValidaInclusaoTipoIncidencia
 * </p>
 * 
 ...
 */
public class ValidaInclusaoTipoIncidenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IValidaInclusaoTipoIncidenciaPDCAdapter, IValidaInclusaoTipoIncidenciaAdapterMapping {
     ...
     */
    public ValidaInclusaoTipoIncidenciaResponse invokeProcess(ValidaInclusaoTipoIncidenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia.IValidaInclusaoTipoIncidenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia.request.ValidaInclusaoTipoIncidenciaRequest)
     * @param message Objeto do tipo ValidaInclusaoTipoIncidenciaRequest 
     ...
     * @return Objeto do tipo ValidaInclusaoTipoIncidenciaResponse 
     ...
     */
    private ValidaInclusaoTipoIncidenciaResponse invokeProcess(
            ValidaInclusaoTipoIncidenciaRequest message, 
     ...
     */
    public String mappingRequest(ValidaInclusaoTipoIncidenciaRequest message) {
     ...
     * objeto do tipo ValidaInclusaoTipoIncidenciaResponse.
     * 
	 * @param response Objeto do tipo ValidaInclusaoTipoIncidenciaResponse 
     ...
     */
    public ValidaInclusaoTipoIncidenciaResponse mappingResponse(String response) {

        ValidaInclusaoTipoIncidenciaResponse processResponse = new ValidaInclusaoTipoIncidenciaResponse();
        try {
            
            processResponse = 
            	(ValidaInclusaoTipoIncidenciaResponse) ValidaInclusaoTipoIncidenciaResponse.
