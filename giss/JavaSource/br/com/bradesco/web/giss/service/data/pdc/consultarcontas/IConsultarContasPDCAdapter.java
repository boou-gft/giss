 ...
 */
public interface IConsultarContasPDCAdapter {
     ...
     */
    ConsultarContasResponse invokeProcess(ConsultarContasRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ConsultarContasResponse invokeProcess(ConsultarContasRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ConsultarContasResponse[] invokeProcess(ConsultarContasRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ConsultarContasResponse[] invokeProcess(ConsultarContasRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
