 ...
 */
public interface IGerarRelHistTransacoesAdapterMapping {
     ...
     */
    String mappingRequest(GerarRelHistTransacoesRequest message);
     ...
     */
    GerarRelHistTransacoesResponse mappingResponse(String response);
