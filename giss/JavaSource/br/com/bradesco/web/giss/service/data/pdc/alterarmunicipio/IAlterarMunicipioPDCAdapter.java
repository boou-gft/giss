 ...
 */
public interface IAlterarMunicipioPDCAdapter {
     ...
     */
    AlterarMunicipioResponse invokeProcess(AlterarMunicipioRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    AlterarMunicipioResponse invokeProcess(AlterarMunicipioRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     AlterarMunicipioResponse[] invokeProcess(AlterarMunicipioRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    AlterarMunicipioResponse[] invokeProcess(AlterarMunicipioRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
