package br.com.bradesco.web.giss.service.data.pdc.consultarprocessarcontabilidade;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarProcessarContabilidade
 * </p>
 * 
 ...
 */
public class ConsultarProcessarContabilidadePDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarProcessarContabilidadePDCAdapter, IConsultarProcessarContabilidadeAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarprocessarcontabilidade.IConsultarProcessarContabilidadePDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarprocessarcontabilidade.request.ConsultarProcessarContabilidadeRequest)
     * @param message Objeto do tipo ConsultarProcessarContabilidadeRequest 
     ...
     * @return Objeto do tipo ConsultarProcessarContabilidadeResponse 
     ...
     */
    public ConsultarProcessarContabilidadeResponse invokeProcess(
            ConsultarProcessarContabilidadeRequest message) 
     ...
     */
    public String mappingRequest(ConsultarProcessarContabilidadeRequest message) {
     ...
     * objeto do tipo ConsultarProcessarContabilidadeResponse.
     * 
	 * @param response Objeto do tipo ConsultarProcessarContabilidadeResponse 
     ...
     */
    public ConsultarProcessarContabilidadeResponse mappingResponse(String response) {

        ConsultarProcessarContabilidadeResponse processResponse = new ConsultarProcessarContabilidadeResponse();
        try {
            
            processResponse = 
            	(ConsultarProcessarContabilidadeResponse) ConsultarProcessarContabilidadeResponse.
