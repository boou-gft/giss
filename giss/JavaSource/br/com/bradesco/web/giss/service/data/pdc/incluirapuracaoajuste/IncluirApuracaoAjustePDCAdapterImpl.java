package br.com.bradesco.web.giss.service.data.pdc.incluirapuracaoajuste;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirApuracaoAjuste
 * </p>
 * 
 ...
 */
public class IncluirApuracaoAjustePDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirApuracaoAjustePDCAdapter, IIncluirApuracaoAjusteAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluirapuracaoajuste.IIncluirApuracaoAjustePDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluirapuracaoajuste.request.IncluirApuracaoAjusteRequest)
     * @param message Objeto do tipo IncluirApuracaoAjusteRequest 
     ...
     * @return Objeto do tipo IncluirApuracaoAjusteResponse 
     ...
     */
    public IncluirApuracaoAjusteResponse invokeProcess(
            IncluirApuracaoAjusteRequest message) 
     ...
     */
    public String mappingRequest(IncluirApuracaoAjusteRequest message) {
     ...
     * objeto do tipo IncluirApuracaoAjusteResponse.
     * 
	 * @param response Objeto do tipo IncluirApuracaoAjusteResponse 
     ...
     */
    public IncluirApuracaoAjusteResponse mappingResponse(String response) {

        IncluirApuracaoAjusteResponse processResponse = new IncluirApuracaoAjusteResponse();
        try {
            
            processResponse = 
            	(IncluirApuracaoAjusteResponse) IncluirApuracaoAjusteResponse.
