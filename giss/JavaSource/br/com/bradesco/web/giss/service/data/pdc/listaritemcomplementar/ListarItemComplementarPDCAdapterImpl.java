package br.com.bradesco.web.giss.service.data.pdc.listaritemcomplementar;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarItemComplementar
 * </p>
 * 
 ...
 */
public class ListarItemComplementarPDCAdapterImpl extends PdcBaseAdapter implements
        IListarItemComplementarPDCAdapter, IListarItemComplementarAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listaritemcomplementar.IListarItemComplementarPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listaritemcomplementar.request.ListarItemComplementarRequest)
     * @param message Objeto do tipo ListarItemComplementarRequest 
     ...
     * @return Objeto do tipo ListarItemComplementarResponse 
     ...
     */
    public ListarItemComplementarResponse invokeProcess(
            ListarItemComplementarRequest message) 
     ...
     */
    public String mappingRequest(ListarItemComplementarRequest message) {
     ...
     * objeto do tipo ListarItemComplementarResponse.
     * 
	 * @param response Objeto do tipo ListarItemComplementarResponse 
     ...
     */
    public ListarItemComplementarResponse mappingResponse(String response) {

        ListarItemComplementarResponse processResponse = new ListarItemComplementarResponse();
        try {
            
            processResponse = 
            	(ListarItemComplementarResponse) ListarItemComplementarResponse.
