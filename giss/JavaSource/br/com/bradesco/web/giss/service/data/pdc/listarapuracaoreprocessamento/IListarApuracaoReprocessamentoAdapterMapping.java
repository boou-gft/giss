 ...
 */
public interface IListarApuracaoReprocessamentoAdapterMapping {
     ...
     */
    String mappingRequest(ListarApuracaoReprocessamentoRequest message);
     ...
     */
    ListarApuracaoReprocessamentoResponse mappingResponse(String response);
