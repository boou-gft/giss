 ...
 */
public interface IListarHistoricoEmpresaAdapterMapping {
     ...
     */
    String mappingRequest(ListarHistoricoEmpresaRequest message);
     ...
     */
    ListarHistoricoEmpresaResponse mappingResponse(String response);
