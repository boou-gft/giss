 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: EfetivaSelecMunicipiosSemConv
 * </p>
 * 
 ...
 */
public class EfetivaSelecMunicipiosSemConvPDCAdapterImpl extends PdcBaseAdapter implements
        IEfetivaSelecMunicipiosSemConvPDCAdapter, IEfetivaSelecMunicipiosSemConvAdapterMapping {
     ...
     */
    public EfetivaSelecMunicipiosSemConvResponse invokeProcess(EfetivaSelecMunicipiosSemConvRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.efetivaselecmunicipiossemconv.IEfetivaSelecMunicipiosSemConvPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.efetivaselecmunicipiossemconv.request.EfetivaSelecMunicipiosSemConvRequest)
     * @param message Objeto do tipo EfetivaSelecMunicipiosSemConvRequest 
     ...
     */
    private EfetivaSelecMunicipiosSemConvResponse invokeProcess(
            EfetivaSelecMunicipiosSemConvRequest message, 
     ...
     */
    public String mappingRequest(EfetivaSelecMunicipiosSemConvRequest message) {
     ...
     * objeto do tipo EfetivaSelecMunicipiosSemConvResponse.
     * 
	 * @param response Objeto do tipo EfetivaSelecMunicipiosSemConvResponse 
     ...
     */
    public EfetivaSelecMunicipiosSemConvResponse mappingResponse(String response) {

        EfetivaSelecMunicipiosSemConvResponse processResponse = new EfetivaSelecMunicipiosSemConvResponse();
        try {
            
            processResponse = 
            	(EfetivaSelecMunicipiosSemConvResponse) EfetivaSelecMunicipiosSemConvResponse.
