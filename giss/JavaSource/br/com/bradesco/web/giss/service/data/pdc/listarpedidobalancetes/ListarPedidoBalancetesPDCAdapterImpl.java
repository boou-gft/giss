package br.com.bradesco.web.giss.service.data.pdc.listarpedidobalancetes;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarPedidoBalancetes
 * </p>
 * 
 ...
 */
public class ListarPedidoBalancetesPDCAdapterImpl extends PdcBaseAdapter implements
        IListarPedidoBalancetesPDCAdapter, IListarPedidoBalancetesAdapterMapping {
     ...
     */
    public ListarPedidoBalancetesResponse invokeProcess(ListarPedidoBalancetesRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcontascontabeis.IListarPedidoBalancetesPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcontascontabeis.request.ListarPedidoBalancetesRequest)
     * @param message Objeto do tipo ListarPedidoBalancetesRequest 
     ...
     * @return Objeto do tipo ListarPedidoBalancetesResponse 
     ...
     */
    private ListarPedidoBalancetesResponse invokeProcess(
            ListarPedidoBalancetesRequest message, 
     ...
     */
    public String mappingRequest(ListarPedidoBalancetesRequest message) {
     ...
     * objeto do tipo ListarPedidoBalancetesResponse.
     * 
	 * @param response Objeto do tipo ListarPedidoBalancetesResponse 
     ...
     */
    public ListarPedidoBalancetesResponse mappingResponse(String response) {

        ListarPedidoBalancetesResponse processResponse = new ListarPedidoBalancetesResponse();
        try {
            
            processResponse = 
            	(ListarPedidoBalancetesResponse) ListarPedidoBalancetesResponse.
