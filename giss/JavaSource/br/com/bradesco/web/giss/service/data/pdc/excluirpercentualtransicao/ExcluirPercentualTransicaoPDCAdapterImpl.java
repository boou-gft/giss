 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirPercentualTransicao
 * </p>
 * 
 ...
 */
public class ExcluirPercentualTransicaoPDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirPercentualTransicaoPDCAdapter, IExcluirPercentualTransicaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ExcluirPercentualTransicaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ExcluirPercentualTransicaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ExcluirPercentualTransicaoResponse invokeProcess(ExcluirPercentualTransicaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ExcluirPercentualTransicaoResponse invokeProcess(ExcluirPercentualTransicaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ExcluirPercentualTransicaoRequest 
     ...
     */
    private ExcluirPercentualTransicaoResponse invokeProcess(
            ExcluirPercentualTransicaoRequest message, 
     ...
     */
    public String mappingRequest(ExcluirPercentualTransicaoRequest message) {
     ...
     * objeto do tipo ExcluirPercentualTransicaoResponse.
     * 
	 * @param response Objeto do tipo ExcluirPercentualTransicaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ExcluirPercentualTransicaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ExcluirPercentualTransicaoResponse mappingResponse(String response) {

        ExcluirPercentualTransicaoResponse processResponse = new ExcluirPercentualTransicaoResponse();
        try {
            
            processResponse = 
            	(ExcluirPercentualTransicaoResponse) ExcluirPercentualTransicaoResponse.
