package br.com.bradesco.web.giss.service.data.pdc.listarcombocosifemp;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarComboCosifEmp
 * </p>
 * 
 ...
 */
public class ListarComboCosifEmpPDCAdapterImpl extends PdcBaseAdapter implements
        IListarComboCosifEmpPDCAdapter, IListarComboCosifEmpAdapterMapping {
     ...
     */
    public ListarComboCosifEmpResponse invokeProcess(ListarComboCosifEmpRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcombocosifemp.IListarComboCosifEmpPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcombocosifemp.request.ListarComboCosifEmpRequest)
     * @param message Objeto do tipo ListarComboCosifEmpRequest 
     ...
     * @return Objeto do tipo ListarComboCosifEmpResponse 
     ...
     */
    private ListarComboCosifEmpResponse invokeProcess(
            ListarComboCosifEmpRequest message, 
     ...
     */
    public String mappingRequest(ListarComboCosifEmpRequest message) {
     ...
     * objeto do tipo ListarComboCosifEmpResponse.
     * 
	 * @param response Objeto do tipo ListarComboCosifEmpResponse 
     ...
     */
    public ListarComboCosifEmpResponse mappingResponse(String response) {

        ListarComboCosifEmpResponse processResponse = new ListarComboCosifEmpResponse();
        try {
            
            processResponse = 
            	(ListarComboCosifEmpResponse) ListarComboCosifEmpResponse.
