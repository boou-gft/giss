 ...
 */
public interface ILogTransmissaoArquivoAdapterMapping {
     ...
     */
    String mappingRequest(LogTransmissaoArquivoRequest message);
     ...
     */
    LogTransmissaoArquivoResponse mappingResponse(String response);
