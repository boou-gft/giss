package br.com.bradesco.web.giss.service.data.pdc.consultararquivoempsemanal;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarArquivoEmpSemanal
 * </p>
 * 
 ...
 */
public class ConsultarArquivoEmpSemanalPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarArquivoEmpSemanalPDCAdapter, IConsultarArquivoEmpSemanalAdapterMapping {
     ...
     */
    public ConsultarArquivoEmpSemanalResponse invokeProcess(ConsultarArquivoEmpSemanalRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultararquivoempsemanal.IConsultarArquivoEmpSemanalPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultararquivoempsemanal.request.ConsultarArquivoEmpSemanalRequest)
     * @param message Objeto do tipo ConsultarArquivoEmpSemanalRequest 
     ...
     * @return Objeto do tipo ConsultarArquivoEmpSemanalResponse 
     ...
     */
    private ConsultarArquivoEmpSemanalResponse invokeProcess(
            ConsultarArquivoEmpSemanalRequest message, 
     ...
     */
    public String mappingRequest(ConsultarArquivoEmpSemanalRequest message) {
     ...
     * objeto do tipo ConsultarArquivoEmpSemanalResponse.
     * 
	 * @param response Objeto do tipo ConsultarArquivoEmpSemanalResponse 
     ...
     */
    public ConsultarArquivoEmpSemanalResponse mappingResponse(String response) {

        ConsultarArquivoEmpSemanalResponse processResponse = new ConsultarArquivoEmpSemanalResponse();
        try {
            
            processResponse = 
            	(ConsultarArquivoEmpSemanalResponse) ConsultarArquivoEmpSemanalResponse.
