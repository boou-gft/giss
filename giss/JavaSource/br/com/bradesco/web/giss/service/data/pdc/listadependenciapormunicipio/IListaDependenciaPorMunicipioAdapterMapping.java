package br.com.bradesco.web.giss.service.data.pdc.listadependenciapormunicipio;
 ...
 */
public interface IListaDependenciaPorMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(ListaDependenciaPorMunicipioRequest message);
     ...
     *            processo no PDC
     * @return Objeto do tipo ListaDependenciaPorMunicipioResponse 
     * 		   que representa o resultado da chamada do processo no PDC
     */
    ListaDependenciaPorMunicipioResponse mappingResponse(String response);
