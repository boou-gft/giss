 ...
 */
public interface IResultPesqApurMovNaoTributavelAdapterMapping {
     ...
     */
    String mappingRequest(ResultPesqApurMovNaoTributavelRequest message);
     ...
     */
    ResultPesqApurMovNaoTributavelResponse mappingResponse(String response);
