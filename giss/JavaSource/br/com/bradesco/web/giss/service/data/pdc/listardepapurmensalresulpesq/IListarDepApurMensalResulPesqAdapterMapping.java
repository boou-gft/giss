 ...
 */
public interface IListarDepApurMensalResulPesqAdapterMapping {
     ...
     */
    String mappingRequest(ListarDepApurMensalResulPesqRequest message);
     ...
     */
    ListarDepApurMensalResulPesqResponse mappingResponse(String response);
