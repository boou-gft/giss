 ...
 * Schema.
 * $Id: ListarDepApurMensalResulPesqRequest.java,v 1.1 2017/04/11 14:09:13 gmichelini Exp $
 */

package br.com.bradesco.web.giss.service.data.pdc.listardepapurmensalresulpesq.request;
...
/**
 * Class ListarDepApurMensalResulPesqRequest.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:09:13 $
 */
public class ListarDepApurMensalResulPesqRequest implements java.io.Serializable {
    ...
    /**
     * Field _numSolicitacao
     */
    private int _numSolicitacao = 0;

    /**
     * keeps track of state for field: _numSolicitacao
     */
    private boolean _has_numSolicitacao;
    ...
    public ListarDepApurMensalResulPesqRequest() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listardepapurmensalresulpesq.request.ListarDepApurMensalResulPesqRequest()
    ...
    /**
     * Method deleteNumSolicitacao
     * 
     */
    public void deleteNumSolicitacao()
    {
        this._has_numSolicitacao= false;
    } //-- void deleteNumSolicitacao() 
    ...
    /**
     * Returns the value of field 'numSolicitacao'.
     * 
     * @return int
     * @return the value of field 'numSolicitacao'.
     */
    public int getNumSolicitacao()
    {
        return this._numSolicitacao;
    } //-- int getNumSolicitacao() 
    ...
    /**
     * Method hasNumSolicitacao
     * 
     * 
     * 
     * @return boolean
     */
    public boolean hasNumSolicitacao()
    {
        return this._has_numSolicitacao;
    } //-- boolean hasNumSolicitacao() 
    ...
    /**
     * Sets the value of field 'numSolicitacao'.
     * 
     * @param numSolicitacao the value of field 'numSolicitacao'.
     */
    public void setNumSolicitacao(int numSolicitacao)
    {
        this._numSolicitacao = numSolicitacao;
        this._has_numSolicitacao = true;
    } //-- void setNumSolicitacao(int) 
     ...
     * 
     * @param reader
     * @return ListarDepApurMensalResulPesqRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listardepapurmensalresulpesq.request.ListarDepApurMensalResulPesqRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listardepapurmensalresulpesq.request.ListarDepApurMensalResulPesqRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listardepapurmensalresulpesq.request.ListarDepApurMensalResulPesqRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listardepapurmensalresulpesq.request.ListarDepApurMensalResulPesqRequest unmarshal(java.io.Reader) 
