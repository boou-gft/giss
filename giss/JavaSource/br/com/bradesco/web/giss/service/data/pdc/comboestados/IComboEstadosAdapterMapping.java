package br.com.bradesco.web.giss.service.data.pdc.comboestados;
 ...
 */
public interface IComboEstadosAdapterMapping {
     ...
     */
    String mappingRequest(ComboEstadosRequest message);
     ...
     *            processo no PDC
     * @return Objeto do tipo ComboEstadosResponse 
     * 		   que representa o resultado da chamada do processo no PDC
     */
    ComboEstadosResponse mappingResponse(String response);
