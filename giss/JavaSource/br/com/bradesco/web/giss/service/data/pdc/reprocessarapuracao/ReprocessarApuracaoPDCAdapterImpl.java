package br.com.bradesco.web.giss.service.data.pdc.reprocessarapuracao;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ReprocessarApuracao
 * </p>
 * 
 ...
 */
public class ReprocessarApuracaoPDCAdapterImpl extends PdcBaseAdapter implements
        IReprocessarApuracaoPDCAdapter, IReprocessarApuracaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ReprocessarApuracaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ReprocessarApuracaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ReprocessarApuracaoResponse invokeProcess(ReprocessarApuracaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ReprocessarApuracaoResponse invokeProcess(ReprocessarApuracaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ReprocessarApuracaoRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ReprocessarApuracaoResponse 
     ...
     */
    private ReprocessarApuracaoResponse invokeProcess(
            ReprocessarApuracaoRequest message, 
     ...
     */
    public String mappingRequest(ReprocessarApuracaoRequest message) {
     ...
     * objeto do tipo ReprocessarApuracaoResponse.
     * 
	 * @param response Objeto do tipo ReprocessarApuracaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ReprocessarApuracaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ReprocessarApuracaoResponse mappingResponse(String response) {

        ReprocessarApuracaoResponse processResponse = new ReprocessarApuracaoResponse();
        try {
            
            processResponse = 
            	(ReprocessarApuracaoResponse) ReprocessarApuracaoResponse.
