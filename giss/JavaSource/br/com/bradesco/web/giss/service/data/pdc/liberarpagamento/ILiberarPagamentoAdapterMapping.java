 ...
 */
public interface ILiberarPagamentoAdapterMapping {
     ...
     */
    String mappingRequest(LiberarPagamentoRequest message);
     ...
     */
    LiberarPagamentoResponse mappingResponse(String response);
