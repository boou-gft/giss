 ...
 * Schema.
 * $Id: AlterarMunicipioRequest.java,v 1.1 2017/04/11 14:11:03 gmichelini Exp $
 */

package br.com.bradesco.web.giss.service.data.pdc.alterarmunicipio.request;
...
/**
 * Class AlterarMunicipioRequest.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:11:03 $
 */
public class AlterarMunicipioRequest implements java.io.Serializable {
    ...
    public AlterarMunicipioRequest() 
     {
        super();
        setPercentualBaseAliquota(new java.math.BigDecimal("0"));
        setPercentualAliquotaPadrao(new java.math.BigDecimal("0"));
    } //-- br.com.bradesco.web.giss.service.data.pdc.alterarmunicipio.request.AlterarMunicipioRequest()
     ...
     * 
     * @param reader
     * @return AlterarMunicipioRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.alterarmunicipio.request.AlterarMunicipioRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.alterarmunicipio.request.AlterarMunicipioRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.alterarmunicipio.request.AlterarMunicipioRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.alterarmunicipio.request.AlterarMunicipioRequest unmarshal(java.io.Reader) 
