 ...
 */
public interface IIncluirDependenciasNovasAdapterMapping {
     ...
     */
    String mappingRequest(IncluirDependenciasNovasRequest message);
     ...
     */
    IncluirDependenciasNovasResponse mappingResponse(String response);
