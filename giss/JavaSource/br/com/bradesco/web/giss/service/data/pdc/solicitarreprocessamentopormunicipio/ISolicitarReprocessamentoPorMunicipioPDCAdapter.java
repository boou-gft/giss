 ...
 */
public interface ISolicitarReprocessamentoPorMunicipioPDCAdapter {
     ...
     */
    SolicitarReprocessamentoPorMunicipioResponse invokeProcess(SolicitarReprocessamentoPorMunicipioRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    SolicitarReprocessamentoPorMunicipioResponse invokeProcess(SolicitarReprocessamentoPorMunicipioRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     SolicitarReprocessamentoPorMunicipioResponse[] invokeProcess(SolicitarReprocessamentoPorMunicipioRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    SolicitarReprocessamentoPorMunicipioResponse[] invokeProcess(SolicitarReprocessamentoPorMunicipioRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
