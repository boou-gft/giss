 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ManterAliquotaLista
 * </p>
 * 
 ...
 */
public class ManterAliquotaListaPDCAdapterImpl extends PdcBaseAdapter implements
        IManterAliquotaListaPDCAdapter, IManterAliquotaListaAdapterMapping {
     ...
     */
    public ManterAliquotaListaResponse invokeProcess(ManterAliquotaListaRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaListaResponse invokeProcess(ManterAliquotaListaRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ManterAliquotaListaRequest 
     ...
     */
    private ManterAliquotaListaResponse invokeProcess(
            ManterAliquotaListaRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaListaResponse[] invokeProcess(ManterAliquotaListaRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ManterAliquotaListaResponse[] invokeProcess(ManterAliquotaListaRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ManterAliquotaListaRequest message) {
     ...
     * objeto do tipo ManterAliquotaListaResponse.
     * 
	 * @param response Objeto do tipo ManterAliquotaListaResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ManterAliquotaListaResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ManterAliquotaListaResponse mappingResponse(String response) {

        ManterAliquotaListaResponse processResponse = new ManterAliquotaListaResponse();
        try {
            
            processResponse = 
            	(ManterAliquotaListaResponse) ManterAliquotaListaResponse.
