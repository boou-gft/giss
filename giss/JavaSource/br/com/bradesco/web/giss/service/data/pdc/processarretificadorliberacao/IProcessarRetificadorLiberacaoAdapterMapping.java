 ...
 */
public interface IProcessarRetificadorLiberacaoAdapterMapping {
     ...
     */
    String mappingRequest(ProcessarRetificadorLiberacaoRequest message);
     ...
     */
    ProcessarRetificadorLiberacaoResponse mappingResponse(String response);
