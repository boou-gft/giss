 ...
 */
public interface ICalcularSelecionadosOuTodosPDCAdapter {
     ...
     */
    CalcularSelecionadosOuTodosResponse invokeProcess(CalcularSelecionadosOuTodosRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    CalcularSelecionadosOuTodosResponse invokeProcess(CalcularSelecionadosOuTodosRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
