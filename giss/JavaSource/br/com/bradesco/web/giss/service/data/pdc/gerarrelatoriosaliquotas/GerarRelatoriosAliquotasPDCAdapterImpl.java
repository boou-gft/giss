package br.com.bradesco.web.giss.service.data.pdc.gerarrelatoriosaliquotas;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: GerarRelatoriosAliquotas
 * </p>
 * 
 ...
 */
public class GerarRelatoriosAliquotasPDCAdapterImpl extends PdcBaseAdapter implements
        IGerarRelatoriosAliquotasPDCAdapter, IGerarRelatoriosAliquotasAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.gerarrelatoriosaliquotas.IGerarRelatoriosAliquotasPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.gerarrelatoriosaliquotas.request.GerarRelatoriosAliquotasRequest)
     * @param message Objeto do tipo GerarRelatoriosAliquotasRequest 
     ...
     * @return Objeto do tipo GerarRelatoriosAliquotasResponse 
     ...
     */
    public GerarRelatoriosAliquotasResponse invokeProcess(
            GerarRelatoriosAliquotasRequest message) 
     ...
     */
    public String mappingRequest(GerarRelatoriosAliquotasRequest message) {
     ...
     * objeto do tipo GerarRelatoriosAliquotasResponse.
     * 
	 * @param response Objeto do tipo GerarRelatoriosAliquotasResponse 
     ...
     */
    public GerarRelatoriosAliquotasResponse mappingResponse(String response) {

        GerarRelatoriosAliquotasResponse processResponse = new GerarRelatoriosAliquotasResponse();
        try {
            
            processResponse = 
            	(GerarRelatoriosAliquotasResponse) GerarRelatoriosAliquotasResponse.
