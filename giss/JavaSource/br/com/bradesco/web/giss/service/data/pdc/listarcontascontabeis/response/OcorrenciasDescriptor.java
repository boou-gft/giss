...
public class OcorrenciasDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcontascontabeis.response.OcorrenciasDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarcontascontabeis.response.Ocorrencias.class;
