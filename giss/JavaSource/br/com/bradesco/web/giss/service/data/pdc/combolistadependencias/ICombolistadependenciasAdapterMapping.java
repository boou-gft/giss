 ...
 */
public interface ICombolistadependenciasAdapterMapping {
     ...
     */
    String mappingRequest(CombolistadependenciasRequest message);
     ...
     */
    CombolistadependenciasResponse mappingResponse(String response);
