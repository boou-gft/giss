package br.com.bradesco.web.giss.service.data.pdc.listarapuracaoaposfechamentoiss;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarApuracaoAposFechamentoISS
 * </p>
 * 
 ...
 */
public class ListarApuracaoAposFechamentoISSPDCAdapterImpl extends PdcBaseAdapter implements
        IListarApuracaoAposFechamentoISSPDCAdapter, IListarApuracaoAposFechamentoISSAdapterMapping {
     ...
     */
    public ListarApuracaoAposFechamentoISSResponse invokeProcess(ListarApuracaoAposFechamentoISSRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarapuracaoaposfechamentoiss.IListarApuracaoAposFechamentoISSPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarapuracaoaposfechamentoiss.request.ListarApuracaoAposFechamentoISSRequest)
     * @param message Objeto do tipo ListarApuracaoAposFechamentoISSRequest 
     ...
     * @return Objeto do tipo ListarApuracaoAposFechamentoISSResponse 
     ...
     */
    private ListarApuracaoAposFechamentoISSResponse invokeProcess(
            ListarApuracaoAposFechamentoISSRequest message, 
     ...
     */
    public String mappingRequest(ListarApuracaoAposFechamentoISSRequest message) {
     ...
     * objeto do tipo ListarApuracaoAposFechamentoISSResponse.
     * 
	 * @param response Objeto do tipo ListarApuracaoAposFechamentoISSResponse 
     ...
     */
    public ListarApuracaoAposFechamentoISSResponse mappingResponse(String response) {

        ListarApuracaoAposFechamentoISSResponse processResponse = new ListarApuracaoAposFechamentoISSResponse();
        try {
            
            processResponse = 
            	(ListarApuracaoAposFechamentoISSResponse) ListarApuracaoAposFechamentoISSResponse.
