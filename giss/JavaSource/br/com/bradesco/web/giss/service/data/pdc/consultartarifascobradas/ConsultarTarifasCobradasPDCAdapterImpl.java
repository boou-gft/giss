package br.com.bradesco.web.giss.service.data.pdc.consultartarifascobradas;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarTarifasCobradas
 * </p>
 * 
 ...
 */
public class ConsultarTarifasCobradasPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarTarifasCobradasPDCAdapter, IConsultarTarifasCobradasAdapterMapping {
     ...
     */
    public ConsultarTarifasCobradasResponse invokeProcess(ConsultarTarifasCobradasRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultartarifascobradas.IConsultarTarifasCobradasPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultartarifascobradas.request.ConsultarTarifasCobradasRequest)
     * @param message Objeto do tipo ConsultarTarifasCobradasRequest 
     ...
     * @return Objeto do tipo ConsultarTarifasCobradasResponse 
     ...
     */
    private ConsultarTarifasCobradasResponse invokeProcess(
            ConsultarTarifasCobradasRequest message, 
     ...
     */
    public String mappingRequest(ConsultarTarifasCobradasRequest message) {
     ...
     * objeto do tipo ConsultarTarifasCobradasResponse.
     * 
	 * @param response Objeto do tipo ConsultarTarifasCobradasResponse 
     ...
     */
    public ConsultarTarifasCobradasResponse mappingResponse(String response) {

        ConsultarTarifasCobradasResponse processResponse = new ConsultarTarifasCobradasResponse();
        try {
            
            processResponse = 
            	(ConsultarTarifasCobradasResponse) ConsultarTarifasCobradasResponse.
