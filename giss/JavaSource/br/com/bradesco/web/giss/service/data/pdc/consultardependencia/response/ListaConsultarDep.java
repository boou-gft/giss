...
public class ListaConsultarDep implements java.io.Serializable {
     ...
     * Field _sDtSelecao
     */
    private java.lang.String _sDtSelecao;
    ...
    public ListaConsultarDep() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultardependencia.response.ListaConsultarDep()
    ...
    /**
     * Returns the value of field 'sDtSelecao'.
     * 
     * @return String
     * @return the value of field 'sDtSelecao'.
     */
    public java.lang.String getSDtSelecao()
    {
        return this._sDtSelecao;
    } //-- java.lang.String getSDtSelecao() 
    ...
    /**
     * Sets the value of field 'sDtSelecao'.
     * 
     * @param sDtSelecao the value of field 'sDtSelecao'.
     */
    public void setSDtSelecao(java.lang.String sDtSelecao)
    {
        this._sDtSelecao = sDtSelecao;
    } //-- void setSDtSelecao(java.lang.String) 
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.consultardependencia.response.ListaConsultarDep unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.consultardependencia.response.ListaConsultarDep) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.consultardependencia.response.ListaConsultarDep.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultardependencia.response.ListaConsultarDep unmarshal(java.io.Reader) 
