 ...
 * Schema.
 * $Id: DetalharDenpendenciasEncerradasResponseDescriptor.java,v 1.1 2017/04/11 14:12:25 gmichelini Exp $
 */
...
/**
 * Class DetalharDenpendenciasEncerradasResponseDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:12:25 $
 */
public class DetalharDenpendenciasEncerradasResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DetalharDenpendenciasEncerradasResponseDescriptor() 
     {
        super();
        xmlName = "detalharDenpendenciasEncerradasResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DetalharDenpendenciasEncerradasResponse target = (DetalharDenpendenciasEncerradasResponse) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.detalhardenpendenciasencerradas.response.DetalharDenpendenciasEncerradasResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.detalhardenpendenciasencerradas.response.DetalharDenpendenciasEncerradasResponse.class;
