 ...
 */
public interface IListarPedidoBalancetesAdapterMapping {
     ...
     */
    String mappingRequest(ListarPedidoBalancetesRequest message);
     ...
     */
    ListarPedidoBalancetesResponse mappingResponse(String response);
