...
/**
 * Class ManterAliquotaListaResponseDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ManterAliquotaListaResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ManterAliquotaListaResponseDescriptor() 
     {
        super();
        xmlName = "manterAliquotaListaResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ManterAliquotaListaResponse target = (ManterAliquotaListaResponse) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _listaList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.manteraliquotalista.response.Lista.class, "_listaList", "lista", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ManterAliquotaListaResponse target = (ManterAliquotaListaResponse) object;
                    target.addLista( (br.com.bradesco.web.giss.service.data.pdc.manteraliquotalista.response.Lista) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.manteraliquotalista.response.Lista();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.manteraliquotalista.response.ManterAliquotaListaResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.manteraliquotalista.response.ManterAliquotaListaResponse.class;
