 ...
 * Schema.
 * $Id: IncluirCodLancamentoRequest.java,v 1.3 2017/05/31 10:59:36 gmichelini Exp $
 */

package br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento.request;
...
/**
 * Class IncluirCodLancamentoRequest.
 * 
 * @version $Revision: 1.3 $ $Date: 2017/05/31 10:59:36 $
 */
public class IncluirCodLancamentoRequest implements java.io.Serializable {
    ...
    public IncluirCodLancamentoRequest() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento.request.IncluirCodLancamentoRequest()
     ...
     * 
     * @param reader
     * @return IncluirCodLancamentoRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento.request.IncluirCodLancamentoRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento.request.IncluirCodLancamentoRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento.request.IncluirCodLancamentoRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.incluircodlancamento.request.IncluirCodLancamentoRequest unmarshal(java.io.Reader) 
