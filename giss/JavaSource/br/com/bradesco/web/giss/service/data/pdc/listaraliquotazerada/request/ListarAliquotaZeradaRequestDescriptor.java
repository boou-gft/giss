 ...
 * Schema.
 * $Id: ListarAliquotaZeradaRequestDescriptor.java,v 1.3 2017/07/28 19:14:37 gilbertocopoli Exp $
 */
...
/**
 * Class ListarAliquotaZeradaRequestDescriptor.
 * 
 * @version $Revision: 1.3 $ $Date: 2017/07/28 19:14:37 $
 */
public class ListarAliquotaZeradaRequestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListarAliquotaZeradaRequestDescriptor() 
     {
        super();
        xmlName = "listarAliquotaZeradaRequest";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListarAliquotaZeradaRequest target = (ListarAliquotaZeradaRequest) object;
        ...
        //-- _codigoPessaoJuridica
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(long.class, "_codigoPessaoJuridica", "codigoPessaoJuridica", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ListarAliquotaZeradaRequest target = (ListarAliquotaZeradaRequest) object;
                if(!target.hasCodigoPessaoJuridica())
                    return null;
                return new java.lang.Long(target.getCodigoPessaoJuridica());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setCodigoPessaoJuridica( ((java.lang.Long)value).longValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _codigoPessaoJuridica
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaraliquotazerada.request.ListarAliquotaZeradaRequestDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listaraliquotazerada.request.ListarAliquotaZeradaRequest.class;
