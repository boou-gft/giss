 ...
 * Schema.
 * $Id: ListarLcAliquotaRequestDescriptor.java,v 1.3 2017/12/08 17:29:24 gmichelini Exp $
 */
...
/**
 * Class ListarLcAliquotaRequestDescriptor.
 * 
 * @version $Revision: 1.3 $ $Date: 2017/12/08 17:29:24 $
 */
public class ListarLcAliquotaRequestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListarLcAliquotaRequestDescriptor() 
     {
        super();
        xmlName = "listarLcAliquotaRequest";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListarLcAliquotaRequest target = (ListarLcAliquotaRequest) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarlcaliquota.request.ListarLcAliquotaRequestDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarlcaliquota.request.ListarLcAliquotaRequest.class;
