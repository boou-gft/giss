 ...
 */
public interface IIncluirApuracaoAjusteAdapterMapping {
     ...
     */
    String mappingRequest(IncluirApuracaoAjusteRequest message);
     ...
     */
    IncluirApuracaoAjusteResponse mappingResponse(String response);
