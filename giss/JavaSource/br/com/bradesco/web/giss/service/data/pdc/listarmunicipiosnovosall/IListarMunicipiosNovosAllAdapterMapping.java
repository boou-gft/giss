 ...
 */
public interface IListarMunicipiosNovosAllAdapterMapping {
     ...
     */
    String mappingRequest(ListarMunicipiosNovosAllRequest message);
     ...
     */
    ListarMunicipiosNovosAllResponse mappingResponse(String response);
