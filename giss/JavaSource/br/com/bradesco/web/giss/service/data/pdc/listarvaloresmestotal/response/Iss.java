 ...
 * Schema.
 * $Id: Iss.java,v 1.1 2012/11/22 15:40:48 gmichelini Exp $
 */
...
public class Iss implements java.io.Serializable {
    ...
    public Iss() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.response.Iss()
     ...
     * @return Iss
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.response.Iss unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.response.Iss) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.response.Iss.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarvaloresmestotal.response.Iss unmarshal(java.io.Reader) 
