 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultaConciliacaoApuracao
 * </p>
 * 
 ...
 */
public class ConsultaConciliacaoApuracaoPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultaConciliacaoApuracaoPDCAdapter, IConsultaConciliacaoApuracaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultaconciliacaoapuracao.IConsultaConciliacaoApuracaoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultaconciliacaoapuracao.request.ConsultaConciliacaoApuracaoRequest)
     * @param message Objeto do tipo ConsultaConciliacaoApuracaoRequest 
     ...
     */
    public ConsultaConciliacaoApuracaoResponse invokeProcess(
            ConsultaConciliacaoApuracaoRequest message) 
     ...
     */
    public String mappingRequest(ConsultaConciliacaoApuracaoRequest message) {
     ...
     * objeto do tipo ConsultaConciliacaoApuracaoResponse.
     * 
	 * @param response Objeto do tipo ConsultaConciliacaoApuracaoResponse 
     ...
     */
    public ConsultaConciliacaoApuracaoResponse mappingResponse(String response) {

        ConsultaConciliacaoApuracaoResponse processResponse = new ConsultaConciliacaoApuracaoResponse();
        try {
            
            processResponse = 
            	(ConsultaConciliacaoApuracaoResponse) ConsultaConciliacaoApuracaoResponse.
