package br.com.bradesco.web.giss.service.data.pdc.listarcontasemp;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarContasEmp
 * </p>
 * 
 ...
 */
public class ListarContasEmpPDCAdapterImpl extends PdcBaseAdapter implements
        IListarContasEmpPDCAdapter, IListarContasEmpAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarContasEmpRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ListarContasEmpResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ListarContasEmpResponse invokeProcess(ListarContasEmpRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarContasEmpResponse invokeProcess(ListarContasEmpRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarContasEmpRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ListarContasEmpResponse 
	...
	private ListarContasEmpResponse invokeProcess(
            ListarContasEmpRequest message, 
     ...
     */
    public String mappingRequest(ListarContasEmpRequest message) {
     ...
     * objeto do tipo ListarContasEmpResponse.
     * 
	 * @param response Objeto do tipo ListarContasEmpResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListarContasEmpResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListarContasEmpResponse mappingResponse(String response) {

        ListarContasEmpResponse processResponse = new ListarContasEmpResponse();
        try {
            
            processResponse = 
            	(ListarContasEmpResponse) ListarContasEmpResponse.
