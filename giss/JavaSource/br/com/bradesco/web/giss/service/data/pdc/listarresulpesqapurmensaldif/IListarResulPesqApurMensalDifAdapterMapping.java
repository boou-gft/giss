 ...
 */
public interface IListarResulPesqApurMensalDifAdapterMapping {
     ...
     */
    String mappingRequest(ListarResulPesqApurMensalDifRequest message);
     ...
     */
    ListarResulPesqApurMensalDifResponse mappingResponse(String response);
