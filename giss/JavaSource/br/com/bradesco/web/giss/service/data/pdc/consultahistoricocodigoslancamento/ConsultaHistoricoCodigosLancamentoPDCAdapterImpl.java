package br.com.bradesco.web.giss.service.data.pdc.consultahistoricocodigoslancamento;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultaHistoricoCodigosLancamento
 * </p>
 * 
 ...
 */
public class ConsultaHistoricoCodigosLancamentoPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultaHistoricoCodigosLancamentoPDCAdapter, IConsultaHistoricoCodigosLancamentoAdapterMapping {
     ...
     */
    public ConsultaHistoricoCodigosLancamentoResponse invokeProcess(ConsultaHistoricoCodigosLancamentoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultahistoricocodigoslancamento.IConsultaHistoricoCodigosLancamentoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultahistoricocodigoslancamento.request.ConsultaHistoricoCodigosLancamentoRequest)
     * @param message Objeto do tipo ConsultaHistoricoCodigosLancamentoRequest 
     ...
     * @return Objeto do tipo ConsultaHistoricoCodigosLancamentoResponse 
     ...
     */
    private ConsultaHistoricoCodigosLancamentoResponse invokeProcess(
            ConsultaHistoricoCodigosLancamentoRequest message, 
     ...
     */
    public String mappingRequest(ConsultaHistoricoCodigosLancamentoRequest message) {
     ...
     * objeto do tipo ConsultaHistoricoCodigosLancamentoResponse.
     * 
	 * @param response Objeto do tipo ConsultaHistoricoCodigosLancamentoResponse 
     ...
     */
    public ConsultaHistoricoCodigosLancamentoResponse mappingResponse(String response) {

        ConsultaHistoricoCodigosLancamentoResponse processResponse = new ConsultaHistoricoCodigosLancamentoResponse();
        try {
            
            processResponse = 
            	(ConsultaHistoricoCodigosLancamentoResponse) ConsultaHistoricoCodigosLancamentoResponse.
