package br.com.bradesco.web.giss.service.data.pdc.combolistamunicipios;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: Combolistamunicipios
 * </p>
 * 
 ...
 */
public class CombolistamunicipiosPDCAdapterImpl extends PdcBaseAdapter implements
        ICombolistamunicipiosPDCAdapter, ICombolistamunicipiosAdapterMapping {
     ...
     */
    public CombolistamunicipiosResponse invokeProcess(CombolistamunicipiosRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.service.data.pdc.combolistamunicipios.ICombolistamunicipiosPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.service.data.pdc.combolistamunicipios.request.CombolistamunicipiosRequest)
     * @param message Objeto do tipo CombolistamunicipiosRequest 
     ...
     * @return Objeto do tipo CombolistamunicipiosResponse 
     ...
     */
    private CombolistamunicipiosResponse invokeProcess(
            CombolistamunicipiosRequest message, 
     ...
     */
    public String mappingRequest(CombolistamunicipiosRequest message) {
     ...
     * objeto do tipo CombolistamunicipiosResponse.
     * 
	 * @param response Objeto do tipo CombolistamunicipiosResponse 
     ...
     */
    public CombolistamunicipiosResponse mappingResponse(String response) {

        CombolistamunicipiosResponse processResponse = new CombolistamunicipiosResponse();
        try {
            
            processResponse = 
            	(CombolistamunicipiosResponse) CombolistamunicipiosResponse.
