package br.com.bradesco.web.giss.service.data.pdc.listardependenciassaldorecolhimento;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarDependenciasSaldoRecolhimento
 * </p>
 * 
 ...
 */
public class ListarDependenciasSaldoRecolhimentoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarDependenciasSaldoRecolhimentoPDCAdapter, IListarDependenciasSaldoRecolhimentoAdapterMapping {
     ...
     */
    public ListarDependenciasSaldoRecolhimentoResponse invokeProcess(ListarDependenciasSaldoRecolhimentoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listardependenciassaldorecolhimento.IListarDependenciasSaldoRecolhimentoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listardependenciassaldorecolhimento.request.ListarDependenciasSaldoRecolhimentoRequest)
     * @param message Objeto do tipo ListarDependenciasSaldoRecolhimentoRequest 
     ...
     * @return Objeto do tipo ListarDependenciasSaldoRecolhimentoResponse 
     ...
     */
    private ListarDependenciasSaldoRecolhimentoResponse invokeProcess(
            ListarDependenciasSaldoRecolhimentoRequest message, 
     ...
     */
    public String mappingRequest(ListarDependenciasSaldoRecolhimentoRequest message) {
     ...
     * objeto do tipo ListarDependenciasSaldoRecolhimentoResponse.
     * 
	 * @param response Objeto do tipo ListarDependenciasSaldoRecolhimentoResponse 
     ...
     */
    public ListarDependenciasSaldoRecolhimentoResponse mappingResponse(String response) {

        ListarDependenciasSaldoRecolhimentoResponse processResponse = new ListarDependenciasSaldoRecolhimentoResponse();
        try {
            
            processResponse = 
            	(ListarDependenciasSaldoRecolhimentoResponse) ListarDependenciasSaldoRecolhimentoResponse.
