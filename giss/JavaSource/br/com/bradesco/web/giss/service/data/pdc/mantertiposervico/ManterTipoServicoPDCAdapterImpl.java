package br.com.bradesco.web.giss.service.data.pdc.mantertiposervico;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ManterTipoServico
 * </p>
 * 
 ...
 */
public class ManterTipoServicoPDCAdapterImpl extends PdcBaseAdapter implements
        IManterTipoServicoPDCAdapter, IManterTipoServicoAdapterMapping {
     ...
     */
    public ManterTipoServicoResponse invokeProcess(ManterTipoServicoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.piloto.service.data.pdc.mantertiposervico.IManterTipoServicoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.piloto.service.data.pdc.mantertiposervico.request.ManterTipoServicoRequest)
     * @param message Objeto do tipo ManterTipoServicoRequest 
     ...
     * @return Objeto do tipo ManterTipoServicoResponse 
     ...
     */
    private ManterTipoServicoResponse invokeProcess(
            ManterTipoServicoRequest message, 
     ...
     */
    public String mappingRequest(ManterTipoServicoRequest message) {
     ...
     * objeto do tipo ManterTipoServicoResponse.
     * 
	 * @param response Objeto do tipo ManterTipoServicoResponse 
     ...
     */
    public ManterTipoServicoResponse mappingResponse(String response) {

        ManterTipoServicoResponse processResponse = new ManterTipoServicoResponse();
        try {
            
            processResponse = 
            	(ManterTipoServicoResponse) ManterTipoServicoResponse.
