 ...
 */
public interface IExcluirPercentualTransicaoAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirPercentualTransicaoRequest message);
     ...
     */
    ExcluirPercentualTransicaoResponse mappingResponse(String response);
