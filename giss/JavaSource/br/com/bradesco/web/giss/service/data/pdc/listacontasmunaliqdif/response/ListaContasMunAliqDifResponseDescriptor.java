...
/**
 * Class ListaContasMunAliqDifResponseDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ListaContasMunAliqDifResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListaContasMunAliqDifResponseDescriptor() 
     {
        super();
        xmlName = "listaContasMunAliqDifResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListaContasMunAliqDifResponse target = (ListaContasMunAliqDifResponse) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _ocorrenciasList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.listacontasmunaliqdif.response.Ocorrencias.class, "_ocorrenciasList", "ocorrencias", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ListaContasMunAliqDifResponse target = (ListaContasMunAliqDifResponse) object;
                    target.addOcorrencias( (br.com.bradesco.web.giss.service.data.pdc.listacontasmunaliqdif.response.Ocorrencias) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.listacontasmunaliqdif.response.Ocorrencias();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listacontasmunaliqdif.response.ListaContasMunAliqDifResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listacontasmunaliqdif.response.ListaContasMunAliqDifResponse.class;
