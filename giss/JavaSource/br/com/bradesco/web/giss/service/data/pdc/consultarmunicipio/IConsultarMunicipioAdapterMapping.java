 ...
 */
public interface IConsultarMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarMunicipioRequest message);
     ...
     */
    ConsultarMunicipioResponse mappingResponse(String response);
