 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AlterarMunicipioISS
 * </p>
 * 
 ...
 */
public class AlterarMunicipioISSPDCAdapterImpl extends PdcBaseAdapter implements
        IAlterarMunicipioISSPDCAdapter, IAlterarMunicipioISSAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.alterarmunicipioiss.IAlterarMunicipioISSPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.alterarmunicipioiss.request.AlterarMunicipioISSRequest)
     * @param message Objeto do tipo AlterarMunicipioISSRequest 
     ...
     */
    public AlterarMunicipioISSResponse invokeProcess(
            AlterarMunicipioISSRequest message) 
     ...
     */
    public String mappingRequest(AlterarMunicipioISSRequest message) {
     ...
     * objeto do tipo AlterarMunicipioISSResponse.
     * 
	 * @param response Objeto do tipo AlterarMunicipioISSResponse 
     ...
     */
    public AlterarMunicipioISSResponse mappingResponse(String response) {

        AlterarMunicipioISSResponse processResponse = new AlterarMunicipioISSResponse();
        try {
            
            processResponse = 
            	(AlterarMunicipioISSResponse) AlterarMunicipioISSResponse.
