package br.com.bradesco.web.giss.service.data.pdc.excluiritemcomplementar;
 ...
 */
public interface IExcluirItemComplementarAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirItemComplementarRequest message);
     ...
     *            processo no PDC
     * @return Objeto do tipo ExcluirItemComplementarResponse 
     * 		   que representa o resultado da chamada do processo no PDC
     */
    ExcluirItemComplementarResponse mappingResponse(String response);
