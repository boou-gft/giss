 ...
 */
public interface IConsultarInformacoesAliquotaAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarInformacoesAliquotaRequest message);
     ...
     */
    ConsultarInformacoesAliquotaResponse mappingResponse(String response);
