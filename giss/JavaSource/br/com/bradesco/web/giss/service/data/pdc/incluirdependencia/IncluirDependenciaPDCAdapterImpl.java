package br.com.bradesco.web.giss.service.data.pdc.incluirdependencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirDependencia
 * </p>
 * 
 ...
 */
public class IncluirDependenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirDependenciaPDCAdapter, IIncluirDependenciaAdapterMapping {
     ...
     */
    public IncluirDependenciaResponse invokeProcess(IncluirDependenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluirdependencia.IIncluirDependenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluirdependencia.request.IncluirDependenciaRequest)
     * @param message Objeto do tipo IncluirDependenciaRequest 
     ...
     * @return Objeto do tipo IncluirDependenciaResponse 
     ...
     */
    private IncluirDependenciaResponse invokeProcess(
            IncluirDependenciaRequest message, 
     ...
     */
    public String mappingRequest(IncluirDependenciaRequest message) {
     ...
     * objeto do tipo IncluirDependenciaResponse.
     * 
	 * @param response Objeto do tipo IncluirDependenciaResponse 
     ...
     */
    public IncluirDependenciaResponse mappingResponse(String response) {

        IncluirDependenciaResponse processResponse = new IncluirDependenciaResponse();
        try {
            
            processResponse = 
            	(IncluirDependenciaResponse) IncluirDependenciaResponse.
