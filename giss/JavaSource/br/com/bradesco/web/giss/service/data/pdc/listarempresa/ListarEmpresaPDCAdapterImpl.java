package br.com.bradesco.web.giss.service.data.pdc.listarempresa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarEmpresa
 * </p>
 * 
 ...
 */
public class ListarEmpresaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarEmpresaPDCAdapter, IListarEmpresaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarempresa.IListarEmpresaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarempresa.request.ListarEmpresaRequest)
     * @param message Objeto do tipo ListarEmpresaRequest 
     ...
     * @return Objeto do tipo ListarEmpresaResponse 
     ...
     */
    public ListarEmpresaResponse invokeProcess(
            ListarEmpresaRequest message) 
     ...
     */
    public String mappingRequest(ListarEmpresaRequest message) {
     ...
     * objeto do tipo ListarEmpresaResponse.
     * 
	 * @param response Objeto do tipo ListarEmpresaResponse 
     ...
     */
    public ListarEmpresaResponse mappingResponse(String response) {

        ListarEmpresaResponse processResponse = new ListarEmpresaResponse();
        try {
            
            processResponse = 
            	(ListarEmpresaResponse) ListarEmpresaResponse.
