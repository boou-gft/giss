 ...
 */
public interface IIncluirPercentualTransicaoPDCAdapter {
     ...
     */
    IncluirPercentualTransicaoResponse invokeProcess(IncluirPercentualTransicaoRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    IncluirPercentualTransicaoResponse invokeProcess(IncluirPercentualTransicaoRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
