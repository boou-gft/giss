package br.com.bradesco.web.giss.service.data.pdc.conferirrejeitarcargamassiva;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConferirRejeitarCargaMassiva
 * </p>
 * 
 ...
 */
public class ConferirRejeitarCargaMassivaPDCAdapterImpl extends PdcBaseAdapter implements
        IConferirRejeitarCargaMassivaPDCAdapter, IConferirRejeitarCargaMassivaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ConferirRejeitarCargaMassivaRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ConferirRejeitarCargaMassivaResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ConferirRejeitarCargaMassivaResponse invokeProcess(ConferirRejeitarCargaMassivaRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConferirRejeitarCargaMassivaResponse invokeProcess(ConferirRejeitarCargaMassivaRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ConferirRejeitarCargaMassivaRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ConferirRejeitarCargaMassivaResponse 
     ...
     */
    private ConferirRejeitarCargaMassivaResponse invokeProcess(
            ConferirRejeitarCargaMassivaRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConferirRejeitarCargaMassivaResponse[] invokeProcess(ConferirRejeitarCargaMassivaRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConferirRejeitarCargaMassivaResponse[] invokeProcess(ConferirRejeitarCargaMassivaRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ConferirRejeitarCargaMassivaRequest message) {
     ...
     * objeto do tipo ConferirRejeitarCargaMassivaResponse.
     * 
	 * @param response Objeto do tipo ConferirRejeitarCargaMassivaResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ConferirRejeitarCargaMassivaResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ConferirRejeitarCargaMassivaResponse mappingResponse(String response) {

        ConferirRejeitarCargaMassivaResponse processResponse = new ConferirRejeitarCargaMassivaResponse();
        try {
            
            processResponse = 
            	(ConferirRejeitarCargaMassivaResponse) ConferirRejeitarCargaMassivaResponse.
