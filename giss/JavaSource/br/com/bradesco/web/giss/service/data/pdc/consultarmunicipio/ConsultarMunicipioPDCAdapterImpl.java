package br.com.bradesco.web.giss.service.data.pdc.consultarmunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarMunicipio
 * </p>
 * 
 ...
 */
public class ConsultarMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarMunicipioPDCAdapter, IConsultarMunicipioAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarmunicipio.IConsultarMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarmunicipio.request.ConsultarMunicipioRequest)
     * @param message Objeto do tipo ConsultarMunicipioRequest 
     ...
     * @return Objeto do tipo ConsultarMunicipioResponse 
     ...
     */
    public ConsultarMunicipioResponse invokeProcess(
            ConsultarMunicipioRequest message) 
     ...
     */
    public String mappingRequest(ConsultarMunicipioRequest message) {
     ...
     * objeto do tipo ConsultarMunicipioResponse.
     * 
	 * @param response Objeto do tipo ConsultarMunicipioResponse 
     ...
     */
    public ConsultarMunicipioResponse mappingResponse(String response) {

        ConsultarMunicipioResponse processResponse = new ConsultarMunicipioResponse();
        try {
            
            processResponse = 
            	(ConsultarMunicipioResponse) ConsultarMunicipioResponse.
