 ...
 */
public interface IListarComboEstadoAdapterMapping {
     ...
     */
    String mappingRequest(ListarComboEstadoRequest message);
     ...
     */
    ListarComboEstadoResponse mappingResponse(String response);
