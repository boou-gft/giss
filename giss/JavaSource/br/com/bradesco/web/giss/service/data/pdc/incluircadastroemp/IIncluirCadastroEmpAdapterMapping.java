 ...
 */
public interface IIncluirCadastroEmpAdapterMapping {
     ...
     */
    String mappingRequest(IncluirCadastroEmpRequest message);
     ...
     */
    IncluirCadastroEmpResponse mappingResponse(String response);
