package br.com.bradesco.web.giss.service.data.pdc.listarpgtosnaogerados;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarPgtosNaoGerados
 * </p>
 * 
 ...
 */
public class ListarPgtosNaoGeradosPDCAdapterImpl extends PdcBaseAdapter implements
        IListarPgtosNaoGeradosPDCAdapter, IListarPgtosNaoGeradosAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarpgtosnaogerados.IListarPgtosNaoGeradosPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarpgtosnaogerados.request.ListarPgtosNaoGeradosRequest)
     * @param message Objeto do tipo ListarPgtosNaoGeradosRequest 
     ...
     * @return Objeto do tipo ListarPgtosNaoGeradosResponse 
     ...
     */
    public ListarPgtosNaoGeradosResponse invokeProcess(
            ListarPgtosNaoGeradosRequest message) 
     ...
     */
    public String mappingRequest(ListarPgtosNaoGeradosRequest message) {
     ...
     * objeto do tipo ListarPgtosNaoGeradosResponse.
     * 
	 * @param response Objeto do tipo ListarPgtosNaoGeradosResponse 
     ...
     */
    public ListarPgtosNaoGeradosResponse mappingResponse(String response) {

        ListarPgtosNaoGeradosResponse processResponse = new ListarPgtosNaoGeradosResponse();
        try {
            
            processResponse = 
            	(ListarPgtosNaoGeradosResponse) ListarPgtosNaoGeradosResponse.
