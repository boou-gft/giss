 ...
 */
public interface IListarContasTipoServicoAdapterMapping {
     ...
     */
    String mappingRequest(ListarContasTipoServicoRequest message);
     ...
     */
    ListarContasTipoServicoResponse mappingResponse(String response);
