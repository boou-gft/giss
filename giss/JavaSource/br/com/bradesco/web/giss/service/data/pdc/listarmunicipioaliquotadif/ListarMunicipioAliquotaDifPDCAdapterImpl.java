package br.com.bradesco.web.giss.service.data.pdc.listarmunicipioaliquotadif;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarMunicipioAliquotaDif
 * </p>
 * 
 ...
 */
public class ListarMunicipioAliquotaDifPDCAdapterImpl extends PdcBaseAdapter implements
        IListarMunicipioAliquotaDifPDCAdapter, IListarMunicipioAliquotaDifAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarmunicipioaliquotadif.IListarMunicipioAliquotaDifPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarmunicipioaliquotadif.request.ListarMunicipioAliquotaDifRequest)
     * @param message Objeto do tipo ListarMunicipioAliquotaDifRequest 
     ...
     * @return Objeto do tipo ListarMunicipioAliquotaDifResponse 
     ...
     */
    public ListarMunicipioAliquotaDifResponse invokeProcess(
            ListarMunicipioAliquotaDifRequest message) 
     ...
     */
    public String mappingRequest(ListarMunicipioAliquotaDifRequest message) {
     ...
     * objeto do tipo ListarMunicipioAliquotaDifResponse.
     * 
	 * @param response Objeto do tipo ListarMunicipioAliquotaDifResponse 
     ...
     */
    public ListarMunicipioAliquotaDifResponse mappingResponse(String response) {

        ListarMunicipioAliquotaDifResponse processResponse = new ListarMunicipioAliquotaDifResponse();
        try {
            
            processResponse = 
            	(ListarMunicipioAliquotaDifResponse) ListarMunicipioAliquotaDifResponse.
