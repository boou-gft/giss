 ...
 */
public interface IConferirRejeitarCargaMassivaGerencialPDCAdapter {
     ...
     */
    ConferirRejeitarCargaMassivaGerencialResponse invokeProcess(ConferirRejeitarCargaMassivaGerencialRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ConferirRejeitarCargaMassivaGerencialResponse invokeProcess(ConferirRejeitarCargaMassivaGerencialRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     * 
     * @param message Objeto do tipo ConferirRejeitarCargaMassivaGerencialRequest que contém a informação necessária para invocar o processo PDC.
     ...
     * @return Objeto do tipo ConferirRejeitarCargaMassivaGerencialResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
     ConferirRejeitarCargaMassivaGerencialResponse[] invokeProcess(ConferirRejeitarCargaMassivaGerencialRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ConferirRejeitarCargaMassivaGerencialResponse[] invokeProcess(ConferirRejeitarCargaMassivaGerencialRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
