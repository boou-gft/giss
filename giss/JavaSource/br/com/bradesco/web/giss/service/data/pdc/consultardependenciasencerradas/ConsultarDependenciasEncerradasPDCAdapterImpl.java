package br.com.bradesco.web.giss.service.data.pdc.consultardependenciasencerradas;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarDependenciasEncerradas
 * </p>
 * 
 ...
 */
public class ConsultarDependenciasEncerradasPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarDependenciasEncerradasPDCAdapter, IConsultarDependenciasEncerradasAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultardependenciasencerradas.IConsultarDependenciasEncerradasPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultardependenciasencerradas.request.ConsultarDependenciasEncerradasRequest)
     * @param message Objeto do tipo ConsultarDependenciasEncerradasRequest 
     ...
     * @return Objeto do tipo ConsultarDependenciasEncerradasResponse 
     ...
     */
    public ConsultarDependenciasEncerradasResponse invokeProcess(
            ConsultarDependenciasEncerradasRequest message) 
     ...
     */
    public String mappingRequest(ConsultarDependenciasEncerradasRequest message) {
     ...
     * objeto do tipo ConsultarDependenciasEncerradasResponse.
     * 
	 * @param response Objeto do tipo ConsultarDependenciasEncerradasResponse 
     ...
     */
    public ConsultarDependenciasEncerradasResponse mappingResponse(String response) {

        ConsultarDependenciasEncerradasResponse processResponse = new ConsultarDependenciasEncerradasResponse();
        try {
            
            processResponse = 
            	(ConsultarDependenciasEncerradasResponse) ConsultarDependenciasEncerradasResponse.
