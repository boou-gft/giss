 ...
 */
public interface IAlterarMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(AlterarMunicipioRequest message);
     ...
     */
    AlterarMunicipioResponse mappingResponse(String response);
