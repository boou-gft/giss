package br.com.bradesco.web.giss.service.data.pdc.parametrizacaodepconsultar;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ParametrizacaoDepConsultar
 * </p>
 * 
 ...
 */
public class ParametrizacaoDepConsultarPDCAdapterImpl extends PdcBaseAdapter implements
        IParametrizacaoDepConsultarPDCAdapter, IParametrizacaoDepConsultarAdapterMapping {
     ...
     */
    public ParametrizacaoDepConsultarResponse invokeProcess(ParametrizacaoDepConsultarRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.service.data.pdc.parametrizacaodepconsultar.IParametrizacaoDepConsultarPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.service.data.pdc.parametrizacaodepconsultar.request.ParametrizacaoDepConsultarRequest)
     * @param message Objeto do tipo ParametrizacaoDepConsultarRequest 
     ...
     * @return Objeto do tipo ParametrizacaoDepConsultarResponse 
     ...
     */
    private ParametrizacaoDepConsultarResponse invokeProcess(
            ParametrizacaoDepConsultarRequest message, 
     ...
     */
    public String mappingRequest(ParametrizacaoDepConsultarRequest message) {
     ...
     * objeto do tipo ParametrizacaoDepConsultarResponse.
     * 
	 * @param response Objeto do tipo ParametrizacaoDepConsultarResponse 
     ...
     */
    public ParametrizacaoDepConsultarResponse mappingResponse(String response) {

        ParametrizacaoDepConsultarResponse processResponse = new ParametrizacaoDepConsultarResponse();
        try {
            
            processResponse = 
            	(ParametrizacaoDepConsultarResponse) ParametrizacaoDepConsultarResponse.
