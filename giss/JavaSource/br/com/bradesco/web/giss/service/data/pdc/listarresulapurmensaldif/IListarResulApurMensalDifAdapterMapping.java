 ...
 */
public interface IListarResulApurMensalDifAdapterMapping {
     ...
     */
    String mappingRequest(ListarResulApurMensalDifRequest message);
     ...
     */
    ListarResulApurMensalDifResponse mappingResponse(String response);
