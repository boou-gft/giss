package br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarContasTipoServico
 * </p>
 * 
 ...
 */
public class ListarContasTipoServicoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarContasTipoServicoPDCAdapter, IListarContasTipoServicoAdapterMapping {
     ...
     */
    public ListarContasTipoServicoResponse invokeProcess(ListarContasTipoServicoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.IListarContasTipoServicoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.request.ListarContasTipoServicoRequest)
     * @param message Objeto do tipo ListarContasTipoServicoRequest 
     ...
     * @return Objeto do tipo ListarContasTipoServicoResponse 
     ...
     */
    private ListarContasTipoServicoResponse invokeProcess(
            ListarContasTipoServicoRequest message, 
     ...
     */
    public String mappingRequest(ListarContasTipoServicoRequest message) {
     ...
     * objeto do tipo ListarContasTipoServicoResponse.
     * 
	 * @param response Objeto do tipo ListarContasTipoServicoResponse 
     ...
     */
    public ListarContasTipoServicoResponse mappingResponse(String response) {

        ListarContasTipoServicoResponse processResponse = new ListarContasTipoServicoResponse();
        try {
            
            processResponse = 
            	(ListarContasTipoServicoResponse) ListarContasTipoServicoResponse.
