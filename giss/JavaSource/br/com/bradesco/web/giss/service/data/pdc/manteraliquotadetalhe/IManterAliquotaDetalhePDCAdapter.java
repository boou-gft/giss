 ...
 */
public interface IManterAliquotaDetalhePDCAdapter {
     ...
     */
    ManterAliquotaDetalheResponse invokeProcess(ManterAliquotaDetalheRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ManterAliquotaDetalheResponse invokeProcess(ManterAliquotaDetalheRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ManterAliquotaDetalheResponse[] invokeProcess(ManterAliquotaDetalheRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ManterAliquotaDetalheResponse[] invokeProcess(ManterAliquotaDetalheRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
