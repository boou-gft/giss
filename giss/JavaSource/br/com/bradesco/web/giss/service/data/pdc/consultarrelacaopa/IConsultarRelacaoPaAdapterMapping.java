 ...
 */
public interface IConsultarRelacaoPaAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarRelacaoPaRequest message);
     ...
     */
    ConsultarRelacaoPaResponse mappingResponse(String response);
