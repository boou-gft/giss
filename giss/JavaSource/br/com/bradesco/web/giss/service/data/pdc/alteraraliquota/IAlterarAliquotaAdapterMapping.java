 ...
 */
public interface IAlterarAliquotaAdapterMapping {
     ...
     */
    String mappingRequest(AlterarAliquotaRequest message);
     ...
     */
    AlterarAliquotaResponse mappingResponse(String response);
