 ...
 */
public interface IProcessarRetificadorContabilPDCAdapter {
     ...
     */
    ProcessarRetificadorContabilResponse invokeProcess(ProcessarRetificadorContabilRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ProcessarRetificadorContabilResponse invokeProcess(ProcessarRetificadorContabilRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     ProcessarRetificadorContabilResponse[] invokeProcess(ProcessarRetificadorContabilRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ProcessarRetificadorContabilResponse[] invokeProcess(ProcessarRetificadorContabilRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
