 ...
 * Schema.
 * $Id: OcorrenciasMunicipioNovos.java,v 1.3 2017/06/05 15:24:44 gmichelini Exp $
 */
 ...
 * 
 * @version $Revision: 1.3 $ $Date: 2017/06/05 15:24:44 $
 */
public class OcorrenciasMunicipioNovos implements java.io.Serializable {
    ...
    public OcorrenciasMunicipioNovos() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.response.OcorrenciasMunicipioNovos()
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.response.OcorrenciasMunicipioNovos unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.response.OcorrenciasMunicipioNovos) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.response.OcorrenciasMunicipioNovos.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.response.OcorrenciasMunicipioNovos unmarshal(java.io.Reader) 
