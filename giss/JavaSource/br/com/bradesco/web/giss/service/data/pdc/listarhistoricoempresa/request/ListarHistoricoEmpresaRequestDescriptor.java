...
/**
 * Class ListarHistoricoEmpresaRequestDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ListarHistoricoEmpresaRequestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListarHistoricoEmpresaRequestDescriptor() 
     {
        super();
        xmlName = "listarHistoricoEmpresaRequest";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListarHistoricoEmpresaRequest target = (ListarHistoricoEmpresaRequest) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _cnpjEmpresa
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(long.class, "_cnpjEmpresa", "cnpjEmpresa", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ListarHistoricoEmpresaRequest target = (ListarHistoricoEmpresaRequest) object;
                if(!target.hasCnpjEmpresa())
                    return null;
                return new java.lang.Long(target.getCnpjEmpresa());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setCnpjEmpresa( ((java.lang.Long)value).longValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _cnpjEmpresa
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarhistoricoempresa.request.ListarHistoricoEmpresaRequestDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarhistoricoempresa.request.ListarHistoricoEmpresaRequest.class;
