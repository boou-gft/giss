 ...
 */
public interface IListarDependenciaPlanilhaApuracaoAdapterMapping {
     ...
     */
    String mappingRequest(ListarDependenciaPlanilhaApuracaoRequest message);
     ...
     */
    ListarDependenciaPlanilhaApuracaoResponse mappingResponse(String response);
