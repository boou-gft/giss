 ...
 */
public interface IListarMunicipiosSemConvenioAdapterMapping {
     ...
     */
    String mappingRequest(ListarMunicipiosSemConvenioRequest message);
     ...
     */
    ListarMunicipiosSemConvenioResponse mappingResponse(String response);
