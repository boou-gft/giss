 ...
 * Schema.
 * $Id: ValidaInclusaoTipoIncidenciaRequest.java,v 1.1 2017/04/11 14:13:13 gmichelini Exp $
 */

package br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia.request;
...
/**
 * Class ValidaInclusaoTipoIncidenciaRequest.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:13:13 $
 */
public class ValidaInclusaoTipoIncidenciaRequest implements java.io.Serializable {
    ...
    public ValidaInclusaoTipoIncidenciaRequest() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia.request.ValidaInclusaoTipoIncidenciaRequest()
     ...
     * 
     * @param reader
     * @return ValidaInclusaoTipoIncidenciaRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia.request.ValidaInclusaoTipoIncidenciaRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia.request.ValidaInclusaoTipoIncidenciaRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia.request.ValidaInclusaoTipoIncidenciaRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.validainclusaotipoincidencia.request.ValidaInclusaoTipoIncidenciaRequest unmarshal(java.io.Reader) 
