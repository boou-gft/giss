 ...
 */
public interface IParametrizarMinMaxAliquotaAdapterMapping {
     ...
     */
    String mappingRequest(ParametrizarMinMaxAliquotaRequest message);
     ...
     */
    ParametrizarMinMaxAliquotaResponse mappingResponse(String response);
