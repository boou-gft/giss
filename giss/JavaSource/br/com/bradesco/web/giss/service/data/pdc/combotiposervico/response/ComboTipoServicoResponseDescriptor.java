 ...
 * Schema.
 * $Id: ComboTipoServicoResponseDescriptor.java,v 1.1 2017/04/11 14:11:18 gmichelini Exp $
 */
...
/**
 * Class ComboTipoServicoResponseDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:11:18 $
 */
public class ComboTipoServicoResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ComboTipoServicoResponseDescriptor() 
     {
        super();
        xmlName = "comboTipoServicoResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ComboTipoServicoResponse target = (ComboTipoServicoResponse) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _ocorrenciasList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.combotiposervico.response.Ocorrencias.class, "_ocorrenciasList", "ocorrencias", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ComboTipoServicoResponse target = (ComboTipoServicoResponse) object;
                    target.addOcorrencias( (br.com.bradesco.web.giss.service.data.pdc.combotiposervico.response.Ocorrencias) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.combotiposervico.response.Ocorrencias();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.combotiposervico.response.ComboTipoServicoResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.combotiposervico.response.ComboTipoServicoResponse.class;
