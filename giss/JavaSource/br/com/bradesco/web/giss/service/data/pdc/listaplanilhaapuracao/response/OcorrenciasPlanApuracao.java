...
public class OcorrenciasPlanApuracao implements java.io.Serializable {
     ...
     */
    private java.math.BigDecimal _aliquotaApuracao = new java.math.BigDecimal("0");
     ...
     */
    private java.math.BigDecimal _valorRedutorMes = new java.math.BigDecimal("0");

    /**
     * Field _valorTotalReceitaMes
     */
    private java.math.BigDecimal _valorTotalReceitaMes = new java.math.BigDecimal("0");

    /**
     * Field _valorTotalIssMes
     */
    private java.math.BigDecimal _valorTotalIssMes = new java.math.BigDecimal("0");
    ...
    public OcorrenciasPlanApuracao() 
     {
        super();
        setAliquotaApuracao(new java.math.BigDecimal("0"));
        setValorReceita(new java.math.BigDecimal("0"));
        setValorIss(new java.math.BigDecimal("0"));
        setValorRedutorMes(new java.math.BigDecimal("0"));
        setValorTotalReceitaMes(new java.math.BigDecimal("0"));
        setValorTotalIssMes(new java.math.BigDecimal("0"));
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao.response.OcorrenciasPlanApuracao()
     ...
     */
    public java.math.BigDecimal getAliquotaApuracao()
    {
        return this._aliquotaApuracao;
    } //-- java.math.BigDecimal getAliquotaApuracao() 
     ...
     */
    public java.math.BigDecimal getValorRedutorMes()
    {
        return this._valorRedutorMes;
    } //-- java.math.BigDecimal getValorRedutorMes() 
     ...
     */
    public java.math.BigDecimal getValorTotalIssMes()
    {
        return this._valorTotalIssMes;
    } //-- java.math.BigDecimal getValorTotalIssMes() 
     ...
     */
    public java.math.BigDecimal getValorTotalReceitaMes()
    {
        return this._valorTotalReceitaMes;
    } //-- java.math.BigDecimal getValorTotalReceitaMes() 
     ...
     */
    public void setAliquotaApuracao(java.math.BigDecimal aliquotaApuracao)
    {
        this._aliquotaApuracao = aliquotaApuracao;
    } //-- void setAliquotaApuracao(java.math.BigDecimal) 
     ...
     */
    public void setValorRedutorMes(java.math.BigDecimal valorRedutorMes)
    {
        this._valorRedutorMes = valorRedutorMes;
    } //-- void setValorRedutorMes(java.math.BigDecimal) 
     ...
     */
    public void setValorTotalIssMes(java.math.BigDecimal valorTotalIssMes)
    {
        this._valorTotalIssMes = valorTotalIssMes;
    } //-- void setValorTotalIssMes(java.math.BigDecimal) 
     ...
     */
    public void setValorTotalReceitaMes(java.math.BigDecimal valorTotalReceitaMes)
    {
        this._valorTotalReceitaMes = valorTotalReceitaMes;
    } //-- void setValorTotalReceitaMes(java.math.BigDecimal) 
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao.response.OcorrenciasPlanApuracao unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao.response.OcorrenciasPlanApuracao) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao.response.OcorrenciasPlanApuracao.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listaplanilhaapuracao.response.OcorrenciasPlanApuracao unmarshal(java.io.Reader) 
