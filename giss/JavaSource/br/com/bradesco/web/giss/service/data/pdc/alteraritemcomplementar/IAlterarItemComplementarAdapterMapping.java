 ...
 */
public interface IAlterarItemComplementarAdapterMapping {
     ...
     */
    String mappingRequest(AlterarItemComplementarRequest message);
     ...
     */
    AlterarItemComplementarResponse mappingResponse(String response);
