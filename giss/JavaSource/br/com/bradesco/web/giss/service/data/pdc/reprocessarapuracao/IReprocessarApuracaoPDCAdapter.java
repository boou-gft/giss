 ...
 */
public interface IReprocessarApuracaoPDCAdapter {
     ...
     */
    ReprocessarApuracaoResponse invokeProcess(ReprocessarApuracaoRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    ReprocessarApuracaoResponse invokeProcess(ReprocessarApuracaoRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
}
