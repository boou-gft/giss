 ...
 * Schema.
 * $Id: ListaCodLancamentoDescriptor.java,v 1.7 2018/05/17 18:47:17 gmichelini Exp $
 */
...
/**
 * Class ListaCodLancamentoDescriptor.
 * 
 * @version $Revision: 1.7 $ $Date: 2018/05/17 18:47:17 $
 */
public class ListaCodLancamentoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListaCodLancamentoDescriptor() 
     {
        super();
        xmlName = "listaCodLancamento";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListaCodLancamento target = (ListaCodLancamento) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _parametro
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Integer.TYPE, "_parametro", "parametro", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ListaCodLancamento target = (ListaCodLancamento) object;
                if(!target.hasParametro())
                    return null;
                return new java.lang.Integer(target.getParametro());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setParametro( ((java.lang.Integer)value).intValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _parametro
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            IntegerValidator typeValidator= new IntegerValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcodlancamento.response.ListaCodLancamentoDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarcodlancamento.response.ListaCodLancamento.class;
