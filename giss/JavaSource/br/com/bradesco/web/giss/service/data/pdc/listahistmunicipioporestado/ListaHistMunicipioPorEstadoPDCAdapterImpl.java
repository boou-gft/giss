 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaHistMunicipioPorEstado
 * </p>
 * 
 ...
 */
public class ListaHistMunicipioPorEstadoPDCAdapterImpl extends PdcBaseAdapter implements
        IListaHistMunicipioPorEstadoPDCAdapter, IListaHistMunicipioPorEstadoAdapterMapping {
     ...
     */
    public ListaHistMunicipioPorEstadoResponse invokeProcess(ListaHistMunicipioPorEstadoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListaHistMunicipioPorEstadoResponse invokeProcess(ListaHistMunicipioPorEstadoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListaHistMunicipioPorEstadoRequest 
     ...
     */
    private ListaHistMunicipioPorEstadoResponse invokeProcess(
            ListaHistMunicipioPorEstadoRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListaHistMunicipioPorEstadoResponse[] invokeProcess(ListaHistMunicipioPorEstadoRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListaHistMunicipioPorEstadoResponse[] invokeProcess(ListaHistMunicipioPorEstadoRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ListaHistMunicipioPorEstadoRequest message) {
     ...
     * objeto do tipo ListaHistMunicipioPorEstadoResponse.
     * 
	 * @param response Objeto do tipo ListaHistMunicipioPorEstadoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListaHistMunicipioPorEstadoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListaHistMunicipioPorEstadoResponse mappingResponse(String response) {

        ListaHistMunicipioPorEstadoResponse processResponse = new ListaHistMunicipioPorEstadoResponse();
        try {
            
            processResponse = 
            	(ListaHistMunicipioPorEstadoResponse) ListaHistMunicipioPorEstadoResponse.
