 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarDependenciasNovas
 * </p>
 * 
 ...
 */
public class ListarDependenciasNovasPDCAdapterImpl extends PdcBaseAdapter implements
        IListarDependenciasNovasPDCAdapter, IListarDependenciasNovasAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listardependenciasnovas.IListarDependenciasNovasPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listardependenciasnovas.request.ListarDependenciasNovasRequest)
     * @param message Objeto do tipo ListarDependenciasNovasRequest 
     ...
     */
    public ListarDependenciasNovasResponse invokeProcess(
            ListarDependenciasNovasRequest message) 
     ...
     */
    public String mappingRequest(ListarDependenciasNovasRequest message) {
     ...
     * objeto do tipo ListarDependenciasNovasResponse.
     * 
	 * @param response Objeto do tipo ListarDependenciasNovasResponse 
     ...
     */
    public ListarDependenciasNovasResponse mappingResponse(String response) {

        ListarDependenciasNovasResponse processResponse = new ListarDependenciasNovasResponse();
        try {
            
            processResponse = 
            	(ListarDependenciasNovasResponse) ListarDependenciasNovasResponse.
