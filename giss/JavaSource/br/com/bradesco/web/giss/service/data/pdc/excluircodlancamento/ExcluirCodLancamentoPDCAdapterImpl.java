package br.com.bradesco.web.giss.service.data.pdc.excluircodlancamento;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirCodLancamento
 * </p>
 * 
 ...
 */
public class ExcluirCodLancamentoPDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirCodLancamentoPDCAdapter, IExcluirCodLancamentoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.excluircodlancamento.IExcluirCodLancamentoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.excluircodlancamento.request.ExcluirCodLancamentoRequest)
     * @param message Objeto do tipo ExcluirCodLancamentoRequest 
     ...
     * @return Objeto do tipo ExcluirCodLancamentoResponse 
     ...
     */
    public ExcluirCodLancamentoResponse invokeProcess(
            ExcluirCodLancamentoRequest message) 
     ...
     */
    public String mappingRequest(ExcluirCodLancamentoRequest message) {
     ...
     * objeto do tipo ExcluirCodLancamentoResponse.
     * 
	 * @param response Objeto do tipo ExcluirCodLancamentoResponse 
     ...
     */
    public ExcluirCodLancamentoResponse mappingResponse(String response) {

        ExcluirCodLancamentoResponse processResponse = new ExcluirCodLancamentoResponse();
        try {
            
            processResponse = 
            	(ExcluirCodLancamentoResponse) ExcluirCodLancamentoResponse.
