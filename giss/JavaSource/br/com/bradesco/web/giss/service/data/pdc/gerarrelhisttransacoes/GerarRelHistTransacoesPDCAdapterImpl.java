 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: GerarRelHistTransacoes
 * </p>
 * 
 ...
 */
public class GerarRelHistTransacoesPDCAdapterImpl extends PdcBaseAdapter implements
        IGerarRelHistTransacoesPDCAdapter, IGerarRelHistTransacoesAdapterMapping {
     ...
     */
    public GerarRelHistTransacoesResponse invokeProcess(GerarRelHistTransacoesRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.gerarrelhisttransacoes.IGerarRelHistTransacoesPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.gerarrelhisttransacoes.request.GerarRelHistTransacoesRequest)
     * @param message Objeto do tipo GerarRelHistTransacoesRequest 
     ...
     */
    private GerarRelHistTransacoesResponse invokeProcess(
            GerarRelHistTransacoesRequest message, 
     ...
     */
    public String mappingRequest(GerarRelHistTransacoesRequest message) {
     ...
     * objeto do tipo GerarRelHistTransacoesResponse.
     * 
	 * @param response Objeto do tipo GerarRelHistTransacoesResponse 
     ...
     */
    public GerarRelHistTransacoesResponse mappingResponse(String response) {

        GerarRelHistTransacoesResponse processResponse = new GerarRelHistTransacoesResponse();
        try {
            
            processResponse = 
            	(GerarRelHistTransacoesResponse) GerarRelHistTransacoesResponse.
