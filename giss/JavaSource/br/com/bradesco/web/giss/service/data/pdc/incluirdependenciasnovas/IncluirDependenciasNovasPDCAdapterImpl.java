package br.com.bradesco.web.giss.service.data.pdc.incluirdependenciasnovas;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirDependenciasNovas
 * </p>
 * 
 ...
 */
public class IncluirDependenciasNovasPDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirDependenciasNovasPDCAdapter, IIncluirDependenciasNovasAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.incluirdependenciasnovas.IIncluirDependenciasNovasPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.incluirdependenciasnovas.request.IncluirDependenciasNovasRequest)
     * @param message Objeto do tipo IncluirDependenciasNovasRequest 
     ...
     * @return Objeto do tipo IncluirDependenciasNovasResponse 
     ...
     */
    public IncluirDependenciasNovasResponse invokeProcess(
            IncluirDependenciasNovasRequest message) 
     ...
     */
    public String mappingRequest(IncluirDependenciasNovasRequest message) {
     ...
     * objeto do tipo IncluirDependenciasNovasResponse.
     * 
	 * @param response Objeto do tipo IncluirDependenciasNovasResponse 
     ...
     */
    public IncluirDependenciasNovasResponse mappingResponse(String response) {

        IncluirDependenciasNovasResponse processResponse = new IncluirDependenciasNovasResponse();
        try {
            
            processResponse = 
            	(IncluirDependenciasNovasResponse) IncluirDependenciasNovasResponse.
