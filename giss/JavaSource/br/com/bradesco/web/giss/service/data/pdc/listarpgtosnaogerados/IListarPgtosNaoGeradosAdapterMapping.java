 ...
 */
public interface IListarPgtosNaoGeradosAdapterMapping {
     ...
     */
    String mappingRequest(ListarPgtosNaoGeradosRequest message);
     ...
     */
    ListarPgtosNaoGeradosResponse mappingResponse(String response);
