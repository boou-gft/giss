 ...
 * Schema.
 * $Id: OcorrenciasMunManter.java,v 1.3 2017/06/05 16:32:35 gmichelini Exp $
 */
 ...
 * 
 * @version $Revision: 1.3 $ $Date: 2017/06/05 16:32:35 $
 */
public class OcorrenciasMunManter implements java.io.Serializable {
    ...
    public OcorrenciasMunManter() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanter.response.OcorrenciasMunManter()
     ...
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanter.response.OcorrenciasMunManter unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanter.response.OcorrenciasMunManter) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanter.response.OcorrenciasMunManter.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listamunicipiosestadomanter.response.OcorrenciasMunManter unmarshal(java.io.Reader) 
