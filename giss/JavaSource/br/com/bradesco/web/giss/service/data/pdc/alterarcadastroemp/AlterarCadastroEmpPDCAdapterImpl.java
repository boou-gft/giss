package br.com.bradesco.web.giss.service.data.pdc.alterarcadastroemp;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AlterarCadastroEmp
 * </p>
 * 
 ...
 */
public class AlterarCadastroEmpPDCAdapterImpl extends PdcBaseAdapter implements
        IAlterarCadastroEmpPDCAdapter, IAlterarCadastroEmpAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.alterarcadastroemp.IAlterarCadastroEmpPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.alterarcadastroemp.request.AlterarCadastroEmpRequest)
     * @param message Objeto do tipo AlterarCadastroEmpRequest 
     ...
     * @return Objeto do tipo AlterarCadastroEmpResponse 
     ...
     */
    public AlterarCadastroEmpResponse invokeProcess(
            AlterarCadastroEmpRequest message) 
     ...
     */
    public String mappingRequest(AlterarCadastroEmpRequest message) {
     ...
     * objeto do tipo AlterarCadastroEmpResponse.
     * 
	 * @param response Objeto do tipo AlterarCadastroEmpResponse 
     ...
     */
    public AlterarCadastroEmpResponse mappingResponse(String response) {

        AlterarCadastroEmpResponse processResponse = new AlterarCadastroEmpResponse();
        try {
            
            processResponse = 
            	(AlterarCadastroEmpResponse) AlterarCadastroEmpResponse.
