 ...
 * Schema.
 * $Id: OcorrenciasDescriptor.java,v 1.1 2017/04/11 14:10:26 gmichelini Exp $
 */
...
public class OcorrenciasDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.piloto.service.data.pdc.listartiposervico.response.OcorrenciasDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listartiposervico.response.Ocorrencias.class;
