package br.com.bradesco.web.giss.service.data.pdc.listarresultmunnovosall;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarResultMunNovosAll
 * </p>
 * 
 ...
 */
public class ListarResultMunNovosAllPDCAdapterImpl extends PdcBaseAdapter implements
        IListarResultMunNovosAllPDCAdapter, IListarResultMunNovosAllAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarresultmunnovosall.IListarResultMunNovosAllPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarresultmunnovosall.request.ListarResultMunNovosAllRequest)
     * @param message Objeto do tipo ListarResultMunNovosAllRequest 
     ...
     * @return Objeto do tipo ListarResultMunNovosAllResponse 
     ...
     */
    public ListarResultMunNovosAllResponse invokeProcess(
            ListarResultMunNovosAllRequest message) 
     ...
     */
    public String mappingRequest(ListarResultMunNovosAllRequest message) {
     ...
     * objeto do tipo ListarResultMunNovosAllResponse.
     * 
	 * @param response Objeto do tipo ListarResultMunNovosAllResponse 
     ...
     */
    public ListarResultMunNovosAllResponse mappingResponse(String response) {

        ListarResultMunNovosAllResponse processResponse = new ListarResultMunNovosAllResponse();
        try {
            
            processResponse = 
            	(ListarResultMunNovosAllResponse) ListarResultMunNovosAllResponse.
