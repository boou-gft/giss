package br.com.bradesco.web.giss.service.data.pdc.consultardependenciaaliquotazerada;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarDependenciaAliquotaZerada
 * </p>
 * 
 ...
 */
public class ConsultarDependenciaAliquotaZeradaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarDependenciaAliquotaZeradaPDCAdapter, IConsultarDependenciaAliquotaZeradaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultardependenciaaliquotazerada.IConsultarDependenciaAliquotaZeradaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultardependenciaaliquotazerada.request.ConsultarDependenciaAliquotaZeradaRequest)
     * @param message Objeto do tipo ConsultarDependenciaAliquotaZeradaRequest 
     ...
     * @return Objeto do tipo ConsultarDependenciaAliquotaZeradaResponse 
     ...
     */
    public ConsultarDependenciaAliquotaZeradaResponse invokeProcess(
            ConsultarDependenciaAliquotaZeradaRequest message) 
     ...
     */
    public String mappingRequest(ConsultarDependenciaAliquotaZeradaRequest message) {
     ...
     * objeto do tipo ConsultarDependenciaAliquotaZeradaResponse.
     * 
	 * @param response Objeto do tipo ConsultarDependenciaAliquotaZeradaResponse 
     ...
     */
    public ConsultarDependenciaAliquotaZeradaResponse mappingResponse(String response) {

        ConsultarDependenciaAliquotaZeradaResponse processResponse = new ConsultarDependenciaAliquotaZeradaResponse();
        try {
            
            processResponse = 
            	(ConsultarDependenciaAliquotaZeradaResponse) ConsultarDependenciaAliquotaZeradaResponse.
