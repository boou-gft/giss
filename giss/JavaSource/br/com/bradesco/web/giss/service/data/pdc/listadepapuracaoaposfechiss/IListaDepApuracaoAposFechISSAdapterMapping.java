 ...
 */
public interface IListaDepApuracaoAposFechISSAdapterMapping {
     ...
     */
    String mappingRequest(ListaDepApuracaoAposFechISSRequest message);
     ...
     */
    ListaDepApuracaoAposFechISSResponse mappingResponse(String response);
