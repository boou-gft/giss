 ...
 */
public interface IConsultaApuracaoPaAdapterMapping {
     ...
     */
    String mappingRequest(ConsultaApuracaoPaRequest message);
     ...
     */
    ConsultaApuracaoPaResponse mappingResponse(String response);
