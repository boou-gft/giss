package br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosbalancetes;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarMunicipiosBalancetes
 * </p>
 * 
 ...
 */
public class ListarMunicipiosBalancetesPDCAdapterImpl extends PdcBaseAdapter implements
        IListarMunicipiosBalancetesPDCAdapter, IListarMunicipiosBalancetesAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarempresa.IListarMunicipiosBalancetesPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarempresa.request.ListarMunicipiosBalancetesRequest)
     * @param message Objeto do tipo ListarMunicipiosBalancetesRequest 
     ...
     * @return Objeto do tipo ListarMunicipiosBalancetesResponse 
     ...
     */
    public ListarMunicipiosBalancetesResponse invokeProcess(
            ListarMunicipiosBalancetesRequest message) 
     ...
     */
    public String mappingRequest(ListarMunicipiosBalancetesRequest message) {
     ...
     * objeto do tipo ListarMunicipiosBalancetesResponse.
     * 
	 * @param response Objeto do tipo ListarMunicipiosBalancetesResponse 
     ...
     */
    public ListarMunicipiosBalancetesResponse mappingResponse(String response) {

        ListarMunicipiosBalancetesResponse processResponse = new ListarMunicipiosBalancetesResponse();
        try {
            
            processResponse = 
            	(ListarMunicipiosBalancetesResponse) ListarMunicipiosBalancetesResponse.
