package br.com.bradesco.web.giss.service.data.pdc.listardependenciashistoricas;
...
import br.com.bradesco.web.giss.service.data.pdc.listardependenciashistoricas.response.ListarDependenciasHistoricasResponse;
import br.com.bradesco.web.giss.service.data.pdc.listardependenciashistoricas.request.ListarDependenciasHistoricasRequest;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarDependenciasHistoricas
 * </p>
 * 
 ...
 */
public class ListarDependenciasHistoricasPDCAdapterImpl extends PdcBaseAdapter implements
        IListarDependenciasHistoricasPDCAdapter, IListarDependenciasHistoricasAdapterMapping {
     ...
     */
    public ListarDependenciasHistoricasResponse invokeProcess(ListarDependenciasHistoricasRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listardependenciashistoricas.IListarDependenciasHistoricasPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listardependenciashistoricas.request.ListarDependenciasHistoricasRequest)
     * @param message Objeto do tipo ListarDependenciasHistoricasRequest 
     ...
     * @return Objeto do tipo ListarDependenciasHistoricasResponse 
     ...
     */
    private ListarDependenciasHistoricasResponse invokeProcess(
            ListarDependenciasHistoricasRequest message, 
     ...
     */
    public String mappingRequest(ListarDependenciasHistoricasRequest message) {
     ...
     * objeto do tipo ListarDependenciasHistoricasResponse.
     * 
	 * @param response Objeto do tipo ListarDependenciasHistoricasResponse 
     ...
     */
    public ListarDependenciasHistoricasResponse mappingResponse(String response) {

        ListarDependenciasHistoricasResponse processResponse = new ListarDependenciasHistoricasResponse();
        try {
            
            processResponse = 
            	(ListarDependenciasHistoricasResponse) ListarDependenciasHistoricasResponse.
