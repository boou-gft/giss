 ...
 * Schema.
 * $Id: OcorrenciasDescriptor.java,v 1.3 2017/12/14 16:00:43 gabrielmarani Exp $
 */
 ...
 * 
 * @version $Revision: 1.3 $ $Date: 2017/12/14 16:00:43 $
 */
public class OcorrenciasDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _percentualAliquota
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.math.BigDecimal.class, "_percentualAliquota", "percentualAliquota", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Ocorrencias target = (Ocorrencias) object;
                return target.getPercentualAliquota();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Ocorrencias target = (Ocorrencias) object;
                    target.setPercentualAliquota( (java.math.BigDecimal) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.response.OcorrenciasDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarcontastiposervico.response.Ocorrencias.class;
