package br.com.bradesco.web.giss.service.data.pdc.listarplanilhaapuracao;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarPlanilhaApuracao
 * </p>
 * 
 ...
 */
public class ListarPlanilhaApuracaoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarPlanilhaApuracaoPDCAdapter, IListarPlanilhaApuracaoAdapterMapping {
     ...
     */
    public ListarPlanilhaApuracaoResponse invokeProcess(ListarPlanilhaApuracaoRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarplanilhaapuracao.IListarPlanilhaApuracaoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarplanilhaapuracao.request.ListarPlanilhaApuracaoRequest)
     * @param message Objeto do tipo ListarPlanilhaApuracaoRequest 
     ...
     * @return Objeto do tipo ListarPlanilhaApuracaoResponse 
     ...
     */
    private ListarPlanilhaApuracaoResponse invokeProcess(
            ListarPlanilhaApuracaoRequest message, 
     ...
     */
    public String mappingRequest(ListarPlanilhaApuracaoRequest message) {
     ...
     * objeto do tipo ListarPlanilhaApuracaoResponse.
     * 
	 * @param response Objeto do tipo ListarPlanilhaApuracaoResponse 
     ...
     */
    public ListarPlanilhaApuracaoResponse mappingResponse(String response) {

        ListarPlanilhaApuracaoResponse processResponse = new ListarPlanilhaApuracaoResponse();
        try {
            
            processResponse = 
            	(ListarPlanilhaApuracaoResponse) ListarPlanilhaApuracaoResponse.
