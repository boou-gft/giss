package br.com.bradesco.web.giss.service.data.pdc.listarretificadorliberacao;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarRetificadorLiberacao
 * </p>
 * 
 ...
 */
public class ListarRetificadorLiberacaoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarRetificadorLiberacaoPDCAdapter, IListarRetificadorLiberacaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarRetificadorLiberacaoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ListarRetificadorLiberacaoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ListarRetificadorLiberacaoResponse invokeProcess(ListarRetificadorLiberacaoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarRetificadorLiberacaoResponse invokeProcess(ListarRetificadorLiberacaoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarRetificadorLiberacaoRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ListarRetificadorLiberacaoResponse 
     ...
     */
    private ListarRetificadorLiberacaoResponse invokeProcess(
            ListarRetificadorLiberacaoRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarRetificadorLiberacaoResponse[] invokeProcess(ListarRetificadorLiberacaoRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarRetificadorLiberacaoResponse[] invokeProcess(ListarRetificadorLiberacaoRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ListarRetificadorLiberacaoRequest message) {
     ...
     * objeto do tipo ListarRetificadorLiberacaoResponse.
     * 
	 * @param response Objeto do tipo ListarRetificadorLiberacaoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListarRetificadorLiberacaoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListarRetificadorLiberacaoResponse mappingResponse(String response) {

        ListarRetificadorLiberacaoResponse processResponse = new ListarRetificadorLiberacaoResponse();
        try {
            
            processResponse = 
            	(ListarRetificadorLiberacaoResponse) ListarRetificadorLiberacaoResponse.
