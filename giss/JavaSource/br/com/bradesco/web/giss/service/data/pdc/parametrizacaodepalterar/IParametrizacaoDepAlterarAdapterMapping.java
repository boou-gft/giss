 ...
 */
public interface IParametrizacaoDepAlterarAdapterMapping {
     ...
     */
    String mappingRequest(ParametrizacaoDepAlterarRequest message);
     ...
     */
    ParametrizacaoDepAlterarResponse mappingResponse(String response);
