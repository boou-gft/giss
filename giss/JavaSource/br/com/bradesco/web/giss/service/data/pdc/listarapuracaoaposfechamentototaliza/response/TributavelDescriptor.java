 ...
 * Schema.
 * $Id: TributavelDescriptor.java,v 1.1 2017/04/11 14:10:17 gmichelini Exp $
 */
...
/**
 * Class TributavelDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:10:17 $
 */
public class TributavelDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TributavelDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Tributavel target = (Tributavel) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarapuracaoaposfechamentototaliza.response.TributavelDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarapuracaoaposfechamentototaliza.response.Tributavel.class;
