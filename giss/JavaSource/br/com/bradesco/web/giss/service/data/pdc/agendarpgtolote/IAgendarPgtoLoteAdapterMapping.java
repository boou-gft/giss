 ...
 */
public interface IAgendarPgtoLoteAdapterMapping {
     ...
     */
    String mappingRequest(AgendarPgtoLoteRequest message);
     ...
     */
    AgendarPgtoLoteResponse mappingResponse(String response);
