 ...
 */
public interface IConsultarTipoIncidenciaAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarTipoIncidenciaRequest message);
     ...
     */
    ConsultarTipoIncidenciaResponse mappingResponse(String response);
