 ...
 */
public interface IProcessarRetificadorContabilAdapterMapping {
     ...
     */
    String mappingRequest(ProcessarRetificadorContabilRequest message);
     ...
     */
    ProcessarRetificadorContabilResponse mappingResponse(String response);
