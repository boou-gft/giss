package br.com.bradesco.web.giss.service.data.pdc.listarconciliacaoapuracaoloop;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarConciliacaoApuracaoLoop
 * </p>
 * 
 ...
 */
public class ListarConciliacaoApuracaoLoopPDCAdapterImpl extends PdcBaseAdapter implements
        IListarConciliacaoApuracaoLoopPDCAdapter, IListarConciliacaoApuracaoLoopAdapterMapping {
     ...
     */
    public ListarConciliacaoApuracaoLoopResponse invokeProcess(ListarConciliacaoApuracaoLoopRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarconciliacaoapuracaoloop.IListarConciliacaoApuracaoLoopPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarconciliacaoapuracaoloop.request.ListarConciliacaoApuracaoLoopRequest)
     * @param message Objeto do tipo ListarConciliacaoApuracaoLoopRequest 
     ...
     * @return Objeto do tipo ListarConciliacaoApuracaoLoopResponse 
     ...
     */
    private ListarConciliacaoApuracaoLoopResponse invokeProcess(
            ListarConciliacaoApuracaoLoopRequest message, 
     ...
     */
    public String mappingRequest(ListarConciliacaoApuracaoLoopRequest message) {
     ...
     * objeto do tipo ListarConciliacaoApuracaoLoopResponse.
     * 
	 * @param response Objeto do tipo ListarConciliacaoApuracaoLoopResponse 
     ...
     */
    public ListarConciliacaoApuracaoLoopResponse mappingResponse(String response) {

        ListarConciliacaoApuracaoLoopResponse processResponse = new ListarConciliacaoApuracaoLoopResponse();
        try {
            
            processResponse = 
            	(ListarConciliacaoApuracaoLoopResponse) ListarConciliacaoApuracaoLoopResponse.
