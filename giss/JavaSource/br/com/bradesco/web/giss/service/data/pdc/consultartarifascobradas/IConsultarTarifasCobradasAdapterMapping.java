 ...
 */
public interface IConsultarTarifasCobradasAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarTarifasCobradasRequest message);
     ...
     */
    ConsultarTarifasCobradasResponse mappingResponse(String response);
