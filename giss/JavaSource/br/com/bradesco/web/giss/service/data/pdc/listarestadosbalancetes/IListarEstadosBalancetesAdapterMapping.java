 ...
 */
public interface IListarEstadosBalancetesAdapterMapping {
     ...
     */
    String mappingRequest(ListarEstadosBalancetesRequest message);
     ...
     */
    ListarEstadosBalancetesResponse mappingResponse(String response);
