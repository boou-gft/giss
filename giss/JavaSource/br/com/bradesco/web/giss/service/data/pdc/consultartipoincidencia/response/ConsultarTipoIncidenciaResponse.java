 ...
 * Schema.
 * $Id: ConsultarTipoIncidenciaResponse.java,v 1.1 2017/04/11 14:08:48 gmichelini Exp $
 */

package br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response;
...
/**
 * Class ConsultarTipoIncidenciaResponse.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:08:48 $
 */
public class ConsultarTipoIncidenciaResponse implements java.io.Serializable {
    ...
    public ConsultarTipoIncidenciaResponse() 
     {
        super();
        _ocorrenciasList = new Vector();
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.ConsultarTipoIncidenciaResponse()
     ...
     * @param vOcorrencias
     */
    public void addOcorrencias(br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias vOcorrencias)
        throws java.lang.IndexOutOfBoundsException
    {
        _ocorrenciasList.addElement(vOcorrencias);
    } //-- void addOcorrencias(br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias) 
     ...
     * @param vOcorrencias
     */
    public void addOcorrencias(int index, br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias vOcorrencias)
        throws java.lang.IndexOutOfBoundsException
    {
        _ocorrenciasList.insertElementAt(vOcorrencias, index);
    } //-- void addOcorrencias(int, br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias) 
     ...
     * @return Ocorrencias
     */
    public br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias getOcorrencias(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias) _ocorrenciasList.elementAt(index);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias getOcorrencias(int) 
     ...
     * @return Ocorrencias
     */
    public br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias[] getOcorrencias()
    {
        int size = _ocorrenciasList.size();
        br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias[] mArray = new br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias) _ocorrenciasList.elementAt(index);
        }
        return mArray;
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias[] getOcorrencias() 
     ...
     * @return Ocorrencias
     */
    public br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias removeOcorrencias(int index)
    {
        java.lang.Object obj = _ocorrenciasList.elementAt(index);
        _ocorrenciasList.removeElementAt(index);
        return (br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias) obj;
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias removeOcorrencias(int) 
     ...
     * @param vOcorrencias
     */
    public void setOcorrencias(int index, br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias vOcorrencias)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _ocorrenciasList.size())) {
    ...
    } //-- void setOcorrencias(int, br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias) 
     ...
     */
    public void setOcorrencias(br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias[] ocorrenciasArray)
    {
        //-- copy array
        _ocorrenciasList.removeAllElements();
    ...
    } //-- void setOcorrencias(br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.Ocorrencias) 
     ...
     * 
     * @param reader
     * @return ConsultarTipoIncidenciaResponse
     */
    public static br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.ConsultarTipoIncidenciaResponse unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.ConsultarTipoIncidenciaResponse) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.ConsultarTipoIncidenciaResponse.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultartipoincidencia.response.ConsultarTipoIncidenciaResponse unmarshal(java.io.Reader) 
