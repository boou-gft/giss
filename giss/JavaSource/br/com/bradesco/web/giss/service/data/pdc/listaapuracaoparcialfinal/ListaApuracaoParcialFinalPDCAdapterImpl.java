 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListaApuracaoParcialFinal
 * </p>
 * 
 ...
 */
public class ListaApuracaoParcialFinalPDCAdapterImpl extends PdcBaseAdapter implements
        IListaApuracaoParcialFinalPDCAdapter, IListaApuracaoParcialFinalAdapterMapping {
     ...
     */
    public ListaApuracaoParcialFinalResponse invokeProcess(ListaApuracaoParcialFinalRequest message) {
     ...
     * M�todo Sobreescrito - Coment�rios: M�todo utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listaapuracaoparcialfinal.IListaApuracaoParcialFinalPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listaapuracaoparcialfinal.request.ListaApuracaoParcialFinalRequest)
     * @param message Objeto do tipo ListaApuracaoParcialFinalRequest 
     ...
     */
    private ListaApuracaoParcialFinalResponse invokeProcess(
            ListaApuracaoParcialFinalRequest message, 
     ...
     */
    public String mappingRequest(ListaApuracaoParcialFinalRequest message) {
     ...
     * objeto do tipo ListaApuracaoParcialFinalResponse.
     * 
	 * @param response Objeto do tipo ListaApuracaoParcialFinalResponse 
     ...
     */
    public ListaApuracaoParcialFinalResponse mappingResponse(String response) {

        ListaApuracaoParcialFinalResponse processResponse = new ListaApuracaoParcialFinalResponse();
        try {
            
            processResponse = 
            	(ListaApuracaoParcialFinalResponse) ListaApuracaoParcialFinalResponse.
