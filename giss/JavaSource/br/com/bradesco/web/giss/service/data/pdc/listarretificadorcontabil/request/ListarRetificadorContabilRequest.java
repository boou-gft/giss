...
/**
 * Class ListarRetificadorContabilRequest.
 * 
 * @version $Revision$ $Date$
 */
public class ListarRetificadorContabilRequest implements java.io.Serializable {
    ...
    public ListarRetificadorContabilRequest() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.request.ListarRetificadorContabilRequest()
     ...
     * 
     * @param reader
     * @return ListarRetificadorContabilRequest
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.request.ListarRetificadorContabilRequest unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.request.ListarRetificadorContabilRequest) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.request.ListarRetificadorContabilRequest.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarretificadorcontabil.request.ListarRetificadorContabilRequest unmarshal(java.io.Reader) 
