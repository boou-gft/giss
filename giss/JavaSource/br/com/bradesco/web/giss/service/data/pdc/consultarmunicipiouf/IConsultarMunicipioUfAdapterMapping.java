 ...
 */
public interface IConsultarMunicipioUfAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarMunicipioUfRequest message);
     ...
     */
    ConsultarMunicipioUfResponse mappingResponse(String response);
