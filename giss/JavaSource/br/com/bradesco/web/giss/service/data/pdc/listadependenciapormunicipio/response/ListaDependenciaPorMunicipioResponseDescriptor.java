...
/**
 * Class ListaDependenciaPorMunicipioResponseDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ListaDependenciaPorMunicipioResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListaDependenciaPorMunicipioResponseDescriptor() 
     {
        super();
        xmlName = "listaDependenciaPorMunicipioResponse";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListaDependenciaPorMunicipioResponse target = (ListaDependenciaPorMunicipioResponse) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _ocorrenciasDepPorMunicipioList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(br.com.bradesco.web.giss.service.data.pdc.listadependenciapormunicipio.response.OcorrenciasDepPorMunicipio.class, "_ocorrenciasDepPorMunicipioList", "OcorrenciasDepPorMunicipio", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ListaDependenciaPorMunicipioResponse target = (ListaDependenciaPorMunicipioResponse) object;
                return target.getOcorrenciasDepPorMunicipio();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ListaDependenciaPorMunicipioResponse target = (ListaDependenciaPorMunicipioResponse) object;
                    target.addOcorrenciasDepPorMunicipio( (br.com.bradesco.web.giss.service.data.pdc.listadependenciapormunicipio.response.OcorrenciasDepPorMunicipio) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new br.com.bradesco.web.giss.service.data.pdc.listadependenciapormunicipio.response.OcorrenciasDepPorMunicipio();
            }
        };
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        //-- validation code for: _ocorrenciasDepPorMunicipioList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listadependenciapormunicipio.response.ListaDependenciaPorMunicipioResponseDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listadependenciapormunicipio.response.ListaDependenciaPorMunicipioResponse.class;
