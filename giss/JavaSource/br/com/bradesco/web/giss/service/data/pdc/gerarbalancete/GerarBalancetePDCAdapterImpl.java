package br.com.bradesco.web.giss.service.data.pdc.gerarbalancete;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: GerarBalancete
 * </p>
 * 
 ...
 */
public class GerarBalancetePDCAdapterImpl extends PdcBaseAdapter implements
        IGerarBalancetePDCAdapter, IGerarBalanceteAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarempresa.IGerarBalancetePDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarempresa.request.GerarBalanceteRequest)
     * @param message Objeto do tipo GerarBalanceteRequest 
     ...
     * @return Objeto do tipo GerarBalanceteResponse 
     ...
     */
    public GerarBalanceteResponse invokeProcess(
            GerarBalanceteRequest message) 
     ...
     */
    public String mappingRequest(GerarBalanceteRequest message) {
     ...
     * objeto do tipo GerarBalanceteResponse.
     * 
	 * @param response Objeto do tipo GerarBalanceteResponse 
     ...
     */
    public GerarBalanceteResponse mappingResponse(String response) {

        GerarBalanceteResponse processResponse = new GerarBalanceteResponse();
        try {
            
            processResponse = 
            	(GerarBalanceteResponse) GerarBalanceteResponse.
