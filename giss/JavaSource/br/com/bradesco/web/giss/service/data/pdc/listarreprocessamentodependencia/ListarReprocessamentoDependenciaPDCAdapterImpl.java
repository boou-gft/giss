package br.com.bradesco.web.giss.service.data.pdc.listarreprocessamentodependencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarReprocessamentoDependencia
 * </p>
 * 
 ...
 */
public class ListarReprocessamentoDependenciaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarReprocessamentoDependenciaPDCAdapter, IListarReprocessamentoDependenciaAdapterMapping {
     ...
     */
    public ListarReprocessamentoDependenciaResponse invokeProcess(ListarReprocessamentoDependenciaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarreprocessamentodependencia.IListarReprocessamentoDependenciaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarreprocessamentodependencia.request.ListarReprocessamentoDependenciaRequest)
     * @param message Objeto do tipo ListarReprocessamentoDependenciaRequest 
     ...
     * @return Objeto do tipo ListarReprocessamentoDependenciaResponse 
     ...
     */
    private ListarReprocessamentoDependenciaResponse invokeProcess(
            ListarReprocessamentoDependenciaRequest message, 
     ...
     */
    public String mappingRequest(ListarReprocessamentoDependenciaRequest message) {
     ...
     * objeto do tipo ListarReprocessamentoDependenciaResponse.
     * 
	 * @param response Objeto do tipo ListarReprocessamentoDependenciaResponse 
     ...
     */
    public ListarReprocessamentoDependenciaResponse mappingResponse(String response) {

        ListarReprocessamentoDependenciaResponse processResponse = new ListarReprocessamentoDependenciaResponse();
        try {
            
            processResponse = 
            	(ListarReprocessamentoDependenciaResponse) ListarReprocessamentoDependenciaResponse.
