 ...
 * Schema.
 * $Id: OcorrenciasDescriptor.java,v 1.1 2017/04/11 14:08:51 gmichelini Exp $
 */
 ...
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:08:51 $
 */
public class OcorrenciasDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.consultarlistacontastiposervico.response.OcorrenciasDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.consultarlistacontastiposervico.response.Ocorrencias.class;
