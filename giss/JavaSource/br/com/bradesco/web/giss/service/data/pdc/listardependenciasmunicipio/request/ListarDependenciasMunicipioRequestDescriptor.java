...
/**
 * Class ListarDependenciasMunicipioRequestDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ListarDependenciasMunicipioRequestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListarDependenciasMunicipioRequestDescriptor() 
     {
        super();
        xmlName = "listarDependenciasMunicipioRequest";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListarDependenciasMunicipioRequest target = (ListarDependenciasMunicipioRequest) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _qtdDependenciasAtivas
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Integer.TYPE, "_qtdDependenciasAtivas", "qtdDependenciasAtivas", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ListarDependenciasMunicipioRequest target = (ListarDependenciasMunicipioRequest) object;
                if(!target.hasQtdDependenciasAtivas())
                    return null;
                return new java.lang.Integer(target.getQtdDependenciasAtivas());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setQtdDependenciasAtivas( ((java.lang.Integer)value).intValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _qtdDependenciasAtivas
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            IntegerValidator typeValidator= new IntegerValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listardependenciasmunicipio.request.ListarDependenciasMunicipioRequestDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listardependenciasmunicipio.request.ListarDependenciasMunicipioRequest.class;
