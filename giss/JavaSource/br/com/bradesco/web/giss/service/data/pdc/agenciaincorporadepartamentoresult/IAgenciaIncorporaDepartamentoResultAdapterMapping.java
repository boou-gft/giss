 ...
 */
public interface IAgenciaIncorporaDepartamentoResultAdapterMapping {
     ...
     */
    String mappingRequest(AgenciaIncorporaDepartamentoResultRequest message);
     ...
     */
    AgenciaIncorporaDepartamentoResultResponse mappingResponse(String response);
