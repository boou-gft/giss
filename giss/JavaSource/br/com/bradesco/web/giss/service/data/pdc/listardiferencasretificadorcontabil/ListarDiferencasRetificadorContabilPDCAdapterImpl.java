package br.com.bradesco.web.giss.service.data.pdc.listardiferencasretificadorcontabil;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarDiferencasRetificadorContabil
 * </p>
 * 
 ...
 */
public class ListarDiferencasRetificadorContabilPDCAdapterImpl extends PdcBaseAdapter implements
        IListarDiferencasRetificadorContabilPDCAdapter, IListarDiferencasRetificadorContabilAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarDiferencasRetificadorContabilRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ListarDiferencasRetificadorContabilResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ListarDiferencasRetificadorContabilResponse invokeProcess(ListarDiferencasRetificadorContabilRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ListarDiferencasRetificadorContabilResponse invokeProcess(ListarDiferencasRetificadorContabilRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ListarDiferencasRetificadorContabilRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ListarDiferencasRetificadorContabilResponse 
     ...
     */
    private ListarDiferencasRetificadorContabilResponse invokeProcess(
            ListarDiferencasRetificadorContabilRequest message, 
     ...
     */
    public String mappingRequest(ListarDiferencasRetificadorContabilRequest message) {
     ...
     * objeto do tipo ListarDiferencasRetificadorContabilResponse.
     * 
	 * @param response Objeto do tipo ListarDiferencasRetificadorContabilResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ListarDiferencasRetificadorContabilResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ListarDiferencasRetificadorContabilResponse mappingResponse(String response) {

        ListarDiferencasRetificadorContabilResponse processResponse = new ListarDiferencasRetificadorContabilResponse();
        try {
            
            processResponse = 
            	(ListarDiferencasRetificadorContabilResponse) ListarDiferencasRetificadorContabilResponse.
