 ...
 */
public interface IIncluirMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(IncluirMunicipioRequest message);
     ...
     */
    IncluirMunicipioResponse mappingResponse(String response);
