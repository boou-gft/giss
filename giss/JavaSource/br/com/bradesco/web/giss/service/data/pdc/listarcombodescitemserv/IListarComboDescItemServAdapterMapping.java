 ...
 */
public interface IListarComboDescItemServAdapterMapping {
     ...
     */
    String mappingRequest(ListarComboDescItemServRequest message);
     ...
     */
    ListarComboDescItemServResponse mappingResponse(String response);
