package br.com.bradesco.web.giss.service.data.pdc.consultarlupamunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarLupaMunicipio
 * </p>
 * 
 ...
 */
public class ConsultarLupaMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarLupaMunicipioPDCAdapter, IConsultarLupaMunicipioAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarlupamunicipio.IConsultarLupaMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarlupamunicipio.request.ConsultarLupaMunicipioRequest)
     * @param message Objeto do tipo ConsultarLupaMunicipioRequest 
     ...
     * @return Objeto do tipo ConsultarLupaMunicipioResponse 
     ...
     */
    public ConsultarLupaMunicipioResponse invokeProcess(
            ConsultarLupaMunicipioRequest message) 
     ...
     */
    public String mappingRequest(ConsultarLupaMunicipioRequest message) {
     ...
     * objeto do tipo ConsultarLupaMunicipioResponse.
     * 
	 * @param response Objeto do tipo ConsultarLupaMunicipioResponse 
     ...
     */
    public ConsultarLupaMunicipioResponse mappingResponse(String response) {

        ConsultarLupaMunicipioResponse processResponse = new ConsultarLupaMunicipioResponse();
        try {
            
            processResponse = 
            	(ConsultarLupaMunicipioResponse) ConsultarLupaMunicipioResponse.
