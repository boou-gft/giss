 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarComboRazao
 * </p>
 * 
 ...
 */
public class ListarComboRazaoPDCAdapterImpl extends PdcBaseAdapter implements
        IListarComboRazaoPDCAdapter, IListarComboRazaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarcomborazao.IListarComboRazaoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarcomborazao.request.ListarComboRazaoRequest)
     * @param message Objeto do tipo ListarComboRazaoRequest 
     ...
     */
    public ListarComboRazaoResponse invokeProcess(
            ListarComboRazaoRequest message) 
     ...
     */
    public String mappingRequest(ListarComboRazaoRequest message) {
     ...
     * objeto do tipo ListarComboRazaoResponse.
     * 
	 * @param response Objeto do tipo ListarComboRazaoResponse 
     ...
     */
    public ListarComboRazaoResponse mappingResponse(String response) {

        ListarComboRazaoResponse processResponse = new ListarComboRazaoResponse();
        try {
            
            processResponse = 
            	(ListarComboRazaoResponse) ListarComboRazaoResponse.
