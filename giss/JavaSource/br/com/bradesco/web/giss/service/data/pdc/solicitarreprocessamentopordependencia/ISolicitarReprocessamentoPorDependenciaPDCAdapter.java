 ...
 */
public interface ISolicitarReprocessamentoPorDependenciaPDCAdapter {
     ...
     */
    SolicitarReprocessamentoPorDependenciaResponse invokeProcess(SolicitarReprocessamentoPorDependenciaRequest request) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    SolicitarReprocessamentoPorDependenciaResponse invokeProcess(SolicitarReprocessamentoPorDependenciaRequest request, String stateID) 
    								throws PdcAdapterException, PdcConnectorException;
     ...
     */
     SolicitarReprocessamentoPorDependenciaResponse[] invokeProcess(SolicitarReprocessamentoPorDependenciaRequest request, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
    
    
    SolicitarReprocessamentoPorDependenciaResponse[] invokeProcess(SolicitarReprocessamentoPorDependenciaRequest request, String stateID, int numItensWeb, int numItensMF) 
    								throws PdcAdapterException, PdcConnectorException;
