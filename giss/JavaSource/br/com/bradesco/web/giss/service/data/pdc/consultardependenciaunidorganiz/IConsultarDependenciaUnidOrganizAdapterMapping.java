 ...
 */
public interface IConsultarDependenciaUnidOrganizAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarDependenciaUnidOrganizRequest message);
     ...
     */
    ConsultarDependenciaUnidOrganizResponse mappingResponse(String response);
