 ...
 */
public interface IExcluirCtaContabilAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirCtaContabilRequest message);
     ...
     */
    ExcluirCtaContabilResponse mappingResponse(String response);
