 ...
 */
public interface IProcessarContabilidadeAdapterMapping {
     ...
     */
    String mappingRequest(ProcessarContabilidadeRequest message);
     ...
     */
    ProcessarContabilidadeResponse mappingResponse(String response);
