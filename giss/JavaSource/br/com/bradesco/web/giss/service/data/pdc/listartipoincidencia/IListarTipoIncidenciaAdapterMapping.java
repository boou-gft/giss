 ...
 */
public interface IListarTipoIncidenciaAdapterMapping {
     ...
     */
    String mappingRequest(ListarTipoIncidenciaRequest message);
     ...
     */
    ListarTipoIncidenciaResponse mappingResponse(String response);
