 ...
 */
public interface IResultadoPesquisaOscilacaoNegativaAdapterMapping {
     ...
     */
    String mappingRequest(ResultadoPesquisaOscilacaoNegativaRequest message);
     ...
     */
    ResultadoPesquisaOscilacaoNegativaResponse mappingResponse(String response);
