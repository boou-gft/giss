 ...
 */
public interface IConsultarArquivoEmpSemanalAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarArquivoEmpSemanalRequest message);
     ...
     */
    ConsultarArquivoEmpSemanalResponse mappingResponse(String response);
