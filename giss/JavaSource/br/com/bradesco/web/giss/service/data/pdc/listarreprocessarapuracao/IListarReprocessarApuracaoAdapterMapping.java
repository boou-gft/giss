 ...
 */
public interface IListarReprocessarApuracaoAdapterMapping {
     ...
     */
    String mappingRequest(ListarReprocessarApuracaoRequest message);
     ...
     */
    ListarReprocessarApuracaoResponse mappingResponse(String response);
