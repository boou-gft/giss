 ...
 */
public interface IDetalharHistoricoEmpresaAdapterMapping {
     ...
     */
    String mappingRequest(DetalharHistoricoEmpresaRequest message);
     ...
     */
    DetalharHistoricoEmpresaResponse mappingResponse(String response);
