 ...
 */
public interface IGerarRelatorioApuracaoAdapterMapping {
     ...
     */
    String mappingRequest(GerarRelatorioApuracaoRequest message);
     ...
     */
    GerarRelatorioApuracaoResponse mappingResponse(String response);
