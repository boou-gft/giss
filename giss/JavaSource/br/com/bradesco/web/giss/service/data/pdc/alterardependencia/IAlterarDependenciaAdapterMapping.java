 ...
 */
public interface IAlterarDependenciaAdapterMapping {
     ...
     */
    String mappingRequest(AlterarDependenciaRequest message);
     ...
     */
    AlterarDependenciaResponse mappingResponse(String response);
