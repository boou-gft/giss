 ...
 */
public interface IListarMunicipiosBalancetesAdapterMapping {
     ...
     */
    String mappingRequest(ListarMunicipiosBalancetesRequest message);
     ...
     */
    ListarMunicipiosBalancetesResponse mappingResponse(String response);
