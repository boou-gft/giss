package br.com.bradesco.web.giss.service.data.pdc.consultarhistoricominmaxaliquota;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarHistoricoMinMaxAliquota
 * </p>
 * 
 ...
 */
public class ConsultarHistoricoMinMaxAliquotaPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarHistoricoMinMaxAliquotaPDCAdapter, IConsultarHistoricoMinMaxAliquotaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarhistoricominmaxaliquota.IConsultarHistoricoMinMaxAliquotaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarhistoricominmaxaliquota.request.ConsultarHistoricoMinMaxAliquotaRequest)
     * @param message Objeto do tipo ConsultarHistoricoMinMaxAliquotaRequest 
     ...
     * @return Objeto do tipo ConsultarHistoricoMinMaxAliquotaResponse 
     ...
     */
    public ConsultarHistoricoMinMaxAliquotaResponse invokeProcess(
            ConsultarHistoricoMinMaxAliquotaRequest message) 
     ...
     */
    public String mappingRequest(ConsultarHistoricoMinMaxAliquotaRequest message) {
     ...
     * objeto do tipo ConsultarHistoricoMinMaxAliquotaResponse.
     * 
	 * @param response Objeto do tipo ConsultarHistoricoMinMaxAliquotaResponse 
     ...
     */
    public ConsultarHistoricoMinMaxAliquotaResponse mappingResponse(String response) {

        ConsultarHistoricoMinMaxAliquotaResponse processResponse = new ConsultarHistoricoMinMaxAliquotaResponse();
        try {
            
            processResponse = 
            	(ConsultarHistoricoMinMaxAliquotaResponse) ConsultarHistoricoMinMaxAliquotaResponse.
