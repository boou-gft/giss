 ...
 * Schema.
 * $Id: ListarApuracaoReprocessamentoRequestDescriptor.java,v 1.1 2017/04/11 14:08:47 gmichelini Exp $
 */
...
/**
 * Class ListarApuracaoReprocessamentoRequestDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/04/11 14:08:47 $
 */
public class ListarApuracaoReprocessamentoRequestDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListarApuracaoReprocessamentoRequestDescriptor() 
     {
        super();
        xmlName = "listarApuracaoReprocessamentoRequest";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListarApuracaoReprocessamentoRequest target = (ListarApuracaoReprocessamentoRequest) object;
        ...
        //-- _nroSolicitacao
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Integer.TYPE, "_nroSolicitacao", "nroSolicitacao", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ListarApuracaoReprocessamentoRequest target = (ListarApuracaoReprocessamentoRequest) object;
                if(!target.hasNroSolicitacao())
                    return null;
                return new java.lang.Integer(target.getNroSolicitacao());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setNroSolicitacao( ((java.lang.Integer)value).intValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _nroSolicitacao
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            IntegerValidator typeValidator= new IntegerValidator();
        ...
        desc.setValidator(fieldValidator);
        //-- _nroSeqUndOrganizadora
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Integer.TYPE, "_nroSeqUndOrganizadora", "nroSeqUndOrganizadora", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ListarApuracaoReprocessamentoRequest target = (ListarApuracaoReprocessamentoRequest) object;
                if(!target.hasNroSeqUndOrganizadora())
                    return null;
                return new java.lang.Integer(target.getNroSeqUndOrganizadora());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setNroSeqUndOrganizadora( ((java.lang.Integer)value).intValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _nroSeqUndOrganizadora
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            IntegerValidator typeValidator= new IntegerValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarapuracaoreprocessamento.request.ListarApuracaoReprocessamentoRequestDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarapuracaoreprocessamento.request.ListarApuracaoReprocessamentoRequest.class;
