...
/**
 * Class ListaLiberarPagamentoDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ListaLiberarPagamentoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListaLiberarPagamentoDescriptor() 
     {
        super();
        xmlName = "listaLiberarPagamento";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListaLiberarPagamento target = (ListaLiberarPagamento) object;
                if(!target.hasAnoMes())
                    return null;
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.liberarpagamento.request.ListaLiberarPagamentoDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.liberarpagamento.request.ListaLiberarPagamento.class;
