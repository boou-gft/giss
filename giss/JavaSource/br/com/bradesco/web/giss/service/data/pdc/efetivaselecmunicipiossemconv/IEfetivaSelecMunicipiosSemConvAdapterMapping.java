 ...
 */
public interface IEfetivaSelecMunicipiosSemConvAdapterMapping {
     ...
     */
    String mappingRequest(EfetivaSelecMunicipiosSemConvRequest message);
     ...
     */
    EfetivaSelecMunicipiosSemConvResponse mappingResponse(String response);
