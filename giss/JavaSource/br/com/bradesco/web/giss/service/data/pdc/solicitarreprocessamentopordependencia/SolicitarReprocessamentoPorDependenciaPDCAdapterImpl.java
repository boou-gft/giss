package br.com.bradesco.web.giss.service.data.pdc.solicitarreprocessamentopordependencia;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: SolicitarReprocessamentoPorDependencia
 * </p>
 * 
 ...
 */
public class SolicitarReprocessamentoPorDependenciaPDCAdapterImpl extends PdcBaseAdapter implements
        ISolicitarReprocessamentoPorDependenciaPDCAdapter, ISolicitarReprocessamentoPorDependenciaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo SolicitarReprocessamentoPorDependenciaRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo SolicitarReprocessamentoPorDependenciaResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public SolicitarReprocessamentoPorDependenciaResponse invokeProcess(SolicitarReprocessamentoPorDependenciaRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarReprocessamentoPorDependenciaResponse invokeProcess(SolicitarReprocessamentoPorDependenciaRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo SolicitarReprocessamentoPorDependenciaRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo SolicitarReprocessamentoPorDependenciaResponse 
     ...
     */
    private SolicitarReprocessamentoPorDependenciaResponse invokeProcess(
            SolicitarReprocessamentoPorDependenciaRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarReprocessamentoPorDependenciaResponse[] invokeProcess(SolicitarReprocessamentoPorDependenciaRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public SolicitarReprocessamentoPorDependenciaResponse[] invokeProcess(SolicitarReprocessamentoPorDependenciaRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(SolicitarReprocessamentoPorDependenciaRequest message) {
     ...
     * objeto do tipo SolicitarReprocessamentoPorDependenciaResponse.
     * 
	 * @param response Objeto do tipo SolicitarReprocessamentoPorDependenciaResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo SolicitarReprocessamentoPorDependenciaResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public SolicitarReprocessamentoPorDependenciaResponse mappingResponse(String response) {

        SolicitarReprocessamentoPorDependenciaResponse processResponse = new SolicitarReprocessamentoPorDependenciaResponse();
        try {
            
            processResponse = 
            	(SolicitarReprocessamentoPorDependenciaResponse) SolicitarReprocessamentoPorDependenciaResponse.
