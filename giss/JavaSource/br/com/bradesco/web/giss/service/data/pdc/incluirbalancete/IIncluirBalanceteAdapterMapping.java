 ...
 */
public interface IIncluirBalanceteAdapterMapping {
     ...
     */
    String mappingRequest(IncluirBalanceteRequest message);
     ...
     */
    IncluirBalanceteResponse mappingResponse(String response);
