 ...
 */
public interface IParametrizacaoDepConsultarAdapterMapping {
     ...
     */
    String mappingRequest(ParametrizacaoDepConsultarRequest message);
     ...
     */
    ParametrizacaoDepConsultarResponse mappingResponse(String response);
