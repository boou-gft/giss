package br.com.bradesco.web.giss.service.data.pdc.detalharcargamassiva;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: DetalharCargaMassiva
 * </p>
 * 
 ...
 */
public class DetalharCargaMassivaPDCAdapterImpl extends PdcBaseAdapter implements
        IDetalharCargaMassivaPDCAdapter, IDetalharCargaMassivaAdapterMapping {
     ...
     */
    public DetalharCargaMassivaResponse invokeProcess(DetalharCargaMassivaRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.detalharcargamassiva.IDetalharCargaMassivaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.detalharcargamassiva.request.DetalharCargaMassivaRequest)
     * @param message Objeto do tipo DetalharCargaMassivaRequest 
     ...
     * @return Objeto do tipo DetalharCargaMassivaResponse 
	...
	private DetalharCargaMassivaResponse invokeProcess(
            DetalharCargaMassivaRequest message, 
     ...
     */
    public String mappingRequest(DetalharCargaMassivaRequest message) {
     ...
     * objeto do tipo DetalharCargaMassivaResponse.
     * 
	 * @param response Objeto do tipo DetalharCargaMassivaResponse 
     ...
     */
    public DetalharCargaMassivaResponse mappingResponse(String response) {

        DetalharCargaMassivaResponse processResponse = new DetalharCargaMassivaResponse();
        try {
            
            processResponse = 
            	(DetalharCargaMassivaResponse) DetalharCargaMassivaResponse.
