package br.com.bradesco.web.giss.service.data.pdc.listarapuracaofinalaposfechamentoiss;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarApuracaoFinalAposFechamentoISS
 * </p>
 * 
 ...
 */
public class ListarApuracaoFinalAposFechamentoISSPDCAdapterImpl extends PdcBaseAdapter implements
        IListarApuracaoFinalAposFechamentoISSPDCAdapter, IListarApuracaoFinalAposFechamentoISSAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarapuracaofinalaposfechamentoiss.IListarApuracaoFinalAposFechamentoISSPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarapuracaofinalaposfechamentoiss.request.ListarApuracaoFinalAposFechamentoISSRequest)
     * @param message Objeto do tipo ListarApuracaoFinalAposFechamentoISSRequest 
     ...
     * @return Objeto do tipo ListarApuracaoFinalAposFechamentoISSResponse 
     ...
     */
    public ListarApuracaoFinalAposFechamentoISSResponse invokeProcess(
            ListarApuracaoFinalAposFechamentoISSRequest message) 
     ...
     */
    public String mappingRequest(ListarApuracaoFinalAposFechamentoISSRequest message) {
     ...
     * objeto do tipo ListarApuracaoFinalAposFechamentoISSResponse.
     * 
	 * @param response Objeto do tipo ListarApuracaoFinalAposFechamentoISSResponse 
     ...
     */
    public ListarApuracaoFinalAposFechamentoISSResponse mappingResponse(String response) {

        ListarApuracaoFinalAposFechamentoISSResponse processResponse = new ListarApuracaoFinalAposFechamentoISSResponse();
        try {
            
            processResponse = 
            	(ListarApuracaoFinalAposFechamentoISSResponse) ListarApuracaoFinalAposFechamentoISSResponse.
