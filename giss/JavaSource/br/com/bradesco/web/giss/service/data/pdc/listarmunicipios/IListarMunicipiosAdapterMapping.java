 ...
 */
public interface IListarMunicipiosAdapterMapping {
     ...
     */
    String mappingRequest(ListarMunicipiosRequest message);
     ...
     */
    ListarMunicipiosResponse mappingResponse(String response);
