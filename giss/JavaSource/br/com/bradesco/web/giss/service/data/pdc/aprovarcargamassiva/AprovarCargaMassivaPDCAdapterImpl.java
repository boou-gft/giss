 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: AprovarCargaMassiva
 * </p>
 * 
 ...
 */
public class AprovarCargaMassivaPDCAdapterImpl extends PdcBaseAdapter implements
        IAprovarCargaMassivaPDCAdapter, IAprovarCargaMassivaAdapterMapping {
     ...
     */
    public AprovarCargaMassivaResponse invokeProcess(AprovarCargaMassivaRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public AprovarCargaMassivaResponse invokeProcess(AprovarCargaMassivaRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo AprovarCargaMassivaRequest 
     ...
     */
    private AprovarCargaMassivaResponse invokeProcess(
            AprovarCargaMassivaRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public AprovarCargaMassivaResponse[] invokeProcess(AprovarCargaMassivaRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public AprovarCargaMassivaResponse[] invokeProcess(AprovarCargaMassivaRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(AprovarCargaMassivaRequest message) {
     ...
     * objeto do tipo AprovarCargaMassivaResponse.
     * 
	 * @param response Objeto do tipo AprovarCargaMassivaResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo AprovarCargaMassivaResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public AprovarCargaMassivaResponse mappingResponse(String response) {

        AprovarCargaMassivaResponse processResponse = new AprovarCargaMassivaResponse();
        try {
            
            processResponse = 
            	(AprovarCargaMassivaResponse) AprovarCargaMassivaResponse.
