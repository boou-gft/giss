package br.com.bradesco.web.giss.service.data.pdc.consultardependenciaunidorganiz;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarDependenciaUnidOrganiz
 * </p>
 * 
 ...
 */
public class ConsultarDependenciaUnidOrganizPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarDependenciaUnidOrganizPDCAdapter, IConsultarDependenciaUnidOrganizAdapterMapping {
     ...
     */
    public ConsultarDependenciaUnidOrganizResponse invokeProcess(ConsultarDependenciaUnidOrganizRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultardependenciaunidorganiz.IConsultarDependenciaUnidOrganizPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultardependenciaunidorganiz.request.ConsultarDependenciaUnidOrganizRequest)
     * @param message Objeto do tipo ConsultarDependenciaUnidOrganizRequest 
     ...
     * @return Objeto do tipo ConsultarDependenciaUnidOrganizResponse 
     ...
     */
    private ConsultarDependenciaUnidOrganizResponse invokeProcess(
            ConsultarDependenciaUnidOrganizRequest message, 
     ...
     */
    public String mappingRequest(ConsultarDependenciaUnidOrganizRequest message) {
     ...
     * objeto do tipo ConsultarDependenciaUnidOrganizResponse.
     * 
	 * @param response Objeto do tipo ConsultarDependenciaUnidOrganizResponse 
     ...
     */
    public ConsultarDependenciaUnidOrganizResponse mappingResponse(String response) {

        ConsultarDependenciaUnidOrganizResponse processResponse = new ConsultarDependenciaUnidOrganizResponse();
        try {
            
            processResponse = 
            	(ConsultarDependenciaUnidOrganizResponse) ConsultarDependenciaUnidOrganizResponse.
