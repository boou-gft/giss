 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: GerarRelatorioApuracao
 * </p>
 * 
 ...
 */
public class GerarRelatorioApuracaoPDCAdapterImpl extends PdcBaseAdapter implements
        IGerarRelatorioApuracaoPDCAdapter, IGerarRelatorioApuracaoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.gerarrelatorioapuracao.IGerarRelatorioApuracaoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.gerarrelatorioapuracao.request.GerarRelatorioApuracaoRequest)
     * @param message Objeto do tipo GerarRelatorioApuracaoRequest 
     ...
     */
    public GerarRelatorioApuracaoResponse invokeProcess(
            GerarRelatorioApuracaoRequest message) 
     ...
     */
    public String mappingRequest(GerarRelatorioApuracaoRequest message) {
     ...
     * objeto do tipo GerarRelatorioApuracaoResponse.
     * 
	 * @param response Objeto do tipo GerarRelatorioApuracaoResponse 
     ...
     */
    public GerarRelatorioApuracaoResponse mappingResponse(String response) {

        GerarRelatorioApuracaoResponse processResponse = new GerarRelatorioApuracaoResponse();
        try {
            
            processResponse = 
            	(GerarRelatorioApuracaoResponse) GerarRelatorioApuracaoResponse.
