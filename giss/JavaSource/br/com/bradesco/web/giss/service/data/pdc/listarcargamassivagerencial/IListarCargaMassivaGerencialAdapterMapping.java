 ...
 */
public interface IListarCargaMassivaGerencialAdapterMapping {
     ...
     */
    String mappingRequest(ListarCargaMassivaGerencialRequest message);
     ...
     */
    ListarCargaMassivaGerencialResponse mappingResponse(String response);
