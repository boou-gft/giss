 ...
 */
public interface IListarComboCosifEmpAdapterMapping {
     ...
     */
    String mappingRequest(ListarComboCosifEmpRequest message);
     ...
     */
    ListarComboCosifEmpResponse mappingResponse(String response);
