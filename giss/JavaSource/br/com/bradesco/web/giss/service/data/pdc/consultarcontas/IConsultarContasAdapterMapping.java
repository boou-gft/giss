 ...
 */
public interface IConsultarContasAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarContasRequest message);
     ...
     */
    ConsultarContasResponse mappingResponse(String response);
