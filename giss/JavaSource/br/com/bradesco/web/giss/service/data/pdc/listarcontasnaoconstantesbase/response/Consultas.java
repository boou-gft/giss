 ...
 * Schema.
 * $Id: Consultas.java,v 1.1 2017/04/11 14:07:29 gmichelini Exp $
 */
...
public class Consultas implements java.io.Serializable {
    ...
    public Consultas() 
     {
        super();
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcontasnaoconstantesbase.response.Consultas()
     ...
     * @return Consultas
     */
    public static br.com.bradesco.web.giss.service.data.pdc.listarcontasnaoconstantesbase.response.Consultas unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (br.com.bradesco.web.giss.service.data.pdc.listarcontasnaoconstantesbase.response.Consultas) Unmarshaller.unmarshal(br.com.bradesco.web.giss.service.data.pdc.listarcontasnaoconstantesbase.response.Consultas.class, reader);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarcontasnaoconstantesbase.response.Consultas unmarshal(java.io.Reader) 
