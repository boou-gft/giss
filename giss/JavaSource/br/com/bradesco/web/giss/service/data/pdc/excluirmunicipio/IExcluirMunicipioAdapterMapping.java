 ...
 */
public interface IExcluirMunicipioAdapterMapping {
     ...
     */
    String mappingRequest(ExcluirMunicipioRequest message);
     ...
     */
    ExcluirMunicipioResponse mappingResponse(String response);
