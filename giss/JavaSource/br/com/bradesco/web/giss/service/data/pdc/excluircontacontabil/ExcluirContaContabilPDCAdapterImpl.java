package br.com.bradesco.web.giss.service.data.pdc.excluircontacontabil;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirContaContabil
 * </p>
 * 
 ...
 */
public class ExcluirContaContabilPDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirContaContabilPDCAdapter, IExcluirContaContabilAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.excluircontacontabil.IExcluirContaContabilPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.excluircontacontabil.request.ExcluirContaContabilRequest)
     * @param message Objeto do tipo ExcluirContaContabilRequest 
     ...
     * @return Objeto do tipo ExcluirContaContabilResponse 
     ...
     */
    public ExcluirContaContabilResponse invokeProcess(
            ExcluirContaContabilRequest message) 
     ...
     */
    public String mappingRequest(ExcluirContaContabilRequest message) {
     ...
     * objeto do tipo ExcluirContaContabilResponse.
     * 
	 * @param response Objeto do tipo ExcluirContaContabilResponse 
     ...
     */
    public ExcluirContaContabilResponse mappingResponse(String response) {

        ExcluirContaContabilResponse processResponse = new ExcluirContaContabilResponse();
        try {
            
            processResponse = 
            	(ExcluirContaContabilResponse) ExcluirContaContabilResponse.
