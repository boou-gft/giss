package br.com.bradesco.web.giss.service.data.pdc.consultarlistacontastiposervico;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarListaContasTipoServico
 * </p>
 * 
 ...
 */
public class ConsultarListaContasTipoServicoPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarListaContasTipoServicoPDCAdapter, IConsultarListaContasTipoServicoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultarlistacontastiposervico.IConsultarListaContasTipoServicoPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultarlistacontastiposervico.request.ConsultarListaContasTipoServicoRequest)
     * @param message Objeto do tipo ConsultarListaContasTipoServicoRequest 
     ...
     * @return Objeto do tipo ConsultarListaContasTipoServicoResponse 
     ...
     */
    public ConsultarListaContasTipoServicoResponse invokeProcess(
            ConsultarListaContasTipoServicoRequest message) 
     ...
     */
    public String mappingRequest(ConsultarListaContasTipoServicoRequest message) {
     ...
     * objeto do tipo ConsultarListaContasTipoServicoResponse.
     * 
	 * @param response Objeto do tipo ConsultarListaContasTipoServicoResponse 
     ...
     */
    public ConsultarListaContasTipoServicoResponse mappingResponse(String response) {

        ConsultarListaContasTipoServicoResponse processResponse = new ConsultarListaContasTipoServicoResponse();
        try {
            
            processResponse = 
            	(ConsultarListaContasTipoServicoResponse) ConsultarListaContasTipoServicoResponse.
