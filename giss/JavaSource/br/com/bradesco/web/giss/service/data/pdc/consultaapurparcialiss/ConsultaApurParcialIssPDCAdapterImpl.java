package br.com.bradesco.web.giss.service.data.pdc.consultaapurparcialiss;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultaApurParcialIss
 * </p>
 * 
 ...
 */
public class ConsultaApurParcialIssPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultaApurParcialIssPDCAdapter, IConsultaApurParcialIssAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.consultaapurparcialiss.IConsultaApurParcialIssPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.consultaapurparcialiss.request.ConsultaApurParcialIssRequest)
     * @param message Objeto do tipo ConsultaApurParcialIssRequest 
     ...
     * @return Objeto do tipo ConsultaApurParcialIssResponse 
     ...
     */
    public ConsultaApurParcialIssResponse invokeProcess(
            ConsultaApurParcialIssRequest message) 
     ...
     */
    public String mappingRequest(ConsultaApurParcialIssRequest message) {
     ...
     * objeto do tipo ConsultaApurParcialIssResponse.
     * 
	 * @param response Objeto do tipo ConsultaApurParcialIssResponse 
     ...
     */
    public ConsultaApurParcialIssResponse mappingResponse(String response) {

        ConsultaApurParcialIssResponse processResponse = new ConsultaApurParcialIssResponse();
        try {
            
            processResponse = 
            	(ConsultaApurParcialIssResponse) ConsultaApurParcialIssResponse.
