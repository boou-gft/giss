package br.com.bradesco.web.giss.service.data.pdc.excluircontaempresa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ExcluirContaEmpresa
 * </p>
 * 
 ...
 */
public class ExcluirContaEmpresaPDCAdapterImpl extends PdcBaseAdapter implements
        IExcluirContaEmpresaPDCAdapter, IExcluirContaEmpresaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.excluircontaempresa.IExcluirContaEmpresaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.excluircontaempresa.request.ExcluirContaEmpresaRequest)
     * @param message Objeto do tipo ExcluirContaEmpresaRequest 
     ...
     * @return Objeto do tipo ExcluirContaEmpresaResponse 
     ...
     */
    public ExcluirContaEmpresaResponse invokeProcess(
            ExcluirContaEmpresaRequest message) 
     ...
     */
    public String mappingRequest(ExcluirContaEmpresaRequest message) {
     ...
     * objeto do tipo ExcluirContaEmpresaResponse.
     * 
	 * @param response Objeto do tipo ExcluirContaEmpresaResponse 
     ...
     */
    public ExcluirContaEmpresaResponse mappingResponse(String response) {

        ExcluirContaEmpresaResponse processResponse = new ExcluirContaEmpresaResponse();
        try {
            
            processResponse = 
            	(ExcluirContaEmpresaResponse) ExcluirContaEmpresaResponse.
