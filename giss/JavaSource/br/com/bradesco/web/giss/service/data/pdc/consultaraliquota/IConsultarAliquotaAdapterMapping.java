 ...
 */
public interface IConsultarAliquotaAdapterMapping {
     ...
     */
    String mappingRequest(ConsultarAliquotaRequest message);
     ...
     */
    ConsultarAliquotaResponse mappingResponse(String response);
