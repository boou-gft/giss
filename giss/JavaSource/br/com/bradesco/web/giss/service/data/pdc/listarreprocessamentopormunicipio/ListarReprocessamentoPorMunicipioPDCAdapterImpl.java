package br.com.bradesco.web.giss.service.data.pdc.listarreprocessamentopormunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarReprocessamentoPorMunicipio
 * </p>
 * 
 ...
 */
public class ListarReprocessamentoPorMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IListarReprocessamentoPorMunicipioPDCAdapter, IListarReprocessamentoPorMunicipioAdapterMapping {
     ...
     */
    public ListarReprocessamentoPorMunicipioResponse invokeProcess(ListarReprocessamentoPorMunicipioRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarreprocessamentopormunicipio.IListarReprocessamentoPorMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarreprocessamentopormunicipio.request.ListarReprocessamentoPorMunicipioRequest)
     * @param message Objeto do tipo ListarReprocessamentoPorMunicipioRequest 
     ...
     * @return Objeto do tipo ListarReprocessamentoPorMunicipioResponse 
     ...
     */
    private ListarReprocessamentoPorMunicipioResponse invokeProcess(
            ListarReprocessamentoPorMunicipioRequest message, 
     ...
     */
    public String mappingRequest(ListarReprocessamentoPorMunicipioRequest message) {
     ...
     * objeto do tipo ListarReprocessamentoPorMunicipioResponse.
     * 
	 * @param response Objeto do tipo ListarReprocessamentoPorMunicipioResponse 
     ...
     */
    public ListarReprocessamentoPorMunicipioResponse mappingResponse(String response) {

        ListarReprocessamentoPorMunicipioResponse processResponse = new ListarReprocessamentoPorMunicipioResponse();
        try {
            
            processResponse = 
            	(ListarReprocessamentoPorMunicipioResponse) ListarReprocessamentoPorMunicipioResponse.
