 ...
 */
public interface IValidaInclusaoTipoIncidenciaAdapterMapping {
     ...
     */
    String mappingRequest(ValidaInclusaoTipoIncidenciaRequest message);
     ...
     */
    ValidaInclusaoTipoIncidenciaResponse mappingResponse(String response);
