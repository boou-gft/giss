 ...
 * Schema.
 * $Id: ListaExcluirCodLancamentoDescriptor.java,v 1.1 2017/07/06 14:31:58 gmichelini Exp $
 */
...
/**
 * Class ListaExcluirCodLancamentoDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2017/07/06 14:31:58 $
 */
public class ListaExcluirCodLancamentoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ListaExcluirCodLancamentoDescriptor() 
     {
        super();
        xmlName = "listaExcluirCodLancamento";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ListaExcluirCodLancamento target = (ListaExcluirCodLancamento) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _nomeConta
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_nomeConta", "nomeConta", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ListaExcluirCodLancamento target = (ListaExcluirCodLancamento) object;
                    target.setNomeConta( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _nomeConta
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
        ...
        desc.setValidator(fieldValidator);
        //-- _numParam
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Integer.TYPE, "_numParam", "numParam", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ListaExcluirCodLancamento target = (ListaExcluirCodLancamento) object;
                if(!target.hasNumParam())
                    return null;
                return new java.lang.Integer(target.getNumParam());
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setNumParam( ((java.lang.Integer)value).intValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.excluircodlancamento.request.ListaExcluirCodLancamentoDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.excluircodlancamento.request.ListaExcluirCodLancamento.class;
