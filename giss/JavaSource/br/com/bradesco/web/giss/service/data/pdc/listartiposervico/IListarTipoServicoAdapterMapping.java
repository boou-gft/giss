 ...
 */
public interface IListarTipoServicoAdapterMapping {
     ...
     */
    String mappingRequest(ListarTipoServicoRequest message);
     ...
     */
    ListarTipoServicoResponse mappingResponse(String response);
