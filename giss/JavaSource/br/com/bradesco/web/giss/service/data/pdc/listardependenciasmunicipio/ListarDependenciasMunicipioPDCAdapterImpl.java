package br.com.bradesco.web.giss.service.data.pdc.listardependenciasmunicipio;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarDependenciasMunicipio
 * </p>
 * 
 ...
 */
public class ListarDependenciasMunicipioPDCAdapterImpl extends PdcBaseAdapter implements
        IListarDependenciasMunicipioPDCAdapter, IListarDependenciasMunicipioAdapterMapping {
     ...
     */
    public ListarDependenciasMunicipioResponse invokeProcess(ListarDependenciasMunicipioRequest message) {
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listardependenciasmunicipio.IListarDependenciasMunicipioPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listardependenciasmunicipio.request.ListarDependenciasMunicipioRequest)
     * @param message Objeto do tipo ListarDependenciasMunicipioRequest 
     ...
     * @return Objeto do tipo ListarDependenciasMunicipioResponse 
     ...
     */
    private ListarDependenciasMunicipioResponse invokeProcess(
            ListarDependenciasMunicipioRequest message, 
     ...
     */
    public String mappingRequest(ListarDependenciasMunicipioRequest message) {
     ...
     * objeto do tipo ListarDependenciasMunicipioResponse.
     * 
	 * @param response Objeto do tipo ListarDependenciasMunicipioResponse 
     ...
     */
    public ListarDependenciasMunicipioResponse mappingResponse(String response) {

        ListarDependenciasMunicipioResponse processResponse = new ListarDependenciasMunicipioResponse();
        try {
            
            processResponse = 
            	(ListarDependenciasMunicipioResponse) ListarDependenciasMunicipioResponse.
