 ...
 */
public interface IManterAliquotaDetalheAdapterMapping {
     ...
     */
    String mappingRequest(ManterAliquotaDetalheRequest message);
     ...
     */
    ManterAliquotaDetalheResponse mappingResponse(String response);
