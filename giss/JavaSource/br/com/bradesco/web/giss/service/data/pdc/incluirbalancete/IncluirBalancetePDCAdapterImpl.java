package br.com.bradesco.web.giss.service.data.pdc.incluirbalancete;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: IncluirBalancete
 * </p>
 * 
 ...
 */
public class IncluirBalancetePDCAdapterImpl extends PdcBaseAdapter implements
        IIncluirBalancetePDCAdapter, IIncluirBalanceteAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarempresa.IIncluirBalancetePDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarempresa.request.IncluirBalanceteRequest)
     * @param message Objeto do tipo IncluirBalanceteRequest 
     ...
     * @return Objeto do tipo IncluirBalanceteResponse 
     ...
     */
    public IncluirBalanceteResponse invokeProcess(
            IncluirBalanceteRequest message) 
     ...
     */
    public String mappingRequest(IncluirBalanceteRequest message) {
     ...
     * objeto do tipo IncluirBalanceteResponse.
     * 
	 * @param response Objeto do tipo IncluirBalanceteResponse 
     ...
     */
    public IncluirBalanceteResponse mappingResponse(String response) {

        IncluirBalanceteResponse processResponse = new IncluirBalanceteResponse();
        try {
            
            processResponse = 
            	(IncluirBalanceteResponse) IncluirBalanceteResponse.
