 ...
 */
public interface IParametrizacaoDepExcluirAdapterMapping {
     ...
     */
    String mappingRequest(ParametrizacaoDepExcluirRequest message);
     ...
     */
    ParametrizacaoDepExcluirResponse mappingResponse(String response);
