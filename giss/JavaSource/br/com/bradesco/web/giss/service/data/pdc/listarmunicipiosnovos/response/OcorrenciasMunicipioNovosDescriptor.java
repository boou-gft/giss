 ...
 * Schema.
 * $Id: OcorrenciasMunicipioNovosDescriptor.java,v 1.4 2017/06/05 15:59:04 gmichelini Exp $
 */
 ...
 * 
 * @version $Revision: 1.4 $ $Date: 2017/06/05 15:59:04 $
 */
public class OcorrenciasMunicipioNovosDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OcorrenciasMunicipioNovosDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.response.OcorrenciasMunicipioNovosDescriptor()
    ...
    {
        return br.com.bradesco.web.giss.service.data.pdc.listarmunicipiosnovos.response.OcorrenciasMunicipioNovos.class;
