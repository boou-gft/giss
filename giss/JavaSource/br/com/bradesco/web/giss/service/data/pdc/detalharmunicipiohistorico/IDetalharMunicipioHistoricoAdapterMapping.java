 ...
 */
public interface IDetalharMunicipioHistoricoAdapterMapping {
     ...
     */
    String mappingRequest(DetalharMunicipioHistoricoRequest message);
     ...
     */
    DetalharMunicipioHistoricoResponse mappingResponse(String response);
