 ...
 */
public interface IListaPlanilhaApuracaoAdapterMapping {
     ...
     */
    String mappingRequest(ListaPlanilhaApuracaoRequest message);
     ...
     */
    ListaPlanilhaApuracaoResponse mappingResponse(String response);
