 ...
 */
public interface IAlterarCadastroEmpAdapterMapping {
     ...
     */
    String mappingRequest(AlterarCadastroEmpRequest message);
     ...
     */
    AlterarCadastroEmpResponse mappingResponse(String response);
