package br.com.bradesco.web.giss.service.data.pdc.listarhistoricoempresa;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ListarHistoricoEmpresa
 * </p>
 * 
 ...
 */
public class ListarHistoricoEmpresaPDCAdapterImpl extends PdcBaseAdapter implements
        IListarHistoricoEmpresaPDCAdapter, IListarHistoricoEmpresaAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @see br.com.bradesco.web.giss.service.data.pdc.listarhistoricoempresa.IListarHistoricoEmpresaPDCAdapter#
     *      invokeProcess(br.com.bradesco.web.giss.service.data.pdc.listarhistoricoempresa.request.ListarHistoricoEmpresaRequest)
     * @param message Objeto do tipo ListarHistoricoEmpresaRequest 
     ...
     * @return Objeto do tipo ListarHistoricoEmpresaResponse 
     ...
     */
    public ListarHistoricoEmpresaResponse invokeProcess(
            ListarHistoricoEmpresaRequest message) 
     ...
     */
    public String mappingRequest(ListarHistoricoEmpresaRequest message) {
     ...
     * objeto do tipo ListarHistoricoEmpresaResponse.
     * 
	 * @param response Objeto do tipo ListarHistoricoEmpresaResponse 
     ...
     */
    public ListarHistoricoEmpresaResponse mappingResponse(String response) {

        ListarHistoricoEmpresaResponse processResponse = new ListarHistoricoEmpresaResponse();
        try {
            
            processResponse = 
            	(ListarHistoricoEmpresaResponse) ListarHistoricoEmpresaResponse.
