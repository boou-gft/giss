package br.com.bradesco.web.giss.service.data.pdc.consultarhistoricotiposervico;
 ...
 * </p>
 * <p>
 * Classe implementadora do adaptador: ConsultarHistoricoTipoServico
 * </p>
 * 
 ...
 */
public class ConsultarHistoricoTipoServicoPDCAdapterImpl extends PdcBaseAdapter implements
        IConsultarHistoricoTipoServicoPDCAdapter, IConsultarHistoricoTipoServicoAdapterMapping {

    /**
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ConsultarHistoricoTipoServicoRequest que contém a informação necessária para invocar o processo PDC.
     * @return Objeto do tipo ConsultarHistoricoTipoServicoResponse que contém o resultado de chamar o processo no PDC.
     ...
     */
    public ConsultarHistoricoTipoServicoResponse invokeProcess(ConsultarHistoricoTipoServicoRequest message) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConsultarHistoricoTipoServicoResponse invokeProcess(ConsultarHistoricoTipoServicoRequest message, String stateID) 
     ...
     * Método Sobreescrito - Comentários: Método utilizado para chamar um processo de PDC.
     * 
     * @param message Objeto do tipo ConsultarHistoricoTipoServicoRequest 
     ...
     * @param stateID ID que identifica a sessão do PDC (caso ela tenha q manter o estado)
     * @return Objeto do tipo ConsultarHistoricoTipoServicoResponse 
     ...
     */
    private ConsultarHistoricoTipoServicoResponse invokeProcess(
            ConsultarHistoricoTipoServicoRequest message, 
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConsultarHistoricoTipoServicoResponse[] invokeProcess(ConsultarHistoricoTipoServicoRequest message, int numItensWeb, int numItensMF) {
     ...
     * @throws PdcConnectorException Representa qualquer exceção que pode ser produzido no Conector.
     */
    public ConsultarHistoricoTipoServicoResponse[] invokeProcess(ConsultarHistoricoTipoServicoRequest message, String stateID, int numItensWeb, int numItensMF) 
    	throws PdcAdapterException, PdcConnectorException {
     ...
     */
    public String mappingRequest(ConsultarHistoricoTipoServicoRequest message) {
     ...
     * objeto do tipo ConsultarHistoricoTipoServicoResponse.
     * 
	 * @param response Objeto do tipo ConsultarHistoricoTipoServicoResponse 
	 *         que contém a informação de retorno do processo PDC. 	     
     * @return Objeto do tipo ConsultarHistoricoTipoServicoResponse 
     *          que representa o resultado da invocação de um processo no PDC.
     */
    public ConsultarHistoricoTipoServicoResponse mappingResponse(String response) {

        ConsultarHistoricoTipoServicoResponse processResponse = new ConsultarHistoricoTipoServicoResponse();
        try {
            
            processResponse = 
            	(ConsultarHistoricoTipoServicoResponse) ConsultarHistoricoTipoServicoResponse.
