 ...
 */
public interface IIncluirJustificativaAdapterMapping {
     ...
     */
    String mappingRequest(IncluirJustificativaRequest message);
     ...
     */
    IncluirJustificativaResponse mappingResponse(String response);
