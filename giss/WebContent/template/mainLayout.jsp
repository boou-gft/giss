...
<f:view>
	...
	<body leftmargin="0" topmargin="0" scroll="no" onresize="resizeWorkArea();" onload="${onload}; esconderCombosModal();">
			...
			<b:brPanelGrid id="innerLayout" border="0" columns="1"
				...
				<b:brPanelGroup id="bodyContent">
					<b:brPanelGrid id="contentLayout" border="0" columns="1"
						...
						<t:div id="pageContent" style="height: 530; overflow: auto">
							...
							<c:if test="${isHome!=null}">
								...
								<%-- Fim Indicador de Passos --%>
									...
									<b:brPanelGroup id="pageBody" style="width: 752px">
