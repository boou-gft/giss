...
<brArq:form id="consultarBalanceteObrigacoesAcessoriasForm" name="consultarBalanceteObrigacoesAcessoriasForm">
...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="1" width="100%" cellpadding="0" cellspacing="0">	
		<br:brPanelGroup>	
	    	...
	    	<t:dataTable id="dataTable" value="#{consultarBalanceteObrigacoesAcessoriasBean.consultarBalanceteFiscalizacoesIssDTO.listarPedidoBalancetes}" rowIndexVar="parametroKey" var="result" rows="50" 
	...
	<br:brPanelGrid columns="1" width="100%" style="text-align:center" cellpadding="0" cellspacing="0">	
		<br:brPanelGroup>
			<brArq:pdcDataScroller id="dataScroller" for="dataTable" actionListener="#{consultarBalanceteObrigacoesAcessoriasBean.paginarListaPedido}" rendered="#{consultarBalanceteObrigacoesAcessoriasBean.consultarBalanceteFiscalizacoesIssDTO.listarPedidoBalancetes != null}">
