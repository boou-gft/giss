...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid styleClass="mainPanel" cellpadding="0" cellspacing="0" columns="1" width="100%"  >
		<br:brPanelGroup>
			<br:brOutputText styleClass="HtmlOutputTextTitleBradesco" value="#{msgs.consultarContasTipoServico_informacoesParaPesquisa}:"/>
		</br:brPanelGroup>
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="1" width="100%" cellpadding="0" cellspacing="0" rendered="#{contaContabilBean.carregaContas}">
		...
		<br:brPanelGrid styleClass="mainPanel" cellpadding="0" cellspacing="0" columns="2" width="100%" rendered="#{contaContabilBean.dto.listaContasContabeis!= null && contaContabilBean.carregaContas}" >
			<br:brPanelGroup>
				...
				<br:brPanelGrid columns="1" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" >	
					<br:brCommandButton id="btnPlanilhaEletronica" style="align:right"
...
{
	if (formulario.elements[i].id == 'consultarContaTipoServicoForm:tipoServico'){
		combo= formulario.elements[i].value;
	}
	
	if (formulario.elements[i].id == 'consultarContaTipoServicoForm:btnProsseguir'){
		if (combo == "" || combo == null)
...
function habilitarProsseguir(form, object){	
	...
	{
		if (form.elements[i].id == 'consultarContaTipoServicoForm:btnProsseguir'){
