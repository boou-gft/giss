...
<brArq:form id="manterMunicipioConsultaForm" name="manterMunicipioConsultaForm" >
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="4" cellpadding="0" cellspacing="0" >
		...
		<br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
			<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.manterMunicipio_label_razoes}: " />
			<br:brCommandButton image="/images/lupa.gif" id="btnConsultarMunicipio"  styleClass="HtmlCommandButtonBradesco"  value="#{msgs.manterMunicipio_label_resultadoConsultarMunicipio_consultar}" action="#{manterMunicipioBean.abreContasMunicipio}">
	...
	<br:brPanelGrid columns="3" cellpadding="0" cellspacing="0" >
		...
		<br:brPanelGroup>
			...
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{manterMunicipioBean.codDependenciaCentralizadora}" />	
		</br:brPanelGroup>	
		<br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
			<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.manterMunicipio_label_descricao}: " />
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{manterMunicipioBean.descDependenciaCentralizadora}" />
		</br:brPanelGroup>	
	    <br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
