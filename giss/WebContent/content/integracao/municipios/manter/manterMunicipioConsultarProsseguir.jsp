...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="1" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" >
		<br:brPanelGroup>
			<br:brCommandButton  id="btnProsseguir" disabled="true" styleClass="HtmlCommandButtonBradesco" value="#{msgs.resultadoDependenciasNovasAgencia_pesquisar}" action="#{manterMunicipioBean.carregaListaContasTipoServico}" onclick="javascript: return validateForm(document.forms[1]);">
	...
	<br:brPanelGrid columns="3" width="100%" cellpadding="0" cellspacing="0">	
		<br:brPanelGroup style="text-align:left;width:150px"  >
			<br:brCommandButton  id="btnVoltar" styleClass="HtmlCommandButtonBradesco" value="#{msgs.manterMunicipio_botao_voltar}" action="#{manterMunicipioBean.voltarPaginaDetalheConsulta}" >	
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>	
		...
		<br:brPanelGroup style="text-align:left;width:150px"  >
			<br:brCommandButton  id="btnPlanilhaEletronica" 
				...
				value="#{msgs.manterMunicipio_botao_planilha_eletronica}" 
				rendered="#{not empty manterMunicipioBean.listaContasTipoServico}"
				actionListener="#{manterMunicipioBean.imprimir}"
				onclick="desbloqTela()" >	
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>				
