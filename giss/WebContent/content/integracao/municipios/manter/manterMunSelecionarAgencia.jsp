...
<brArq:form id="manterMunicipioAlterarRecolhimentoForm" name="manterMunicipioAlterarRecolhimentoForm">
	<h:inputHidden id="hiddenRadio" value="#{manterMunicipioBean.codListaPesquisarAgencia}" />
	...
	<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
		...
		<br:brPanelGrid columns="1" width="465px" cellpadding="0"
			cellspacing="0">
			<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />
				<br:brOutputTextBold styleClass="HtmlOutputTextRespostaBradesco"
					value="#{msgs.path_manteMunicipio_resultadoPesquisaDependencias}:" />
			</br:brPanelGroup>
			...
			<br:brPanelGroup>
				<t:div styleClass="barraDeRolagem">
					...
					<t:dataTable id="dataTable"
						value="#{manterMunicipioBean.listaAgencias}" var="result"
						...
						<t:column width="25px">
							<f:facet name="header">
								<br:brOutputText value=""
									style="font-weight: bold;font-family: verdana;font-size: 10 px;"
									escape="false" />
							</f:facet>
							<t:selectOneRadio
								onclick="javascript:habilitarBotaoFinalizar(document.forms[1], this);"
								id="sor" styleClass="HtmlSelectOneRadioBradesco" layout="spread"
								forceId="true" forceIdIndex="false">
								<f:selectItems
									value="#{manterMunicipioBean.listaAgenciaControleCheckRadio}" />
							</t:selectOneRadio>
						...
						<t:column width="120px">
							<f:facet name="header">
								<br:brOutputText
									value="#{msgs.resultadoDependenciasNovasAgencia_agencia}"
							...
							<br:brOutputText value="#{result.codigoDependencia}"
								style="float:left; margin-left:5 px;" />
						</t:column>
						<t:column width="320px">
							<f:facet name="header">
								<h:outputText
									value="#{msgs.resultadoDependenciasNovasAgencia_nome}"
									style="margin-left:5 px;float:left;font-weight: bold;font-family: verdana;font-size: 10 px;"
									escape="false" />
							</f:facet>
		...
		<br:brPanelGrid columns="7" width="100%" cellpadding="0"
			cellspacing="0">
			<br:brPanelGroup>
				<f:verbatim>
					<hr class="lin">
		...
		<br:brPanelGrid columns="5" width="100%" style="text-align:right"
			cellpadding="0" cellspacing="0" border="0">
			<f:verbatim>
				<hr class="lin">
			</f:verbatim>
			<br:brPanelGroup style="text-align:left;width:150px">
				<br:brCommandButton styleClass="HtmlCommandButtonBradesco"
					value="#{msgs.resultadoDependenciasNovasAgencia_voltar}"
					action="#{manterMunicipioBean.voltarPaginaSelecionarMunicipio}">
					<brArq:submitCheckClient />
				</br:brCommandButton>
			</br:brPanelGroup>

			<br:brPanelGrid columns="1" style="width:480px" cellpadding="0"
				cellspacing="0">
				<br:brPanelGroup>
				</br:brPanelGroup>
			</br:brPanelGrid>
			...
			<br:brPanelGroup style="text-align:right;width:80px">
				<br:brCommandButton id="btnProsseguirContas"
					styleClass="HtmlCommandButtonBradesco"
					value="#{msgs.resultadoDependenciasNovasAgencia_prosseguir}"
					action="#{manterMunicipioBean.prosseguirSelecaoDependencia}"
					disabled="true">
					<brArq:submitCheckClient />
				</br:brCommandButton>
			</br:brPanelGroup>
