...
<brArq:form id="manterDependenciaAlterarRecolhimentoForm" name="manterDependenciaAlterarRecolhimentoForm" >
<h:inputHidden id="hiddenRadio" value="#{dependenciaBean.codListaPesquisarAgencia}"/>
...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="1" style="margin-top:9px" cellpadding="0" cellspacing="0" >
 	...
 	<br:brPanelGrid columns="1" width="440" style="text-align:center" cellpadding="0" cellspacing="0">	
		<br:brPanelGroup>
	...
	<br:brPanelGrid columns="7" width="100%" style="text-align:right" cellpadding="0" cellspacing="0" border="0">	
		...
		<br:brPanelGroup style="text-align:left;width:150px"  >
			<br:brCommandButton styleClass="HtmlCommandButtonBradesco" value="#{msgs.resultadoDependenciasNovasAgencia_voltar}" action="#{dependenciaBean.voltarManterDependenciasMunicipios}" >	
		...
		<br:brPanelGroup style="text-align:right;width:80px" >
			<br:brCommandButton id="btnProsseguir"  styleClass="HtmlCommandButtonBradesco" value="#{msgs.resultadoDependenciasNovasAgencia_prosseguir}" action="#{dependenciaBean.retornarInformacoesManterDependenciasPreenchido}" disabled="true">
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>
	</br:brPanelGrid>		
...
function habilitarBotaoFinalizar(form, radio){	
	...
	{
		if (form.elements[i].id == 'manterDependenciaAlterarRecolhimentoForm:btnProsseguir'){
			form.elements[i].disabled=false;
		}	
		if (form.elements[i].id == 'manterDependenciaAlterarRecolhimentoForm:hiddenRadio'){		
