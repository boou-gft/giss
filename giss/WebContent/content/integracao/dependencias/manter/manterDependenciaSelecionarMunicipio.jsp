...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="1" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" >	
		<br:brPanelGroup>
			<br:brCommandButton onclick="javascript: return validateForm(document.forms[1]);" id="btnProsseguirPesquisa" style="cursor:hand" styleClass="HtmlCommandButtonBradesco"  value="#{msgs.mantercontacontabil_btn_pesquisar}" action="#{dependenciaBean.pesquisarMunicipioIncorporaManter}">
				<brArq:submitCheckClient/>
			</br:brCommandButton>			
		</br:brPanelGroup>		
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="1" width="465px" cellpadding="0" cellspacing="0" rendered="#{dependenciaBean.mostraMunicipiosIncorpora}">			
		<br:brPanelGroup >
			<t:dataTable id="dataTable" value="#{dependenciaBean.listaMunicipiosAgIncorpora}" var="result" rows="50" 
	...
	<br:brPanelGroup style="height: 10px" />
	 ...
	 <br:brPanelGrid columns="1" width="440px" style="text-align:center" cellpadding="0" cellspacing="0" rendered="#{dependenciaBean.mostraMunicipiosIncorpora}">	
		<br:brPanelGroup>
		<brArq:pdcDataScroller id="dataScroller" for="dataTable"   actionListener="#{dependenciaBean.paginarListaMunicipiosManterAgIncorpora}" rendered="#{dependenciaBean.listaMunicipiosAgIncorpora != null &&  dependenciaBean.mostraBotoes}">
	...
	<br:brPanelGrid columns="4" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" >	
		
		<br:brPanelGroup>
			<br:brCommandButton styleClass="HtmlCommandButtonBradesco" value="#{msgs.resultadoDependenciasNovasInformacoes_voltar}" action="#{dependenciaBean.voltarInformacoesManter}" >	
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>	
		
		<br:brPanelGrid columns="1" style="width:570px" cellpadding="0" cellspacing="0" >
			<br:brPanelGroup> 
			</br:brPanelGroup>
		</br:brPanelGrid>	
		
		<br:brPanelGroup>
			<br:brCommandButton id="btnProsseguir" styleClass="HtmlCommandButtonBradesco" disabled="true" value="#{msgs.mantercontacontabil_btn_prosseguir}" action="#{dependenciaBean.retornarManterDependenciasAgencia}" disabled="#{dependenciaBean.codListaPesquisarMunicipio == 0}" disabled="true">
				<brArq:submitCheckClient/>
			</br:brCommandButton>			
		</br:brPanelGroup>		
	</br:brPanelGrid>
