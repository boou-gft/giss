...
<brArq:form id="manterDependenciaForm" name="manterDependenciaForm" >
	...
	<h:inputHidden id="hiddenRadio" value="#{dependenciaBean.codListaMunicipioSelecionado}"/>
    ...
    <br:brPanelGrid columns="5" cellpadding="0" cellspacing="0" >
		...
		<br:brSelectOneMenu style="width:180px" id="estado" value="#{dependenciaBean.estadoFiltro}">
		...
		<br:brCommandButton image="/images/lupa.gif" id="buttonBuscarMun" onclick="submit();" action="#{dependenciaBean.buscaMunicipioManter}">
	...
	<br:brPanelGrid columns="1" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" >	
		<br:brPanelGroup>
			<br:brCommandButton onclick="javascript: return validateForm(document.forms[1]);" id="btnProsseguirPesquisa" style="cursor:hand" styleClass="HtmlCommandButtonBradesco" value="#{msgs.mantercontacontabil_btn_pesquisar}" action="#{dependenciaBean.carregarListaMunicipiosManter}">
				<brArq:submitCheckClient/>
			</br:brCommandButton>			
		</br:brPanelGroup>		
	</br:brPanelGrid>
		
	<br:brPanelGrid columns="1" width="535" style="margin-top:5px;"cellpadding="0" cellspacing="0" rendered="#{dependenciaBean.mostraMunicipios}">	
		<br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
	...
	<br:brPanelGroup style="height: 10px" />
 	<br:brPanelGrid columns="1" width="520px" style="text-align:center" cellpadding="0" cellspacing="0" rendered="#{dependenciaBean.mostraMunicipios}">	
		<br:brPanelGroup>
		    <brArq:pdcDataScroller id="dataScroller" for="dataTable" actionListener="#{dependenciaBean.paginarListaMunicipiosManter}" >
	...
	<br:brPanelGrid columns="1" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" rendered="#{dependenciaBean.mostraMunicipios}">	
		<f:verbatim><hr class="lin"> </f:verbatim>
		<br:brPanelGroup>
			<br:brCommandButton id="btnProsseguir" styleClass="HtmlCommandButtonBradesco" value="#{msgs.mantercontacontabil_btn_prosseguir}" action="#{dependenciaBean.prosseguirManterDependencia}" disabled="#{dependenciaBean.codListaMunicipioSelecionado == 0}">
				<brArq:submitCheckClient/>
			</br:brCommandButton>			
		</br:brPanelGroup>		
	</br:brPanelGrid>
