...
<brArq:form id="resultadoDependenciasNovasAgenciaForm" name="resultadoDependenciasNovasAgenciaForm" >
...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="3" width="100%" style="text-align:right" cellpadding="0" cellspacing="0" border="0">	
		...
		<br:brPanelGroup style="text-align:left;width:150px"  >
			<br:brCommandButton styleClass="HtmlCommandButtonBradesco" value="#{msgs.resultadoDependenciasNovasAgencia_voltar}" action="#{dependenciaBean.voltarDependenciasMunicipios}" >	
		...
		<br:brPanelGroup style="text-align:right;width:80px" >
			<br:brCommandButton id="btnProsseguir" disabled="true" styleClass="HtmlCommandButtonBradesco"  onclick="javascript: return validateForm(document.forms[1]);" value="#{msgs.resultadoDependenciasNovasAgencia_prosseguir}" action="#{dependenciaBean.retornarInformacoesDependenciasNovasPreenchido}">
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>
	</br:brPanelGrid>		
...
function habilitarBotaoFinalizar(form, radio){	
	...
	{
		if (form.elements[i].id == 'resultadoDependenciasNovasAgenciaForm:btnProsseguir'){
			form.elements[i].disabled=false;
		}	
		if (form.elements[i].id == 'resultadoDependenciasNovasAgenciaForm:hiddenRadioGrid'){		
