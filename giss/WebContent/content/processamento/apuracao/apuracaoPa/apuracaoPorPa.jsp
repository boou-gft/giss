...
<brArq:form id="apuracaoPorPaForm" name="apuracaoPorPaForm" >
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="5" cellpadding="0" cellspacing="0">
			...
			<br:brSelectOneMenu style="width:180px" id="estado" value="#{apuracaoPorPaBean.estadoFiltro}" >
				<f:selectItem itemValue="" itemLabel="#{msgs.manter_dependencia_label_selecione}" />
				<f:selectItems value="#{apuracaoPorPaBean.listaEstados}" />
			</br:brSelectOneMenu>
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" />
			<br:brInputText id="inputCodigoMunicipio" maxlength="5" size="7" value="#{apuracaoPorPaBean.buscaMunicipio.codigo}" />
			<br:brCommandButton image="/images/lupa.gif" id="buttonBuscarMun" onclick="submit();" action="#{apuracaoPorPaBean.buscaMunicipioManter}">
				<brArq:submitCheckClient />
			</br:brCommandButton>
			<br:brInputText id="inputMunicipio" maxlength="60" size="70" value="#{apuracaoPorPaBean.buscaMunicipio.descricao}" />
		</br:brPanelGrid>
	...
	<br:brPanelGrid columns="3" width="100%" cellpadding="0" cellspacing="0" >	
		...
		<br:brPanelGrid columns="1">
			<br:brCommandButton id="botao_consultar"
					styleClass="HtmlCommandButtonBradesco"
					value="#{msgs.botao_consultar}" action="#{apuracaoPorPaBean.consultar}"
					onclick="desbloqTela();" style="margin-left:5px">
					<brArq:submitCheckClient />
				</br:brCommandButton>
		</br:brPanelGrid>
...
<t:aliasBeansScope>
	<t:aliasBean  alias="#{BuscaMunicipioBean}" value="#{apuracaoPorPaBean.buscaMunicipio}" />
