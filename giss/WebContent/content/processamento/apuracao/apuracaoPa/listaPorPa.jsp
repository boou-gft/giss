...
<brArq:form id="listaPorPaForm" name="listaPorPaForm" >
				...
				<t:div styleClass="barraDeRolagem">
						<t:dataTable id="dataTable"
							...
							<t:column width="250px"
								style="padding-right:5px; padding-left:5px;height:23px;">
								<f:facet name="header">
									<h:outputText value="#{msgs.label_receita}" />
								</f:facet>
	...
	<br:brPanelGrid columns="3" width="100%" cellpadding="0" cellspacing="0" >	
		<br:brPanelGroup style="text-align:left;width:150px">
			<br:brCommandButton id="botao_voltar"
					...
					value="#{msgs.botao_voltar}" action="apuracaoPorPa"
