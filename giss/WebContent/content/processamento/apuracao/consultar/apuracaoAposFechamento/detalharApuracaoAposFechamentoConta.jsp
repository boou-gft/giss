...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="3" rendered="#{!empty consultarApuracaoAposFechamentoBean.listaDependenciaApuracao}">
		<br:brPanelGroup>
			...
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{consultarApuracaoAposFechamentoBean.baseCalculoConta}" style="margin-right:20px"/>
		</br:brPanelGroup>		
		<br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet"/>	
			<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.consultarApuracaoAposFechamento_label_aliquota_padrao}:"/>
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{consultarApuracaoAposFechamentoBean.aliquotaPadraoConta}" style="margin-right:20px"/>
		</br:brPanelGroup>		
		<br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet"/>	
			<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.consultarApuracaoAposFechamento_label_tipo_incidencia}:"/>
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{consultarApuracaoAposFechamentoBean.tipoIncidenciaConta}"/>
		</br:brPanelGroup>		
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="3" rendered="#{!empty consultarApuracaoAposFechamentoBean.listaDependenciaApuracao}">
		...
		<br:brPanelGroup>
			...
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{consultarApuracaoAposFechamentoBean.detalheEstadoConta}" style="margin-right:20px"/>
		</br:brPanelGroup>		
		<br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet"/>	
			<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.consultarApuracaoAposFechamento_label_municipio}:"/>
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{consultarApuracaoAposFechamentoBean.detalheMunicipioCopnta}" style="margin-right:20px"/>
		</br:brPanelGroup>		
	</br:brPanelGrid>
		...
		<br:brPanelGroup>
				<t:div styleClass="barraDeRolagem">
						<t:dataTable id="dataTable"
							value="#{consultarApuracaoAposFechamentoBean.listaFinalConta}"
	...
	<br:brPanelGrid columns="6" cellpadding="0" cellspacing="0" rendered="#{!empty consultarApuracaoAposFechamentoBean.listaFinalConta}" width="100%">	
			<br:brPanelGroup>
			...
			<br:brPanelGroup>
				<br:brOutputText styleClass="HtmlOutputFormatBoldBradesco" value="#{consultarApuracaoAposFechamentoBean.totalMovimentoConta}" style="width:140px; padding-right:5px; padding-left:5px; text-align:right"/>	
			</br:brPanelGroup>	
			<br:brPanelGroup>
				<br:brOutputText styleClass="HtmlOutputFormatBoldBradesco" value="#{consultarApuracaoAposFechamentoBean.totalTributavelConta}" style="width:140px; padding-right:5px; padding-left:5px; text-align:right"/>	
			</br:brPanelGroup>
			<br:brPanelGroup>
				<br:brOutputText value="" style="width:130px;text-align:right"/>	
			</br:brPanelGroup>
			<br:brPanelGroup>
				<br:brOutputText styleClass="HtmlOutputFormatBoldBradesco" value="#{consultarApuracaoAposFechamentoBean.totalISSFinalConta}" style="width:140px; padding-right:5px; padding-left:5px; text-align:right"/>	
			</br:brPanelGroup>
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="3" width="100%" cellpadding="0" cellspacing="0">	
		<br:brPanelGroup>
			<br:brCommandButton id="btnVoltar" 
				...
				action="#{consultarApuracaoAposFechamentoBean.voltarRazap}" >
		...
		<br:brPanelGroup>
			<br:brCommandButton id="btnPlanilhaEletronica" 
				...
				actionListener="#{consultarApuracaoAposFechamentoBean.imprimirPlanilhaDetalheConta}"
				onclick="desbloqTela();">
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>	
