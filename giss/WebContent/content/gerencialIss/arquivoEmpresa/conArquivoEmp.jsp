...
<h:inputHidden id="hiddenProsseguir" value="#{arquivoEmpresaISSBean.hiddenProsseguir}"/>
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="5" cellpadding="0" cellspacing="0" >
		...
		<br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{msgs.label_mes_base}" />
		</br:brPanelGroup>
		<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco"/>
		<br:brPanelGroup> 
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
		...
		<br:brSelectOneMenu style="width:180px" id="estado" value="#{arquivoEmpresaISSBean.dto.codEmpresa}">
		...
		<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco"/>
		<br:brPanelGroup>
			<br:brInputText id="txtMesBase" value="#{arquivoEmpresaISSBean.dto.mesBase}" styleClass="HtmlInputTextBradesco" style="text-align: right" maxlength="2" size="3" onblur="validarData('incluirCodLancamentoForm','incluirCodLancamentoForm:txtMesBase','mes', '#{msgs.label_periodo_dia}', '#{msgs.label_periodo_mes}', '#{msgs.label_periodo_ano}')" onchange="habilitaBotaoConsultar()" onkeypress="aplicamascara('incluirCodLancamentoForm','incluirCodLancamentoForm:txtMesBase',numeros);" onkeyup="proximoCampo(2,'incluirCodLancamentoForm','incluirCodLancamentoForm:txtMesBase','incluirCodLancamentoForm:txtAnoBase');">
				<brArq:commonsValidator type="required" arg="#{msgs.label_mes_base}" server="false" client="true" />
			</br:brInputText>
			<f:verbatim>&nbsp;/&nbsp;</f:verbatim>
			<br:brInputText id="txtAnoBase" value="#{arquivoEmpresaISSBean.dto.anoBase}" styleClass="HtmlInputTextBradesco" style="text-align: right" maxlength="4" size="5" onblur="validarData('incluirCodLancamentoForm','incluirCodLancamentoForm:txtAnoBase', 'ano', '#{msgs.label_periodo_dia}', '#{msgs.label_periodo_mes}', '#{msgs.label_periodo_ano}');" onchange="habilitaBotaoConsultar()" onkeypress="onlyNum()" onfocus="cleanClipboard()">
				<brArq:commonsValidator type="required" arg="#{msgs.label_ano_base}" server="false" client="true" />
			</br:brInputText>
		</br:brPanelGroup>
		<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco"/>
		<br:brSelectOneMenu style="width:370px" id="produto" value="#{arquivoEmpresaISSBean.dto.codProduto}">
			<f:selectItem itemValue="0" itemLabel="#{msgs.manter_dependencia_label_selecione}"/>
	...
	<br:brPanelGrid columns="1" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" >	
		<br:brPanelGroup>
			...
			<br:brCommandButton id="btnIncluir" styleClass="HtmlCommandButtonBradesco"
				  value="#{msgs.botao_pesquisar}" action="#{arquivoEmpresaISSBean.pesquisar}" >
	...
	<br:brPanelGrid columns="1" width="100%" cellpadding="0" cellspacing="0">	
		...
		<t:dataTable id="dataTable" value="#{arquivoEmpresaISSBean.dto.lista}" var="result" rowIndexVar="indexLista"
			...
			headerClass="tabela_celula_destaque_acentuado"  width="3000px">			
			  ...
			  <t:column width="150px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_mes_competencia}" />
			    </f:facet>
			    <br:brOutputText value="#{result.anoMesFormatado}" />
			  </t:column>
			  <t:column width="150px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_data_recepcao}" />
			    </f:facet>
			    <br:brOutputText value="#{result.dataRecepcao}" />
			  </t:column>
			  <t:column width="150px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_status_Arquivo}" />
			    </f:facet>
			    <br:brOutputText value="#{result.statusArquivo}"/>
			  </t:column>
		      <t:column width="200px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_codigo_finalidade}" />
			    </f:facet>
			  ...
			  <t:column width="200px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_porcent_rejeicao}" />
			    </f:facet>
			    <br:brOutputText value="#{result.porcentRejeicao}"/>
			  </t:column>
			  <t:column width="180px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_receita_rejeitado}"  />
			    </f:facet>
			  ...
			  <t:column width="200px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_receita_aceita}" />
			    </f:facet>
			  ...
			  <t:column width="180px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_valor_receita_base_neg}" />
			    </f:facet>
			    <br:brOutputText value="#{result.valorReceitaBaseNegativa}" />
			  </t:column>
			  <t:column width="180px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_base_calc_apurada}" />
			    </f:facet>
			    <br:brOutputText value="#{result.baseCalcApurada}" />
			  </t:column>
			  <t:column width="200px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_valor_calc_iss}" />
			    </f:facet>
			  ...
			  <t:column width="200px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_percentual_base_calculo_prestador}" />
			    </f:facet>
			    <br:brOutputText value="#{result.percDistrIssPrestador}" />
			  </t:column>
			  <t:column width="200px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_valor_total_iss_prestador}" />
			    </f:facet>
			    <br:brOutputText value="#{result.valorTotalApuracaoPrestador}" />
			  </t:column>
			  <t:column width="200px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_percentual_base_calculo_tomador}" />
			    </f:facet>
			    <br:brOutputText value="#{result.percDistrIssTomador}" />
			  </t:column>
			  <t:column width="200px" style="padding-right:5px; padding-left:5px" >
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_valor_total_iss_tomador}" />
			    </f:facet>
			    <br:brOutputText value="#{result.valorTotalApuracaoTomador}" />
			  </t:column>
