...
<brArq:form id="alterarPercentualTransicaoForm" name="alterarPercentualTransicaoForm" >
	<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
		...
		<br:brPanelGrid columns="1" width="100%" cellpadding="0" cellspacing="0" >	
			<br:brPanelGroup>
				...
				<br:brCommandButton id="btnAlterar" styleClass="HtmlCommandButtonBradesco" value="#{msgs.botao_alterar}" action="#{parametrizarPercentualTransicaoBean.alterar}" style="float:right"
		...
		<script>
			var validacao = {
				...
				validarCamposNegocio : function() {
					var txtDataVigenciaInicio = document.getElementById("alterarPercentualTransicaoForm:txtDataVigenciaInicio");
					var txtDataVigenciaFim = document.getElementById("alterarPercentualTransicaoForm:txtDataVigenciaFim");
					var txtPercentualMunicipioPrestador = document.getElementById("alterarPercentualTransicaoForm:txtPercentualMunicipioPrestador");
					var txtPercentualMunicipioTomador = document.getElementById("alterarPercentualTransicaoForm:txtPercentualMunicipioTomador");
