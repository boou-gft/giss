...
<brArq:form id="consultarNaoElegiveis" name="consultarNaoElegiveis">
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
	...
	<br:brPanelGrid columns="1" width="100%" cellpadding="0" cellspacing="0">	
		...
		<t:dataTable id="dataTable" value="#{listarPgtosNaoElegiveisBean.dto.lista}" var="result" rowIndexVar="indexLista"
	...
	<br:brPanelGrid columns="2" width="100%" cellpadding="0" cellspacing="0" >	
		<br:brCommandButton id="btnVoltar" styleClass="HtmlCommandButtonBradesco" value="#{msgs.botao_voltar}" action="#{listarPgtosNaoElegiveisBean.voltar}">
		...
		<br:brPanelGrid width="100%" cellpadding="0" cellspacing="0" style="text-align:right">	
			<br:brPanelGroup>
			<%-- 
				<br:brCommandButton id="btnExportarTxt" styleClass="HtmlCommandButtonBradesco" value="#{msgs.btn_iss_gerencial_exportar_txt}" action="#{listarPgtosNaoElegiveisBean.exportarTxt}" style="margin-right:5px">
					<brArq:submitCheckClient/>
				</br:brCommandButton>
			--%>	
				<br:brCommandButton id="btnExportarExcel" styleClass="HtmlCommandButtonBradesco" value="#{msgs.btn_exportar_planilha_eletronica}" action="#{listarPgtosNaoElegiveisBean.imprimirPlanilha}" onclick="desbloquearTela();">
					<brArq:submitCheckClient/>
				</br:brCommandButton>
			</br:brPanelGroup>
		</br:brPanelGrid>
