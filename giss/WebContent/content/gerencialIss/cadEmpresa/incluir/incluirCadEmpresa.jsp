...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
    ...
    <br:brPanelGrid columns="5" cellpadding="0" cellspacing="0" >
		...
		<br:brPanelGroup>
    		<br:brInputText size="32" maxlength="5" id="txtCodigo" value="#{empresaISSBean.dtoIncluir.codEmpresa}" onkeyup="aplicamascara('incluirCodLancamentoForm', 'incluirCodLancamentoForm:txtCodigo',numeros);"/>  
		</br:brPanelGroup>		
	...
	<br:brPanelGrid columns="3" cellpadding="0" cellspacing="0" >
		<br:brInputText id="cnpj" maxlength="18" size="25" onfocus="loadMasks()" alt="cnpj" 
    	onkeypress="return validaTecla('0123456789', event)" value="#{empresaISSBean.dtoIncluir.cnpjFormatado}" />  
    	<br:brPanelGroup style="width:5px;" >
		</br:brPanelGroup>	
			<br:brCommandButton image="/images/lupa.gif" id="buttonBuscarNomeEmpresa" onclick="submit();" action="#{empresaISSBean.buscarDescCnpj}">
	...
	<br:brPanelGroup>
    	<br:brInputText size="60" maxlength="40" disabled="true" id="txtDescEmpresa" value="#{empresaISSBean.dtoIncluir.descEmpresa}"/>  
	</br:brPanelGroup>
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="3" cellpadding="0" cellspacing="0" >
		...
		<br:brPanelGroup>
			<br:brSelectOneMenu style="width:270px" id="sistemaContabil" value="#{empresaISSBean.dtoIncluir.combos.codSistemaContabil}">
		...
		<br:brPanelGroup>
	    	<br:brInputText id="percentualIss" maxlength="5" size="50" value="#{empresaISSBean.dtoIncluir.perRejeicaoArquivo}" onblur="vNumero(this,'9(2)V99')"/>    
		</br:brPanelGroup>
		...
		<br:brPanelGroup>
	    	<br:brInputText size="50" maxlength="18" id="txtContaDespesa" value="#{empresaISSBean.dtoIncluir.contaDespesa}" onkeyup="aplicamascara('incluirCodLancamentoForm', 'incluirCodLancamentoForm:txtContaDespesa',numeros);"/>  
		</br:brPanelGroup>
		...
		<br:brPanelGroup>
    		<br:brInputText size="50" maxlength="18" id="txtContaProvisao" value="#{empresaISSBean.dtoIncluir.contaProvisao}" onkeyup="aplicamascara('incluirCodLancamentoForm', 'incluirCodLancamentoForm:txtContaProvisao',numeros);"/>  
		</br:brPanelGroup>
		...
		<br:brPanelGroup>
    		<br:brInputText size="50" maxlength="4" onfocus="loadMasks()" id="txtIdentContribuinte" value="#{empresaISSBean.dtoIncluir.codigoContribuinte}" onkeypress="return validaTecla('0123456789', event)" /> 
		</br:brPanelGroup>
		<br:brPanelGroup style="width:20px; margin-bottom:5px" >
		</br:brPanelGroup>				
		<br:brPanelGroup>
			<br:brInputText size="50" maxlength="255" onfocus="loadMasks()" id="txtNomeContato" value="#{empresaISSBean.dtoIncluir.nomeResponsavel}" />
	    </br:brPanelGroup>
		...
		<br:brPanelGroup>
    		<br:brInputText size="50" maxlength="14" onfocus="loadMasks()" id="txtTelefone" value="#{empresaISSBean.dtoIncluir.telResponsavel}" onkeypress="return validaTecla('0123456789', event)"/>  
		</br:brPanelGroup>	
		<br:brPanelGroup style="width:20px; margin-bottom:5px" >
		</br:brPanelGroup>			
		<br:brPanelGroup>
			<br:brInputText size="50" maxlength="50" id="txtEmail" value="#{empresaISSBean.dtoIncluir.emailResponsavel}"/>
	    </br:brPanelGroup>
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="3" cellpadding="0" cellspacing="0" >
		...
		<br:brPanelGroup>
    		<br:brInputText size="93" maxlength="90" onfocus="loadMasks()" id="txtLogradouro" value="#{empresaISSBean.dtoIncluir.logradouro}"/>  
		</br:brPanelGroup>		
		<br:brPanelGroup style="width:20px; margin-bottom:5px" >
		</br:brPanelGroup>	
		<br:brPanelGroup>
			<br:brInputText size="7" maxlength="5" id="txtNroEndereco" value="#{empresaISSBean.dtoIncluir.nroEndereco}"/>
	    </br:brPanelGroup>
	 </br:brPanelGrid>
	...
	<br:brPanelGrid columns="3" cellpadding="0" cellspacing="0" >
		...
		<br:brPanelGroup>
    		<br:brInputText size="50" maxlength="22" onfocus="loadMasks()" id="txtCompl" value="#{empresaISSBean.dtoIncluir.complEndereco}"/>  
		</br:brPanelGroup>	
		<br:brPanelGroup style="width:20px; margin-bottom:5px" >
		</br:brPanelGroup>			
		<br:brPanelGroup>
			<br:brInputText size="50" maxlength="9" onfocus="loadMasks()" id="txtCep" value="#{empresaISSBean.dtoIncluir.cep}" onfocus="loadMasks()" alt="cep" 
		...
		<br:brPanelGroup>
    		<br:brInputText size="50" maxlength="40" onfocus="loadMasks()" id="txtBairro" value="#{empresaISSBean.dtoIncluir.bairro}" />  
		</br:brPanelGroup>	
		<br:brPanelGroup style="width:20px; margin-bottom:5px" >
		</br:brPanelGroup>			
		<br:brPanelGroup>
	...
	<br:brPanelGrid columns="5" cellpadding="0" cellspacing="0" >
		...
		<br:brSelectOneMenu style="width:180px; margin-left: 2px;" id="estado" value="#{empresaISSBean.dtoIncluir.estado}">
		...
		<br:brCommandButton style="margin-left: 5px;" image="/images/lupa.gif" id="buttonBuscarMunicipio" onclick="submit();" action="#{empresaISSBean.pesquisarMunicipioIncluir}">
			 <brArq:submitCheckClient />
		</br:brCommandButton>
    ...
    <br:brPanelGrid columns="9" cellpadding="0" cellspacing="0"  rendered="#{empresaISSBean.dtoIncluir.combos.codSistemaContabil != 1}">
        <br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
		...
		<br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet"/>	
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{msgs.label_iss_gerencial_desc_conta_receita}"/>
		</br:brPanelGroup>
		...
		<br:brPanelGroup>
    		<br:brInputText size="7" maxlength="5" id="txtCosif" value="#{empresaISSBean.dtoIncluir.contas.contaResumo}" onkeyup="aplicamascara('incluirCodLancamentoForm', 'incluirCodLancamentoForm:txtCosif',numeros);"/>  
		</br:brPanelGroup>		
		...
		<br:brPanelGroup>
    		<br:brInputText size="12" maxlength="11" id="txtContaResumo" value="#{empresaISSBean.dtoIncluir.contas.cosif}" onkeyup="aplicamascara('incluirCodLancamentoForm', 'incluirCodLancamentoForm:txtContaResumo',numeros);"/>  
		</br:brPanelGroup>
		...
		<br:brPanelGroup>
    		<br:brInputText size="25" maxlength="18" id="ContaReceita" value="#{empresaISSBean.dtoIncluir.contas.contaReceita}" onkeyup="aplicamascara('incluirCodLancamentoForm', 'incluirCodLancamentoForm:ContaReceita',numeros);"/>  
		</br:brPanelGroup>		
		...
		<br:brPanelGroup>
    		<br:brInputText size="50" maxlength="40" id="txtDescContaReceita" value="#{empresaISSBean.dtoIncluir.contas.descContaReceita}"/>  
		</br:brPanelGroup>		
		
		<br:brPanelGroup style="width:2px" >
		</br:brPanelGroup>		
		
		<br:brSelectOneMenu style="width:180px" id="descItemServico" value="#{empresaISSBean.dtoIncluir.contas.codItemServicoLC}">
				<f:selectItem itemValue="0" itemLabel="#{msgs.manter_dependencia_label_selecione}"/>
	...
	<br:brPanelGrid columns="7" cellpadding="0" cellspacing="0" rendered="#{empresaISSBean.dtoIncluir.combos.codSistemaContabil == 1}">
        <br:brPanelGroup>
			<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
			<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{msgs.label_iss_gerencial_conta_resumo}:" />
		</br:brPanelGroup>	
		...
		<br:brPanelGroup>
    		<br:brInputText size="7" maxlength="5" id="txtCosif2" value="#{empresaISSBean.dtoIncluir.contas.contaResumo}" onkeyup="aplicamascara('incluirCodLancamentoForm', 'incluirCodLancamentoForm:txtCodigo',numeros);"/>  
		</br:brPanelGroup>		
		
		<br:brPanelGroup style="width:2px" >
		</br:brPanelGroup>
		
		<br:brSelectOneMenu style="width:120px" id="comboCosif" value="#{empresaISSBean.dtoIncluir.contas.cosif}" rendered="#{empresaISSBean.dtoIncluir.combos.codSistemaContabil == 1}">
			<f:selectItem itemValue="0" itemLabel="#{msgs.manter_dependencia_label_selecione}"/>
			<f:selectItems value="#{empresaISSBean.selectItemCosif}"/>
			<a4j:support reRender="incluirCodLancamentoForm" event="onchange" action="#{empresaISSBean.carregarComboContaReceita}"/>
		</br:brSelectOneMenu>
		
		<br:brPanelGroup style="width:2px" >
		</br:brPanelGroup>			
		
		<br:brSelectOneMenu style="width:220px" id="comboContaReceita" value="#{empresaISSBean.dtoIncluir.contas.contaReceita}"  rendered="#{empresaISSBean.dtoIncluir.combos.codSistemaContabil == 1}">
			<f:selectItem itemValue="0" itemLabel="#{msgs.manter_dependencia_label_selecione}"/>
		...
		<br:brSelectOneMenu style="width:180px" id="descItemServico2" value="#{empresaISSBean.dtoIncluir.contas.codItemServicoLC}">
			<f:selectItem itemValue="0" itemLabel="#{msgs.manter_dependencia_label_selecione}"/>
			<f:selectItems value="#{empresaISSBean.selectItemServico}"/>
		</br:brSelectOneMenu>
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="1" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" >	
		<br:brPanelGroup>
			<br:brCommandButton id="btnIncluirConta" styleClass="HtmlCommandButtonBradesco" 
				value="#{msgs.label_iss_gerencial_incluir_conta}" action="#{empresaISSBean.incluirContaIncluir}" >
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="1" width="100%" cellpadding="0" cellspacing="0" >	
		...
		<t:dataTable id="dataTable" value="#{empresaISSBean.dtoIncluir.contas.listaContas}" var="result"  rowIndexVar="indexLista"
			...
			headerClass="tabela_celula_destaque_acentuado" width="750px">	
			   <t:column width="25px" >
				<f:facet name="header">
			      <t:selectBooleanCheckbox id="todos" styleClass="HtmlSelectOneRadioBradesco" value="#{empresaISSBean.checkTodosContas}">
						<a4j:support event="onclick" action="#{empresaISSBean.atribuirTodosIncluir}" reRender="dataTable" />
			  ...
			  <t:column width="60px" style="height:23px;">
			    ...
			    <f:facet name="header">
			      <h:outputText value="#{msgs.label_cosif}" style="margin-left:5 px; float:left;font-weight: bold;font-family: verdana;font-size: 10 px;"escape="false" />
			    </f:facet>
			  ...
			  <t:column width="340px" style="height:23px;">
			    <f:facet name="header">
			      <br:brOutputText value="#{msgs.label_iss_gerencial_conta_receita}" style="margin-left:5 px; float:left;font-weight: bold;font-family: verdana;font-size: 10 px;" escape="false" />
			    </f:facet>
 	...
 	<br:brPanelGrid columns="1" width="100%"  style="text-align:right" cellpadding="0" cellspacing="0" >	
		...
		<br:brPanelGroup>
			<br:brCommandButton id="btnExcluirConta" styleClass="HtmlCommandButtonBradesco" value="#{msgs.label_iss_gerencial_excluir_conta}" onclick="	
								if(!confirm('Deseja excluir a Conta?')){
									setHiddenProssegue(document.forms[1],false);
								}else{
									setHiddenProssegue(document.forms[1],true);
							    };" action="#{empresaISSBean.excluirContasIncluir}" >
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>
	</br:brPanelGrid>
	...
	<br:brPanelGrid columns="3" width="100%" cellpadding="0" cellspacing="0" >	
		...
		<br:brPanelGroup style="text-align:right;width:200px" >			
			<br:brCommandButton id="btnIncluir" styleClass="HtmlCommandButtonBradesco" onclick="	
								if(!confirm('Deseja Incluir o Cadastro da Empresa?')){
									setHiddenProssegue(document.forms[1],false);
								}else{
									setHiddenProssegue(document.forms[1],true);
							    };"
				  value="#{msgs.label_botao_incluir_empresa_iss}" action="#{empresaISSBean.confirmarInclusaoEmpresa}" >
				<brArq:submitCheckClient/>
			</br:brCommandButton>
		</br:brPanelGroup>
	</br:brPanelGrid>	
</br:brPanelGrid>
<br:brCommandButton style="visibility: hidden" id="botaoCombo" action="#{empresaISSBean.atualizaComboItemServico}">
				<brArq:submitCheckClient/>
			</br:brCommandButton>
