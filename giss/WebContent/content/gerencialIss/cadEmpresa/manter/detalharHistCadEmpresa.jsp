...
<br:brPanelGrid columns="1" width="750" cellpadding="0" cellspacing="0">
    ...
    <br:brPanelGrid columns="3" cellpadding="0" cellspacing="0" >
			...
			<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.codEmpresa}" />
			</br:brPanelGroup>	
			...
			<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.cnpjFormatado}" />
			</br:brPanelGroup>			
			...
			<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.descEmpresa}" />
			</br:brPanelGroup>	
		</br:brPanelGrid>
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.codigoContribuinte}" />
			</br:brPanelGroup>	
			
		  	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_nome_contato}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.nomeResponsavel}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.telResponsavel}" />
			</br:brPanelGroup>	
			
		  	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_email}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.emailResponsavel}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.logradouro}" />
			</br:brPanelGroup>	
			
		  	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_nro_endereco}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.nroEndereco}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.complEndereco}" />
			</br:brPanelGroup>	
			
		  	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_cep}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.cep}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.bairro}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="3" cellpadding="0" cellspacing="0" >
			...
			<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.descEstado}" />
			</br:brPanelGroup>	
			...
			<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.codMunicipio}" />
			</br:brPanelGroup>			
			...
			<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.descMunicipios}" />
			</br:brPanelGroup>	
		</br:brPanelGrid>
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
			<br:brPanelGroup>
				...
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.dataManutencaoFormatada} " />
			</br:brPanelGroup>
		
			<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_funcresp_atualizacao}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.codFuncao}" />
			</br:brPanelGroup>
		</br:brPanelGrid>
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_ident_contribuinte}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.codigoContribuinteAnterior}" />
			</br:brPanelGroup>	
			
		  	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_nome_contato}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.nomeResponsavelAnterior}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_telefone}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.telResponsavelAnterior}" />
			</br:brPanelGroup>	
			
		  	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_email}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.emailResponsavelAnterior}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_logradouro}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.logradouroAnterior}" />
			</br:brPanelGroup>	
			
		  	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_nro_endereco}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.nroEnderecoAnterior}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_complemento}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.complEnderecoAnterior}" />
			</br:brPanelGroup>	
			
		  	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_iss_gerencial_cep}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.cepAnterior}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
		 	<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="Bairro: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.bairroAnterior}" />
			</br:brPanelGroup>	
		...
		<br:brPanelGrid columns="3" cellpadding="0" cellspacing="0" >
			...
			<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.manter_dependencia_label_estado}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.descEstadoAnterior}" />
			</br:brPanelGroup>	
			...
			<br:brPanelGroup>
				...
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.geral_codigo_municipio_ibge}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.codMunicipioAnterior}" />
			</br:brPanelGroup>			
			...
			<br:brPanelGroup>
				...
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.geral_municipio}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.descMunicipiosAnterior}" />
			</br:brPanelGroup>	
		</br:brPanelGrid>
		...
		<br:brPanelGrid columns="2" cellpadding="0" cellspacing="0" > 
			<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_data_hora_atualizacao}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.dataManutencaoFormatadaAnterior} " />
			</br:brPanelGroup>
		
			<br:brPanelGroup>
				<br:brGraphicImage url="/images/bullet.jpg" styleClass="HtmlBullet" />	
				<br:brOutputText styleClass="HtmlOutputTextRotuloBradesco" value="#{msgs.label_funcresp_atualizacao}: " />
				<br:brOutputText styleClass="HtmlOutputTextRespostaBradesco" value="#{empresaISSBean.dtoHistoricoDet.codFuncaoAnterior}" />
			</br:brPanelGroup>
		</br:brPanelGrid>
	...
	<%--<br:brPanelGrid columns="1" width="100%" cellpadding="0" cellspacing="0" >	
		...
		<t:dataTable id="dataTable" value="#{empresaISSBean.dtoHistoricoDet.contas.listaContas}" var="result"  rowIndexVar="indexLista"
	...
	<br:brPanelGrid columns="3" width="100%" cellpadding="0" cellspacing="0" >	
		<br:brPanelGroup style="text-align:left;width:550px"  >
			<br:brCommandButton id="btnVoltar" styleClass="HtmlCommandButtonBradesco" value="#{msgs.botao_voltar}" action="historicoCadEmpresa" >
