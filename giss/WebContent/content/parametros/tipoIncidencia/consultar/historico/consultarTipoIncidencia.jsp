	...
	<br:brPanelGrid columns="1" width="750px" cellpadding="0" cellspacing="0">
		...
		<br:brPanelGrid columns="1" width="100%" cellpadding="0" cellspacing="0" styleClass="mainPanel"  >
			<br:brPanelGroup>
				...
				<br:brOutputText styleClass="" value="#{msgs.label_title_consultar_manterTipoIncidencia}:"/>
			</br:brPanelGroup>
		</br:brPanelGrid>
		...
		<br:brPanelGrid columns="1" cellpadding="0" cellspacing="0" style="text-align:left">
			<br:brPanelGroup>
				<br:brCommandButton id="btnVoltar" styleClass="HtmlCommandButtonBradesco" value="#{msgs.label_botao_voltar_consultar_manterTipoIncidencia}" action="voltar_historicotipoincidencia" style="margin-right:5px">
